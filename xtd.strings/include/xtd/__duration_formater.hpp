...
inline std::basic_string<Char> __make_string_from_duration(std::chrono::duration<Type, Period> value, bool constant = true) {
  ...
  if (std::chrono::duration_cast<std::chrono::hours>(value).count() / 24)
    result += xtd::strings::format(std::basic_string<Char> {'{', ':', 'D', '}', '.'}, std::chrono::duration_cast<std::chrono::hours>(value).count() / 24);
...
inline std::basic_string<Char> __duration_formater(std::basic_string<Char> fmt, const std::chrono::duration<Type, Period>& value, const std::locale& loc) {
  ...
  switch (fmt[0]) {
    ...
    case 'd': return xtd::strings::format(std::basic_string<Char> {'{', ':', 'D', '}'}, std::chrono::duration_cast<std::chrono::hours>(value).count() / 24);
    case 'D': return xtd::strings::format(std::basic_string<Char> {'{', ':', 'D', '2', '}'}, std::chrono::duration_cast<std::chrono::hours>(value).count() / 24);
    case 'f': return xtd::strings::format(std::basic_string<Char> {'{', ':', 'D', '}', ':', '{', ':', 'D', '}', ':', '{', ':', 'D', '2', '}', ':', '{', ':', 'D', '2', '}', ':', '{', ':', 'D', '9', '}'}, std::chrono::duration_cast<std::chrono::hours>(value).count() / 24, std::chrono::duration_cast<std::chrono::hours>(value).count() % 24, std::chrono::duration_cast<std::chrono::minutes>(value).count() % 60, std::chrono::duration_cast<std::chrono::seconds>(value).count() % 60, std::chrono::duration_cast<std::chrono::nanoseconds>(value).count() % 1000000000);
    case 'F': return xtd::strings::format(std::basic_string<Char> {'{', ':', 'D', '}', ':', '{', ':', 'D', '2', '}', ':', '{', ':', 'D', '2', '}', ':', '{', ':', 'D', '2', '}', ':', '{', ':', 'D', '9', '}'}, std::chrono::duration_cast<std::chrono::hours>(value).count() / 24, std::chrono::duration_cast<std::chrono::hours>(value).count() % 24, std::chrono::duration_cast<std::chrono::minutes>(value).count() % 60, std::chrono::duration_cast<std::chrono::seconds>(value).count() % 60, std::chrono::duration_cast<std::chrono::nanoseconds>(value).count() % 1000000000);
