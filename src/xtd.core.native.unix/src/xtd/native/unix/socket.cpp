...
int_least32_t socket::address_family_to_native(int_least32_t address_family) {
  static map<int_least32_t, int_least32_t> address_families = {{ADDRESS_FAMILY_UNKNOWN, -1}, {ADDRESS_FAMILY_UNSPECIFIED, AF_UNSPEC}, {ADDRESS_FAMILY_UNIX, AF_UNIX}, {ADDRESS_FAMILY_INTER_NETWORK, AF_INET}, {ADDRESS_FAMILY_SNA, AF_SNA}, /*{ADDRESS_FAMILY_IMP_LINK, AF_IMPLINK}, {ADDRESS_FAMILY_PUP, AF_PUP}, {ADDRESS_FAMILY_CHAOS, AF_CHAOS}, {ADDRESS_FAMILY_NS, AF_NS}, {ADDRESS_FAMILY_IPX, AF_}, {ADDRESS_FAMILY_ISO, AF_ISO}, {ADDRESS_FAMILY_ECMA, AF_ECMA}, {ADDRESS_FAMILY_DATA_KIT, AF_DATAKIT}, {ADDRESS_FAMILY_CCITT, AF_CCITT},*/ {ADDRESS_FAMILY_DEC_NET, AF_DECnet}, /*{ADDRESS_FAMILY_DATA_LINK, AF_DLI}, {ADDRESS_FAMILY_LAT, AF_LAT}, {ADDRESS_FAMILY_HYPER_CHANNEL, AF_HYLINK},*/ {ADDRESS_FAMILY_APPLE_TALK, AF_APPLETALK}, /*{ADDRESS_FAMILY_NET_BIOS, AF_NETBIOS}, {ADDRESS_FAMILY_VOICE_VIEW, AF_}, {ADDRESS_FAMILY_FIRE_FOX, AF_}, {ADDRESS_FAMILY_BANYAN, AF_}, {ADDRESS_FAMILY_ATM, AF_NATM},*/ {ADDRESS_FAMILY_INTER_NETWORK_V6, AF_INET6}, /*{ADDRESS_FAMILY_CLUSTER, AF_}, {ADDRESS_FAMILY_IEEE12844, AF_}, {ADDRESS_FAMILY_IRDA, AF_}, {ADDRESS_FAMILY_NETWORK_DESIGNERS, AF_},*/ {ADDRESS_FAMILY_MAX, AF_MAX}};
