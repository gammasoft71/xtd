...
constexpr int32_t SF_RIGHT_TO_LEFT = 0b1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_VERTICAL = 0b10;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_FIT_BLACK_BOX = 0b100;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_DISPLAY_FORMAT_CONTROL = 0b100000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_NO_FONT_FAILBACK = 0b10000000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_MEASURE_TRAILING_SPACES = 0b100000000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_NO_WRAP = 0b1000000000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_LINE_LIMIT = 0b10000000000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t SF_NO_CLIP = 0b100000000000000;
