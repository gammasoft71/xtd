  ...
  namespace drawing {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @return The created region handle.
        /// @warning Internal use only
        [[nodiscard]] static auto create_from_rect(float x, float y, float width, float height) -> xtd::intptr;
        
        /// @brief Creates a region with the specified graphics path.
        /// @param path A graphics path handle that defines the region.
        /// @return The created region handle.
        /// @warning Internal use only
        [[nodiscard]] static auto create_from_graphics_path(xtd::intptr path) -> xtd::intptr;
        ...
        /// @warning Internal use only
        static auto complement(xtd::intptr handle, xtd::intptr region) -> void;
        ...
        /// @warning Internal use only
        static auto exclude(xtd::intptr handle, xtd::intptr region) -> void;
        
        /// @brief Creates a region from a handle to the specified existing GDI region.
        /// @param hrgn A handle to an existing region.
        /// @return The created region handle.
        /// @warning Internal use only
        [[nodiscard]] static auto from_hrgn(xtd::intptr hrgn) -> xtd::intptr;
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto get_hrgn(xtd::intptr handle, xtd::intptr grpahics) -> xtd::intptr;
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto is_empty(xtd::intptr handle, xtd::intptr grpahics) -> bool;
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto is_infinite(xtd::intptr handle) -> bool;
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto is_infinite(xtd::intptr handle, xtd::intptr grpahics) -> bool;
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto is_visible(xtd::intptr handle, float x, float y) -> bool;
        /// @brief Tests whether the specified point is contained within the region when drawn using the specified graphics.
        /// @param handle The region handle.
        /// @param x The x-coordinate of the point to test.
        /// @param y The y-coordinate of the point to test.
        ...
        /// @return `true` when the specified point is contained within the region; otherwise, `false`.
        /// @warning Internal use only
        [[nodiscard]] static auto is_visible(xtd::intptr handle, float x, float y, xtd::intptr grpahics) -> bool;
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto is_visible(xtd::intptr handle, float x, float y, float width, float height) -> bool;
        ...
        /// @return `true` when any portion of the specified rectangle is contained within the region; otherwise, `false`.
        /// @warning Internal use only
        [[nodiscard]] static auto is_visible(xtd::intptr handle, float x, float y, float width, float height, xtd::intptr grpahics) -> bool;
        
        /// @brief Initializes the region to an empty interior.
        /// @param handle The region handle.
        /// @warning Internal use only
        static auto make_empty(xtd::intptr handle) -> void;
        ...
        /// @warning Internal use only
        static auto make_union(xtd::intptr handle, xtd::intptr region) -> void;
        ...
        /// @warning Internal use only
        static auto make_xor(xtd::intptr handle, xtd::intptr region) -> void;
        
        /// @brief Releases the handle of the region.
        /// @param region_handle The handle to the region.
        /// @warning Internal use only
        static auto release_hrgn(xtd::intptr region_handle) -> void;
        ...
        /// @warning Internal use only
        static auto translate(xtd::intptr handle, float dx, float dy) -> void;
        /// @}
      };
    }
  }
