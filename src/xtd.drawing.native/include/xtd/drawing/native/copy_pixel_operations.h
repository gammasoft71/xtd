...
constexpr int32_t CPO_BLACKNESS = 66;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_CAPTURE_BLT = 1073741824;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_DESTINATION_INVERT = 5570569;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_MERGE_COPY = 12583114;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_MERGE_PAINT = 12255782;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_NO_MIRROR_BITMAP = -2147483648;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_NOT_SOURCE_COPY = 3342344;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_NOT_SOURCE_ERASE = 1114278;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_PAT_COPY = 15728673;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_PAT_INVERT = 5898313;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_PAT_PAINT = 16452105;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_SOURCE_AND = 8913094;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_SOURCE_COPY = 13369376;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_SOURCE_ERASE = 4457256;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_SOURCE_INVERT = 6684742;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_SOURCE_PAINT = 15597702;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int32_t CPO_WHITENESS = 16711778;
