...
namespace xtd {
  ...
  /// @remarks The members of the xtd::month_of_year enumeration are not localized. To return the localized name of the month of the year, call the xtd::date_time::to_string(string) method with either the "j" or "J" format strings. The former format string produces the abbreviated month name; the latter produces the full month name.
