...
namespace xtd {
  ...
  namespace diagnostics {
    ...
    public:
      ...
      /// @return std::map<xtd::string, xtd::string> A generic dictionary containing the environment variables that apply to this process and its child processes.
      ...
      /// @return std::map<xtd::string, xtd::string> A string dictionary that provides environment variables that apply to this process and child processes. The default is empty.
    ...
    private:
      ...
      std::map<xtd::string, xtd::string> environment_variables_;
