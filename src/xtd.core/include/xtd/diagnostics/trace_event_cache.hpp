...
namespace xtd {
  ...
  namespace diagnostics {
    ...
    public:
      ...
      /// @cond
      trace_event_cache(const xtd::diagnostics::trace_event_cache& tec);
      auto operator =(const xtd::diagnostics::trace_event_cache& tec) -> trace_event_cache& = default;
      /// @endcond
      ...
      [[nodiscard]] auto call_stack() const noexcept -> xtd::string;
      ...
      [[nodiscard]] auto date_time() const noexcept -> const xtd::date_time&;
      ...
      [[nodiscard]] auto logical_operation_stack() const noexcept -> xtd::array<xtd::string>;
      ...
      [[nodiscard]] auto process_id() const noexcept -> xtd::int32;
      ...
      [[nodiscard]] auto thread_id() const noexcept -> xtd::string;
      ...
      [[nodiscard]] auto timestamp() const noexcept -> std::chrono::nanoseconds;
      ...
      /// @remarks The get accessor calls the Stopwatch.GetTimestamp method to get the timestamp. If the Stopwatch class uses a high-resolution performance counter, GetTimestamp returns the current value of that counter. If the Stopwatch class uses the system timer, GetTimestamp returns the Ticks property of DateTime.Now.
      [[nodiscard]] auto timestamp_milliseconds() const noexcept -> xtd::int64;
      ...
      /// @remarks The get accessor calls the Stopwatch.GetTimestamp method to get the timestamp. If the Stopwatch class uses a high-resolution performance counter, GetTimestamp returns the current value of that counter. If the Stopwatch class uses the system timer, GetTimestamp returns the Ticks property of DateTime.Now.
      [[nodiscard]] auto timestamp_nanoseconds() const noexcept -> xtd::int64;
      
      /// @brief Gets the current number of ticks in the timer mechanism, in nanoseconds.
      /// @return int64 The tick counter value of the underlying timer mechanism.
      /// @remarks The get accessor calls the Stopwatch.GetTimestamp method to get the timestamp. If the Stopwatch class uses a high-resolution performance counter, GetTimestamp returns the current value of that counter. If the Stopwatch class uses the system timer, GetTimestamp returns the Ticks property of DateTime.Now.
      [[nodiscard]] auto timestamp_ticks() const noexcept -> xtd::int64;
      /// @}
