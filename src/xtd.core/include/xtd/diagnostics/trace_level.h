...
template<> struct xtd::enum_register<xtd::diagnostics::trace_level> {
  void operator()(xtd::enum_collection<xtd::diagnostics::trace_level>& values, xtd::enum_type& type) {values = {{xtd::diagnostics::trace_level::off, "off"}, {xtd::diagnostics::trace_level::error, "error"}, {xtd::diagnostics::trace_level::warning, "warning"}, {xtd::diagnostics::trace_level::info, "info"}, {xtd::diagnostics::trace_level::verbose, "verbose"}};}
};
/// @endcond
