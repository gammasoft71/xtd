...
template<> struct xtd::enum_register<xtd::diagnostics::process_window_style> {
  void operator()(xtd::enum_collection<xtd::diagnostics::process_window_style>& values) {values = {{xtd::diagnostics::process_window_style::normal, "normal"}, {xtd::diagnostics::process_window_style::hidden, "hidden"}, {xtd::diagnostics::process_window_style::minimized, "minimized"}, {xtd::diagnostics::process_window_style::maximized, "maximized"}};}
};
/// @endcond
