        ...
        void parse_text(const xtd::string& text) {
          ...
          for (size_t index = 0; index < text.length(); index++) {
            if (text[index] == '/' && text[index + 1] == '*') {
              ...
              if (index == text.npos) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::format, "expected end comment");
              index++;
              start_index = index + 1;
              continue;
              ...
              if (xtd::string::is_empty(current_key)) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::format, "key cannot be empty");
              start_index = index + 1;
              ...
              if (xtd::string::is_empty(value)) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::format, "value cannot be empty");
              start_index = index + 1;
