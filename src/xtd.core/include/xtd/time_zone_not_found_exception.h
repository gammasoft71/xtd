...
/// @brief Helper on xtd::time_zone_not_found_exception to call it with caller information
/// @par Library
/// xtd.core
/// @ingroup xtd_core exceptions
/// @remarks Is equivalent to time_zone_not_found_exception({any argument}, csf_)
/// @code
/// void my_func() {
