...
namespace xtd {
  ...
  namespace io {
    ...
    /// @remarks For a list of common I/O tasks, see <a href="https://github.com/gammasoft71/xtd/blob/master/docs/common_io_tasks.md">Common I/O Tasks</a>.
    ...
    public:
      ...
      public:
        ...
        using value_type = xtd::ustring;
        using difference_type = xtd::ustring;
        using pointer = xtd::ustring*;
        using reference = xtd::ustring&;
