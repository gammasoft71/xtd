...
template<> struct xtd::enum_register<xtd::io::search_option> {
  static auto values() noexcept {return xtd::enum_collection<xtd::io::search_option> {{xtd::io::search_option::top_directory_only, "top_directory_only"}, {xtd::io::search_option::all_directories, "all_directories"}};}
};
/// @endcond
