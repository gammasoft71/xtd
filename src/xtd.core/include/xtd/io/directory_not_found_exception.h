...
/// @brief Helper on xtd::io::directory_not_found_exception to call it with caller information
/// @par Library
/// xtd.core
/// @ingroup xtd_core exceptions
/// @remarks Is equivalent to directory_not_found_exception({any argument}, csf_)
/// @code
/// void my_func() {
