...
namespace xtd {
  ...
  namespace expressions {
    ...
    struct multiplication_expression : expression_base {
      ...
      constexpr multiplication_expression(auto left, auto right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const multiplication_expression& e) -> std::ostream& {
    ...
    constexpr auto operator *(left_t left, right_t right) {
      return multiplication_expression<std::decay_t<decltype(as_expression(left))>, std::decay_t<decltype(as_expression(right))>> {as_expression(left), as_expression(right)};
    }
    /// @}
  }
}
