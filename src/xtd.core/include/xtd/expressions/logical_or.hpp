/// @file
/// @brief Contains xtd::expressions::logical_or operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::logical_or is the or expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    /// #include <xtd/expressions/logical_or>
    /// ```
    /// @par Library
    /// xtd.core
    /// @ingroup xtd_core
    /// @remarks The xtd::expressions::logical_or struct is used by xtd::expressions::expression::logical_or expression.
    template<typename left_t, typename right_t>
    struct logical_or : binary_expression {
      /// @name Public Fields
      ...
      /// @{
      /// @brief Initialize a new xtd::expressions::logical_or object.
      constexpr logical_or() = default;
      
      /// @brief Initialize a new xtd::expressions::logical_or object with specified left and right operands.
      /// @param left The left operand.
      /// @param right The right operand.
      constexpr logical_or(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const logical_or& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " || " << expression_stream {e.right, e.precedence};}
      /// @endcond
    ...
    constexpr auto expression::logical_or(left_t left, right_t right) {
      ...
      return expressions::logical_or<std::decay_t<decltype(left_expression)>, std::decay_t<decltype(right_expression)>> {std::move(left_expression), std::move(right_expression)};
    }
    /// @endcond
