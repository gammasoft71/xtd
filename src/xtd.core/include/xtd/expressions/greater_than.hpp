/// @file
/// @brief Contains xtd::expressions::greater_than operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::greater_than is the greater expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    /// #include <xtd/expressions/greater_than>
    /// ```
    /// @par Library
    /// xtd.core
    /// @ingroup xtd_core
    ...
    /// ```
    /// @remarks The xtd::expressions::greater_than struct is used by xtd::expressions::expression::greater_than expression.
    template<typename left_t, typename right_t>
    struct greater_than : binary_expression {
      /// @name Public Fields
      ...
      /// @{
      /// @brief Initialize a new xtd::expressions::greater_than object.
      constexpr greater_than() = default;
      
      /// @brief Initialize a new xtd::expressions::greater_than object with specified left and right operands.
      /// @param left The left operand.
      /// @param right The right operand.
      constexpr greater_than(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const greater_than& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " > " << expression_stream {e.right, e.precedence};}
      /// @endcond
    ...
    constexpr auto expression::greater_than(left_t left, right_t right) {
      ...
      return expressions::greater_than<std::decay_t<decltype(left_expression)>, std::decay_t<decltype(right_expression)>> {std::move(left_expression), std::move(right_expression)};
    }
    /// @endcond
