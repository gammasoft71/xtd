...
namespace xtd {
  ...
  namespace expressions {
    ...
    /// @par Header
    /// ```cpp
    /// #include <xtd/expressions/less_expression>
    /// ```
    /// @par Library
    /// xtd.core
    /// @ingroup xtd_core
    ...
    struct less_expression : expression {
      /// @name Public Fields
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const less_expression& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " < " << expression_stream {e.right, e.precedence};}
      /// @endcond
