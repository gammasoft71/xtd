/// @file
/// @brief Contains xtd::expressions::add operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::add is the add expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    /// #include <xtd/expressions/add>
    /// ```
    /// @par Library
    /// xtd.core
    /// @ingroup xtd_core
    ...
    struct add : binary_expression {
      ...
      /// @{
      /// @brief Initialize a new xtd::expressions::add object.
      constexpr add() = default;

      /// @brief Initialize a new xtd::expressions::add object with specified left and right operands.
      /// @param left The left operand.
      /// @param right The right operand.
      constexpr add(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const add& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " + " << expression_stream {e.right, e.precedence};}
      /// @endcond
    ...
    constexpr auto expression::add(left_t left, right_t right) {
      ...
      return expressions::add<std::decay_t<decltype(left_expression)>, std::decay_t<decltype(right_expression)>> {std::move(left_expression), std::move(right_expression)};
    }
    /// @endcond
