...
namespace xtd {
  ...
  namespace expressions {
    ...
    /// @par Header
    /// ```cpp
    /// #include <xtd/expressions/bitwise_not_expression>
    /// ```
    /// @par Library
    /// xtd.core
    ...
    struct bitwise_not_expression : expression {
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const bitwise_not_expression& e) -> std::ostream& {return os << "~" << expression_stream {e.value, e.precedence};}
      /// @endcond
