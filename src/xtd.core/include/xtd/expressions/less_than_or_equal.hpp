/// @file
/// @brief Contains xtd::expressions::less_than_or_equal operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::less_than_or_equal is the less or equal expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    ...
    /// xtd.core
    /// @ingroup xtd_core
    /// @remarks The xtd::expressions::less_than_or_equal struct is used by xtd::expressions::expression::less_than_or_equal expression.
    template<typename left_t, typename right_t>
    struct less_than_or_equal : binary_expression {
      /// @name Public Fields
      ...
      /// @{
      /// @brief Initialize a new xtd::expressions::less_than_or_equal object.
      constexpr less_than_or_equal() = default;
      
      /// @brief Initialize a new xtd::expressions::less_than_or_equal object with specified left and right operands.
      /// @param left The left operand.
      /// @param right The right operand.
      constexpr less_than_or_equal(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const less_than_or_equal& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " <= " << expression_stream {e.right, e.precedence};}
      /// @endcond
    ...
    constexpr auto expression::less_than_or_equal(left_t left, right_t right) {
      ...
      return expressions::less_than_or_equal<std::decay_t<decltype(left_expression)>, std::decay_t<decltype(right_expression)>> {std::move(left_expression), std::move(right_expression)};
    }
    /// @endcond
