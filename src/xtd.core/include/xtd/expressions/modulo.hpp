/// @file
/// @brief Contains xtd::expressions::modulo operator.
...
namespace xtd {
  ...
  namespace expressions {
    /// @brief The xtd::expressions::modulo is the modulo expression.
    /// @par Namespace
    /// xtd::expressions
    /// @par Header
    /// ```cpp
    ...
    /// xtd.core
    /// @ingroup xtd_core
    /// @remarks The xtd::expressions::modulo struct is used by xtd::expressions::expression::modulo expression.
    template<typename left_t, typename right_t>
    struct modulo : binary_expression {
      /// @name Public Fields
      ...
      /// @{
      /// @brief Initialize a new xtd::expressions::modulo object.
      constexpr modulo() = default;
      
      /// @brief Initialize a new xtd::expressions::modulo object with specified left and right operands.
      /// @param left The left operand.
      /// @param right The right operand.
      constexpr modulo(left_t left, right_t right) : left {std::move(left)}, right {std::move(right)} {}
      /// @}
      ...
      /// @cond
      friend inline auto operator <<(std::ostream& os, const modulo& e) -> std::ostream& {return os << expression_stream {e.left, e.precedence} << " & " << expression_stream {e.right, e.precedence};}
      /// @endcond
    ...
    constexpr auto expression::modulo(left_t left, right_t right) {
      ...
      return expressions::modulo<std::decay_t<decltype(left_expression)>, std::decay_t<decltype(right_expression)>> {std::move(left_expression), std::move(right_expression)};
    }
    /// @endcond
