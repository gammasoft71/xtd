...
namespace xtd {
  /// @concept xtd::signed_integer_32
  /// @brief Concept signed_integer_32.
  /// @par Definition
  /// ```cpp
  /// template<typename value_t>
  /// concept xtd::signed_integer_32 = std::same_as<value_t, xtd::int32>;
  /// ```
  /// @par Header
  /// ```cpp
  ...
  /// @par Examples
  /// The following code shows how to use xtd::signed_integer_32 conceps
  /// ```cpp
  /// #include <xtd/xtd>
  ///
