...
namespace xtd {
  ...
  public:
    ...
    explicit date_time(xtd::int64 ticks);
    /// @brief Initializes a new instance of the xtd::date_time structure to a specified number of ticks.
    /// @param ticks A date and time expressed in the number of 100-nanosecond intervals that have elapsed since January 1, 0001 at 00:00:00.000 in the Gregorian calendar.
    /// @exception xtd::argument_out_of_range_exception ticks is less than xtd::date_time::min_value or greater than xtd::date_time::max_value.
    /// @remarks The xtd::date_time::kind property is initialized to xtd::date_time_kind::unspecified.
    ...
    [[nodiscard]] auto date() const noexcept -> date_time;
    ...
    [[nodiscard]] auto day_of_year() const noexcept -> xtd::uint32;
    ...
    /// ```
    [[nodiscard]] auto hour() const noexcept -> xtd::uint32;
    ...
    [[nodiscard]] auto kind() const noexcept -> xtd::date_time_kind;
    ...
    /// ```
    [[nodiscard]] auto millisecond() const noexcept -> xtd::uint32;
    ...
    /// uint23_t millisecond = moment.millisecond();
    /// ```
    [[nodiscard]] auto minute() const noexcept -> xtd::uint32;
    ...
    /// uint23_t millisecond = moment.millisecond();
    /// ```
    [[nodiscard]] auto second() const noexcept -> xtd::uint32;
    ...
    [[nodiscard]] auto time_of_day() const noexcept -> xtd::time_span;
    ...
    [[nodiscard]] auto year() const noexcept -> xtd::uint32;
    /// @}
    ...
    [[nodiscard]] auto add(const xtd::time_span& value) const -> date_time;
    ...
    [[nodiscard]] auto add_days(double value) const -> date_time;
    ...
    [[nodiscard]] auto add_hours(double value) const -> date_time;
    ...
    [[nodiscard]] auto add_milliseconds(double value) const -> date_time;
    ...
    [[nodiscard]] auto add_minutes(double value) const -> date_time;
    ...
    [[nodiscard]] auto add_months(xtd::int32 months) const -> date_time;
    ...
    [[nodiscard]] auto add_seconds(double value) const -> date_time;
    ...
    /// @exception xtd::argument_out_of_range_exception The resulting xtd::date_time is less than xtd::date_time::min_value or greater than xtd::date_time::max_value.
    /// @remarks This method does not change the value of this xtd::date_time. Instead, it returns a new xtd::date_time whose value is the result of this operation.
    [[nodiscard]] auto add_ticks(xtd::int64 value) const -> date_time;
    ...
    [[nodiscard]] auto add_years(xtd::int32 value) const -> date_time;
    ...
    [[nodiscard]] auto compare_to(const date_time& value) const noexcept -> xtd::int32 override;
    ...
    [[nodiscard]] auto equals(const date_time& other) const noexcept -> bool override;
    ...
    [[nodiscard]] auto get_date_time_formats() const noexcept -> xtd::array<xtd::string>;
    ...
    [[nodiscard]] auto is_daylight_saving_time() const noexcept -> bool;
    ...
    [[nodiscard]] auto subtract(const date_time& value) const -> xtd::time_span;
    ...
    [[nodiscard]] auto subtract(const xtd::time_span& value) const -> date_time;
    ...
    [[nodiscard]] auto to_binary() const -> xtd::int64;
    ...
    [[nodiscard]] auto to_file_time() const -> xtd::int64;
    ...
    [[nodiscard]] auto to_file_time_utc() const -> xtd::int64;
    ...
    [[nodiscard]] auto to_local_time() const -> date_time;
    ...
    [[nodiscard]] auto to_long_date_string() const -> xtd::string;
    ...
    [[nodiscard]] auto to_long_time_string() const -> xtd::string;
    ...
    [[nodiscard]] auto to_short_date_string() const -> xtd::string;
    ...
    [[nodiscard]] auto to_short_time_string() const -> xtd::string;
    ...
    /// | `"D"`                      | Long date pattern.                                                               | 2009-06-15T13:45:30 -> Monday, June 15, 2009 (en-US) <br><br> 2009-06-15T13:45:30 -> понедельник, 15 июня 2009 г. (ru-RU) <br><br> 2009-06-15T13:45:30 -> Montag, 15. Juni 2009 (de-DE)                                                                       |
    ...
    /// | `"O"`, `"o"`               | round-trip date/time pattern. [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) | 2009-06-15T13:45:30 (date_time_kind::local) -> 2009-06-15T13:45:30.0000000-07:00 <br><br> 2009-06-15T13:45:30 (date_time_kind::utc) -> 2009-06-15T13:45:30.0000000Z <br><br> 2009-06-15T13:45:30 (date_time_kind::unspecified) -> 2009-06-15T13:45:30.0000000 |
    /// | `"R"`, `"r"`               | RFC1123 pattern.                                                                 | 2009-06-15T13:45:30 -> Mon, 15 Jun 2009 13:45:30 GMT                                                                                                                                                                                                          |
    /// | `"s"`                      | Sortable date/time pattern.                                                      | 2009-06-15T13:45:30 (date_time_kind::local) -> 2009-06-15T13:45:30 <br><br> 2009-06-15T13:45:30 (date_time_kind::utc) -> 2009-06-15T13:45:30                                                                                                                  |
    ...
    /// @remarks <br>The custom formatting codes for xtd::date_time::to_string (const xtd::string& format) are listed below:
    /// | Format                     | Description                                                                      | Examples                                                                                                                                                                                                                                                         |
    /// | -------------------------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    ...
    /// | `"ffff"`                   | The ten thousandths of a second in a date and time value.                        | 2009-06-15T13:45:30.6175000 -> 6175 <br><br> 6/15/2009 13:45:30.000005 -> 0000                                                                                                                                                                                   |
    ...
    /// | `"k"`                      | Time zone information.                                                           | 2009-06-15T13:45:30, Kind Unspecified -> <br><br> 2009-06-15T13:45:30, Kind Utc -> Z <br><br> 2009-06-15T13:45:30, Kind Local -> -07:00 (depends on local computer settings)                                                                                     |
    /// | `"m"`                      | The minute, from 0 to 59.                                                        | 2009-06-15T01:09:30 -> 9 <br><br> 2009-06-15T13:29:30 -> 29                                                                                                                                                                                                      |
    /// | `"mm"`                     | The minute, from 00 to 59.                                                       | 2009-06-15T01:09:30 -> 09 <br><br> 2009-06-15T13:29:30 -> 29                                                                                                                                                                                                     |
    ...
    /// | `"yyy"`                    | The year, with a minimum of three digits.                                        | 0001-01-01T00:00:00 -> 001 <br><br> 0900-01-01T00:00:00 -> 000 <br><br> 1900-01-01T00:00:00 -> 900 <br><br> 2019-06-15T13:45:30 -> 019                                                                                                                           |
    /// | `"yyyy"`                   | The year as a four-digit number.                                                 | 0001-01-01T00:00:00 -> 0001 <br><br> 0900-01-01T00:00:00 -> 0900 <br><br> 1900-01-01T00:00:00 -> 1900 <br><br> 2019-06-15T13:45:30 -> 2019                                                                                                                       |
    ...
    /// @remarks <br>The put string formatting codes for xtd::date_time::to_string (const xtd::string& format) are listed below (See [std::put_time](https://en.cppreference.com/w/cpp/io/manip/put_time) for more information.) :
    /// | Format              | Description                                                                                                                   | Examples                                                                                                                                                                                  |
    /// | ------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    /// | `%%a`               | The abbreviated weekday name.                                                                                                 | 2009-06-15T13:45:30 -> Mon (en-US) <br><br> 2009-06-15T13:45:30 -> Пн (ru-RU) <br><br> 2009-06-15T13:45:30 -> lun. (fr-FR)                                                                |
    /// | `%%A`               | The full weekday name.                                                                                                        | 2009-06-15T13:45:30 -> Monday (en-US) <br><br> 2009-06-15T13:45:30 -> понедельник (ru-RU) <br><br> 2009-06-15T13:45:30 -> lundi (fr-FR)                                                   |
    /// | `%%b`               | The abbreviated month name.                                                                                                   | 2009-06-15T13:45:30 -> Jun (en-US) <br><br> 2009-06-15T13:45:30 -> juin (fr-FR) <br><br> 2009-06-15T13:45:30 -> Jun (zu-ZA)                                                               |
    /// | `%%B`               | The full month name.                                                                                                          | 2009-06-15T13:45:30 -> June (en-US) <br><br> 2009-06-15T13:45:30 -> juni (da-DK) <br><br> 2009-06-15T13:45:30 -> uJuni (zu-ZA)                                                            |
    /// | `%%c`               | The standard date and time string.                                                                                            | 2009-06-15T13:45:30 -> Mon Jun 15 13:45:30 2009 (en-US) <br><br> 2009-06-15T13:45:30 -> 月  6/15 13:45:30 2009 (ja-JP) <br><br> 2009-06-15T13:45:30 -> lun. 15 juin 13:45:30 2009 (fr-FR) |
    /// | `%%C`               | The first 2 digits of year as a decimal number (range [00,99]).                                                               | 0001-01-01T00:00:00 -> 00 <br><br> 0900-01-01T00:00:00 -> 09 <br><br> 1900-01-01T00:00:00 -> 19 <br><br> 2019-06-15T13:45:30 -> 20                                                        |
    ...
    /// | `%%Ec`              | The alternative date and time string.                                                                                         | 2009-06-01T13:45:30 -> Mon Jun  1 13:45:30 2009 (en-US) <br><br> 2009-06-01T13:45:30 -> 月  6/ 1 13:45:30 2009 (jp-JA) <br><br> 2009-06-01T13:45:30 -> lun.  1 juin 13:45:30 2009 (fr-FR) |
    /// | `%%EC`              | The name of the base year (period) in the alternative representation.                                                         | 2009-06-01T13:45:30 -> 20 (en-US) <br><br> 2009-06-01T13:45:30 -> 20 (jp-JA) <br><br> 2009-06-01T13:45:30 -> 20 (fr-FR)                                                                   |
    /// | `%%Ex`              | The alternative date representation.                                                                                          | 2009-06-01T13:45:30 -> 6/1/2009 (en-US) <br><br> 2009-06-01T13:45:30 -> 2009/06/01 (jp-JA) <br><br> 2009-06-01T13:45:30 -> 01/06/2009 (fr-FR)                                             |
    /// | `%%EX`              | The alternative time representation.                                                                                          | 2009-06-01T13:45:30 -> 1:45:30 PM (en-US) <br><br> 2009-06-01T13:45:30 -> 13:45:30 (jp-JA) <br><br> 2009-06-01T13:45:30 -> 13:45:30 (fr-FR)                                               |
    /// | `%%Ey`              | The year as offset from alternative calendar period `%%EC`.                                                                   | 2009-06-01T13:45:30 -> 09 (en-US) <br><br> 2009-06-01T13:45:30 -> 09 (jp-JA) <br><br> 2009-06-01T13:45:30 -> 09 (fr-FR)                                                                   |
    /// | `%%EY`              | The year in the alternative representation.                                                                                   | 2009-06-01T13:45:30 -> 2009 (en-US) <br><br> 2009-06-01T13:45:30 -> 2009 (jp-JA) <br><br> 2009-06-01T13:45:30 -> 2009 (fr-FR)                                                             |
    /// | `%%F`               | The equivalent of `%%Y-%%m-%%d` (the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date format).                         | 2009-06-01T13:45:30 -> 2009-06-01                                                                                                                                                         |
    /// | `%%g`               | The last 2 digits of [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) week-based year.                                      | 2009-06-01T13:45:30 -> 09                                                                                                                                                                 |
    /// | `%%G`               | The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) week-based year.                                                       | 2009-06-01T13:45:30 -> 2009                                                                                                                                                               |
    /// | `%%h`               | The `%%b` synonym.                                                                                                            | 2009-06-15T13:45:30 -> Jun (en-US) <br><br> 2009-06-15T13:45:30 -> juin (fr-FR) <br><br> 2009-06-15T13:45:30 -> Jun (zu-ZA)                                                               |
    ...
    /// | `%%p`               | The a.m. / p.m. designator.                                                                                                   | 2009-06-15T13:45:30 -> PM (en-US) <br><br> 2009-06-15T13:45:30 -> 午後 (ja-JP) <br><br> 2009-06-15T13:45:30 -> (fr-FR)                                                                     |
    /// | `%%r`               | The localized 12-hour clock time.                                                                                             | 2009-06-15T13:45:30 -> 1:45:30 PM (en-US) <br><br> 2009-06-15T13:45:30 -> 13:45:30 (ja-JP) <br><br> 2009-06-15T13:45:30 -> 13:45:30 (fr-FR)                                               |
    /// | `%%R`               | The equivalent of `%%H:%%M`.                                                                                                  | 2009-06-15T13:45:30 -> 13:45                                                                                                                                                              |
    /// | `%%S`               | The second as a decimal number (range [00,60]).                                                                               | 2009-06-15T13:45:30 -> 30                                                                                                                                                                 |
    /// | `%%T`               | The equivalent of `%%H:%%M:%%S` (the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) time format).                         | 2009-06-15T13:45:30 -> 13:45:30                                                                                                                                                           |
    /// | `%%u`               | The weekday as a decimal number, where Monday is 1 ([ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format) (range [1-7]). | 2009-06-01T13:45:30 -> 1                                                                                                                                                                  |
    /// | `%%U`               | The week of the year as a decimal number (Sunday is the first day of the week) (range [00,53]).                               | 2009-06-01T13:45:30 -> 22                                                                                                                                                                 |
    /// | `%%V`               | The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) week of the year (range [01,53]).                                      | 2009-06-01T13:45:30 -> 23                                                                                                                                                                 |
    ...
    /// | `%%x`               | The localized date representation.                                                                                            | 2009-06-01T13:45:30 -> 6/1/2009 (en-US) <br><br> 2009-06-01T13:45:30 -> 2009/06/01 (jp-JA) <br><br> 2009-06-01T13:45:30 -> 01/06/2009 (fr-FR)                                             |
    /// | `%%X`               | The localized time representation.                                                                                            | 2009-06-15T13:45:30 -> 1:45:30 PM (en-US) <br><br> 2009-06-15T13:45:30 -> 13:45:30 (ja-JP) <br><br> 2009-06-15T13:45:30 -> 13:45:30 (fr-FR)                                               |
    ...
    /// | `%%z`               | The offset from UTC in the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.                                         | 2009-06-15T13:45:30+01:00 -> +0100                                                                                                                                                        |
    ...
    /// | `%%n`               | The newline character.                                                                                                        | 2009-06-15T13:45:30 (%%H%%n%M) -> 13<br>45                                                                                                                                                |
    /// | `%%t`               | The horizontal tab character.                                                                                                 | 2009-06-15T13:45:30 (%%H%%t%M) -> 13    45                                                                                                                                                |
    ...
    /// | `"Y"`, `"y"`               | Year month pattern.                                                              | 2009-06-15T13:45:30 -> June 2009 (en-US) <br><br> 2009-06-15T13:45:30 -> juni 2009 (da-DK) <br><br> 2009-06-15T13:45:30 -> Juni 2009 (id-ID)                                                                                                                  |
    /// | Any other single character | Unknown specifier.                                                               | Throws a run-time xtd::format_exception.                                                                                                                                                                                                                      |
    /// @remarks <br>The custom formatting codes for xtd::date_time::to_string (const xtd::string& format, const xtd::globalization::culture_info& culture) are listed below:
    /// | Format                     | Description                                                                      | Examples                                                                                                                                                                                                                                                         |
    /// | -------------------------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    /// | `"d"`                      | The day of the month, from 1 to 31.                                              | 2009-06-01T13:45:30 -> 1                                                                                                                                                                                                                                         |
    /// | `"dd"`                     | The day of the month, from 01 to 31.                                             | 2009-06-01T13:45:30 -> 01                                                                                                                                                                                                                                        |
    ...
    /// | `"\"`                      | The escape character.                                                            | 2009-06-15T13:45:30 (h \h) -> 1 h                                                                                                                                                                                                                                |
    /// | Any other character        | The character is copied to the result string unchanged.                          | 2009-06-15T01:45:30 (arr hh:mm t) -> arr 01:45 A                                                                                                                                                                                                                 |
    /// @remarks <br>The put string formatting codes for xtd::date_time::to_string (const xtd::string& format, const xtd::globalization::culture_info& culture) are listed below (See [std::put_time](https://en.cppreference.com/w/cpp/io/manip/put_time) for more information.) :
    /// | Format              | Description                                                                                                                   | Examples                                                                                                                                                                                  |
    /// | ------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    /// | `%%a`               | The abbreviated weekday name.                                                                                                 | 2009-06-15T13:45:30 -> Mon (en-US) <br><br> 2009-06-15T13:45:30 -> Пн (ru-RU) <br><br> 2009-06-15T13:45:30 -> lun. (fr-FR)                                                                |
    /// | `%%A`               | The full weekday name.                                                                                                        | 2009-06-15T13:45:30 -> Monday (en-US) <br><br> 2009-06-15T13:45:30 -> понедельник (ru-RU) <br><br> 2009-06-15T13:45:30 -> lundi (fr-FR)                                                   |
    ...
    [[nodiscard]] auto to_string(const xtd::globalization::culture_info& culture) const -> xtd::string;
    ...
    [[nodiscard]] auto to_time_t() const -> std::time_t;
    ...
    /// @remarks See <[std::chrono](https://en.cppreference.com/w/c/chrono.h) for more information.
    [[nodiscard]] auto to_tm() const -> std::tm;
    ...
    [[nodiscard]] auto to_universal_time() const -> date_time;
    /// @}
    ...
    [[nodiscard]] static auto now() noexcept -> date_time;
    ...
    [[nodiscard]] static auto today() noexcept -> date_time;
    ...
    [[nodiscard]] static auto utc_now() noexcept -> date_time;
    ...
    [[nodiscard]] static auto days_in_month(xtd::uint32 year, xtd::month_of_year month) -> xtd::int32;
    ...
    /// @include date_time_days_in_month2.cpp
    /// @remarks The xtd::date_time::days_in_month method always interprets month and year as the month and year of the Gregorian calendar.
    [[nodiscard]] static auto days_in_month(xtd::uint32 year, xtd::uint32 month) -> xtd::int32;
    ...
    [[nodiscard]] static auto from_binary(xtd::int64 date_data) -> date_time;
    ...
    [[nodiscard]] static auto from_file_time(xtd::int64 file_time) -> date_time;
    ...
    [[nodiscard]] static auto from_file_time_utc(xtd::int64 file_time) -> date_time;
    ...
    [[nodiscard]] static auto from_duration(const xtd::time_span& value) -> date_time;
    /// @brief Converts the specified xtd::time_span to an equivalent to Coordinated Universal Time (UTC) or local time..
    /// @param value A time interval from the start of the Clock's epoch.
    /// @param kind One of the enumeration values that indicates whether ticks specifies a local time, Coordinated Universal Time (UTC), or neither.
    /// @return An object that represents the unspecified time equivalent of the date and time represented by the file_time parameter.
    /// @exception xtd::argument_out_of_range_exception value is less than xtd::date_time:::min_value or represents a time greater than xtd::date_time:::max_value.
    static auto from_duration(const xtd::time_span& value, xtd::date_time_kind kind) -> date_time;
    ...
    /// @remarks [std::time_t](https://en.cppreference.com/w/cpp/chrono/c/time_t) is almost always an integral value holding the number of seconds (not counting leap seconds) since 00:00, Jan 1 1970 UTC, corresponding to POSIX time.
    /// @remarks See <[std::chrono](https://en.cppreference.com/w/c/chrono.h) for more information.
    [[nodiscard]] static auto from_time_t(std::time_t value) -> date_time;
    ...
    /// @remarks [std::time_t](https://en.cppreference.com/w/cpp/chrono/c/time_t) is almost always an integral value holding the number of seconds (not counting leap seconds) since 00:00, Jan 1 1970 UTC, corresponding to POSIX time.
    /// @remarks See <[std::chrono](https://en.cppreference.com/w/c/chrono.h) for more information.
    [[nodiscard]] static auto from_time_t(std::time_t value, xtd::date_time_kind kind) -> date_time;
    ...
    /// @remarks [std::tm](https://en.cppreference.com/w/c/chrono/tm) is a structure holding a calendar date and time broken down into its components. is almost always an integral value holding the number of seconds (not counting leap seconds) since 00:00, Jan 1 1970 UTC, corresponding to POSIX time.
    /// @remarks See <[std::chrono](https://en.cppreference.com/w/c/chrono.h) for more information.
    [[nodiscard]] static auto from_tm(const std::tm& value) -> date_time;
    ...
    /// @remarks [std::tm](https://en.cppreference.com/w/c/chrono/tm) is a structure holding a calendar date and time broken down into its components. is almost always an integral value holding the number of seconds (not counting leap seconds) since 00:00, Jan 1 1970 UTC, corresponding to POSIX time.
    /// @remarks See <[std::chrono](https://en.cppreference.com/w/c/chrono.h) for more information.
    [[nodiscard]] static auto from_tm(const std::tm& value, xtd::date_time_kind kind) -> date_time;
    ...
    [[nodiscard]] static auto is_leap_year(xtd::uint32 year) -> bool;
    ...
    [[nodiscard]] static auto parse(const xtd::string& s) -> date_time;
    /// @brief Converts the string representation of a date and time to its xtd::date_time equivalent by using the conventions of the current culture.
    /// @param s A string that contains a date and time to convert. See The string to parse for more information.
    /// @return An object that is equivalent to the date and time contained in s.
    /// @exception xtd::format_exception s does not contain a valid string representation of a date and time.
    ...
    /// @remarks This overload attempts to parse s by using the formatting conventions of the current culture. The current culture is indicated by the CurrentCulture property. To parse a string using the formatting conventions of a specific culture, call the Parse(String, IFormatProvider) or the Parse(String, IFormatProvider, DateTimeStyles) overloads.
    /// @remarks This overload attempts to parse s by using DateTimeStyles.AllowWhiteSpaces style.
    [[nodiscard]] static auto parse(const xtd::string& s, const xtd::globalization::culture_info& culture) -> date_time;
    ...
    /// The following example uses the xtd::date_time::specify_kind method to demonstrate how the xtd::date_time::kind property influences the xtd::date_time::to_local_time and xtd::date_time::to_universal_time conversion methods.
    /// @include date_time_specify_kind.cpp
    [[nodiscard]] static auto specify_kind(const date_time& value, xtd::date_time_kind kind) -> date_time;
    ...
    /// | `%%t`               | The horizontal tab character.                                                                                                 | 2009-06-15T13:45:30 (%%H%%t%M) -> 13    45                                                                                                                                                |
    /// | Any other character | The character is copied to the result string unchanged.                                                                       | 2009-06-15T01:45:30 (arr %%H:%%MT) -> arr 13:45T                                                                                                                                          |
    [[nodiscard]] static auto sprintf(const xtd::string& format, const xtd::date_time& value) -> xtd::string;
    /// @brief Returns a xtd::string that represents the current xtd::date_time.
    /// @param format Format-control String.
    /// @param value The xtd::date_time object to format.
    /// @param culture An xtd::globalization::culture_info object that contains culture information.
    ...
    /// | `%%t`               | The horizontal tab character.                                                                                                 | 2009-06-15T13:45:30 (%%H%%t%M) -> 13    45                                                                                                                                                |
    /// | Any other character | The character is copied to the result string unchanged.                                                                       | 2009-06-15T01:45:30 (arr %%H:%%MT) -> arr 13:45T                                                                                                                                          |
    [[nodiscard]] static auto sprintf(const xtd::string& format, const date_time& value, const xtd::globalization::culture_info& culture) -> xtd::string;
    ...
    [[nodiscard]] static auto try_parse(const xtd::string& s, date_time& result) noexcept -> bool;
    /// @brief Converts the specified string representation of a date and time to its xtd::date_time equivalent and returns a value that indicates whether the conversion succeeded.
    /// @param s A string containing a date and time to convert.
    /// @param result When this method returns, contains the xtd::date_time value equivalent to the date and time contained in s, if the conversion succeeded, or xtd::date_time::min_value if the conversion failed. The conversion fails if the s parameter is an empty string (""), or does not contain a valid string representation of a date and time.
    /// @return `true` if the s parameter was converted successfully; otherwise, `false`.
    /// @remarks The xtd::date_time::try_parse method is similar to the xtd::date_time::parse method, except that the xtd::date_time::try_parse method does not throw an exception if the conversion fails.
    [[nodiscard]] static auto try_parse(const xtd::string& s, date_time& result, const xtd::globalization::culture_info& culture) noexcept -> bool;
    
    [[nodiscard]] static auto try_parse_exact(const xtd::string& text, const xtd::string& format, date_time& result) noexcept -> bool;
    [[nodiscard]] static auto try_parse_exact(const xtd::string& text, const xtd::string& format, date_time& result, const xtd::globalization::culture_info& culture) noexcept -> bool;
    [[nodiscard]] static auto try_parse_exact(const xtd::string& text, const xtd::array<xtd::string>& formats, date_time& result) noexcept -> bool;
    [[nodiscard]] static auto try_parse_exact(const xtd::string& text, const xtd::array<xtd::string>& formats, date_time& result, const xtd::globalization::culture_info& culture) noexcept -> bool;
    /// @}
    
    /// @cond
    operator xtd::time_span() const;
    auto operator +=(const date_time& value) -> date_time = delete;
    auto operator +=(const xtd::time_span& value) -> date_time;
    auto operator -=(const date_time& value) -> xtd::time_span;
    auto operator -=(const xtd::time_span& value) -> xtd::time_span;
    auto operator +() const -> date_time;
    auto operator -() const -> date_time;
    auto operator +(const date_time& value) const -> date_time = delete;
    auto operator +(const xtd::time_span& value) const -> date_time;
    auto operator -(const date_time& value) const -> xtd::time_span;
    auto operator -(const xtd::time_span& value) const -> date_time;
    auto operator ++() -> date_time&;
    auto operator ++(int) -> date_time;
    auto operator --() -> date_time&;
    auto operator --(int) -> date_time;
  ...
  private:
    friend class xtd::time_zone_info;
    [[nodiscard]] auto utc_offset() const -> xtd::ticks;
    [[nodiscard]] auto get_date_time() const -> std::tuple<xtd::uint32, xtd::uint32, xtd::uint32, xtd::uint32, xtd::uint32, xtd::uint32, xtd::uint32, xtd::int32>;
    auto set_date_time(xtd::uint32 year, xtd::uint32 month, xtd::uint32 day, xtd::uint32 hour, xtd::uint32 minute, xtd::uint32 second, xtd::uint32 millisecond, xtd::date_time_kind kind) -> void;
    [[nodiscard]] static auto standard_format_to_custom_format(char standard_format, const xtd::globalization::culture_info& culture) noexcept -> xtd::string;
    [[nodiscard]] auto to_string_custom(const xtd::string& format, const xtd::globalization::culture_info& culture) const -> xtd::string;
    [[nodiscard]] auto to_string_put_time(const xtd::string& format, const xtd::globalization::culture_info& culture) const -> xtd::string;
    [[nodiscard]] auto to_string_standard(char format, const xtd::globalization::culture_info& culture) const -> xtd::string;
