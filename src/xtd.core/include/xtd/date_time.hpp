...
namespace xtd {
  ...
  public:
    ...
    /// @par Examples
    /// The following example shows how to use xtd::date_time::to_string(const xtd::string&) with differentt formats.
    /// @include date_time_to_string_format.cpp
    /// @remarks The standard formatting codes for xtd::date_time::to_string (const xtd::string&) are listed below:
    ...
    /// @remarks <br>The custom formatting codes for xtd::date_time::to_string (const xtd::string&) are listed below:
    /// | Format                     | Description                                                                      | Examples                                                                                                                                                                                                                                                         |
    /// | -------------------------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    ...
    /// @remarks <br>The put string formatting codes for xtd::date_time::to_string (const xtd::string&) are listed below (See [std::put_time](https://en.cppreference.com/w/cpp/io/manip/put_time) for more information.) :
    /// | Format              | Description                                                                                                                   | Examples                                                                                                                                                                                  |
    /// | ------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
