...
namespace xtd {
  ...
  public:
    ...
    /// | `"Y"`, `"y"`               | Year month pattern.                                                              | 2009-06-15T13:45:30 -> June 2009 (en-US) <br><br> 2009-06-15T13:45:30 -> juni 2009 (da-DK) <br><br> 2009-06-15T13:45:30 -> Juni 2009 (id-ID)                                                                                                                     |
    /// | Any other single character | Unknown specifier.                                                               | Throws a run-time xtd::format_exception.                                                                                                                                                                                                                         |
    /// @remarks The custom formatting codes for xtd::date_time::to_string (const xtd::string&) are listed below:
    /// | Format                     | Description                                                                      | examples                                                                                                                                                                                                                                                         |
    /// | -------------------------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    ...
    /// @remarks The put stting formatting codes for xtd::date_time::to_string (const xtd::string&) are listed below:
    /// | Format | Description                                                                                                                 |
    /// | ------ | --------------------------------------------------------------------------------------------------------------------------- |
