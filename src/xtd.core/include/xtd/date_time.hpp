...
namespace xtd {
  ...
  public:
    ...
    /// @remarks <br>The put stting formatting codes for xtd::date_time::to_string (const xtd::string&) are listed below (See [std::put_time](https://en.cppreference.com/w/cpp/io/manip/put_time) for more information.) :
    /// | Format              | Description                                                                                     | Examples                                                                                                                                                                                  |
    /// | ------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
