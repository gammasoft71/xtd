...
namespace xtd {
  ...
  enum class compiler_id {
    ...
    apple_clang,
    /// @brief The compiler is Microsoft Visual Studio.
    /// @deprecated Replaced by xtd::compiler_id::msvc - Will be removed in version 1.2.0.
    microsoft_visual_studio [[deprecated("Replaced by xtd::compiler_id::msvc - Will be removed in version 1.2.0.")]] = msvc,
  };
}
