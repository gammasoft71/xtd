...
namespace xtd {
  /// @concept xtd::integer_64
  /// @brief Concept integer_64.
  /// @par Definition
  /// ```cpp
  /// template<typename value_t>
  /// concept xtd::integer_64 = xtd::signed_integer_64<value_t> || xtd::unsigned_integer_64<value_t>;
  /// ```
  /// @par Header
  /// ```cpp
  ...
  /// @par Examples
  /// The following code shows how to use xtd::integer_64 conceps
  /// ```cpp
  /// #include <xtd/xtd>
  ///
