/// @file
/// @brief Contains xtd::unsigned_integer_32 concept documentation.
/// @copyright Copyright (c) 2026 Gammasoft. All rights reserved.
#pragma once
#error "Do not include this file: Internal use only. Include <xtd/unsigned_integer_32> or <xtd/unsigned_integer_32.hpp> instead."

/// @brief The xtd namespace contains all fundamental classes to access Hardware, Os, System, and more.
namespace xtd {
  /// @brief Represents the unsigned integer 32 bist concept.
  /// @par Definition
  /// ```cpp
  ...
  /// @par Examples
  /// The following code shows how to use xtd::unsigned_integer_32 concept
  /// ```cpp
  /// #include <xtd/xtd>
  ///
