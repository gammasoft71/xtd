...
namespace xtd {
  ...
  public:
    ...
    [[nodiscard]] static auto get_free_physical_memory() noexcept -> xtd::usize;
    ...
    [[nodiscard]] static auto get_free_process_memory() noexcept -> xtd::usize;
    ...
    [[nodiscard]] static auto get_free_virtual_memory() noexcept -> xtd::usize;
    ...
    [[nodiscard]] static auto get_total_physical_memory() noexcept -> xtd::usize;
    ...
    [[nodiscard]] static auto get_total_process_memory() noexcept -> xtd::usize;
    ...
    [[nodiscard]] static auto get_total_virtual_memory() noexcept -> xtd::usize;
    ...
    /// The following example shows how to retrieve some information about the memory.
    /// @include memory_information.cpp
    [[nodiscard]] static auto get_used_physical_memory() noexcept -> xtd::usize;
    ...
    /// The following example shows how to retrieve some information about the memory.
    /// @include memory_information.cpp
    [[nodiscard]] static auto get_used_process_memory() noexcept -> xtd::usize;
    ...
    /// The following example shows how to retrieve some information about the memory.
    /// @include memory_information.cpp
    [[nodiscard]] static auto get_used_virtual_memory() noexcept -> xtd::usize;
    /// @}
  };
}
