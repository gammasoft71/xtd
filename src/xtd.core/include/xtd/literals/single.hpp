...
namespace xtd {
  ...
  inline namespace literals {
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const char* s, xtd::usize n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const char8_t* s, xtd::usize n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const char16_t* s, xtd::usize n) -> float;
    ...
    /// xtd::console::out << U"125"_f << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_f(const char32_t* s, xtd::usize n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const wchar_t* s, xtd::usize n) -> float;
    /// @}
  }
}
