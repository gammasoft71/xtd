...
namespace xtd {
  ...
  inline namespace literals {
    ...
    /// ```
    [[nodiscard]] auto operator""_f(long double n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(unsigned long long n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const char* s, std::size_t n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const char8_t* s, std::size_t n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const char16_t* s, std::size_t n) -> float;
    ...
    /// xtd::console::out << U"125"_f << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_f(const char32_t* s, std::size_t n) -> float;
    ...
    /// ```
    [[nodiscard]] auto operator""_f(const wchar_t* s, std::size_t n) -> float;
    /// @}
  }
}
