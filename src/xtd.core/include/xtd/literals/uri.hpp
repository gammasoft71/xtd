...
namespace xtd {
  ...
  inline namespace literals {
    ...
    /// ```
    [[nodiscard]] auto operator""_uri(const char* s, xtd::usize n) -> xtd::uri;
    ...
    /// xtd::console::out << u << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_uri(const char8* s, xtd::usize n) -> xtd::uri;
    ...
    /// xtd::console::out << u << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_uri(const char16* s, xtd::usize n) -> xtd::uri;
    ...
    /// xtd::console::out << u << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_uri(const char32* s, xtd::usize n) -> xtd::uri;
    ...
    /// xtd::console::out << u << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_uri(const wchar* s, xtd::usize n) -> xtd::uri;
    /// @}
  }
}
