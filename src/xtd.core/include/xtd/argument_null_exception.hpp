...
namespace xtd {
  ...
  public:
    ...
    static void throw_if_null(const object_t* argument, const xtd::string& param_name = xtd::string::empty_string, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {if (!argument) throw argument_null_exception {string::format("The value cannot benull. (Parameter '{}')", param_name, stack_frame)};}
    /// @brief Throws an xtd::argument_null_exception if argument is null.
    ...
    /// @cond
    static void throw_if_null(std::nullptr_t argument, const xtd::string& param_name = xtd::string::empty_string, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {throw argument_null_exception {string::format("The value cannot be null. (Parameter '{}')", param_name, stack_frame)};}
    /// @endcond
    /// @}
