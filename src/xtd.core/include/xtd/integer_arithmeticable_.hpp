/// @file
/// @brief Contains xtd::integer_arithmeticable concept documentation.
/// @copyright Copyright (c) 2026 Gammasoft. All rights reserved.
#pragma once
#error "Do not include this file: Internal use only. Include <xtd/integer_arithmeticable> or <xtd/integer_arithmeticable.hpp> instead."

/// @brief The xtd namespace contains all fundamental classes to access Hardware, Os, System, and more.
namespace xtd {
  /// @brief Represents the integer arithmeticable concept.
  /// @par Definition
  /// ```cpp
