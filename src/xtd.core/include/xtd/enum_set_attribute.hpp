...
namespace xtd {
  ...
  struct enum_set_attribute {
    ...
    /// };
    /// ```
    static auto attribute() noexcept {return xtd::enum_attribute::standard;}
  };
}

/// @cond
template<> struct xtd::enum_register<xtd::enum_attribute> {
  static auto values() noexcept {return xtd::enum_collection<xtd::enum_attribute> {{enum_attribute::standard, "standard"}, {enum_attribute::flags, "flags"}};}
};
...
template<> struct xtd::enum_register<xtd::string_split_options> {
  static auto values() noexcept {return xtd::enum_collection<xtd::string_split_options> {{xtd::string_split_options::none, "none"}, {xtd::string_split_options::remove_empty_entries, "remove_empty_entries"}};}
};
