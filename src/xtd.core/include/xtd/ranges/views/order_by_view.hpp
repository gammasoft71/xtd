    ...
    namespace views {
      ...
      class order_by_view {
        ...
        struct with_key_selector {
          ...
          auto operator()(range_t&& source) const {return xtd::linq::enumerable::as_enumerable(std::forward<range_t>(source)).order_by(key_selector);}
      ...
      public:
        ...
        auto operator()(range_t&& source, const key_selector_t& key_selector) const {return xtd::linq::enumerable::from(std::forward<range_t>(source)).order_by(key_selector);}
        /// @brief Sorts the elements of a sequence in ascending order according to a key.
        /// @tparam range_t The type of the elements of source.
        /// @param key_selector A function to extract a key from an element.
        template <typename key_selector_t>
        ...
        friend auto operator |(range_type&& source, const order_by_view& view) {return view(std::forward<range_type>(source));}
        /// @}
      };
    }
  }
