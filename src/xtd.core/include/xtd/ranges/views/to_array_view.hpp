  ...
  namespace ranges {
    ...
    namespace views {
      ...
      public:
        ...
        auto operator()(iterable_t&& source) const {return xtd::linq::enumerable::from(std::forward<iterable_t>(source)).to_array();}
        ...
        /// @endcode
        template <xtd::iterable iterable_t>
        friend auto operator |(iterable_t&& source, const to_array_view& view) {return view(std::forward<iterable_t>(source));}
        /// @}
      };
    }
  }
