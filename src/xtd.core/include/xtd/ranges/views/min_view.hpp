/// @file
/// @brief Contains xtd::ranges::views::min_view class.
  ...
  namespace ranges {
    ...
    namespace views {
      ...
      public:
        ...
        auto operator()(range_t&& source) const {return xtd::linq::enumerable::from(std::forward<range_t>(source)).min();}
        
        template <std::ranges::range range_t>
        friend auto operator |(range_t&& source, const min_view& view) {return view(std::forward<range_t>(source));}
        /// @}
      };
    }
  }
