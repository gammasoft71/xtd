...
namespace xtd {
  ...
  namespace text {
    /// @brief Represents a mutable string of characters of UTF-16 code units. This class cannot be inherited.
    /// @par Namespace
    /// xtd::text
    /// @par Library
    /// xtd.core
    /// @ingroup xtd_core system text strings
    /// @remarks xtd::text::u16string_builder class represents a string-like object whose value is a mutable sequence of characters.
    /// @remarks xtd::text::u16string_builder implements [std::u16string](https://en.cppreference.com/w/cpp/string/basic_string) and therefore offers the full API of [std::u16string](https://en.cppreference.com/w/cpp/string/basic_string).
