...
namespace xtd {
  ...
  public:
    ...
    [[nodiscard]] auto desktop_environment() const noexcept -> xtd::string;
    ...
    [[nodiscard]] auto platform() const noexcept -> xtd::platform_id;
    ...
    [[nodiscard]] auto service_pack() const noexcept -> xtd::string;
    ...
    [[nodiscard]] auto is_apple_platform() const noexcept -> bool;
    ...
    [[nodiscard]] auto is_bsd_platform() const noexcept -> bool;
    ...
    [[nodiscard]] auto is_posix_platform() const noexcept -> bool;
    ...
    /// @note In this implementation, Unix and POSIX platforms overlap significantly but are semantically distinguished.
    [[nodiscard]] auto is_unix_platform() const noexcept -> bool;
    ...
    [[nodiscard]] auto is_windows_ce() const noexcept -> bool;
