/// @file
/// @brief Contains xtd::real_decimal concept documentation.
/// @copyright Copyright (c) 2026 Gammasoft. All rights reserved.
#pragma once
#error "Do not include this file: Internal use only. Include <xtd/real_decimal> or <xtd/real_decimal.hpp> instead."

/// @brief The xtd namespace contains all fundamental classes to access Hardware, Os, System, and more.
namespace xtd {
  /// @brief Represents the real decimal concept.
  /// @par Definition
  /// ```cpp
  ...
  /// @par Examples
  /// The following code shows how to use xtd::real_decimal concept
  /// ```cpp
  /// #include <xtd/xtd>
  ///
