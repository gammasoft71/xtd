...
namespace xtd {
  ...
  [[nodiscard]] auto sprintf(const xtd::string& fmt, args_t&& ... args) -> xtd::string {return xtd::string::sprintf(fmt, std::forward<args_t>(args)...);}
  /// @brief Writes the text representation of the specified arguments list, to basic_string using the specified format information.
  /// @param fmt A composite format basic_string.
  /// @param args arguments list to write using format.
  /// @return basic_string formatted.
  ...
  /// @remarks you can use std::basic_string or std::wstring with format param %%s.
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const xtd::u8string& fmt, args_t&& ... args) -> xtd::u8string {return xtd::string::sprintf(fmt.to_string(), std::forward<args_t>(args)...);}
  /// @brief Writes the text representation of the specified arguments list, to basic_string using the specified format information.
  /// @param fmt A composite format basic_string.
  /// @param args arguments list to write using format.
  /// @return basic_string formatted.
  ...
  /// @remarks you can use std::basic_string or std::wstring with format param %%s.
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const xtd::u16string& fmt, args_t&& ... args) -> xtd::u16string {return xtd::string::sprintf(fmt.to_string(), std::forward<args_t>(args)...);}
  /// @brief Writes the text representation of the specified arguments list, to basic_string using the specified format information.
  /// @param fmt A composite format basic_string.
  /// @param args arguments list to write using format.
  /// @return basic_string formatted.
  ...
  /// @remarks you can use std::basic_string or std::wstring with format param %%s.
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const xtd::u32string& fmt, args_t&& ... args) -> xtd::u32string {return xtd::string::sprintf(fmt.to_string(), std::forward<args_t>(args)...);}
  /// @brief Writes the text representation of the specified arguments list, to basic_string using the specified format information.
  /// @param fmt A composite format basic_string.
  /// @param args arguments list to write using format.
  /// @return basic_string formatted.
  ...
  /// @remarks you can use std::basic_string or std::wstring with format param %%s.
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const xtd::wstring& fmt, args_t&& ... args) -> xtd::wstring {return xtd::string::sprintf(fmt.to_string(), std::forward<args_t>(args)...);}
  
  /// @cond
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const char* fmt, args_t&& ... args) -> xtd::string {return xtd::string::sprintf(std::string {fmt}, std::forward<args_t>(args)...);}
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const char8_t* fmt, args_t&& ... args) -> xtd::u8string {return xtd::string::sprintf(std::u8string {fmt}, std::forward<args_t>(args)...);}
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const char16_t* fmt, args_t&& ... args) -> xtd::u16string {return xtd::string::sprintf(std::u16string {fmt}, std::forward<args_t>(args)...);}
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const char32_t* fmt, args_t&& ... args) -> xtd::u32string {return xtd::string::sprintf(std::u32string {fmt}, std::forward<args_t>(args)...);}
  template<typename ...args_t>
  [[nodiscard]] auto sprintf(const wchar_t* fmt, args_t&& ... args) -> xtd::wstring {return xtd::string::sprintf(std::wstring {fmt}, std::forward<args_t>(args)...);}
  /// @endcond
}
