...
template<> struct xtd::enum_register<xtd::environment::special_folder_option> {
  explicit operator auto() const {return xtd::enum_collection<xtd::environment::special_folder_option> {{xtd::environment::special_folder_option::none, "none"}, {xtd::environment::special_folder_option::do_not_verify, "do_not_verify"}, {xtd::environment::special_folder_option::create, "create"}};}
};
/// @endcond
