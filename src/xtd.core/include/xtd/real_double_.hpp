/// @file
/// @brief Contains xtd::real_double concept documentation.
/// @copyright Copyright (c) 2026 Gammasoft. All rights reserved.
#pragma once
#error "Do not include this file: Internal use only. Include <xtd/real_double> or <xtd/real_double.hpp> instead."

/// @brief The xtd namespace contains all fundamental classes to access Hardware, Os, System, and more.
namespace xtd {
  /// @brief Represents the real double concept.
  /// @par Definition
  /// ```cpp
  ...
  /// @par Examples
  /// The following code shows how to use xtd::real_double concept
  /// ```cpp
  /// #include <xtd/xtd>
  ///
