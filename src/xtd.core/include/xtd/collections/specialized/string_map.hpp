...
#  pragma message("Deprecated : Replaced by #include <xtd/collection/specialized/string_dictionary.hpp> - Will be removed in version 0.4.0.")
#else
#  warning "Deprecated : Replaced by #include <xtd/collection/specialized/string_dictionary.hpp> - Will be removed in version 0.4.0."
#endif
