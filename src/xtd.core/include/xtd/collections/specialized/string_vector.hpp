...
namespace xtd {
  ...
  namespace collections {
    ...
    namespace specialized {
      ...
      /// @deprecated Replaced by xtd::collections::specialized::string_collection - Will be removed in version 1.2.0.
      using string_vector [[deprecated("Replaced by xtd::collections::specialized::string_collection - Will be removed in version 1.2.0.")]] = string_collection;
    }
  }
}
