...
namespace xtd {
  ...
  namespace collections {
    ...
    namespace generic {
      ...
      /// class list : public std::vector<type_t, xtd::collections::allocator<type_t>>
      /// ```
      /// @par Header
      /// ```cpp
      ...
      /// @remarks The xtd::collections::generic::list class is same as [std::vector](https://en.cppreference.com/w/cpp/container/vector) with xtd::collections::allocator instead [std::allocator](https://en.cppreference.com/w/cpp/memory/allocator).
      template<typename type_t>
      class list : public std::vector<type_t, xtd::collections::allocator<type_t>> {
      public:
        /// @brief Represents the allocator type of list.
        using allocator_type = xtd::collections::allocator<type_t>;
