...
namespace xtd {
  ...
  namespace collections {
    ...
    /// @deprecated Replaced by xtd::collections::array_list - Will be removed in version 1.2.0.
    using vector_list [[deprecated("Replaced by xtd::collections::array_list - Will be removed in version 1.2.0.")]] = array_list;
  }
}
