...
#  pragma message("Deprecated : Replaced by #include <xtd/collection/array_list.hpp> - Will be removed in version 0.4.0.")
#else
#  warning "Deprecated : Replaced by #include <xtd/collection/array_list.hpp> - Will be removed in version 0.4.0."
#endif
...
namespace xtd {
  ...
  namespace collections {
    /// @brief Represents a collection of xtd::any_object.
    /// ```cpp
