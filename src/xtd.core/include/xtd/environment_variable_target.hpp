...
template<> struct xtd::enum_register<xtd::environment_variable_target> {
  static auto values() noexcept {return xtd::enum_collection<xtd::environment_variable_target> {{xtd::environment_variable_target::process, "process"}, {xtd::environment_variable_target::user, "user"}, {xtd::environment_variable_target::machine, "machine"}};}
};
/// @endcond
