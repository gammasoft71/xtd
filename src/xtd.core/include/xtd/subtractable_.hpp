/// @file
/// @brief Contains xtd::subtractable concept documentation.
/// @copyright Copyright (c) 2026 Gammasoft. All rights reserved.
#error "Do not include this file: Internal use only. Include <xtd/subtractable> or <xtd/subtractable.hpp> instead."
