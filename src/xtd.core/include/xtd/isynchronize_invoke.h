...
namespace xtd {
  ...
  public:
    ...
    virtual xtd::iasync_result_ptr begin_invoke(delegate<void()> method) = 0;
    /// @brief Asynchronously executes the delegate on the thread that created this object.
    ...
    /// @remarks The method delegate is executed on the thread that created the object, instead of the thread on which xtd::isynchronize_invoke::begin_invoke was called.
    /// @remarks The delegate is called asynchronously, and this method returns immediately. You can call this method from any thread. If you need the return value from a process started with this method, call xtd::isynchronize_invoke::end_invoke to get the value.
    virtual xtd::iasync_result_ptr begin_invoke(delegate<void(std::vector<std::any>)> value, const std::vector<std::any>& args) = 0;
    ...
    virtual std::optional<object_ref> end_invoke(xtd::iasync_result_ptr async) = 0;
    ...
    xtd::iasync_result_ptr begin_invoke(delegate_t value, const std::vector<std::any>& args) {return begin_invoke(delegate<void(std::vector<std::any>)>(value), args);}
    
    template<typename delegate_t>
    xtd::iasync_result_ptr begin_invoke(delegate_t value) {return begin_invoke(delegate<void(std::vector<std::any>)>(value), {});}
