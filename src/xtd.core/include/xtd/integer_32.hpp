...
namespace xtd {
  /// @concept xtd::integer_32
  /// @brief Concept integer_32.
  /// @par Definition
  /// ```cpp
  /// template<typename value_t>
  /// concept xtd::integer_32 = xtd::signed_integer_32<value_t> || xtd::unsigned_integer_32<value_t>;
  ...
  /// @par Examples
  /// The following code shows how to use xtd::integer_32 conceps
  /// ```cpp
  /// #include <xtd/xtd>
  ///
