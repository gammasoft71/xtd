...
namespace xtd {
  /// @concept xtd::signed_integer_16
  /// @brief Concept signed_integer_16.
  /// @par Definition
  /// ```cpp
  /// template<typename value_t>
  /// concept xtd::signed_integer_16 = std::same_as<value_t, xtd::int16>;
  /// ```
  /// @par Header
  /// ```cpp
  ...
  /// @par Examples
  /// The following code shows how to use xtd::signed_integer_16 conceps
  /// ```cpp
  /// #include <xtd/xtd>
  ///
