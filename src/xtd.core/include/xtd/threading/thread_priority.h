...
namespace xtd {
  /// @brief The xtd::threading namespace provides classes and interfaces that enable multithread_priorityed programming.
  /// In addition to classes for synchronizing thread_priority activities and access to data ( xtd::threading::mutex, xtd::threading::monitor, xtd::threading::thread_priority, xtd::threading::auto_reset_event, and so on), this namespace includes a xtd::threading::thread_priority_pool class that allows you to use a pool of system-supplied thread_prioritys, and a xtd::threading::timer class that executes callback methods on thread_priority pool thread_prioritys.
  namespace threading {
