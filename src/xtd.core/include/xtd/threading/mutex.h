...
namespace xtd {
  ...
  namespace threading {
    ...
    /// @remarks The unnamed mutex is a std::recursive_timed_mutex of C++17. You can therefore use xtd::threading::mutex or std::recursive_timed_mutex indifferently in your projects.
    /// @remarks If you use other synchronization objects for your threads and you use xtd::threading::thread you are interested in using xtd::threading::mutex. You will also benefit from xtd::threding::wait_handle::wait_all and td::threding::wait_handle::wait_any among others to synchronize all your objects.
    /// @remarks  On the other hand, if you only use mutexes and you use std::thread then you are interested in using std::recursive_timed_mutex.
