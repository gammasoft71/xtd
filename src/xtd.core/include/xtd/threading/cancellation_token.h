...
namespace xtd {
  /// @brief The xtd::threading namespace provides classes and interfaces that enable multithreaded programming. In addition to classes for synchronizing cancellation_token activities and access to data ( xtd::threading::mutex, xtd::threading::monitor, xtd::threading::interlocked, xtd::threading::auto_reset_event, and so on), this namespace includes a xtd::threading::cancellation_token class that allows you to use a pool of system-supplied threads, and a xtd::threading::cancellation_token class that executes callback methods on cancellation_token pool threads.
  namespace threading {
    /// @cond
