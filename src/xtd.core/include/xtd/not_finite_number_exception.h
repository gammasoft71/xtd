...
/// @brief Helper on xtd::not_finite_number_exception to call it with caller information
/// @par Library
/// xtd.core
/// @ingroup xtd_core exceptions
/// @remarks Is equivalent to not_finite_number_exception({any argument}, csf_)
/// @code
/// void my_func() {
