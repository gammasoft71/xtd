...
namespace xtd {
  ...
  public:
    ...
    /// The following code example converts the bit patterns of Char values to xtd::byte std::vectors with the get_bytes method.
    /// @include bit_converterget_bytesChar.cpp
    static std::vector<xtd::byte> get_bytes(wchar_t value) noexcept;
    ...
    /// @cond
    static std::vector<xtd::byte> get_bytes(llong_t value) noexcept;
    static std::vector<xtd::byte> get_bytes(ullong_t value) noexcept;
    /// @endcond
