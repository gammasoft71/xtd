...
template<> struct xtd::enum_register<xtd::uri_kind> {
  void operator()(xtd::enum_collection<xtd::uri_kind>& values) {values = {{xtd::uri_kind::relative_or_absolute, "relative_or_absolute"}, {xtd::uri_kind::absolute, "absolute"}, {xtd::uri_kind::relative, "relative"}};}
};
/// @endcond
