/// @file
/// @brief Contains xtd::real concept documentation.
/// @copyright Copyright (c) 2026 Gammasoft. All rights reserved.
#pragma once
#error "Do not include this file: Internal use only. Include <xtd/real> or <xtd/real.hpp> instead."

/// @brief The xtd namespace contains all fundamental classes to access Hardware, Os, System, and more.
namespace xtd {
  /// @brief Represents the real concept.
  /// @par Definition
  /// ```cpp
  ...
  /// @par Examples
  /// The following code shows how to use xtd::real concept
  /// ```cpp
  /// #include <xtd/xtd>
  ///
