...
namespace xtd {
  ...
  public:
    ...
    /// @{
    /// @brief Initializes a new instance of xtd::string.
    string() noexcept;
    /// @brief Initializes a new instance of xtd::string with specified allocator.
    /// @param allocator The allocator to use for all memory allocations of this string.
    explicit string(const allocator_type& allocator) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified count copies of character.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    string(xtd::size count, value_type character);
    /// @brief Initializes a new instance of xtd::string with specified count copies of character and specified allocator.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(xtd::size count, value_type character, const allocator_type& allocator);
#if defined(__xtd__cpp_lib_char8_t)
    /// @brief Initializes a new instance of xtd::string with specified count copies of character.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    string(xtd::size count, char8 character);
    /// @brief Initializes a new instance of xtd::string with specified count copies of character and specified allocator.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(xtd::size count, char8 character, const allocator_type& allocator);
#endif
    /// @brief Initializes a new instance of xtd::string with specified count copies of character.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    string(xtd::size count, char16 character);
    /// @brief Initializes a new instance of xtd::string with specified count copies of character and specified allocator.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(xtd::size count, char16 character, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified count copies of character.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    string(xtd::size count, char32 character);
    /// @brief Initializes a new instance of xtd::string with specified count copies of character and specified allocator.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(xtd::size count, char32 character, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified count copies of character.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    string(xtd::size count, wchar character);
    /// @brief Initializes a new instance of xtd::string with specified count copies of character and specified allocator.
    /// @param str The string to copy.
    /// @param count The number of copies of character.
    /// @param character The character copied.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(xtd::size count, wchar character, const allocator_type& allocator);
    
    /// @brief Initializes a new instance of xtd::string with specified substring at index and count characters.
    /// @param str The string to copy.
    ...
    string(const string& str, xtd::size index, xtd::size count);
    /// @brief Initializes a new instance of xtd::string with specified substring at index, count characters and allocator.
    /// @param str The string to copy.
    /// @param index The index of the first substring character where start copy.
    /// @param count The number of substring characters to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const string& str, xtd::size index, xtd::size count, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified substring at index.
    /// @param str The string to copy.
    /// @param index The index of the first substring character where start copy.
    string(const string& str, xtd::size index);
    /// @brief Initializes a new instance of xtd::string with specified substring at index and allocator.
    /// @param str The string to copy.
    /// @param index The index of the first substring character where start copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const string& str, xtd::size index, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified substring and count characters.
    /// @param count The number of substring characters to copy.
    string(const value_type* str, xtd::size count);
    /// @brief Initializes a new instance of xtd::string with specified substring, count characters and allocator.
    /// @param str The string to copy.
    /// @param count The number of substring characters to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const value_type* str, xtd::size count, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(const value_type* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const value_type* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(value_type* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(value_type* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    /// @param str The string to copy.
    ...
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const string& str, const allocator_type& allocator) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    /// @param str The string to copy.
    string(const std::string& str) noexcept; // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const std::string& str, const allocator_type& allocator) noexcept;
#if defined(__xtd__cpp_lib_char8_t)
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    /// @param str The string to copy.
    string(const std::u8string& str) noexcept; // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const std::u8string& str, const allocator_type& allocator) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(const char8* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const char8* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(char8* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(char8* str, const allocator_type& allocator);
#endif
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    /// @param str The string to copy.
    string(const std::u16string& str) noexcept; // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const std::u16string& str, const allocator_type& allocator) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(const char16* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const char16* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(char16* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(char16* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    /// @param str The string to copy.
    string(const std::u32string& str) noexcept; // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const std::u32string& str, const allocator_type& allocator) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(const char32* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const char32* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(char32* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(char32* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    /// @param str The string to copy.
    string(const std::wstring& str) noexcept; // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const std::wstring& str, const allocator_type& allocator) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(const wchar* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(const wchar* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to copy.
    string(wchar* str); // Can't be explicit by design.
    /// @brief Initializes a new instance of xtd::string with specified string to copy, and allocator.
    /// @param str The string to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(wchar* str, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified string to move.
    /// @param str The string to move.
    string(string&& str) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified string to move and allocator.
    /// @param str The string to move.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(string&& str, const allocator_type& allocator) noexcept;
    /// @brief Initializes a new instance of xtd::string with specified first and last iterators of substring.
    /// @param first The first iterator of substring.
    /// @param last The first iterator of substring.
    template<typename input_iterator_t>
    string(input_iterator_t first, input_iterator_t last) : std::basic_string<value_type>(first, last) {}
    /// @brief Initializes a new instance of xtd::string with specified first and last iterators of substring and allocator.
    /// @param first The first iterator of substring.
    /// @param last The first iterator of substring.
    /// @param allocator The allocator to use for all memory allocations of this string.
    template<typename input_iterator_t>
    string(input_iterator_t first, input_iterator_t last, const allocator_type& allocator) : std::basic_string<value_type>(first, last, allocator) {}
    /// @brief Initializes a new instance of xtd::string with specified string view of substring and allocator.
    /// @param string_view The string view.
    /// @param allocator The allocator to use for all memory allocations of this string.
    template<typename string_view_like_t>
    explicit constexpr string(const string_view_like_t& string_view, const allocator_type& allocator = allocator_type()) : std::basic_string<value_type>(string_view, allocator) {}
    /// @brief Initializes a new instance of xtd::string with specified string view of substring and allocator.
    /// @param string_view The string view.
    /// @param index The index of the first substring character where start copy.
    /// @param count The number of substring characters to copy.
    /// @param allocator The allocator to use for all memory allocations of this string.
    template<typename string_view_like_t>
    constexpr string(const string_view_like_t& string_view, size_type index, size_type count, const allocator_type& allocator = allocator_type()) : std::basic_string<value_type>(string_view, index, count, allocator) {}
    /// @brief Initializes a new instance of xtd::string with specified initializer list.
    /// @param il The initializer list to fill.
    string(std::initializer_list<value_type> il);
    /// @brief Initializes a new instance of xtd::string with specified initializer list and allocator.
    /// @param il The initializer list to fill.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(std::initializer_list<value_type> il, const allocator_type& allocator);
#if defined(__xtd__cpp_lib_char8_t)
    /// @brief Initializes a new instance of xtd::string with specified initializer list.
    /// @param il The initializer list to fill.
    ...
    /// @param il The initializer list to fill.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(std::initializer_list<char8> il, const allocator_type& allocator);
#endif
    ...
    /// @param il The initializer list to fill.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(std::initializer_list<char16> il, const allocator_type& allocator);
    /// @brief Initializes a new instance of xtd::string with specified initializer list.
    /// @param il The initializer list to fill.
    ...
    /// @param il The initializer list to fill.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(std::initializer_list<char32> il, const allocator_type& allocator);
    
    /// @brief Initializes a new instance of xtd::string with specified initializer list.
    /// @param il The initializer list to fill.
    string(std::initializer_list<wchar> il);
    /// @brief Initializes a new instance of xtd::string with specified initializer list and allocator.
    /// @param il The initializer list to fill.
    /// @param allocator The allocator to use for all memory allocations of this string.
    string(std::initializer_list<wchar> il, const allocator_type& allocator);
    /// @}
    /// @cond
    /*
    template<typename type_t>
    string(const type_t& object) : std::basic_string<value_type>(object) {}
    template<typename type_t>
    string(const type_t& object, const allocator_type& allocator) : std::basic_string<value_type>(object, allocator) {}
    template<typename type_t>
    string(const type_t& object, xtd::size index, xtd::size count) : std::basic_string<value_type>(object, index, count) {}
    template<typename type_t>
    string(const type_t& object, xtd::size index, xtd::size count, const allocator_type& allocator) : std::basic_string<value_type>(object, index, count, allocator) {}
    template<typename type_t>
    string(const type_t& object, xtd::size count) : std::basic_string<value_type>(object, 0, count) {}
    template<typename type_t>
    string(const type_t& object, xtd::size count, const allocator_type& allocator) : std::basic_string<value_type>(object, 0, count, allocator) {}
     */
    
    string& operator =(const string& str) noexcept;
    string& operator =(const std::string& str) noexcept;
    string& operator =(const value_type* str);
#if defined(__xtd__cpp_lib_char8_t)
    string& operator =(const std::u8string& str) noexcept;
    string& operator =(const char8* str);
#endif
    string& operator =(const std::u16string& str) noexcept;
    string& operator =(const char16* str);
    string& operator =(const std::u32string& str) noexcept;
    string& operator =(const char32* str);
    string& operator =(const std::wstring& str) noexcept;
    string& operator =(const wchar* str);
    string& operator =(string&& str) noexcept;
    
    string& operator =(value_type character);
#if defined(__xtd__cpp_lib_char8_t)
    string& operator =(char8 character);
#endif
    string& operator =(char16 character);
    string& operator =(char32 character);
    string& operator =(wchar character);
    string& operator =(const std::initializer_list<value_type>& il);
#if defined(__xtd__cpp_lib_char8_t)
    string& operator =(const std::initializer_list<char8>& il);
#endif
    string& operator =(const std::initializer_list<char16>& il);
    string& operator =(const std::initializer_list<char32>& il);
    string& operator =(const std::initializer_list<wchar>& il);
    //template<typename type_t>
    //string& operator =(const type_t& object) {return std::basic_string<value_type>::assign(object);}
    
    template<typename type_t>
    string operator +(const type_t& object) const {
      string result(*this);
    ...
    template<typename type_t>
    string operator +(type_t* object) const {
      string result(*this);
      result.append(string(object));
      return result;
    }
    ...
    string& operator +=(const value_type* str);
#if defined(__xtd__cpp_lib_char8_t)
    string& operator +=(const std::u8string& str);
    string& operator +=(const char8* str);
#endif
    ...
    string& operator +=(const std::initializer_list<wchar>& il);
    template<typename type_t>
    string& operator +=(const type_t& object) {
      *this = *this + string(object);
      return *this;
    }
    ...
    /// @{
    int32 compare_to(const string& tzi) const noexcept override;
    ...
    bool contains(const string& value) const noexcept;

    /// @brief Determines whether this instance and a specified object, which must also be a xtd::string object, have the same value.
    /// @param obj The string to compare to this instance.
    /// @return `true` if `obj` is a xtd::string and its value is the same as this instance; otherwise, `false`.
    ...
    bool equals(const string& value, bool ignore_case) const noexcept;
    ...
    /// @return true if value matches the end of this instance; otherwise, false.
    bool ends_with(const string& value) const noexcept;
    ...
    bool ends_with(const string& value, bool ignore_case) const noexcept;
    ...
    /// @return bool true if value matches the end of the specified string; otherwise, false.
    bool ends_with(const string& value, xtd::string_comparison comparison_type) const noexcept;
    ...
    /// @param value An unicode character to seek
    /// @return The index position of value if that character is found, or std::basic_string<char_t>::npos if it is not.
    xtd::size index_of(const string& value) const noexcept;
    ...
    /// @param start_index The search starting position
    /// @return The index position of value if that character is found, or std::basic_string<char_t>::npos if it is not.
    xtd::size index_of(const string& value, xtd::size start_index) const noexcept;
    ...
    /// @param count The number of character positions to examine
    /// @return The index position of value if that character is found, or std::basic_string<char_t>::npos if it is not.
    xtd::size index_of(const string& value, xtd::size start_index, xtd::size count) const noexcept;
    ...
    string insert(xtd::size start_index, const string& value) const noexcept;
    ...
    /// @deprecated Replaced by xtd::string::is_empty(const xtd::string&) - Will be removed in version 0.4.0
    [[deprecated("Replaced by xtd::string::is_empty(const xtd::string&) - Will be removed in version 0.4.0")]]
    ...
    /// @param value An unicode character to seek
    /// @return The index position of value if that character is found, or std::basic_string<char_t>::npos if it is not.
    xtd::size last_index_of(const string& value) const noexcept;
    ...
    /// @param start_index The search starting position
    /// @return The index position of value if that character is found, or std::basic_string<char_t>::npos if it is not.
    xtd::size last_index_of(const string& value, xtd::size start_index) const noexcept;
    ...
    /// @param count The number of character positions to examine
    /// @return The index position of value if that character is found, or std::basic_string<char_t>::npos if it is not.
    xtd::size last_index_of(const string& value, xtd::size start_index, xtd::size count) const noexcept;
    ...
    /// @return A new quoted string.
    /// @remarks for more information see [std::quoted](https://en.cppreference.com/w/cpp/io/manip/quoted).
    string quoted(value_type delimiter, value_type escape) const;
    ...
    string remove(xtd::size start_index) const noexcept;
    /// @brief Deletes all the characters from this string beginning at a specified position and continuing through the last position.
    /// @param start_index The position to begin deleting characters.
    /// @param count The number of characters to delete.
    /// @return A new string object that is equivalent to this string less the removed characters.
    string remove(xtd::size start_index, xtd::size count) const noexcept;
    ...
    string replace(value_type old_char, value_type new_char) const noexcept;
    ...
    string replace(const string& old_string, const string& new_string) const noexcept;
    ...
    std::vector<string> split(const std::vector<value_type>& separators, xtd::size count, string_split_options options) const noexcept;
    ...
    /// @remarks Delimiter characters are not included in the elements of the returned array.
    /// @remarks If the specified string does not contain any of the characters in separator, or the count parameter is 1, the returned array consists of a single element that contains the specified string.
    std::vector<string> split(const std::vector<value_type>& separators) const noexcept;
    ...
    /// @remarks If count is greater than the number of substrings, the available substrings are returned.
    std::vector<string> split(const std::vector<value_type>& separators, string_split_options options) const noexcept;
    ...
    /// @remarks If there are more than count substrings in the specified string, the first count minus 1 substrings are returned in the first count minus 1 elements of the return value, and the remaining characters in the specified string are returned in the last element of the return value.
    std::vector<string> split(const std::vector<value_type>& separators, xtd::size count) const noexcept;
    
    /// @brief Determines whether the beginning of this instance of xtd::string matches a specified xtd::string.
    /// @param value A xtd::string to compare to.
    ...
    /// @brief Determines whether the beginning of this instance of xtd::string matches a specified xtd::string, ignoring or honoring their case.
    /// @param value A xtd::string to compare to.
    ...
    /// @return bool true if value matches the beginning of the specified string; otherwise, false.
    /// @remarks This method compares value to the substring at the beginning of the specified string that is the same length as value, and returns an indication whether they are equal. To be equal, value must be a reference to this same instance, or match the beginning of the specified string.
    bool starts_with(const string& value) const noexcept;
    /// @brief Determines whether the beginning of this instance of xtd::string matches a specified xtd::string, ignoring or honoring their case.
    /// @param value A xtd::string to compare to.
    /// @param ignore_case true to ignore case when comparing the specified string and value; otherwise, false
    /// @return bool true if value matches the beginning of the specified string; otherwise, false.
    /// @remarks This method compares value to the substring at the beginning of the specified string that is the same length as value, and returns an indication whether they are equal. To be equal, value must be a reference to this same instance, or match the beginning of the specified string.
    bool starts_with(const string& value, bool ignore_case) const noexcept;
    
    /// @brief Returns a substring [`pos`, `pos + count`). If the requested substring extends past the end of the string, i.e. the `count` is greater than `size()` - `pos` (e.g. if `count` == `npos`), the returned substring is [`pos`, xtd::string::size()).
    /// @param pos The position of the first character to include.
    /// @param count The length of the substring.
    /// @return xtd::string containing the substring [`pos`, `pos` + `count`) or [`pos`, xtd::string::size()).
    ...
    string substring(xtd::size start_index) const noexcept;
    /// @brief Retrieves a substring from this instance. The substring starts at a specified character position and has a specified length.
    /// @param start_index The zero-based starting character position of a substring in this instance.
    /// @param length The number of characters in the substring.
    /// @return A string equivalent to the substring of length length that begins at start_index in this instance, or Empty if start_index is equal to the length of this instance and length is zero.
    string substring(xtd::size start_index, xtd::size length) const noexcept;
    
    /// @brief Copies the characters in this instance to a Unicode character array.
    /// @return A character array whose elements are the individual characters of this instance. If this instance is an empty xtd::string, the returned array is empty and has a zero length.
    ...
    string to_title_case() const noexcept;
    
    /// @brief Returns a copy of the current string converted to uppercase.
    /// @return A new string in uppercase.
    string to_upper() const noexcept;
    
    /// @brief Removes all leading and trailing occurrences of white-space characters from the specified xtd::string.
    /// @param str xtd::string to trim end.
    /// @param trim_char A character to remove.
    /// @return The xtd::string that remains after all occurrences of the character in the trim_char parameter are removed from the start and te and of the specified xtd::string.
    string trim() const noexcept;
    /// @brief Removes all leading and trailing occurrences of a character specified from the specified xtd::string .
    /// @param str xtd::string to trim start.
    /// @param trim_char A character to remove.
    /// @return The xtd::string that remains after all occurrences of the character in the trim_char parameter are removed from the start and the end of the specified xtd::string.
    string trim(value_type trim_char) const noexcept;
    /// @brief Removes all leading and trailing occurrences of a set of characters specified in an array from the specified xtd::string.
    /// @param str xtd::string to trim end.
    /// @param trim_chars An array of characters to remove.
    /// @return The xtd::string that remains after all occurrences of the characters in the trim_chars parameter are removed from the start and the edn of the specified xtd::string.
    string trim(const std::vector<value_type>& trim_chars) const noexcept;
    
    /// @brief Removes all trailing occurrences of white-space characters from the specified xtd::string.
    /// @param str xtd::string to trim end.
    /// @param trim_char A character to remove.
    /// @return The xtd::string that remains after all occurrences of the character in the trim_char parameter are removed from the end of the specified xtd::string.
    string trim_end() const noexcept;
    /// @brief Removes all trailing occurrences of a character specified from the specified xtd::string .
    /// @param str xtd::string to trim start.
    /// @param trim_char A character to remove.
    /// @return The xtd::string that remains after all occurrences of the character in the trim_char parameter are removed from the end of the specified xtd::string.
    string trim_end(value_type trim_char) const noexcept;
    /// @brief Removes all trailing occurrences of a set of characters specified in an array from the specified xtd::string.
    /// @param str xtd::string to trim end.
    /// @param trim_chars An array of characters to remove.
    /// @return The xtd::string that remains after all occurrences of the characters in the trim_chars parameter are removed from the end of the specified xtd::string.
    string trim_end(const std::vector<value_type>& trim_chars) const noexcept;
    
    /// @brief Removes all leading occurrences of white-space characters from the specified xtd::string.
    /// @param str xtd::string to trim start.
    /// @param trim_char A character to remove.
    /// @return The xtd::string that remains after all occurrences of the character in the trim_char parameter are removed from the start of the specified xtd::string.
    string trim_start() const noexcept;
    /// @brief Removes all leading occurrences of a character specified from the specified xtd::string .
    /// @param str xtd::string to trim start.
    /// @param trim_char A character to remove.
    /// @return The xtd::string that remains after all occurrences of the character in the trim_char parameter are removed from the start of the specified xtd::string.
    string trim_start(value_type trim_char) const noexcept;
    /// @brief Removes all leading occurrences of a set of characters specified in an array from the specified xtd::string.
    /// @param str An xtd::string to trim start.
    /// @param trim_chars An array of characters to remove.
    /// @return The xtd::string that remains after all occurrences of the characters in the trim_chars parameter are removed from the start of the specified xtd::string.
    string trim_start(const std::vector<value_type>& trim_chars) const noexcept;
    /// @}
    ...
    [[deprecated("Replaced by typeof_<object_t>().name() - Will be removed in version 0.4.0")]]
    static string class_name() {return get_class_name(full_class_name<object_t>());}
    ...
    template<typename object_t>
    [[deprecated("Replaced by typeof_(object).name() - Will be removed in version 0.4.0")]]
    static string class_name(const object_t& object) {return get_class_name(full_class_name(object));}
    /// @brief Gets the class name of the specified object.
    /// @return The class name of the specified object.
    /// @remarks For example, the name of the string type is string.
    /// @deprecated Replaced by typeof_(info).name() - Will be removed in version 0.4.0
    [[deprecated("Replaced by typeof_(info).name() - Will be removed in version 0.4.0")]]
    static string class_name(const std::type_info& info);
    ...
    static int32 compare(const string& str_a, const string& str_b) noexcept;
    ...
    /// | Zero              | str_a occurs in the same position as str_b in the sort order. |
    /// | Greater than zero | str_a follows str_b in the sort order.                        |
    static int32 compare(const string& str_a, const string& str_b, bool ignore_case) noexcept;
    ...
    /// | Zero              | str_a occurs in the same position as str_b in the sort order. |
    /// | Greater than zero | str_a follows str_b in the sort order.                        |
    static int32 compare(const string& str_a, const string& str_b, xtd::string_comparison comparison_type) noexcept;
    ...
    /// | Zero              | str_a occurs in the same position as str_b in the sort order. |
    /// | Greater than zero | str_a follows str_b in the sort order.                        |
    static int32 compare(const string& str_a, xtd::size index_a, const string& str_b, xtd::size index_b, xtd::size length) noexcept;
    ...
    /// | Zero              | str_a occurs in the same position as str_b in the sort order. |
    /// | Greater than zero | str_a follows str_b in the sort order.                        |
    static int32 compare(const string& str_a, xtd::size index_a, const string& str_b, xtd::size index_b, xtd::size length, bool ignore_case) noexcept;
    ...
    /// | Zero              | str_a occurs in the same position as str_b in the sort order. |
    /// | Greater than zero | str_a follows str_b in the sort order.                        |
    static int32 compare(const string& str_a, xtd::size index_a, const string& str_b, xtd::size index_b, xtd::size length, xtd::string_comparison comparison_type) noexcept;
    ...
    static string concat(const string& str_a, const string& str_b, const string& str_c, const string& str_d) noexcept;
    ...
    static string concat(object_a_t obj_a, object_b_t obj_b, object_c_t obj_c, object_d_t obj_d) noexcept {
    ...
    static string concat(const string& str_a, const string& str_b, const string& str_c) noexcept;
    ...
    static string concat(object_a_t obj_a, object_b_t obj_b, object_c_t obj_c) noexcept {
    ...
    static string concat(const string& str_a, const string& str_b) noexcept;
    /// @brief Concatenates two specified instances of object.
    /// @param obj_a The first object to concatenate.
    /// @param obj_b The second object to concatenate.
    /// @return The concatenation of obj_a and obj_b.
    template<typename object_a_t, typename object_b_t>
    static string concat(object_a_t obj_a, object_b_t obj_b) noexcept {
    ...
    static string concat(const std::vector<string>& values) noexcept;
    /// @cond
    static string concat(const std::vector<const value_type*>& values) noexcept;
#if defined(__xtd__cpp_lib_char8_t)
    static string concat(const std::vector<const char8*>& values) noexcept;
#endif
    static string concat(const std::initializer_list<string>& values) noexcept;
    static string concat(const std::initializer_list<const value_type*>& values) noexcept;
#if defined(__xtd__cpp_lib_char8_t)
    static string concat(const std::initializer_list<const char8*>& values) noexcept;
#endif
    /// @endcond
    ...
    template<typename object_t>
    static string concat(const std::vector<object_t>& args) noexcept {
      string result;
    ...
    /// @cond
    template<typename object_t>
    static string concat(const std::initializer_list<object_t>& args) noexcept {
      string result;
      for (const auto& arg : args)
        result += format("{}", arg);
      return result;
    ...
    static string concat(value_t value) noexcept {
      return format("{}", value);
    }
    ...
    /// @par Examples
    /// The following example shows how to use xtd::string::demangle.
    /// ```cpp
    /// #include <xtd/xtd>
    ///
    /// using namespace xtd;
    ...
    ///   console::write_line("demangled name = {}", string::demangle(typeid(xtd::date_time).name()));
    /// }
    ///
    ...
    /// @brief Determines whether two specified xtd::string objects have the same value.
    /// @param a The first string to compare.
    /// @param b The second string to compare.
    /// @return `true` if the value of `a` is the same as the value of `b`; otherwise, `false`.
    /// @remarks This method performs an ordinal (case-sensitive) comparison.
    static bool equals(const string& a, const string& b) noexcept;
    /// @brief Determines whether two specified xtd::string objects have the same value, ignoring or honoring their case.
    /// @param a The first string to compare.
    /// @param b The second string to compare.
    /// @param ignore_case true to ignore case when comparing this instance and value; otherwise, false
    /// @return `true` if the value of `a` is the same as the value of `b`; otherwise, `false`.
    /// @remarks This method performs an ordinal comparison.
    static bool equals(const string& a, const string& b, bool ignore_case) noexcept;
    ...
    static string format(const string& fmt, args_t&& ... args) {
      string result;
      xtd::size index = 0;
        ...
        if (*iterator == '{') {
          ...
          if (*iterator == '{')
            ...
            if (format_str.size() == 0)
              ...
              xtd::size index_alignment_separator = string(format_str).index_of(',');
              xtd::size index_format_separator = string(format_str).index_of(u':');
    ...
    /// @remarks For example, the fully qualified name of the string type is xtd::string.
    /// @deprecated Replaced by typeof_<object_t>().full_name() - Will be removed in version 0.4.0
    template<typename object_t>
    [[deprecated("Replaced by typeof_<object_t>().full_name() - Will be removed in version 0.4.0")]]
    static string full_class_name() {return demangle(typeid(object_t).name());}
    ...
    template<typename object_t>
    [[deprecated("Replaced by typeof_(object).full_name() - Will be removed in version 0.4.0")]]
    static string full_class_name(const object_t& object) {return demangle(typeid(object).name());}
    /// @brief Gets the fully qualified class name of the specified object, including the namespace of the specified object.
    /// @return The fully qualified class name of the objec_t, including the namespace of the specified object.
    /// @remarks For example, the fully qualified name of the string type is xtd::string.
    /// @deprecated Replaced by typeof_(info).full_name() - Will be removed in version 0.4.0
    [[deprecated("Replaced by typeof_(info).full_name() - Will be removed in version 0.4.0")]]
    static string full_class_name(const std::type_info& info);
    
    /// @brief Indicates whether the specifeid string is an empty string ("").
    /// @param string The xtd::string to check if empty.
    /// @return true if the value parameter is null or an empty string (""); otherwise, false.
    static bool is_empty(const xtd::string& string) noexcept;
    ...
    static string join(const string separator, const collection_t& values) noexcept {return join(separator, values, 0, values.size());}
    /// @brief Concatenates a specified separator string between each element of a specified object array, yielding a single concatenated string.
    /// @param separator A string separator.
    /// @param values An array of Object.
    ...
    /// @remarks stream << operator is called on each object to generate the content.
    template<typename collection_t>
    static string join(const string& separator, const collection_t& values, xtd::size index) noexcept {return join(separator, values, index, values.size() - index);}
    /// @brief Concatenates a specified separator string between each element of a specified Object array, yielding a single concatenated string.
    /// @param separator A string separator.
    /// @param values An array of Object.
    /// @param start_index The first array element in value to use.
    ...
    /// @remarks stream << operator is called on each object to generate the content.
    template<typename collection_t>
    static string join(const string& separator, const collection_t& values, xtd::size index, xtd::size count) noexcept {
      xtd::size i = 0;
      string result;
    ...
    /// @cond
    template<typename value_t>
    static string join(const string& separator, const std::initializer_list<value_t>& values) noexcept {return join(separator, std::vector<value_t>(values));}
    template<typename value_t>
    static string join(const string& separator, const std::initializer_list<value_t>& values, xtd::size index) noexcept {return join(separator, std::vector<value_t>(values), index);}
    template<typename value_t>
    static string join(const string& separator, const std::initializer_list<value_t>& values, xtd::size index, xtd::size count) noexcept {return join(separator, std::vector<value_t>(values), index, count);}
    /// @endcond
    
    /// @brief Converts a string into a value_t type.
    /// @param str Ax xtd::string to convert to value_t
    /// @return The value_t object parsed.
    template<typename value_t>
    static value_t parse(const string& str) {
    ...
    template<typename ... args_t>
    static string sprintf(const string& fmt, args_t&& ... args) noexcept {return __sprintf(fmt.c_str(), convert_param(std::forward<args_t>(args)) ...);}
    
    /// @brief Try to convert a string into a value_t type.
    /// @param str An xtd::string to convert to value_t
    /// @param value The value that will contain the parsed xtd::string.
    /// @return true if xtd::string:=:try_parse succed; otherwise, false.
    template<typename value_t>
    static bool try_parse(const string& str, value_t& value) noexcept {
      try {
    ...
    /// @cond
    friend std::ostream& operator <<(std::ostream& stream, const string& str) {return stream << str.c_str();}
    ...
    friend string operator +(const string& str_a, const std::string& str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, const value_type* str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
...
#if defined(__xtd__cpp_lib_char8_t)
    friend string operator +(const string& str_a, const std::u8string& str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, const char8* str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    ...
    friend string operator +(const string& str_a, const std::u16string& str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, const char16* str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, const std::u32string& str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, const char32* str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, const std::wstring& str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, const wchar* str_b) {
      string result = str_a;
      result.append(string(str_b));
      return result;
    }
    
    friend string operator +(const string& str_a, value_type character) {
      string result = str_a;
      result.append(string(1, character));
      return result;
    }
    
#if defined(__xtd__cpp_lib_char8_t)
    friend string operator +(const string& str_a, char8 character) {
      string result = str_a;
      result.append(string(1, character));
      return result;
    }
    ...
    friend string operator +(const string& str_a, char16 character) {
      string result = str_a;
      result.append(string(1, character));
      return result;
    }
    
    friend string operator +(const string& str_a, char32 character) {
      string result = str_a;
      result.append(string(1, character));
      return result;
    }
    
    friend string operator +(const string& str_a, wchar character) {
      string result = str_a;
      result.append(string(1, character));
      return result;
    }
    
    friend string operator +(const string& str_a, const std::initializer_list<value_type>& il) {
      string result = str_a;
      result.append(string(il));
      return result;
    }
    
#if defined(__xtd__cpp_lib_char8_t)
    friend string operator +(const string& str_a, const std::initializer_list<char8>& il) {
      string result = str_a;
      result.append(string(il));
      return result;
    }
    ...
    friend string operator +(const string& str_a, const std::initializer_list<char16>& il) {
      string result = str_a;
      result.append(string(il));
      return result;
    }
    
    friend string operator +(const string& str_a, const std::initializer_list<char32>& il) {
      string result = str_a;
      result.append(string(il));
      return result;
    }
    
    friend string operator +(const string& str_a, const std::initializer_list<wchar>& il) {
      string result = str_a;
      result.append(string(il));
      return result;
    }
    
    friend string operator +(const std::string& str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const value_type* str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
...
#if defined(__xtd__cpp_lib_char8_t)
    friend string operator +(const std::u8string& str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const char8* str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    ...
    friend string operator +(const std::u16string& str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const char16* str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const std::u32string& str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const char32* str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const std::wstring& str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const wchar* str_a, const string& str_b) {
      string result(str_a);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(value_type character, const string& str_b) {
...
#if defined(__xtd__cpp_lib_char8_t)
    friend string operator +(char8 character, const string& str_b) {
      string result(1, character);
      result.append(str_b);
      return result;
    }
    ...
    friend string operator +(char16 character, const string& str_b) {
      string result(1, character);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(char32 character, const string& str_b) {
      string result(1, character);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(wchar character, const string& str_b) {
      string result(1, character);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const std::initializer_list<value_type>& il, const string& str_b) {
      string result(il);
      result.append(str_b);
      return result;
    }
...
#if defined(__xtd__cpp_lib_char8_t)
    friend string operator +(const std::initializer_list<char8>& il, const string& str_b) {
      string result(il);
      result.append(str_b);
      return result;
    }
    ...
    friend string operator +(const std::initializer_list<char16>& il, const string& str_b) {
      string result(il);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const std::initializer_list<char32>& il, const string& str_b) {
      string result(il);
      result.append(str_b);
      return result;
    }
    
    friend string operator +(const std::initializer_list<wchar>& il, const string& str_b) {
      string result(il);
      result.append(str_b);
      return result;
    }
...
void __ustring_extract_format_arg(std::string& fmt, xtd::size& index, std::vector<__format_information<char>>& formats, arg_t&& arg) {
  ...
  for (auto& format : formats) {
    ...
    if (format.index == index) {
      xtd::string arg_str = xtd::to_string(arg, format.format);
