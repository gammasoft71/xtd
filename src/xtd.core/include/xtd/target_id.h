...
// | __XTD_TARGET_ID_CUSTOM_TARGET__       | 8     |
  ...
  #error "Some variables (like __XTD_TARGET_ID__) are not defined. This is probably because you are not using CMake to generate your project. See the following link for more information: https://github.com/gammasoft71/xtd/blob/master/docs/xtd_cmake_overview.md..."
#endif
/// @endcond
