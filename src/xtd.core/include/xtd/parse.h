...
namespace xtd {
  ...
  inline value_t parse(const std::string& str) {__throw_parse_argument_exception("Parse speciailisation not found");}

  template<typename value_t>
  inline value_t parse(const std::string& str, const std::string& fmt) {__throw_parse_argument_exception("Parse speciailisation not found");}

  template<>
  inline std::string parse<std::string>(const std::string& str) {return str;}

  template<typename value_t>
  inline value_t parse(const std::string& str, number_styles) {__throw_parse_argument_exception("Parse speciailisation not found");}
  ...
  template<typename value_t>
  inline value_t parse(const std::wstring& str) {__throw_parse_argument_exception("Parse speciailisation not found");}

  template<typename value_t>
  inline value_t parse(const std::u16string& str) {__throw_parse_argument_exception("Parse speciailisation not found");}

  template<typename value_t>
  inline value_t parse(const std::u32string& str) {__throw_parse_argument_exception("Parse speciailisation not found");}
