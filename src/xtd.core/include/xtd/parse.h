...
namespace xtd {
  ...
  inline value_t parse(const std::string& str) {__throw_parse_formatt_exception("Parse speciailisation not found"); return {};}

  template<typename value_t>
  inline value_t parse(const std::string& str, const std::string& fmt) {__throw_parse_formatt_exception("Parse speciailisation not found"); return {};}

  template<>
  inline std::string parse<std::string>(const std::string& str) {return str;}

  template<typename value_t>
  inline value_t parse(const std::string& str, number_styles) {__throw_parse_formatt_exception("Parse speciailisation not found"); return {};}
  ...
  inline bool parse<bool>(const std::string& str) {
    ...
    if (lower_str != "true" && lower_str != "1" && lower_str != "false" && lower_str != "0")  __throw_parse_formatt_exception("Invalid string format");
    return lower_str == "true" || lower_str == "1";
  }

  template<typename value_t>
  inline value_t parse(const std::wstring& str) {__throw_parse_formatt_exception("Parse speciailisation not found"); return {};}

  template<typename value_t>
  inline value_t parse(const std::u16string& str) {__throw_parse_formatt_exception("Parse speciailisation not found"); return {};}

  template<typename value_t>
  inline value_t parse(const std::u32string& str) {__throw_parse_formatt_exception("Parse speciailisation not found"); return {};}
