...
template<> struct xtd::enum_register<xtd::net::sockets::protocol_family> {
  void operator()(xtd::enum_collection<xtd::net::sockets::protocol_family>& values, xtd::enum_attribute& attribute) {
    values = {{xtd::net::sockets::protocol_family::unknown, "unknown"}, {xtd::net::sockets::protocol_family::unspecified, "unspecified"}, {xtd::net::sockets::protocol_family::unix, "unix"}, {xtd::net::sockets::protocol_family::inter_network, "inter_network"}, {xtd::net::sockets::protocol_family::imp_link, "imp_link"}, {xtd::net::sockets::protocol_family::pup, "pup"}, {xtd::net::sockets::protocol_family::chaos, "chaos"}, {xtd::net::sockets::protocol_family::ns, "ns"}, {xtd::net::sockets::protocol_family::ipx, "ipx"}, {xtd::net::sockets::protocol_family::iso, "iso"}, {xtd::net::sockets::protocol_family::osi, "osi"}, {xtd::net::sockets::protocol_family::ecma, "ecma"}, {xtd::net::sockets::protocol_family::data_kit, "data_kit"}, {xtd::net::sockets::protocol_family::ccitt, "ccitt"}, {xtd::net::sockets::protocol_family::sna, "sna"}, {xtd::net::sockets::protocol_family::dec_net, "dec_net"}, {xtd::net::sockets::protocol_family::data_link, "data_link"}, {xtd::net::sockets::protocol_family::lat, "lat"}, {xtd::net::sockets::protocol_family::hyper_channel, "hyper_channel"}, {xtd::net::sockets::protocol_family::apple_talk, "apple_talk"}, {xtd::net::sockets::protocol_family::net_bios, "net_bios"}, {xtd::net::sockets::protocol_family::voice_view, "voice_view"}, {xtd::net::sockets::protocol_family::fire_fox, "fire_fox"}, {xtd::net::sockets::protocol_family::banyan, "banyan"}, {xtd::net::sockets::protocol_family::atm, "atm"}, {xtd::net::sockets::protocol_family::inter_network_v6, "inter_network_v6"}, {xtd::net::sockets::protocol_family::cluster, "cluster"}, {xtd::net::sockets::protocol_family::ieee12844, "ieee12844"}, {xtd::net::sockets::protocol_family::irda, "irda"}, {xtd::net::sockets::protocol_family::network_designers, "network_designers"}, {xtd::net::sockets::protocol_family::max, "max"}};
  }
};
/// @endcond
