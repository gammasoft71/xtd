/// @file
/// @brief Contains xtd::net::sockets::iocontrol_code enum.
...
namespace xtd {
  ...
  namespace net {
    ...
    namespace sockets {
      /// @brief Specifies the IO control codes supported by the xtd::net::sockets::socket::iocontrol method.
      /// @par Library
      /// xtd.core
      /// @ingroup xtd_core
      enum class iocontrol_code : uint64_t {
      ...
      inline std::ostream& operator<<(std::ostream& os, iocontrol_code value) {return os << to_string(value, {{iocontrol_code::enable_circular_queuing, "enable_circular_queuing"}, {iocontrol_code::flush, "flush"}, {iocontrol_code::address_list_change, "address_list_change"}, {iocontrol_code::data_to_read, "data_to_read"}, {iocontrol_code::oob_data_read, "oob_data_read"}, {iocontrol_code::get_broadcast_address, "get_broadcast_address"}, {iocontrol_code::address_list_query, "address_list_query"}, {iocontrol_code::query_target_pnp_handle, "query_target_pnp_handle"}, {iocontrol_code::async_io, "async_io"}, {iocontrol_code::non_blocking_io, "non_blocking_io"}, {iocontrol_code::associate_handle, "associate_handle"}, {iocontrol_code::multipoint_loopback, "multipoint_loopback"}, {iocontrol_code::multicast_scope, "multicast_scope"}, {iocontrol_code::set_qos, "set_qos"}, {iocontrol_code::set_group_qos, "set_group_qos"}, {iocontrol_code::routing_interface_change, "routing_interface_change"}, {iocontrol_code::namespace_change, "namespace_change"}, {iocontrol_code::receive_all, "receive_all"}, {iocontrol_code::receive_all_multicast, "receive_all_multicast"}, {iocontrol_code::receive_all_igmp_multicast, "receive_all_igmp_multicast"}, {iocontrol_code::keep_alive_values, "keep_alive_values"}, {iocontrol_code::absorb_router_alert, "absorb_router_alert"}, {iocontrol_code::unicast_interface, "unicast_interface"}, {iocontrol_code::limit_broadcasts, "limit_broadcasts"}, {iocontrol_code::bind_to_interface, "bind_to_interface"}, {iocontrol_code::multicast_interface, "multicast_interface"}, {iocontrol_code::add_multicast_group_on_interface, "add_multicast_group_on_interface"}, {iocontrol_code::delete_multicast_group_from_interface, "delete_multicast_group_from_interface"}, {iocontrol_code::get_extension_function_pointer, "get_extension_function_pointer"}, {iocontrol_code::get_qos, "get_qos"}, {iocontrol_code::get_group_qos, "get_group_qos"}, {iocontrol_code::translate_handle, "translate_handle"}, {iocontrol_code::routing_interface_query, "routing_interface_query"}, {iocontrol_code::address_list_sort, "address_list_sort"}});}
      inline std::wostream& operator<<(std::wostream& os, iocontrol_code value) {return os << to_string(value, {{iocontrol_code::enable_circular_queuing, L"enable_circular_queuing"}, {iocontrol_code::flush, L"flush"}, {iocontrol_code::address_list_change, L"address_list_change"}, {iocontrol_code::data_to_read, L"data_to_read"}, {iocontrol_code::oob_data_read, L"oob_data_read"}, {iocontrol_code::get_broadcast_address, L"get_broadcast_address"}, {iocontrol_code::address_list_query, L"address_list_query"}, {iocontrol_code::query_target_pnp_handle, L"query_target_pnp_handle"}, {iocontrol_code::async_io, L"async_io"}, {iocontrol_code::non_blocking_io, L"non_blocking_io"}, {iocontrol_code::associate_handle, L"associate_handle"}, {iocontrol_code::multipoint_loopback, L"multipoint_loopback"}, {iocontrol_code::multicast_scope, L"multicast_scope"}, {iocontrol_code::set_qos, L"set_qos"}, {iocontrol_code::set_group_qos, L"set_group_qos"}, {iocontrol_code::routing_interface_change, L"routing_interface_change"}, {iocontrol_code::namespace_change, L"namespace_change"}, {iocontrol_code::receive_all, L"receive_all"}, {iocontrol_code::receive_all_multicast, L"receive_all_multicast"}, {iocontrol_code::receive_all_igmp_multicast, L"receive_all_igmp_multicast"}, {iocontrol_code::keep_alive_values, L"keep_alive_values"}, {iocontrol_code::absorb_router_alert, L"absorb_router_alert"}, {iocontrol_code::unicast_interface, L"unicast_interface"}, {iocontrol_code::limit_broadcasts, L"limit_broadcasts"}, {iocontrol_code::bind_to_interface, L"bind_to_interface"}, {iocontrol_code::multicast_interface, L"multicast_interface"}, {iocontrol_code::add_multicast_group_on_interface, L"add_multicast_group_on_interface"}, {iocontrol_code::delete_multicast_group_from_interface, L"delete_multicast_group_from_interface"}, {iocontrol_code::get_extension_function_pointer, L"get_extension_function_pointer"}, {iocontrol_code::get_qos, L"get_qos"}, {iocontrol_code::get_group_qos, L"get_group_qos"}, {iocontrol_code::translate_handle, L"translate_handle"}, {iocontrol_code::routing_interface_query, L"routing_interface_query"}, {iocontrol_code::address_list_sort, L"address_list_sort"}});}
    }
  }
}
