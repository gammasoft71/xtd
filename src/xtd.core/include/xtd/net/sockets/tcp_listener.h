  ...
  namespace net {
    ...
    namespace sockets {
      ...
      public:
        ...
        /// @return An xtd::iasync_result that references the asynchronous creation of the xtd::net::sockets::socket.
        /// @exception xtd::net::sockets::socket_exception An error occurred when attempting to access the socket.
        /// @exception xtd::object_closed_exception The xtd::net::sockets::socket has been closed.
        /// @remarks The asynchronous xtd::net::sockets::tcp_listener::begin_accept_socket operation must be completed by calling the xtd::net::sockets::tcp_listener::end_accept_socket method. Typically, the method is invoked by the callback delegate.
        ...
        /// @exception xtd::net::sockets::socket_exception An error occurred when attempting to access the socket.
        /// @exception xtd::argument_out_of_range_exception The backlog parameter is less than zero or exceeds the maximum number of permitted connections.
