...
template<> struct xtd::enum_register<xtd::net::sockets::socket_option_level> {
  void operator()(xtd::enum_collection<xtd::net::sockets::socket_option_level>& values) {values = {{xtd::net::sockets::socket_option_level::socket, "socket"}, {xtd::net::sockets::socket_option_level::ip, "ip"}, {xtd::net::sockets::socket_option_level::ip_v6, "ip_v6"}, {xtd::net::sockets::socket_option_level::tcp, "tcp"}, {xtd::net::sockets::socket_option_level::udp, "udp"}};}
};
/// @endcond
