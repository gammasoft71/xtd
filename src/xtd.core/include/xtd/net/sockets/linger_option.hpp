  ...
  namespace net {
    ...
    namespace sockets {
      ...
      struct core_export_ linger_option : xtd::object {
        ...
        /// @{
        /// @brief Gets or sets a value that indicates whether to linger after the xtd::net::sockets::socket is closed.
        /// @param enabled `true` if the xtd::net::sockets::socket should linger after xtd::net::sockets::socket::close is called; otherwise, `false`.
        ...
        /// @brief Gets or sets the amount of time to remain connected after calling the xtd::net::sockets::socket::close method if data remains to be sent.
        /// @param linger_time The amount of time, in seconds, to remain connected after calling xtd::net::sockets::socket::close.
