  ...
  namespace net {
    ...
    namespace sockets {
      ...
      public:
        ...
        /// @param e The SocketAsyncEventArgs object to use for this asynchronous socket operation.
        ...
        /// @brief Receives the specified number of bytes of data from a bound Socket into a receive buffer, using the specified xtd::net::sockets::socket_flags.
        /// @param buffer An array of type Byte that is the storage location for the received data.
        ...
        /// @brief Receives the specified number of bytes from a bound Socket into the specified offset position of the receive buffer, using the specified xtd::net::sockets::socket_flags.
        /// @param buffer An array of type Byte that is the storage location for the received data.
