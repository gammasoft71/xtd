...
namespace xtd {
  ...
  namespace net {
    ...
    public:
      ...
      /// @exception xtd::argument_exception The host parameter contains an empty string.
      /// @remarks The xtd::dns_end_point::dns_end_point(const xtd::ustring& host, int32_t port, xtd::net::sockets::address_family) constructor can be used to initialize a dns_end_point class using either a host name or a string that represents an IP address, a port, and an address family.
