...
std::unordered_map<std::type_index, std::function<std::string(std::any const&)>> __any_stringer__ {
  ...
  __to_any_stringer__<llong>([](auto value)->std::string {return ustring::format("{}", value);}),
  ...
  __to_any_stringer__<ullong>([](auto value)->std::string {return ustring::format("{}", value);}),
