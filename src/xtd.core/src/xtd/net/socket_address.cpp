...
auto socket_address::address_family() const -> sockets::address_family {
...
auto socket_address::equals(const object& obj) const noexcept -> bool {
  return is<socket_address>(obj) && equals(static_cast<const socket_address&>(obj));
}

auto socket_address::equals(const socket_address& other) const noexcept -> bool {
...
auto socket_address::to_string() const noexcept -> string {
