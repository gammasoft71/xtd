...
access_violation_exception::access_violation_exception(const stack_frame& info) : access_violation_exception(string::empty_string, std::optional<xtd::exception> {}, info) {
}

access_violation_exception::access_violation_exception(const xtd::string& message, const xtd::diagnostics::stack_frame& info) : access_violation_exception(message, std::optional<xtd::exception> {}, info) {
}
