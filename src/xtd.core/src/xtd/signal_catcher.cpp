...
namespace {
  ...
  struct signal_catcher {
    ...
    static void signal_illegal_instruction_handler(int32 signal) {
      //__startup_catch_exception__(xtd::invalid_operation_exception(csf_));
      //exit(EXIT_FAILURE);
    ...
    static void signal_abort_exception_handler(int32 signal) {
      //__startup_catch_exception__(xtd::threading::thread_abort_exception(csf_));
      //exit(EXIT_FAILURE);
    ...
    static void signal_floating_point_exception_handler(int32 signal) {
      //__startup_catch_exception__(xtd::arithmetic_exception(csf_));
      //exit(EXIT_FAILURE);
    ...
    static void signal_segmentation_violation_handler(int32 signal) {
      //__startup_catch_exception__(xtd::access_violation_exception(csf_));
      //exit(EXIT_FAILURE);
