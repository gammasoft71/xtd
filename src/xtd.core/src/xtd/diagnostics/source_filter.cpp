...
bool source_filter::should_trace(const trace_event_cache& cache, const ustring& source, trace_event_type event_type, int32 id, const ustring& message, std::any data1, const list<std::any>& data_array) noexcept {
