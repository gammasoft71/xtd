...
bool event_type_filter::should_trace(const trace_event_cache& cache, const string& source, trace_event_type event_type, int32 id, const string& message, any_object data1, const list<any_object>& data_array) noexcept {
