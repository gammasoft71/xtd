...
int16 xtd::operator""_s16(const char16_t* s, size_t n) {
  return as<int16>(u16string(s, s + n));
}

int16 xtd::operator""_s16(const char32_t* s, size_t n) {
  return as<int16>(u32string(s, s + n));
}

int16 xtd::operator""_s16(const wchar_t* s, size_t n) {
...
int64 xtd::operator""_s64(const char16_t* s, size_t n) {
  return as<int64>(u16string(s, s + n));
}

int64 xtd::operator""_s64(const char32_t* s, size_t n) {
  return as<int64>(u32string(s, s + n));
}

int64 xtd::operator""_s64(const wchar_t* s, size_t n) {
...
xtd::byte xtd::operator""_u8(const char16_t* s, size_t n) {
  return as<xtd::byte>(u16string(s, s + n));
}

xtd::byte xtd::operator""_u8(const char32_t* s, size_t n) {
  return as<xtd::byte>(u32string(s, s + n));
}

xtd::byte xtd::operator""_u8(const wchar_t* s, size_t n) {
  return as<xtd::byte>(wstring(s, s + n));
}
...
uint32 xtd::operator""_u32(const char16_t* s, size_t n) {
  return as<uint32>(u16string(s, s + n));
}

uint32 xtd::operator""_u32(const char32_t* s, size_t n) {
  return as<uint32>(u32string(s, s + n));
}

uint32 xtd::operator""_u32(const wchar_t* s, size_t n) {
...
uint64 xtd::operator""_u64(const char16_t* s, size_t n) {
  return as<uint64>(u16string(s, s + n));
}

uint64 xtd::operator""_u64(const char32_t* s, size_t n) {
  return as<uint64>(u32string(s, s + n));
}

uint64 xtd::operator""_u64(const wchar_t* s, size_t n) {
