...
vector<byte_t> bit_converter::get_bytes(int64 value) noexcept {
...
vector<byte_t> bit_converter::get_bytes(uint64 value) noexcept {
...
int64 bit_converter::to_int64(const vector<byte_t>& value, size_t start_index) {
...
uint64 bit_converter::to_uint64(const vector<byte_t>& value, size_t start_index) {
