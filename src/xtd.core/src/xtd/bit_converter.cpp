...
vector<byte_t> bit_converter::get_bytes(bool value) {
  return {static_cast<byte_t>(value)};
}

vector<byte_t> bit_converter::get_bytes(char value) {
  return bit_converter::get_bytes(((uint32_t)value));
}

vector<byte_t> bit_converter::get_bytes(char16_t value) {
  return bit_converter::get_bytes(((uint32_t)value));
}

vector<byte_t> bit_converter::get_bytes(char32_t value) {
  return bit_converter::get_bytes(((uint32_t)value));
}

vector<byte_t> bit_converter::get_bytes(wchar_t value) {
  return bit_converter::get_bytes(((uint32_t)value));
}

vector<byte_t> bit_converter::get_bytes(double value) {
...
vector<byte_t> bit_converter::get_bytes(int32_t value) {
  return bit_converter::get_bytes(uint32_t(value));
}

vector<byte_t> bit_converter::get_bytes(int64_t value) {
...
vector<byte_t> bit_converter::get_bytes(ullong value) {
  return bit_converter::get_bytes(uint64_t(value));
}
