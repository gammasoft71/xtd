...
void file::copy(const string& src, const string& dest, bool overwrite) {
  ...
  if (!overwrite && exists(dest)) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::io);
  ...
  if (overwrite && native::file::exists(dest)) {
    ...
    if (native::file::remove(dest) != 0) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::io);
  }
  
  if (native::file::copy(src, dest) != 0) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::io);
}
...
void file::move(const string& src, const string& dest, bool overwrite) {
  ...
  if (native::file::move(src, dest) != 0) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::io);
}
...
void file::remove(const string& path) {
  ...
  if (native::file::remove(path) != 0) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::io);
}
...
void file::set_attributes(const xtd::string& path, xtd::io::file_attributes attributes) {
  ...
  if (native::file_system::set_attributes(path, static_cast<int32>(attributes)) != 0) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::io);
}
