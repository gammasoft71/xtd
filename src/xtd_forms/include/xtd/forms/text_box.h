...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      drawing::color default_back_color() const override {return xtd::forms::theme_color::current_theme_color().text_box();}
      
      drawing::color default_fore_color() const override {return xtd::forms::theme_color::current_theme_color().text_box_text();}
