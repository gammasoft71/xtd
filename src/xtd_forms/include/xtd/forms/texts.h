...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      static const std::string customize;
      ...
      static const std::string floppy;
      ...
      static const std::string harddisk;
      ...
      static const std::string print_preview;
      ...
      static const std::string undelete;
      ...
      static const std::string unindent;
      ...
      static const std::string zoom_to_fit;
    };
  }
}
