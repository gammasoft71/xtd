...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      static xtd::drawing::image file_save_as() {return file_save_as(xtd::forms::theme::default_theme_name(), size());}
      static xtd::drawing::image file_save_as(const std::string& theme) {return file_save_as(theme, size());}
      static xtd::drawing::image file_save_as(const xtd::drawing::size& size) {return file_save_as(xtd::forms::theme::default_theme_name(), size);}
      ...
      static xtd::drawing::image file_page_setup() {return file_page_setup(xtd::forms::theme::default_theme_name(), size());}
      static xtd::drawing::image file_page_setup(const std::string& theme) {return file_page_setup(theme, size());}
      static xtd::drawing::image file_page_setup(const xtd::drawing::size& size) {return file_page_setup(xtd::forms::theme::default_theme_name(), size);}
