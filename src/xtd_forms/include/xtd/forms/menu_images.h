...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      static xtd::drawing::image edit_cut(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "edit_cut", size);}
      ...
      static xtd::drawing::image edit_copy(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "edit_copy", size);}
      ...
      static xtd::drawing::image edit_paste(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "edit_paste", size);}
      ...
      static xtd::drawing::image help_about(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "help_about", size);}
