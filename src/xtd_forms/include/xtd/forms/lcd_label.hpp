  ...
  namespace forms {
    class lcd_label : public control {
      ...
      public:
        ...
        void set_background_digit_transparency(double value) override {fourteen_segment_display::background_digit_transparency(value);}
        void set_character(wchar_t value) override {
        ...
        void set_show_background_digit(bool value) override {fourteen_segment_display::show_background_digit(value);}
        void set_thickness(int32_t value) override {seven_segment_display::thickness(value);}
      ...
      public:
        ...
        void set_background_digit_transparency(double value) override {sixteen_segment_display::background_digit_transparency(value);}
        void set_character(wchar_t value) override {
          static std::map<wchar_t, forms::segments> characters {
            ...
            {']', forms::segments::a1 | forms::segments::a2 | forms::segments::b | forms::segments::c | forms::segments::d},
            {'(', forms::segments::j | forms::segments::m},
            {')', forms::segments::h | forms::segments::k},
            {'|', forms::segments::i | forms::segments::l},
            {' ', forms::segments::none},
        ...
        void set_show_background_digit(bool value) override {sixteen_segment_display::show_background_digit(value);}
