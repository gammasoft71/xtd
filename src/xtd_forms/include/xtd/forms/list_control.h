...
namespace xtd {
  ...
  namespace forms {
    ...
    protected:
      ...
      virtual drawing::color default_back_color() const override {return xtd::forms::theme_color::current_theme().window();}
      
      virtual drawing::color default_fore_color() const override {return xtd::forms::theme_color::current_theme().window_text();}
