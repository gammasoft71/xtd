...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      static xtd::drawing::image add() {return add(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image add(const std::string& theme) {return add(theme, size());}
      static xtd::drawing::image add(const xtd::drawing::size& size) {return add(xtd::drawing::system_images::default_theme(), size);}
      static xtd::drawing::image add(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "list-add", size);}
      
      static xtd::drawing::image apply() {return apply(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image apply(const std::string& theme) {return apply(theme, size());}
      static xtd::drawing::image apply(const xtd::drawing::size& size) {return apply(xtd::drawing::system_images::default_theme(), size);}
      ...
      static xtd::drawing::image ok() {return ok(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image ok(const std::string& theme) {return ok(theme, size());}
      static xtd::drawing::image ok(const xtd::drawing::size& size) {return ok(xtd::drawing::system_images::default_theme(), size);}
      static xtd::drawing::image ok(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "dialog-ok", size);}
      
      static xtd::drawing::image cancel() {return cancel(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image cancel(const std::string& theme) {return cancel(theme, size());}
      static xtd::drawing::image cancel(const xtd::drawing::size& size) {return cancel(xtd::drawing::system_images::default_theme(), size);}
      ...
      static xtd::drawing::image next() {return next(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image next(const std::string& theme) {return next(theme, size());}
      static xtd::drawing::image next(const xtd::drawing::size& size) {return next(xtd::drawing::system_images::default_theme(), size);}
      static xtd::drawing::image next(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "go-next", size);}
      
      static xtd::drawing::image no() {return no(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image no(const std::string& theme) {return no(theme, size());}
      static xtd::drawing::image no(const xtd::drawing::size& size) {return no(xtd::drawing::system_images::default_theme(), size);}
      static xtd::drawing::image no(const std::string& theme, const xtd::drawing::size& size) {return from_name(theme, "dialog-cancel", size);}

      static xtd::drawing::image previous() {return previous(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image previous(const std::string& theme) {return previous(theme, size());}
      static xtd::drawing::image previous(const xtd::drawing::size& size) {return previous(xtd::drawing::system_images::default_theme(), size);}
      ...
      static xtd::drawing::image remove() {return remove(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image remove(const std::string& theme) {return remove(theme, size());}
      static xtd::drawing::image remove(const xtd::drawing::size& size) {return remove(xtd::drawing::system_images::default_theme(), size);}
      ...
      static xtd::drawing::image yes() {return yes(xtd::drawing::system_images::default_theme(), size());}
      static xtd::drawing::image yes(const std::string& theme) {return yes(theme, size());}
      static xtd::drawing::image yes(const xtd::drawing::size& size) {return yes(xtd::drawing::system_images::default_theme(), size);}
