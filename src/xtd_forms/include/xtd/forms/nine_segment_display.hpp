...
namespace xtd {
  namespace forms {
    ...
    class nine_segment_display : public control {
    public:
      ...
      nine_segment_display& background_digit_transparency(double value) {
      ...
      nine_segment_display& show_background_digit(bool value) {
      ...
      nine_segment_display& value(forms::segments segments) {
        if (value_ != segments) {
          value_ = segments;
          invalidate();
        }
      ...
      nine_segment_display& segment_style(forms::segment_style value) {
    ...
    private:
      void draw_background_digit(drawing::graphics& graphics, const drawing::size& size, int32_t thickness) {
        ...
        draw_segment_h(graphics, background_digit_color, size, thickness);
        draw_segment_i(graphics, background_digit_color, size, thickness);
      }
      ...
      void draw_segment_h(drawing::graphics& graphics, const drawing::color& color, const drawing::size& size, int32_t thickness) {
        for (int32_t offset = -thickness / 2; offset < thickness - thickness / 2; offset++) {
      ...
      void draw_segment_i(drawing::graphics& graphics, const drawing::color& color, const drawing::size& size, int32_t thickness) {
        for (int32_t offset = -thickness / 2; offset < thickness - thickness / 2; offset++) {
