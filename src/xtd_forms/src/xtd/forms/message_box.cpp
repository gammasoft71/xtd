...
namespace  {
  dialog_result show_message_box(intptr_t hwnd, const ustring& text, const ustring& caption, message_box_buttons buttons, message_box_icon icon, message_box_default_button default_button, message_box_options options, bool display_help_button) {
...
dialog_result message_box::show(const control& owner, const ustring &text) {
...
dialog_result message_box::show(const control& owner, const ustring &text, const ustring &caption) {
  application::raise_enter_thread_modal(event_args::empty);
...
dialog_result message_box::show(const control& owner, const ustring &text, const ustring &caption, message_box_buttons buttons) {
  application::raise_enter_thread_modal(event_args::empty);
...
dialog_result message_box::show(const control& owner, const ustring &text, const ustring &caption, message_box_buttons buttons, message_box_icon icon) {
  application::raise_enter_thread_modal(event_args::empty);
...
dialog_result message_box::show(const control& owner, const ustring &text, const ustring &caption, message_box_buttons buttons, message_box_icon icon, message_box_default_button default_button) {
  application::raise_enter_thread_modal(event_args::empty);
...
dialog_result message_box::show(const control& owner, const ustring &text, const ustring &caption, message_box_buttons buttons, message_box_icon icon, message_box_default_button default_button, message_box_options options) {
  application::raise_enter_thread_modal(event_args::empty);
...
dialog_result message_box::show(const control& owner, const ustring &text, const ustring &caption, message_box_buttons buttons, message_box_icon icon, message_box_default_button default_button, message_box_options options, bool display_help_button) {
  application::raise_enter_thread_modal(event_args::empty);
