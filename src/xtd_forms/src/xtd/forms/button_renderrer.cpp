...
void button_renderrer::draw_button_macos(graphics g, const rectangle& bounds, const string& text, const font& font, text_format_flags flags, const image& image, const rectangle& image_bounds, bool focused, push_button_state state, const optional<color>& back_color, const optional<color>& fore_color) {
  ...
  g.fill_rounded_rectangle(xtd::drawing::solid_brush(background_color), button_rect, 3.);
...
void button_renderrer::draw_button_windows(graphics g, const rectangle& bounds, const string& text, const font& font, text_format_flags flags, const image& image, const rectangle& image_bounds, bool focused, push_button_state state, const optional<color>& back_color, const optional<color>& fore_color) {
  ...
  auto border_color = system_colors::window().get_lightness() < 0.5 ? background_color : xtd::drawing::color::from_argb(232, 243, 251);
  ...
  if (state == xtd::forms::visual_styles::push_button_state::hot) {
    ...
    border_color = system_colors::window().get_lightness() < 0.5 ? background_color : xtd::drawing::color::from_argb(232, 243, 251);
    button_color = system_colors::window().get_lightness() < 0.5 ? background_color : xtd::drawing::color::from_argb(232, 243, 251);
  } else if (state == xtd::forms::visual_styles::push_button_state::pressed) {
    active_border_color = system_colors::window().get_lightness() < 0.5 ? xtd::drawing::color::from_argb(0, 160, 250) : xtd::drawing::color::from_argb(0, 120, 215); // active_border_color = xtd::drawing::system_colors::highlight();
    ...
    border_color = system_colors::window().get_lightness() < 0.5 ? background_color : xtd::drawing::color::from_argb(0, 120, 215); // border_color = xtd::drawing::system_colors::highlight();
