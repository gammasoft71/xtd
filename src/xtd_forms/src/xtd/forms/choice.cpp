...
choice::choice() {
  ...
  this->items_.item_added += [&](size_t pos, const item& item) {
    ...
    size_t selected_index = 0xFFFFFFFFFFFFFFFF;
    if (this->selected_index_ != 0xFFFFFFFFFFFFFFFF && this->selected_index_ < this->items_.size()) selected_index = this->selected_index_;
