#include "../../../include/xtd/forms/texts.hpp"
...
const std::string texts::new_text = "&New";
...
const std::string texts::speel_check = "&Spell Check";
const std::string texts::stop = "&Stop";
const std::string texts::strikethrough = "&Strikethrough";
