...
void graphics::clear(intmax_t hdc, uint8_t a, uint8_t r, uint8_t g, uint8_t b) {
  if (hdc == 0) return;
  reinterpret_cast<fl_dc*>(hdc)->clear(fl_rgb_color(r, g, b));
}

void graphics::draw_arc(intmax_t hdc, intmax_t pen, int32_t x, int32_t y, int32_t width, int32_t height, int32_t start_angle, int32_t sweep_angle) {
  if (!hdc) return;
...
void graphics::draw_bezier(intmax_t hdc, intmax_t pen, int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t x3, int32_t y3, int32_t x4, int32_t y4) {
  if (!hdc) return;
...
void graphics::draw_ellipse(intmax_t hdc, intmax_t pen, int32_t x, int32_t y, int32_t width, int32_t height) {
  if (!hdc) return;
...
void graphics::draw_line(intmax_t hdc, intmax_t pen, int32_t x1, int32_t y1, int32_t x2, int32_t y2) {
  if (!hdc) return;
...
void graphics::draw_rectangle(intmax_t hdc, intmax_t pen, int32_t x, int32_t y, int32_t width, int32_t height) {
  if (!hdc) return;
...
void graphics::draw_string(intmax_t hdc, const std::string& text, intmax_t font, int32_t x, int32_t y, uint8_t a, uint8_t r, uint8_t g, uint8_t b) {
  if (!hdc) return;
...
void graphics::draw_string(intmax_t hdc, const std::string& text, intmax_t font, int32_t x, int32_t y, int32_t w, int32_t h, uint8_t a, uint8_t r, uint8_t g, uint8_t b) {
  if (!hdc) return;
...
void graphics::fill_ellipse(intmax_t hdc, intmax_t brush, int32_t x, int32_t y, int32_t width, int32_t height) {
  if (!hdc) return;
  reinterpret_cast<fl_dc*>(hdc)->fill_ellipse(reinterpret_cast<fl_brush*>(brush)->color(), x, y, width, height);
}

void graphics::fill_pie(intmax_t hdc, intmax_t brush, int32_t x, int32_t y, int32_t width, int32_t height, int32_t start_angle, int32_t sweep_angle) {
  if (!hdc) return;
  reinterpret_cast<fl_dc*>(hdc)->fill_pie(reinterpret_cast<fl_brush*>(brush)->color(), x, y, width, height, start_angle, sweep_angle);
}

void graphics::fill_rectangle(intmax_t hdc, intmax_t brush, int32_t x, int32_t y, int32_t width, int32_t height) {
  if (!hdc) return;
  reinterpret_cast<fl_dc*>(hdc)->fill_rectangle(reinterpret_cast<fl_brush*>(brush)->color(), x, y, width, height);
}

void graphics::measure_string(intmax_t hdc, const std::string& text, intmax_t font, int32_t& width, int32_t& height) {
  if (!hdc) return;
