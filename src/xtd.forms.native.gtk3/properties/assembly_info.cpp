...
assembly_title_("xtd.forms.native.gtk3");
assembly_description_("xtd.forms.native.gtk3 library is based on Gtk+ 3 toolkit.");
assembly_configuration_("");
assembly_company_("Gammasoft");
assembly_product_("xtd.forms.native.gtk3");
...
assembly_guid_("c2382ba3-23da-4791-a786-225121a8597f");
