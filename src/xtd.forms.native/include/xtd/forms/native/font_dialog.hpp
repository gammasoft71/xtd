  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        static bool run_dialog(intptr hwnd, drawing::font& font, drawing::color& color, xtd::usize options, xtd::usize min_size, xtd::usize max_size, bool show_color);
        ...
        /// @warning Internal use only
        static void run_sheet(xtd::delegate<void(bool)> on_dialog_closed, intptr hwnd, drawing::font& font, drawing::color& color, xtd::usize options, xtd::usize min_size, xtd::usize max_size, bool show_color);
        /// @}
      };
    }
  }
