  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto run_dialog(xtd::intptr hwnd, drawing::font& font, drawing::color& color, xtd::usize options, xtd::usize min_size, xtd::usize max_size, bool show_color) -> bool;
        ...
        /// @warning Internal use only
        static auto run_sheet(xtd::delegate<void(bool)> on_dialog_closed, xtd::intptr hwnd, drawing::font& font, drawing::color& color, xtd::usize options, xtd::usize min_size, xtd::usize max_size, bool show_color) -> void;
        /// @}
      };
    }
  }
