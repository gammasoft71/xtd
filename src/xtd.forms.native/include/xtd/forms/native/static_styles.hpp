...
constexpr xtd::usize SS_LEFT = 0x00000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_CENTER = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_RIGHT = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_ICON = 0x00000003;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_BLACKRECT = 0x00000004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_GRAYRECT = 0x00000005;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_WHITERECT = 0x00000006;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_BLACKFRAME = 0x00000007;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_GRAYFRAME = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_WHITEFRAME = 0x00000009;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_USERITEM = 0x0000000A;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_SIMPLE = 0x0000000B;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_LEFTNOWORDWRAP = 0x0000000C;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_OWNERDRAW = 0x0000000D;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_BITMAP = 0x0000000E;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_ENHMETAFILE = 0x0000000F;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_ETCHEDHORZ = 0x00000010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_ETCHEDVERT = 0x00000011;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_ETCHEDFRAME = 0x00000012;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_TYPEMASK = 0x0000001F;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_REALSIZECONTROL = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_NOPREFIX = 0x00000080; // Don't do "&" character translation
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_NOTIFY = 0x00000100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_CENTERIMAGE = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_RIGHTJUST = 0x00000400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_REALSIZEIMAGE = 0x00000800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_SUNKEN = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_EDITCONTROL = 0x00002000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_ENDELLIPSIS = 0x00004000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_PATHELLIPSIS = 0x00008000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize SS_WORDELLIPSIS = 0x0000C000;
/// @cond
constexpr xtd::usize SS_ELLIPSISMASK = 0x0000C000;
/// @endcond
#endif
...
/// @warning Internal use only
constexpr xtd::usize SS_TOP = 0x00000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize SS_VCENTER = 0x00010000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize SS_BOTTOM = 0x00020000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize SS_BITMAP_NORMAL = 0x00000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize SS_BITMAP_STRETCH = 0x00040000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize SS_BITMAP_AUTOSIZE = 0x00080000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize SS_BITMAP_CENTER = 0x000C0000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize SS_BITMAP_ZOOM = 0x00100000;
