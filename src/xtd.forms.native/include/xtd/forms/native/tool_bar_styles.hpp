...
constexpr xtd::usize TBSTYLE_TOOLTIPS = 0x00000100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_WRAPABLE = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_ALTDRAG = 0x00000400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_FLAT = 0x00000800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_LIST = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_CUSTOMERASE = 0x00002000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_REGISTERDROP = 0x00004000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_TRANSPARENT = 0x00008000;
#endif
...
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_SHOWTEXT = 0x00020000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_TEXTRIGHTALIGN = 0x00040000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_LEFT = 0x00080000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_BOTTOM = 0x00100000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_RIGHT = 0x00200000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_NOSHOWICON = 0x00400000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize TBSTYLE_NODIVIDER = 0x00800000;
