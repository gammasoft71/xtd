...
constexpr xtd::usize MCS_DAYSTATE = 0x0001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MCS_MULTISELECT = 0x0002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MCS_WEEKNUMBERS = 0x0004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MCS_NOTODAYCIRCLE = 0x0008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MCS_NOTODAY = 0x0010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MCS_NOTRAILINGDATES = 0x0040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MCS_SHORTDAYSOFWEEK = 0x0080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MCS_NOSELCHANGEONNAV = 0x0100;
#endif
