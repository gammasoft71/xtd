...
constexpr xtd::usize BS_PUSHBUTTON = 0x00000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_DEFPUSHBUTTON = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_CHECKBOX = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_AUTOCHECKBOX = 0x00000003;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_RADIOBUTTON = 0x00000004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_3STATE = 0x00000005;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_AUTO3STATE = 0x00000006;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_GROUPBOX = 0x00000007;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_USERBUTTON = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_AUTORADIOBUTTON = 0x00000009;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_PUSHBOX = 0x0000000A;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_OWNERDRAW = 0x0000000B;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_TYPEMASK = 0x0000000F;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_LEFTTEXT = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_TEXT = 0x00000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_ICON = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_BITMAP = 0x00000080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_LEFT = 0x00000100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_RIGHT = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_CENTER = 0x00000300;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_TOP = 0x00000400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_BOTTOM = 0x00000800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_VCENTER = 0x00000C00;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_PUSHLIKE = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_MULTILINE = 0x00002000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_NOTIFY = 0x00004000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_FLAT = 0x00008000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_RIGHTBUTTON = BS_LEFTTEXT;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_SPLITBUTTON = 0x0000000C;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_DEFSPLITBUTTON = 0x0000000D;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_COMMANDLINK = 0x0000000E;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BS_DEFCOMMANDLINK = 0x0000000F;
#endif
