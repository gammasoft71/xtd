...
constexpr xtd::usize DTS_UPDOWN = 0x0001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize DTS_SHOWNONE = 0x0002; // allow a NONE selection
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize DTS_SHORTDATEFORMAT = 0x0000; // use the short date format (app must forward WM_WININICHANGE messages)
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize DTS_LONGDATEFORMAT = 0x0004; // use the long date format (app must forward WM_WININICHANGE messages)
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize DTS_SHORTDATECENTURYFORMAT = 0x000C; // short date format with century (app must forward WM_WININICHANGE messages)
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize DTS_TIMEFORMAT = 0x0009; // use the time format (app must forward WM_WININICHANGE messages)
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize DTS_APPCANPARSE = 0x0010; // allow user entered strings (app MUST respond to DTN_USERSTRING)
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize DTS_RIGHTALIGN = 0x0020; // right-align popup instead of left-align it
#endif
