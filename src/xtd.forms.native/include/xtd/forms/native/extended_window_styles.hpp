...
constexpr xtd::usize WS_EX_DLGMODALFRAME = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_NOPARENTNOTIFY = 0x00000004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_TOPMOST = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_ACCEPTFILES = 0x00000010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_TRANSPARENT = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_MDICHILD = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_TOOLWINDOW = 0x00000080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_WINDOWEDGE = 0x00000100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_CLIENTEDGE = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_CONTEXTHELP = 0x00000400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_RIGHT = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_LEFT = 0x00000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_RTLREADING = 0x00002000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_LTRREADING = 0x00000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_LEFTSCROLLBAR = 0x00004000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_RIGHTSCROLLBAR = 0x00000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_CONTROLPARENT = 0x00010000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_STATICEDGE = 0x00020000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_APPWINDOW = 0x00040000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_OVERLAPPEDWINDOW = WS_EX_WINDOWEDGE | WS_EX_CLIENTEDGE;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_PALETTEWINDOW = WS_EX_WINDOWEDGE | WS_EX_TOOLWINDOW | WS_EX_TOPMOST;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_LAYERED = 0x00080000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_NOINHERITLAYOUT = 0x00100000; // Disable inheritance of mirroring by children
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_NOREDIRECTIONBITMAP = 0x00200000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_LAYOUTRTL = 0x00400000; // Right to left mirroring
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_COMPOSITED = 0x02000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize WS_EX_NOACTIVATE = 0x08000000;
#endif
...
/// @warning Internal use only
constexpr xtd::usize WS_EX_AUTOSCROLL = 0x40000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize WS_EX_MODALWINDOW = 0x80000000;

inline static xtd::string __windows_extended_style_to_string__(xtd::usize style) {
  xtd::string result = "";
