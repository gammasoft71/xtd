...
constexpr xtd::usize CS_VREDRAW = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_HREDRAW = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_DBLCLKS = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_OWNDC = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_CLASSDC = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_PARENTDC = 0x00000080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_NOCLOSE = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_SAVEBITS = 0x00000800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_BYTEALIGNCLIENT = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_BYTEALIGNWINDOW = 0x00002000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_GLOBALCLASS = 0x00004000;

/// @cond
/// (undocumented on MSDN)
constexpr xtd::usize CS_IME = 0x00010000;
/// @endcond
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CS_DROPSHADOW = 0x00020000;
#endif
