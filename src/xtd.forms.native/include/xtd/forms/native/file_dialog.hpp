  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        static auto run_open_sheet(xtd::delegate<void(bool)> on_dialog_closed, xtd::intptr hwnd, const xtd::string& default_ext, xtd::string& file_name, xtd::collections::generic::list<xtd::string>& file_names, const xtd::string& filter, xtd::usize filter_index, const xtd::string& initial_directory, xtd::usize options, bool support_multi_dotted_extensions, const xtd::string& title) -> void;
        ...
        /// @remarks If result is `true`, the file_name parameter contains the new chosen file name and if option contains OFN_ALLOWMULTISELECT flags, the file_names parameter contains the new chosen file names.
        /// @warning Internal use only
        [[nodiscard]] static auto run_save_dialog(xtd::intptr hwnd, const xtd::string& default_ext, xtd::string& file_name, xtd::collections::generic::list<xtd::string>& file_names, const xtd::string& filter, xtd::usize filter_index, const xtd::string& initial_directory, xtd::usize options, bool support_multi_dotted_extensions, const xtd::string& title) -> bool;
        ...
        /// @remarks When dialog closed and if result is `true`, the file_name parameter contains the new chosen file name and if option contains OFN_ALLOWMULTISELECT flags, the file_names parameter contains the new chosen file names.
        /// @warning Internal use only
        static auto run_save_sheet(xtd::delegate<void(bool)> on_dialog_closed, xtd::intptr hwnd, const xtd::string& default_ext, xtd::string& file_name, xtd::collections::generic::list<xtd::string>& file_names, const xtd::string& filter, xtd::usize filter_index, const xtd::string& initial_directory, xtd::usize options, bool support_multi_dotted_extensions, const xtd::string& title) -> void;
        /// @}
      };
    }
  }
