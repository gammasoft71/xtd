  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        static bool run_open_dialog(intptr hwnd, const xtd::string& default_ext, xtd::string& file_name, xtd::collections::generic::list<xtd::string>& file_names, const xtd::string& filter, size_t filter_index, const xtd::string& initial_directory, size_t options, bool support_multi_dotted_extensions, const xtd::string& title);
        ...
        /// @remarks If result is `true`, the file_name parameter contains the new chosen file name and if option contains OFN_ALLOWMULTISELECT flags, the file_names parameter contains the new chosen file names.
        /// @warning Internal use only
        static bool run_save_dialog(intptr hwnd, const xtd::string& default_ext, xtd::string& file_name, xtd::collections::generic::list<xtd::string>& file_names, const xtd::string& filter, size_t filter_index, const xtd::string& initial_directory, size_t options, bool support_multi_dotted_extensions, const xtd::string& title);
