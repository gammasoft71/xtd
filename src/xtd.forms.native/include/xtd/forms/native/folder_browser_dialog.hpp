  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto run_dialog(xtd::intptr hwnd, const xtd::string& description, environment::special_folder root_folder, xtd::string& selected_path, xtd::usize options) -> bool;
        ...
        /// @warning Internal use only
        static auto run_sheet(xtd::delegate<void(bool)> on_dialog_closed, xtd::intptr hwnd, const xtd::string& description, environment::special_folder root_folder, xtd::string& selected_path, xtd::usize options) -> void;
        /// @}
      };
    }
  }
