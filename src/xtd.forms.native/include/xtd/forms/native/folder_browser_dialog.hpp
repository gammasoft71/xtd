  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        static bool run_dialog(intptr hwnd, const xtd::string& description, environment::special_folder root_folder, xtd::string& selected_path, xtd::usize options);
        ...
        /// @warning Internal use only
        static void run_sheet(xtd::delegate<void(bool)> on_dialog_closed, intptr hwnd, const xtd::string& description, environment::special_folder root_folder, xtd::string& selected_path, xtd::usize options);
        /// @}
      };
    }
  }
