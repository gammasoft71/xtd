  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        static auto show(xtd::intptr hwnd, const xtd::string& title, const xtd::string& message, const xtd::drawing::icon& icon, xtd::uint32 style, bool close_timeout_enabled, std::chrono::system_clock::duration close_timeout_interval, xtd::delegate<void()> on_notifier_closed) -> void;
        /// @}
      };
    }
  }
