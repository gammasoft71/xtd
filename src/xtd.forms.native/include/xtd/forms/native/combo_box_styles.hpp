...
constexpr xtd::usize CBS_SIMPLE = 0x0001L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_DROPDOWN = 0x0002L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_DROPDOWNLIST = 0x0003L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_OWNERDRAWFIXED = 0x0010L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_OWNERDRAWVARIABLE = 0x0020L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_AUTOHSCROLL = 0x0040L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_OEMCONVERT = 0x0080L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_SORT = 0x0100L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_HASSTRINGS = 0x0200L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_NOINTEGRALHEIGHT = 0x0400L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_DISABLENOSCROLL = 0x0800L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_UPPERCASE = 0x2000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CBS_LOWERCASE = 0x4000L;
#endif
