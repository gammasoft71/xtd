  ...
  namespace forms {
    ...
    namespace native {
      ...
      public:
        ...
        /// @warning Internal use only
        static bool run_dialog(intptr_t hwnd, xtd::drawing::color& color, std::optional<std::vector<uint32_t>>& custom_colors, size_t options);
        ...
        /// @warning Internal use only
        static void run_sheet(xtd::delegate<void(bool)> on_dialog_closed, intptr_t hwnd, xtd::drawing::color& color, std::optional<std::vector<uint32_t>>& custom_colors, size_t options);
      };
    }
  }
}
