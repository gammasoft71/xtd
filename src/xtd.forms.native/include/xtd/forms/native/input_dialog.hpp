  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @param text A xtd::string that specifies the caption title of dialog.
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto run_dialog(xtd::intptr hwnd, const xtd::string& text, const xtd::string& message, xtd::string& value, xtd::int32 character_casting, bool multiline, bool use_system_password_char, bool word_wrap) -> bool;
        ...
        /// @warning Internal use only
        static auto run_sheet(xtd::delegate<void(bool)> on_dialog_closed, xtd::intptr hwnd, const xtd::string& text, const xtd::string& message, xtd::string& value, xtd::int32 character_casting, bool multiline, bool use_system_password_char, bool word_wrap) -> void;
        /// @}
      };
    }
  }
