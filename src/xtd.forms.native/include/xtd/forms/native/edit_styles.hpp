...
constexpr xtd::usize ES_LEFT = 0x00000000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_CENTER = 0x00000001L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_RIGHT = 0x00000002L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_MULTILINE = 0x00000004L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_UPPERCASE = 0x00000008L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_LOWERCASE = 0x00000010L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_PASSWORD = 0x00000020L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_AUTOVSCROLL = 0x00000040L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_AUTOHSCROLL = 0x00000080L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_NOHIDESEL = 0x00000100L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_OEMCONVERT = 0x00000400L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_READONLY = 0x00000800L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_WANTRETURN = 0x00001000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize ES_NUMBER = 0x00002000L;
#endif
...
/// @warning Internal use only
constexpr xtd::usize ES_WANTTAB = 0x00004000L;
