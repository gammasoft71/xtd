  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        [[nodiscard]] static auto show(xtd::intptr hwnd, const xtd::string& text, const xtd::string& caption, xtd::uint32 options, bool display_help_button) -> xtd::int32;
        ...
        /// @param display_help_button `true` to show the Help button; otherwise, `false`.
        /// @warning Internal use only
        static auto show_sheet(xtd::delegate<void(xtd::int32)> on_dialog_closed, xtd::intptr hwnd, const xtd::string& text, const xtd::string& caption, xtd::uint32 options, bool display_help_button) -> void;
        /// @}
      };
    }
  }
