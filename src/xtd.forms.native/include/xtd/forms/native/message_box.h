  ...
  namespace forms {
    ...
    namespace native {
      ...
      protected:
        ...
        /// @warning Internal use only
        static int32 show(intptr_t hwnd, const xtd::ustring& text, const xtd::ustring& caption, uint32_t options, bool display_help_button);
        ...
        /// @param display_help_button true to show the Help button; otherwise, false.
        /// @warning Internal use only
        static void show_sheet(xtd::delegate<void(int32)> on_dialog_closed, intptr_t hwnd, const xtd::ustring& text, const xtd::ustring& caption, uint32_t options, bool display_help_button);
        /// @}
      };
    }
  }
