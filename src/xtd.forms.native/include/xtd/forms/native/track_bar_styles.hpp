...
constexpr xtd::usize TBS_AUTOTICKS = 0x0001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_VERT = 0x0002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_HORZ = 0x0000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_TOP = 0x0004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_BOTTOM = 0x0000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_LEFT = 0x0004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_RIGHT = 0x0000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_BOTH = 0x0008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_NOTICKS = 0x0010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_ENABLESELRANGE = 0x0020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_FIXEDLENGTH = 0x0040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_NOTHUMB = 0x0080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_TOOLTIPS = 0x0100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_REVERSED = 0x0200;  // Accessibility hint: the smaller number (usually the min value) means "high" and the larger number (usually the max value) means "low"
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_DOWNISLEFT = 0x0400;  // Down=Left and Up=Right (default is Down=Right and Up=Left)
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_NOTIFYBEFOREMOVE = 0x0800;  // Trackbar should notify parent before repositioning the slider due to user action (enables snapping)
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TBS_TRANSPARENTBKGND = 0x1000;  // Background is painted by the parent via WM_PRINTCLIENT
#endif
