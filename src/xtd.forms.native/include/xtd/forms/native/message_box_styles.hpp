...
constexpr xtd::usize MB_OK = 0x00000000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_OKCANCEL = 0x00000001L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ABORTRETRYIGNORE = 0x00000002L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_YESNOCANCEL = 0x00000003L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_YESNO = 0x00000004L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_RETRYCANCEL = 0x00000005L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONSTOP = 0x00000010L;
/// @brief A stop-sign icon appears in the message box.
/// @par Library
/// xtd.forms.native
/// @ingroup xtd_forms_native mb
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONERROR = 0x00000010L;
/// @brief A stop-sign icon appears in the message box.
/// @par Library
/// xtd.forms.native
/// @ingroup xtd_forms_native mb
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONHAND = 0x00000010L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONQUESTION = 0x00000020L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONEXCLAMATION = 0x00000030L;
/// @brief An exclamation-point icon appears in the message box.
/// @par Library
/// xtd.forms.native
/// @ingroup xtd_forms_native mb
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONWARNING = 0x00000030L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONINFORMATION = 0x00000040L;
/// @brief An icon consisting of a lowercase letter i in a circle appears in the message box.
/// @par Library
/// xtd.forms.native
/// @ingroup xtd_forms_native mb
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_ICONASTERISK = 0x00000040L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_DEFBUTTON1 = 0x00000000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_DEFBUTTON2 = 0x00000100L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_DEFBUTTON3 = 0x00000200L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_DEFBUTTON4 = 0x00000300L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_APPLMODAL = 0x00000000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_SYSTEMMODAL = 0x00001000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_TASKMODAL = 0x00002000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_HELP = 0x00004000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_DEFAULT_DESKTOP_ONLY = 0x00020000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_RIGHT = 0x00080000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_RTLREADING = 0x00100000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_SETFOREGROUND = 0x00010000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_TOPMOST = 0x00040000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize MB_SERVICE_NOTIFICATION = 0x00200000L;
