...
constexpr xtd::usize TCS_SCROLLOPPOSITE = 0x0001; // assumes multiline tab
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_BOTTOM = 0x0002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_RIGHT = 0x0002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_MULTISELECT = 0x0004; // allow multi-select in button mode
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_FLATBUTTONS = 0x0008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_FORCEICONLEFT = 0x0010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_FORCELABELLEFT = 0x0020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_HOTTRACK = 0x0040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_VERTICAL = 0x0080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_TABS = 0x0000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_BUTTONS = 0x0100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_SINGLELINE = 0x0000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_MULTILINE = 0x0200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_RIGHTJUSTIFY = 0x0000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_FIXEDWIDTH = 0x0400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_RAGGEDRIGHT = 0x0800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_FOCUSONBUTTONDOWN = 0x1000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_OWNERDRAWFIXED = 0x2000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_TOOLTIPS = 0x4000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize TCS_FOCUSNEVER = 0x8000;
#endif
