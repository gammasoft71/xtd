...
constexpr xtd::usize UDS_WRAP = 0x0001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_SETBUDDYINT = 0x0002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_ALIGNRIGHT = 0x0004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_ALIGNLEFT = 0x0008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_AUTOBUDDY = 0x0010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_ARROWKEYS = 0x0020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_HORZ = 0x0040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_NOTHOUSANDS = 0x0080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize UDS_HOTTRACK = 0x0100;
#endif
