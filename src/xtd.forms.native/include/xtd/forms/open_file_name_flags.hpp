...
constexpr xtd::usize OFN_READONLY = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_OVERWRITEPROMPT = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_HIDEREADONLY = 0x00000004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_NOCHANGEDIR = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_SHOWHELP = 0x00000010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_ENABLEHOOK = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_ENABLETEMPLATE = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_ENABLETEMPLATEHANDLE = 0x00000080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_NOVALIDATE = 0x00000100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_ALLOWMULTISELECT = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_EXTENSIONDIFFERENT = 0x00000400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_PATHMUSTEXIST = 0x00000800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_FILEMUSTEXIST = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_CREATEPROMPT = 0x00002000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_SHAREAWARE = 0x00004000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_NOREADONLYRETURN = 0x00008000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_NOTESTFILECREATE = 0x00010000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_NONETWORKBUTTON = 0x00020000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_NOLONGNAMES = 0x00040000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_EXPLORER = 0x00080000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_NODEREFERENCELINKS = 0x00100000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_LONGNAMES = 0x00200000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_ENABLEINCLUDENOTIFY = 0x00400000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_ENABLESIZING = 0x00800000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_DONTADDTORECENT = 0x02000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize OFN_FORCESHOWHIDDEN = 0x10000000;
#endif
...
/// @warning Internal use only
constexpr xtd::usize OFN_SHOWPREVIEW = 0x40000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize OFN_ADDEXTENSION = 0x80000000;
