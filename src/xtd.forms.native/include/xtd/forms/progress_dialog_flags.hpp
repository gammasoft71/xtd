...
constexpr xtd::usize PROGDLG_NORMAL = 0x00000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize PROGDLG_MODAL = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize PROGDLG_AUTOTIME = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize PROGDLG_NOTIME = 0x00000004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize PROGDLG_NOMINIMIZE = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize PROGDLG_NOPROGRESSBAR = 0x00000010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize PROGDLG_MARQUEEPROGRESS = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize PROGDLG_NOCANCEL = 0x00000040;
#endif
...
/// @warning Internal use only
constexpr xtd::usize PROGDLG_NOSKIP = 0x00000080;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize PROGDLG_SMOOTH = 0x00000100;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize PROGDLG_SMOOTH_REVERSE = 0x00000200;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize PROGDLG_ELAPSEDTIME = 0x00000400;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr xtd::usize PROGDLG_ESTIMATEDTIME = 0x00000800;
