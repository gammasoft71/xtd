/// @file
/// @brief Contains folder browser info flags constants.
...
constexpr xtd::usize BIF_RETURNONLYFSDIRS = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_DONTGOBELOWDOMAIN = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_STATUSTEXT = 0x00000004;
/// @brief Include a status area in the dialog box. The callback function can set the status text by sending messages to the dialog box. This flag is not supported when BIF_NEWDIALOGSTYLE is specified.
/// @par Library
/// xtd.forms.native
/// @ingroup xtd_forms_native bif
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_RETURNFSANCESTORS = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_EDITBOX = 0x00000010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_VALIDATE = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_NEWDIALOGSTYLE = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_USENEWUI = (BIF_NEWDIALOGSTYLE | BIF_EDITBOX);
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_BROWSEINCLUDEURLS = 0x00000080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_UAHINT = 0x00000100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_NONEWFOLDERBUTTON = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_NOTRANSLATETARGETS = 0x00000400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_BROWSEFORCOMPUTER = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_BROWSEFORPRINTER = 0x00002000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_BROWSEINCLUDEFILES = 0x00004000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_SHAREABLE = 0x00008000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize BIF_BROWSEFILEJUNCTIONS = 0x00010000;
#endif
