/// @file
/// @brief Contains choose color flags constants.
...
/// @par Library
/// xtd.forms.native
/// @ingroup xtd_forms_native cc
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_RGBINIT = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_FULLOPEN = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_PREVENTFULLOPEN = 0x00000004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_SHOWHELP = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_ENABLEHOOK = 0x00000010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_ENABLETEMPLATE = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_ENABLETEMPLATEHANDLE = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_SOLIDCOLOR = 0x00000080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CC_ANYCOLOR = 0x00000100;
#endif
...
/// @warning Internal use only
constexpr xtd::usize CC_ALPHACOLOR = 0x00000200;
