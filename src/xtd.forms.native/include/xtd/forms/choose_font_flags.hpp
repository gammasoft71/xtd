/// @file
/// @brief Contains choose font flags constants.
...
/// @par Library
/// xtd.forms.native
/// @ingroup xtd_forms_native cf
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_SCREENFONTS = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_PRINTERFONTS = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_BOTH = (CF_SCREENFONTS | CF_PRINTERFONTS);
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_SHOWHELP = 0x00000004L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_ENABLEHOOK = 0x00000008L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_ENABLETEMPLATE = 0x00000010L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_ENABLETEMPLATEHANDLE = 0x00000020L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_INITTOLOGFONTSTRUCT = 0x00000040L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_USESTYLE = 0x00000080L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_EFFECTS = 0x00000100L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_APPLY = 0x00000200L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_ANSIONLY = 0x00000400L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_SCRIPTSONLY = CF_ANSIONLY;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOVECTORFONTS = 0x00000800L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOOEMFONTS = CF_NOVECTORFONTS;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOSIMULATIONS = 0x00001000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_LIMITSIZE = 0x00002000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_FIXEDPITCHONLY = 0x00004000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_WYSIWYG = 0x00008000L; // must also have CF_SCREENFONTS & CF_PRINTERFONTS
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_FORCEFONTEXIST = 0x00010000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_SCALABLEONLY = 0x00020000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_TTONLY = 0x00040000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOFACESEL = 0x00080000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOSTYLESEL = 0x00100000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOSIZESEL = 0x00200000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_SELECTSCRIPT = 0x00400000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOSCRIPTSEL = 0x00800000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_NOVERTFONTS = 0x01000000L;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr xtd::usize CF_INACTIVEFONTS = 0x02000000L;
#endif
