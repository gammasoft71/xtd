...
xtd::system_report::xtd_library_collection system_report::xtd_libraries() noexcept {
  return {{"xtd.core", environment::version(), xtd::io::path::combine(__XTD_INSTALL_PATH__, "include"), xtd::io::path::combine(__XTD_INSTALL_PATH__, "lib"), __XTD_RESOURCES_PATH__}, {"xtd.drawing", environment::version(), xtd::io::path::combine(__XTD_INSTALL_PATH__, "include"), xtd::io::path::combine(__XTD_INSTALL_PATH__, "lib"), __XTD_RESOURCES_PATH__}, {"xtd.forms", environment::version(), xtd::io::path::combine(__XTD_INSTALL_PATH__, "include"), xtd::io::path::combine(__XTD_INSTALL_PATH__, "lib"), __XTD_RESOURCES_PATH__}, {"xtd.tunit", environment::version(), xtd::io::path::combine(__XTD_INSTALL_PATH__, "include"), xtd::io::path::combine(__XTD_INSTALL_PATH__, "lib"), __XTD_RESOURCES_PATH__},};
}
