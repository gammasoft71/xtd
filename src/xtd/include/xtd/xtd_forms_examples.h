...
///
/// @example about_dialog_system.cpp
/// The following code example demonstrate the use of xtd::forms::about_dialog dialog with dialog_styledialog_style tooo system.
/// @par Windows
...
/// The following code example demonstrate the use of xtd::forms::application class.
/// @par Windows
...
/// <br>
/// @image html applicationapplication_gd.png
///
/// @example application_and_exception.cpp
///  following code example demonstrate the use offollowing code example demonstrate how to manage exception with xtd::forms::application class.
/// @par Windows
...
///
/// @example application_context.cpp
...
///
/// @example application_informations.cpp
/// The following code example demonstrate the use of xtd::forms::application_informations class.
/// @par Windows
...
///
/// @example busy_box.cpp
/// The following code example demonstrate the use of xtd::forms::busy_box dialog.
/// @par Windows
