...
void application::register_message_filter(const delegate<bool(intmax_t, int32_t, intmax_t, intmax_t, intmax_t)>& message_filter_proc) {
  initialize(); // Must be first
}

void application::register_wnd_proc(const delegate<intmax_t(intmax_t, int32_t, intmax_t, intmax_t, intmax_t)>& wnd_proc) {
  initialize(); // Must be first
}
