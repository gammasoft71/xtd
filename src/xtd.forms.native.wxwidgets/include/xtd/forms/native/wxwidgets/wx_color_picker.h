    ...
    namespace native {
      ...
      private:
        explicit wx_color_picker(const xtd::forms::create_params& create_params) {
          ...
          control_handler::create<wxColourPickerCtrl>(reinterpret_cast<control_handler*>(create_params.parent())->main_control(), wxID_ANY, wxColour(0, 0, 0), wxPoint(create_params.x(), create_params.y()), wxSize(create_params.width(), create_params.height()), style, wxDefaultValidator, "Color");
