      ...
      private:
        wx_date_time_picker(const xtd::forms::create_params& create_params) {
          ...
          if ((create_params.style() & DTS_TIMEFORMAT) == DTS_TIMEFORMAT)
            control_handler::create<wxTimePickerCtrl>(reinterpret_cast<control_handler*>(create_params.parent())->main_control(), wxID_ANY, wxDefaultDateTime, wxPoint(create_params.x(), create_params.y()), wxDefaultSize, style_to_wx_style(create_params.style(), create_params.ex_style()));
          else
            control_handler::create<wxDatePickerCtrl>(reinterpret_cast<control_handler*>(create_params.parent())->main_control(), wxID_ANY, wxDefaultDateTime, wxPoint(create_params.x(), create_params.y()), wxDefaultSize, style_to_wx_style(create_params.style(), create_params.ex_style()));
