    ...
    namespace native {
      ...
      public:
        wx_checked_list_box(const forms::create_params& create_params) {
          ...
          this->control_handler::create<wxCheckListBox>(reinterpret_cast<control_handler*>(create_params.parent())->main_control(), wxID_ANY, wxPoint(create_params.x(), create_params.y()), wxSize(0, 0), 0, nullptr, style_to_wx_style(create_params.style(), create_params.ex_style()));
