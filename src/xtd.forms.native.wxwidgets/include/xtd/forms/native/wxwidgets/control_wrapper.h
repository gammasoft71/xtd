    ...
    namespace native {
      ...
      private:
        ...
        bool is_command_event(wxEventType event_type) const {
          static std::set<wxEventType> event_types = {wxEVT_BUTTON, wxEVT_CALENDAR_DOUBLECLICKED, wxEVT_CALENDAR_SEL_CHANGED, wxEVT_CALENDAR_PAGE_CHANGED, wxEVT_CALENDAR_WEEK_CLICKED, wxEVT_CALENDAR_WEEKDAY_CLICKED, wxEVT_CHECKBOX, wxEVT_CHOICE, wxEVT_COLLAPSIBLEPANE_CHANGED, wxEVT_COLOURPICKER_CHANGED, wxEVT_DATE_CHANGED, wxEVT_FONTPICKER_CHANGED, wxEVT_LISTBOX, wxEVT_NOTEBOOK_PAGE_CHANGED, wxEVT_LISTBOX_DCLICK, wxEVT_CHECKLISTBOX, wxEVT_MENU, wxEVT_SLIDER, wxEVT_SPINCTRLDOUBLE, wxEVT_RADIOBOX, wxEVT_RADIOBUTTON, wxEVT_SCROLLBAR, wxEVT_VLBOX, wxEVT_COMBOBOX, wxEVT_TOGGLEBUTTON, wxEVT_TOOL_RCLICKED, wxEVT_TIME_CHANGED, wxEVT_TOOL_DROPDOWN, wxEVT_TOOL_ENTER, wxEVT_COMBOBOX_DROPDOWN, wxEVT_COMBOBOX_CLOSEUP};
          return event_types.find(event_type) != event_types.end();
        }
        ...
        bool is_system_event(wxEventType event_type) const {
          static std::set<wxEventType> event_types = {wxEVT_RECREATE, wxEVT_SIZE, wxEVT_MOVE, wxEVT_CLOSE_WINDOW, wxEVT_END_SESSION, wxEVT_QUERY_END_SESSION, wxEVT_ACTIVATE_APP, wxEVT_ACTIVATE, wxEVT_CREATE, wxEVT_DESTROY, wxEVT_HELP, wxEVT_SHOW, wxEVT_FULLSCREEN, wxEVT_ICONIZE, wxEVT_MAXIMIZE, wxEVT_MOUSE_CAPTURE_CHANGED, wxEVT_MOUSE_CAPTURE_LOST, wxEVT_PAINT, wxEVT_ERASE_BACKGROUND, wxEVT_NC_PAINT, wxEVT_MENU_OPEN, wxEVT_MENU_CLOSE, wxEVT_MENU_HIGHLIGHT, wxEVT_CONTEXT_MENU, wxEVT_SYS_COLOUR_CHANGED, wxEVT_DISPLAY_CHANGED, wxEVT_QUERY_NEW_PALETTE, wxEVT_PALETTE_CHANGED, wxEVT_JOY_BUTTON_DOWN, wxEVT_JOY_BUTTON_UP, wxEVT_JOY_MOVE, wxEVT_JOY_ZMOVE, wxEVT_DROP_FILES, wxEVT_INIT_DIALOG, wxEVT_IDLE, wxEVT_UPDATE_UI, wxEVT_SIZING, wxEVT_MOVING, wxEVT_MOVE_START, wxEVT_MOVE_END, wxEVT_HIBERNATE};
          return event_types.find(event_type) != event_types.end();
        }
