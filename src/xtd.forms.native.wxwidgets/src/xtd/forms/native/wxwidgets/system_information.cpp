...
int32 system_information::arrange_direction() {
  #if defined(__WXMSW__)
...
int32 system_information::arrange_starting_position() {
  #if defined(__WXMSW__)
...
int32 system_information::boot_mode() {
  #if defined(__WXMSW__)
