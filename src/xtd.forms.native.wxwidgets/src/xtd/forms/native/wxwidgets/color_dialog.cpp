...
#if defined(__WXGTK__)
bool color_dialog::run_dialog(intptr hwnd, const xtd::string& title, drawing::color& color, std::vector<xtd::drawing::color>& custom_colors, size_t options) {
...
void color_dialog::run_sheet(xtd::delegate<void(bool)> on_dialog_closed, intptr hwnd, const xtd::string& title, drawing::color& color, std::vector<xtd::drawing::color>& custom_colors, size_t options) {
