...
constexpr std::int32_t NORMAL_PRIORITY_CLASS = 0x00000020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t IDLE_PRIORITY_CLASS = 0x00000040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t HIGH_PRIORITY_CLASS = 0x00000080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t REALTIME_PRIORITY_CLASS = 0x00000100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t BELOW_NORMAL_PRIORITY_CLASS = 0x00004000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t ABOVE_NORMAL_PRIORITY_CLASS = 0x00008000;
#endif
