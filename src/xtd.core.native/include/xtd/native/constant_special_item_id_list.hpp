...
constexpr std::int32_t CSIDL_DESKTOP = 0x0000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_INTERNET = 0x0001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PROGRAMS = 0x0002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_CONTROLS = 0x0003;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PRINTERS = 0x0004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PERSONAL = 0x0005;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_FAVORITES = 0x0006;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_STARTUP = 0x0007;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_RECENT = 0x0008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_SENDTO = 0x0009;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_BITBUCKET = 0x000a;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_STARTMENU = 0x000b;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_MYDOCUMENTS = CSIDL_PERSONAL;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_MYMUSIC = 0x000d;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_MYVIDEO = 0x000e;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_DESKTOPDIRECTORY = 0x0010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_DRIVES = 0x0011;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_NETWORK = 0x0012;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_NETHOOD = 0x0013;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_FONTS = 0x0014;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_TEMPLATES = 0x0015;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_STARTMENU = 0x0016;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_PROGRAMS = 0X0017;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_STARTUP = 0x0018;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_DESKTOPDIRECTORY = 0x0019;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_APPDATA = 0x001a;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PRINTHOOD = 0x001b;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_LOCAL_APPDATA = 0x001c;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_ALTSTARTUP = 0x001d;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_ALTSTARTUP = 0x001e;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_FAVORITES = 0x001f;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_INTERNET_CACHE = 0x0020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COOKIES = 0x0021;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_HISTORY = 0x0022;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_APPDATA = 0x0023;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_WINDOWS = 0x0024;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_SYSTEM = 0x0025;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PROGRAM_FILES = 0x0026;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_MYPICTURES = 0x0027;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PROFILE = 0x0028;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_SYSTEMX86 = 0x0029;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PROGRAM_FILESX86 = 0x002a;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PROGRAM_FILES_COMMON = 0x002b;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_PROGRAM_FILES_COMMONX86 = 0x002c;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_TEMPLATES = 0x002d;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_DOCUMENTS = 0x002e;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_ADMINTOOLS = 0x002f;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_ADMINTOOLS = 0x0030;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_CONNECTIONS = 0x0031;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_MUSIC = 0x0035;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_PICTURES = 0x0036;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_VIDEO = 0x0037;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_RESOURCES = 0x0038;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_RESOURCES_LOCALIZED = 0x0039;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMMON_OEM_LINKS = 0x003a;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_CDBURN_AREA = 0x003b;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CSIDL_COMPUTERSNEARME = 0x003d;
#endif
...
/// @warning Internal use only
constexpr std::int32_t CSIDL_HOME = 0x0040;
