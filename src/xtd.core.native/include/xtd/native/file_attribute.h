...
/// @file
/// @brief Contains console file attribute constants.
...
constexpr int_least32_t FILE_ATTRIBUTE_READONLY = 0x0001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_HIDDEN = 0x0002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_SYSTEM = 0x0004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_DIRECTORY = 0x0010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_ARCHIVE = 0x0020;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_DEVICE = 0x0040;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_NORMAL = 0x0080;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_TEMPORARY = 0x0100;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_SPARSE_FILE = 0x0200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_REPARSE_POINT = 0x0400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_COMPRESSED = 0x0800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_OFFLINE = 0x1000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_NOT_CONTENT_INDEXED = 0x2000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_ENCRYPTED = 0x4000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_INTEGRITY_STREAM = 0x00008000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_VIRTUAL = 0x00010000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_NO_SCRUB_DATA = 0x00020000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_EA = 0x00040000;
/// @brief (Not documented).
/// @par Library
/// xtd.core.native
/// @ingroup xtd_core_native file_attributes
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_PINNED = 0x00080000;
/// @brief (Not documented).
/// @par Library
/// xtd.core.native
/// @ingroup xtd_core_native file_attributes
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_UNPINNED = 0x00100000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_RECALL_ON_OPEN = 0x00040000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr int_least32_t FILE_ATTRIBUTE_RECALL_ON_DATA_ACCESS = 0x00400000;
#endif
