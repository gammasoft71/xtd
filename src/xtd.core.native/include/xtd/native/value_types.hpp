...
#if defined(_LP64) && !defined(__APPLE__) && (defined(_POSIX_VERSION) || defined(__ANDROID__) || defined(__CYGWIN__) || defined(__HAIKU_) || defined(__linux__) || defined(__MSYS__) || defined(__unix__))
