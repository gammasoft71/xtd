...
constexpr int_least32_t ENVIRONMENT_VARIABLE_TARGET_PROCESS = 0;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int_least32_t ENVIRONMENT_VARIABLE_TARGET_USER = 1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr int_least32_t ENVIRONMENT_VARIABLE_TARGET_MACHINE = 2;
