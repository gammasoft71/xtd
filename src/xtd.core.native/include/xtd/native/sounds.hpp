...
constexpr std::uint32_t ST_OK = 0x00000000;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONERROR = 0x00000010;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONHAND = 0x00000010;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONSTOP = 0x00000010;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONQUESTION = 0x00000020;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONWARNING = 0x00000030;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONEXCLAMATION = 0x00000030;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONINFORMATION = 0x00000040;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_ICONASTERISK = 0x00000040;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::uint32_t ST_BEEP = 0xFFFFFFFF;
