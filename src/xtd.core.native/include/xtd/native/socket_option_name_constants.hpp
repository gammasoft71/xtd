...
constexpr std::int32_t SOCKET_OPTION_NAME_DEBUG = 1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_ACCEPT_CONNECTION = 2;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_REUSE_ADDRESS = 4;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_KEEP_ALIVE = 8;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_DONT_ROUTE = 16;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_BROADCAST = 32;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_USE_LOOPBACK = 64;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_LINGER = 128;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_OUT_OF_BAND_INLINE = 256;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_DONT_LINGER = -129;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_EXCLUSIVE_ADDRESS_USE = -5;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_SEND_BUFFER = 4097;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_RECEIVE_BUFFER = 4098;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_SEND_LOW_WATER = 4099;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_RECEIVE_LOW_WATER = 4100;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_SEND_TIMEOUT = 4101;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_RECEIVE_TIMEOUT = 4102;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_ERROR = 4103;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_TYPE = 4104;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_MAX_CONNECTION = 2147483647;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_IP_OPTIONS = 1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_HEADER_INCLUDED = 2;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_TYPE_OF_SERVICE = 3;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_IP_TIME_TO_LIVE = 4;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_MULTICAST_INTERFACE = 9;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_MULTICAST_TIME_TO_LIVE = 10;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_MULTICAST_LOOPBACK = 11;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_ADD_MEMBERSHIP = 12;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_DROP_MEMBERSHIP = 13;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_DONT_FRAGMENT = 14;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_ADD_SOURCE_MEMBERSHIP = 15;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_DROP_SOURCE_MEMBERSHIP = 16;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_BLOCK_SOURCE = 17;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_UNBLOCK_SOURCE = 18;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_PACKET_INFORMATION = 19;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_HOP_LIMIT = 21;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_IP_PROTECT_LEVEL = 23;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_IP_V6_ONLY = 27;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_NO_DELAY = 1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_BSD_URGENT = 2;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_EXPEDITED = 2;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_NO_CHECKSUM = 1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_CHECKSUM_COVERAGE = 20;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_UPDATE_ACCEPT_CONTEXT = 28683;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_NAME_UPDATE_CONNECT_CONTEXT = 28688;
