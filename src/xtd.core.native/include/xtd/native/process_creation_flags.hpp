...
constexpr std::int32_t DEBUG_PROCESS = 0x00000001;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t DEBUG_ONLY_THIS_PROCESS = 0x00000002;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_SUSPENDED = 0x00000004;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t DETACHED_PROCESS = 0x00000008;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_NEW_CONSOLE = 0x00000010;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_NEW_PROCESS_GROUP = 0x00000200;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_UNICODE_ENVIRONMENT = 0x00000400;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_SEPARATE_WOW_VDM = 0x00000800;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_SHARED_WOW_VDM = 0x00001000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t INHERIT_PARENT_AFFINITY = 0x00010000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_PROTECTED_PROCESS = 0x00040000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t EXTENDED_STARTUPINFO_PRESENT = 0x00080000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_SECURE_PROCESS = 0x00400000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_BREAKAWAY_FROM_JOB = 0x01000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_PRESERVE_CODE_AUTHZ_LEVEL = 0x02000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_DEFAULT_ERROR_MODE = 0x04000000;
...
/// @remarks For more info see https://docs.microsoft.com .
/// @warning Internal use only
constexpr std::int32_t CREATE_NO_WINDOW = 0x08000000;
#endif
