...
constexpr std::int32_t SOCKET_TYPE_UNKNOWN = -1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_TYPE_STREAM = 1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_TYPE_DGRAM = 2;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_TYPE_RAW = 3;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_TYPE_RDM = 4;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_TYPE_SEQPACKET = 5;
