...
constexpr std::int32_t SOCKET_OPTION_LEVEL_SOCKET = 65535;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_LEVEL_IP = 0;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_LEVEL_IP_V6 = 41;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_LEVEL_TCP = 6;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t SOCKET_OPTION_LEVEL_UDP = 17;
