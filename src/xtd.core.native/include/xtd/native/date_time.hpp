    ...
    public:
      struct time_zone_info {
        struct transition_time {
          ...
          std::uint32_t time_of_day_hour {0};
          std::uint32_t time_of_day_minute {0};
          std::uint32_t time_of_day_second {0};
          std::uint32_t week {0};
        };
        ...
        struct adjustment_rule {
          ...
          std::uint32_t date_start_hour;
          std::uint32_t date_start_minute;
          std::uint32_t date_start_second;
          std::uint32_t date_end_year;
          std::uint32_t date_end_month;
          std::uint32_t date_end_day;
          std::uint32_t date_end_hour;
          std::uint32_t date_end_minute;
          std::uint32_t date_end_second;
          std::int64_t daylight_delta {0};
          time_zone_info::transition_time daylight_transition_start_;
          time_zone_info::transition_time daylight_transition_end;
        };
        
        std::string id;
        std::int64_t base_utc_offset {0};
