...
namespace xtd {
  ...
  namespace native {
    ...
    protected:
      ...
      /// @warning Internal use only
      static intmax_t get_host_by_address(const std::string& host_address, int_least32_t host_address_type);
      ...
      /// @warning Internal use only
      static std::vector<std::vector<uint_least8_t>> get_addresses(intmax_t host);
      ...
      /// @warning Internal use only
      static int_least32_t get_host_name(std::string& host_name);
