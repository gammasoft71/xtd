...
constexpr std::int32_t PROCESS_WINDOW_STYLE_NORMAL = 0;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t PROCESS_WINDOW_STYLE_HIDDEN = 1;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t PROCESS_WINDOW_STYLE_MINIMIZED = 2;
...
/// @remarks Added specifically for xtd.
/// @warning Internal use only
constexpr std::int32_t PROCESS_WINDOW_STYLE_MAXIMIZED = 3;
