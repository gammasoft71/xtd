...
namespace xtd {
  ...
  namespace native {
    ...
    protected:
      ...
      /// @warning Internal use only
      static std::int32_t address_family_to_native(int32_t address_family);
      ...
      /// @warning Internal use only
      static std::int32_t native_to_address_family(int32_t address_family);
      ...
      /// @warning Internal use only
      static std::int32_t bind(intmax_t handle, const std::vector<uint8_t>& socket_address);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t connect(intmax_t handle, const std::vector<uint8_t>& socket_address);
      ...
      /// @return The new socket handle created.
      /// @warning Internal use only
      static intmax_t create(int32_t address_family, std::int32_t socket_type, std::int32_t protocol_type);
      /// @brief Destroys the socket.
      /// @param handle The socket handle.
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t destroy(intmax_t handle);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t get_raw_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t& option_length);
      /// @brief Gets options on socket.
      /// @param handle The socket handle.
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t get_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t& option_length);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t get_socket_linger_option(intmax_t handle, bool& enabled, std::uint32_t& linger_time);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t get_socket_multicast_option(intmax_t handle, std::int32_t socket_option_name, std::uint32_t& multicast_address, std::uint32_t& interface_index);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t get_socket_ip_v6_multicast_option(intmax_t handle, std::int32_t socket_option_name, std::vector<uint8_t>& multicast_address, std::uint64_t& interface_index);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t io_control(intmax_t handle, std::int32_t io_control, std::vector<uint8_t>& option_in_value, std::vector<uint8_t>& option_out_value);
      /// @brief Listens for connections on a socket.
      /// @param handle The socket handle.
      /// @param backlog The maximum length for the queue of pending connections.
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t listen(intmax_t handle, size_t backlog);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t poll(intmax_t handle, std::int32_t microseconds, std::int32_t mode);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t receive(intmax_t handle, std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags);
      /// @brief Receives a message from a socket.
      /// @param handle The socket handle.
      /// @param buffer An array of type byte that is the storage location for the received data.
      /// @param offset The location in buffer to store the received data.
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t receive_from(intmax_t handle, std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags, std::vector<uint8_t>& socket_address);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t select(std::vector<intmax_t>& check_read, std::vector<intmax_t>& check_write, std::vector<intmax_t>& check_error, std::int32_t microseconds);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t send(intmax_t handle, const std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags);
      /// @brief send a message from a socket.
      /// @param handle The socket handle.
      /// @param buffer An array of type Byte that contains the data to be sent.
      /// @param offset TThe position in the data buffer at which to begin sending data.
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t send_to(intmax_t handle, const std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags, const std::vector<uint8_t>& socket_address);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t set_blocking(intmax_t handle, bool blocking);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t set_raw_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t option_length);
      /// @brief Sets options on socket.
      /// @param handle The socket handle.
      /// @param socket_option_level One of socket option level values (see socket_option_level_constants.h).
      /// @param socket_option_name One of socket option name values (see socket_option_name_constants.h).
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t set_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t option_length);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t set_socket_linger_option(intmax_t handle, bool enabled, std::uint32_t linger_time);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t set_socket_multicast_option(intmax_t handle, std::int32_t socket_option_name, std::uint32_t multicast_address, std::uint32_t interface_index);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t set_socket_ip_v6_multicast_option(intmax_t handle, std::int32_t socket_option_name, const std::vector<uint8_t>& multicast_address, std::uint64_t interface_index);
      /// @brief Shut down part of a full-duplex connection.
      /// @param handle The socket handle.
      /// @param how One of socket shutdown values (see socket_shutdown_constants.h).
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static std::int32_t shutdown(intmax_t handle, std::int32_t how);
