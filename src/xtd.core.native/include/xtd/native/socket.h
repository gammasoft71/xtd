...
namespace xtd {
  ...
  namespace native {
    ...
    protected:
      ...
      /// @warning Internal use only
      static intptr_t accept(intptr_t handle, std::vector<uint_least8_t>& socket_address);
      ...
      /// @warning Internal use only
      static int_least32_t bind(intptr_t handle, const std::vector<uint_least8_t>& socket_address);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t connect(intptr_t handle, const std::vector<uint_least8_t>& socket_address);
      ...
      /// @return The new socket handle created.
      /// @warning Internal use only
      static intptr_t create(int_least32_t address_family, int_least32_t socket_type, int_least32_t protocol_type);
      /// @brief Destroys the socket.
      /// @param handle The socket handle.
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t destroy(intptr_t handle);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t get_raw_socket_option(intptr_t handle, int_least32_t socket_option_level, int_least32_t socket_option_name, intptr_t option, size_t& option_length);
      /// @brief Gets options on socket.
      /// @param handle The socket handle.
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t get_socket_option(intptr_t handle, int_least32_t socket_option_level, int_least32_t socket_option_name, intptr_t option, size_t& option_length);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t get_socket_linger_option(intptr_t handle, bool& enabled, uint_least32_t& linger_time);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t get_socket_multicast_option(intptr_t handle, int_least32_t socket_option_name, uint_least32_t& multicast_address, uint_least32_t& interface_index);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t get_socket_ip_v6_multicast_option(intptr_t handle, int_least32_t socket_option_name, std::vector<uint_least8_t>& multicast_address, uint_least32_t& interface_index);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t io_control(intptr_t handle, int_least32_t io_control, std::vector<uint_least8_t>& option_in_value, std::vector<uint_least8_t>& option_out_value);
      /// @brief Listens for connections on a socket.
      /// @param handle The socket handle.
      /// @param backlog The maximum length for the queue of pending connections.
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t listen(intptr_t handle, size_t backlog);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t poll(intptr_t handle, int_least32_t microseconds, int_least32_t mode);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t receive(intptr_t handle, std::vector<uint_least8_t>& buffer, size_t offset, size_t size, int_least32_t flags);
      /// @brief Receives a message from a socket.
      /// @param handle The socket handle.
      /// @param buffer An array of type byte that is the storage location for the received data.
      /// @param offset The location in buffer to store the received data.
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t receive_from(intptr_t handle, std::vector<uint_least8_t>& buffer, size_t offset, size_t size, int_least32_t flags, std::vector<uint_least8_t>& socket_address);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t select(std::vector<intptr_t>& check_read, std::vector<intptr_t>& check_write, std::vector<intptr_t>& check_error, int_least32_t microseconds);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t send(intptr_t handle, const std::vector<uint_least8_t>& buffer, size_t offset, size_t size, int_least32_t flags);
      /// @brief send a message from a socket.
      /// @param handle The socket handle.
      /// @param buffer An array of type Byte that contains the data to be sent.
      /// @param offset TThe position in the data buffer at which to begin sending data.
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t send_to(intptr_t handle, const std::vector<uint_least8_t>& buffer, size_t offset, size_t size, int_least32_t flags, const std::vector<uint_least8_t>& socket_address);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t set_blocking(intptr_t handle, bool blocking);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t set_raw_socket_option(intptr_t handle, int_least32_t socket_option_level, int_least32_t socket_option_name, intptr_t option, size_t option_length);
      /// @brief Sets options on socket.
      /// @param handle The socket handle.
      /// @param socket_option_level One of socket option level values (see socket_option_level_constants.h).
      /// @param socket_option_name One of socket option name values (see socket_option_name_constants.h).
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t set_socket_option(intptr_t handle, int_least32_t socket_option_level, int_least32_t socket_option_name, intptr_t option, size_t option_length);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t set_socket_linger_option(intptr_t handle, bool enabled, uint_least32_t linger_time);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t set_socket_multicast_option(intptr_t handle, int_least32_t socket_option_name, uint_least32_t multicast_address, uint_least32_t interface_index);
      ...
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t set_socket_ip_v6_multicast_option(intptr_t handle, int_least32_t socket_option_name, const std::vector<uint_least8_t>& multicast_address, uint_least32_t interface_index);
      /// @brief Shut down part of a full-duplex connection.
      /// @param handle The socket handle.
      /// @param how One of socket shutdown values (see socket_shutdown_constants.h).
      /// @return Zero (0) if succeed; otherwise on error.
      /// @warning Internal use only
      static int_least32_t shutdown(intptr_t handle, int_least32_t how);
