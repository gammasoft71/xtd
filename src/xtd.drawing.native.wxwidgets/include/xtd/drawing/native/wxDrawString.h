      ...
      public:
        ...
        static wxString TrimString(wxDC& dc, const wxString& string, const wxFont& font, float width, int32 trimming) {
          ...
          for (auto& line : strings) {
            switch (trimming) {
              case ST_NONE: break;
              case ST_CHARACTER: line = TrimmingCharacter(dc, line, font, width, string::empty_string); break;
              case ST_WORD: line = TrimmingWord(dc, line, font, width, string::empty_string); break;
