...
void control_renderer::draw_control(graphics& graphics, const rectangle& bounds) {
  draw_control(graphics, bounds, control_state::normal, std::nullopt);
}

void control_renderer::draw_control(graphics& graphics, const rectangle& bounds, control_state control_state) {
  draw_control(graphics, bounds, control_state, std::nullopt);
}

void control_renderer::draw_control(graphics& graphics, const rectangle& bounds, control_state control_state, const std::optional<color>& back_color) {
  draw_control(style_sheet::current_style_sheet(), graphics, bounds, control_state, back_color);
}

void control_renderer::draw_control(const style_sheets::style_sheet& style_sheet, graphics& graphics, const rectangle& bounds, control_state state, const std::optional<color>& back_color) {
