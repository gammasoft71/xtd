#pragma once
#include "idigit.hpp"
#include "../../../include/xtd/forms/seven_segment_display.hpp"
#include <xtd/collections/generic/dictionary>
#include <xtd/helpers/throw_helper>
#include <xtd/globalization/translator>

class seven_segment_display_digit : public xtd::forms::seven_segment_display, public idigit {
public:
  seven_segment_display_digit() = default;
  
  void back_digit_color(const xtd::drawing::color& value) override {xtd::forms::seven_segment_display::back_segment_color(value);}
  void back_digit_opacity(double value) override {xtd::forms::seven_segment_display::back_segment_opacity(value);}
  ...
  void segment_style_digit(xtd::forms::segment_style value) override {xtd::forms::seven_segment_display::segment_style(value);}
  void show_back_digit(bool value) override {xtd::forms::seven_segment_display::show_back_segment(value);}
  xtd::int32 thickness_digit() const noexcept override {return xtd::forms::seven_segment_display::thickness();}
  void thickness_digit(xtd::int32 value) override {xtd::forms::seven_segment_display::thickness(value);}
...
private:
  ...
  inline static xtd::collections::generic::dictionary<xtd::char32, xtd::forms::segments> characters_ {
    ...
    {U'2', xtd::forms::segments::a | xtd::forms::segments::b | xtd::forms::segments::d | xtd::forms::segments::e | xtd::forms::segments::g},
    {U'3', xtd::forms::segments::a | xtd::forms::segments::b | xtd::forms::segments::c | xtd::forms::segments::d | xtd::forms::segments::g},
    ...
    {U'6', xtd::forms::segments::a | xtd::forms::segments::c | xtd::forms::segments::d | xtd::forms::segments::e | xtd::forms::segments::f | xtd::forms::segments::g},
    {U'7', xtd::forms::segments::a | xtd::forms::segments::b | xtd::forms::segments::c},
    ...
    {U'9', xtd::forms::segments::a | xtd::forms::segments::b | xtd::forms::segments::c | xtd::forms::segments::d | xtd::forms::segments::f | xtd::forms::segments::g},
    ...
    {U'y', xtd::forms::segments::b | xtd::forms::segments::c | xtd::forms::segments::d | xtd::forms::segments::f | xtd::forms::segments::g},
    {U'=', xtd::forms::segments::d | xtd::forms::segments::g},
    {U'-', xtd::forms::segments::g},
