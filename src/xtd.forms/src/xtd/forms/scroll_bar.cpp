#include "../../../include/xtd/forms/scroll_bar.hpp"
...
scroll_bar& scroll_bar::large_change(int32 large_change) {
  if (large_change < 0) throw argument_out_of_range_exception {};
...
scroll_bar& scroll_bar::small_change(int32 small_change) {
  if (small_change < 0) throw argument_out_of_range_exception {};
...
scroll_bar& scroll_bar::value(int32 value) {
  if (value < data_->minimum || value > data_->maximum) throw argument_out_of_range_exception {};
