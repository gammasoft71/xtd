...
namespace xtd::forms {
  ...
  public:
    void on_paint(xtd::drawing::graphics& graphics,  const xtd::drawing::rectangle& clip_rectangle, const xtd::drawing::color& color, bool enabled) override {
      ...
      auto wave1 = enabled ? std::vector {2, 4, 8, 16, 0, 16, 8, 4} : std::vector {0, 0, 0, 0, 0, 0, 0, 0};
      auto wave2 = enabled ? std::vector {4, 2, 4, 8, 16, 0, 16, 8} : std::vector {0, 0, 0, 0, 0, 0, 0, 0};
      auto wave3 = enabled ? std::vector {8, 4, 2, 4, 8, 16, 0, 16} : std::vector {0, 0, 0, 0, 0, 0, 0, 0};
