...
namespace {
  ustring get_os_postfix() noexcept {return environment::os_version().is_windows_platform() ? "_w" : environment::os_version().is_linux_platform() ? "_g" : environment::os_version().is_macos_platform() ? "_m" : "";}
}
