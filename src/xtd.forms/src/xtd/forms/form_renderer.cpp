...
void form_renderer::draw_form(graphics& graphics, const rectangle& bounds, xtd::forms::flat_style form_style, form_state form_state, const optional<color>& back_color) {
  box_data data(padding(0), border_style_property(border_type::none), border_color_property(color::black), border_width_property(0), border_radius_property(0), padding(0), color_property(back_color.value_or(color::light_gray)), std::nullopt, std::nullopt);
