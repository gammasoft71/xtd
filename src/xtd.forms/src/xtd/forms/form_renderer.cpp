...
#include "../../../include/xtd/forms/style_sheets/form_selector.h"
...
void form_renderer::draw_form(graphics& graphics, const rectangle& bounds, xtd::forms::flat_style form_style, form_state form_state, const optional<color>& back_color) {
  //form_selector current_form_selector(padding(0), border_style(border_type::none), border_color(color::black), border_width(0), border_radius(0), padding(0), back_color.value_or(color::light_gray), std::nullopt, std::nullopt, back_color, content_alignment::middle_center, system_fonts::default_font());
