...
namespace {
  ...
  private:
    string generate_report() const {
      auto report = string::format("Use try and catch to handle std::exception or xtd::exception instead{0}of this dialog box. For more information, see the xtd documentation.{0}{0}"_t, environment::new_line());
