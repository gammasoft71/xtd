#include "../../../include/xtd/forms/command_link_button.hpp"
...
xtd::uptr<xtd::object> command_link_button::clone() const {
  ...
  if (typeof_(*result) != typeof_(*this)) throw_helper::throws(xtd::helpers::exception_case::invalid_cast, xtd::string::format("The {} does not implement clone method.", typeof_(*this).full_name()).chars().c_str());
  return result;
}
