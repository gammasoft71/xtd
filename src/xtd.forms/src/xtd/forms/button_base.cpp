...
button_base::button_base() noexcept : data_(xtd::new_sptr<data>()) {
...
button_base& button_base::image_index(int32 value) {
  ...
  if (value < -1 || static_cast<xtd::usize>(value) >= data_->image_list.images().count()) throw_helper::throws(exception_case::argument_out_of_range);
