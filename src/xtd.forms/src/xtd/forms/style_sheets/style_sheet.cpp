...
namespace {
  void theme_reader(selector_map::const_iterator& selectors_iterator, theme_selector& theme) {
    ...
    if ((properties_iterator = selectors_iterator->second.properties().find("name")) != selectors_iterator->second.properties().end()) theme.name(name_property::from_css(properties_iterator->second.to_string(), string_value()));
  ...
  void system_color_reader(selector_map::const_iterator& selectors_iterator, system_colors_selector& colors) {
    ...
    if ((properties_iterator = selectors_iterator->second.properties().find("active-caption-text")) != selectors_iterator->second.properties().end()) colors.active_caption_text(color_property::from_css(properties_iterator->second.to_string(), color_property(system_colors::active_caption_text())));
