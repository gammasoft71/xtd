...
style_sheet style_sheet::system_style_sheet_windows_light() noexcept {
  style_sheet ss;
  ss.theme_ = style_sheets::theme("Windows (light)", "Contains Windows (light) theme.", "Gammasoft", uri("https://gammasoft71.wixsite.com/gammasoft"));
