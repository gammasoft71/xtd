...
bool border_radius::equals(const object& obj) const noexcept {
  return is<border_radius>(obj) && equals(static_cast<const border_radius&>(obj));
}
...
usize border_radius::get_hash_code() const noexcept {
