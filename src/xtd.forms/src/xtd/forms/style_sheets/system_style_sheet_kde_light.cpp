...
style_sheet style_sheet::system_style_sheet_kde_light() noexcept {
  style_sheet ss;
  ss.theme_ = style_sheets::theme("KDE (light)", "Contains KDE (light) theme.", "Gammasoft", uri("https://gammasoft71.wixsite.com/gammasoft"));
