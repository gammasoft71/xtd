...
namespace {
  style_sheet::buttons_t get_buttons(const style_sheets::system_colors& system_color) {
    auto button_standard = style_sheets::button().margin({2, 0, 1, 0}).border_style(border_type::outset).border_color(system_color.control_dark()).border_width(length(1)).border_radius({5}).padding({1, 1, 3, 1}).background_image({image_type::linear_gradient, {system_color.button_face(), system_color.button_face()}}).color(system_color.control_text());
    auto button_default = style_sheets::button().margin({2, 0,1, 0}).border_style(border_type::outset).border_color(system_color.control_dark()).border_width(length(1)).border_radius({5}).padding({1, 1, 3, 1}).background_image({image_type::linear_gradient, {color::from_argb(0xFF177AE5), color::from_argb(0xFF166ECD)}}).color(system_color.control_text());
    auto button_flat = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_text()).border_width(length(1)).border_radius({5}).padding({1, 1, 3, 1}).background_color(system_color.control()).color(system_color.control_text());
    auto button_flat_default = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_text()).border_width(length(1)).border_radius({5}).padding({1, 1, 3, 1}).background_color(system_color.control()).color(system_color.control_text());
    auto button_popup = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_text()).border_width(length(1)).border_radius({5}).padding({1, 1, 3, 1}).background_color(system_color.control()).color(system_color.control_text());
    auto button_popup_default = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_text()).border_width(length(1)).border_radius({5}).padding({1, 1, 3, 1}).background_color(system_color.control()).color(system_color.control_text());
    return style_sheet::buttons_t {
      ...
      {xtd::forms::style_sheets::pseudo_state::popup | xtd::forms::style_sheets::pseudo_state::hover, style_sheets::button(button_popup).border_style(border_type::outset).background_color(color::from_argb(78, 255, 255, 255))},
