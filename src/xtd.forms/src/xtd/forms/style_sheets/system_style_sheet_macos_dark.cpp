...
namespace {
  style_sheet::buttons_t get_buttons(const style_sheets::system_colors& system_color) {
    ...
    const auto button_popup = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_dark()).border_width({1}).border_radius({5}).padding({1, 1, 3, 1}).background_color(system_color.control()).color(system_color.control_text());
    const auto button_popup_default = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_dark()).border_width({2}).border_radius({5}).padding({1, 1, 3, 1}).background_color(system_color.control()).color(system_color.control_text());
