...
style_sheet style_sheet::system_style_sheet_gnome_light() noexcept {
  style_sheet ss;
  ss.theme_ = style_sheets::theme("GNOME (light)", "Contains GNOME (light) theme.", "Gammasoft", uri("https://gammasoft71.wixsite.com/gammasoft"));
