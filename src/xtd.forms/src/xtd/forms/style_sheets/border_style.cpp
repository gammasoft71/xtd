#include "../../../../include/xtd/forms/style_sheets/border_style.hpp"
#include <xtd/as>
#include <xtd/is>
...
bool border_style::equals(const object& obj) const noexcept {
  return is<border_style>(obj) && equals(static_cast<const border_style&>(obj));
}
...
xtd::size border_style::get_hash_code() const noexcept {
