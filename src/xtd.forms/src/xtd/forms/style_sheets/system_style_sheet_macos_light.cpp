...
namespace {
  style_sheet::buttons_t get_buttons(const style_sheets::system_colors& system_color) {
    ...
    const auto button_default = style_sheets::button().margin({2, 0,1, 0}).border_style(border_type::outset).border_color(system_color.control_dark()).border_width({1}).border_radius({5}).background_image({image_type::linear_gradient, {color::from_argb(0xFF3491FF), color::from_argb(0xFF337BFF)}}).padding({1, 1, 3, 1}).color(drawing::color::from_argb(226, 255,255, 255));
    ...
    const auto button_popup = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_light()).border_width({1}).border_radius({5}).background_color(system_color.control()).padding({1, 1, 3, 1}).color(system_color.control_text());
    const auto button_popup_default = style_sheets::button().border_style(border_type::solid).border_color(system_color.control_light()).border_width({2}).border_radius({5}).background_color(system_color.control()).padding({1, 1, 3, 1}).color(system_color.control_text());
    return style_sheet::buttons_t {
      // :standard
      {xtd::forms::style_sheets::pseudo_state::standard, button_standard},
      {xtd::forms::style_sheets::pseudo_state::standard | xtd::forms::style_sheets::pseudo_state::pressed, style_sheets::button(button_standard).background_image({image_type::linear_gradient, {color::from_argb(180, 236, 236, 236), color::from_argb(180, 236, 236, 236)}})},
      {xtd::forms::style_sheets::pseudo_state::standard | xtd::forms::style_sheets::pseudo_state::checked, style_sheets::button(button_standard).background_image({image_type::linear_gradient, {color::from_argb(180, 236, 236, 236), color::from_argb(180, 236, 236, 236)}})},
      {xtd::forms::style_sheets::pseudo_state::standard | xtd::forms::style_sheets::pseudo_state::mixed, style_sheets::button(button_standard).background_image({image_type::linear_gradient, {color::from_argb(180, 157, 157, 157), color::from_argb(180, 157, 157, 157)}})},
      ...
      {xtd::forms::style_sheets::pseudo_state::standard | xtd::forms::style_sheets::pseudo_state::default_state | xtd::forms::style_sheets::pseudo_state::pressed, style_sheets::button(button_default).background_image({image_type::linear_gradient, {color::from_argb(0xFF2F7CEB), color::from_argb(0xFF2E67EB)}})},
      {xtd::forms::style_sheets::pseudo_state::standard | xtd::forms::style_sheets::pseudo_state::default_state | xtd::forms::style_sheets::pseudo_state::checked, style_sheets::button(button_default).background_image({image_type::linear_gradient, {color::from_argb(0xFF2F7CEB), color::from_argb(0xFF2E67EB)}})},
      {xtd::forms::style_sheets::pseudo_state::standard | xtd::forms::style_sheets::pseudo_state::default_state | xtd::forms::style_sheets::pseudo_state::mixed, style_sheets::button(button_default).background_image({image_type::linear_gradient, {color::from_argb(0xFF4E8FEE), color::from_argb(0xFF4D7DEE)}})},
      ...
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::pressed, style_sheets::button(button_flat).background_color(color::from_argb(180, 236, 236, 236))},
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::checked, style_sheets::button(button_flat).background_color(color::from_argb(180, 236, 236, 236))},
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::mixed, style_sheets::button(button_flat).background_color(color::from_argb(180, 157, 157, 157))},
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::hover, style_sheets::button(button_flat).background_color(color::from_argb(180, 157, 157, 157))},
      ...
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::default_state | xtd::forms::style_sheets::pseudo_state::pressed, style_sheets::button(button_flat_default).background_color(color::from_argb(180, 236, 236, 236))},
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::default_state | xtd::forms::style_sheets::pseudo_state::checked, style_sheets::button(button_flat_default).background_color(color::from_argb(180, 236, 236, 236))},
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::default_state | xtd::forms::style_sheets::pseudo_state::mixed, style_sheets::button(button_flat_default).background_color(color::from_argb(180, 157, 157, 157))},
      {xtd::forms::style_sheets::pseudo_state::flat | xtd::forms::style_sheets::pseudo_state::default_state | xtd::forms::style_sheets::pseudo_state::hover, style_sheets::button(button_flat_default).background_color(color::from_argb(180, 157, 157, 157))},
...
style_sheet style_sheet::system_style_sheet_macos_light() noexcept {
  style_sheet ss;
  ss.theme_ = style_sheets::theme("macOS (light)", "Contains macOS (light) theme.", "Gammasoft", uri("https://gammasoft71.github.io"));
