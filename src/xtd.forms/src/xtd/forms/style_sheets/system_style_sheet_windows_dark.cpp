...
style_sheet style_sheet::system_style_sheet_windows_dark() noexcept {
  style_sheet ss;
  ss.theme_ = style_sheets::theme("Windows (dark)", "Contains Windows (dark) theme.", "Gammasoft", uri("https://gammasoft71.wixsite.com/gammasoft"));
