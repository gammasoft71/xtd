...
void button_renderer::draw_button(graphics& graphics, const rectangle& bounds, flat_style button_style, push_button_state button_state, const optional<color>& back_color, const ustring& text, const optional<color>& fore_color, const optional<font>& font) {
  auto box_data = style_sheets::box_data(padding(0, 1, 0, 1), {color_data(color::from_argb(35, 0, 0, 0)), border_style::outset, 1, 5}, padding(1, 1, 1, 3), color_data(color_style::linear_gradient, {color::from_argb(64, 255, 255, 255), color::from_argb(64, 255, 255, 255)}, 180), std::nullopt, std::nullopt);
  if (button_state == push_button_state::pressed) box_data = style_sheets::box_data(padding(0, 1, 0, 1), {color_data(color::from_argb(35, 0, 0, 0)), border_style::outset, 1, 5}, padding(1, 1, 1, 3), color_data(color_style::linear_gradient, {color::from_argb(80, 255, 255, 255), color::from_argb(80, 255, 255, 255)}, 180), std::nullopt, std::nullopt);
