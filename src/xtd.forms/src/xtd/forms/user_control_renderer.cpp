...
void user_control_renderer::draw_user_control(graphics& graphics, const rectangle& bounds) {
  draw_user_control(graphics, bounds, control_state::normal, std::nullopt);
}

void user_control_renderer::draw_user_control(graphics& graphics, const rectangle& bounds, control_state control_state) {
  draw_user_control(graphics, bounds, control_state, std::nullopt);
}

void user_control_renderer::draw_user_control(graphics& graphics, const rectangle& bounds, control_state control_state, const std::optional<color>& back_color) {
  draw_user_control(style_sheet::current_style_sheet(), graphics, bounds, control_state, back_color, std::nullopt, border_sides::none);
}

void user_control_renderer::draw_user_control(const style_sheets::style_sheet& style_sheet, graphics& graphics, const rectangle& bounds, control_state state, const std::optional<color>& back_color, const std::optional<xtd::forms::border_style>& border, xtd::forms::border_sides sides) {
