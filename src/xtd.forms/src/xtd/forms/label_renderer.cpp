...
void label_renderer::draw_label(graphics& graphics, const rectangle& bounds, xtd::forms::flat_style label_style, label_state label_state, const optional<color>& back_color) {
  box_data data(padding(0), border_style(border_type::none), border_color(color::black), border_width(0), border_radius(0), padding(0), color_property(back_color.value_or(color::light_gray)), std::nullopt, std::nullopt);
