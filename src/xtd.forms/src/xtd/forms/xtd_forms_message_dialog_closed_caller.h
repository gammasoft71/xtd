...
struct __xtd_forms_message_dialog_closed_caller__ {
  ...
  void on_message_dialog_closed(int32_t result) {
    message_dialog_->on_message_dialog_closed(xtd::forms::message_dialog_closed_event_args(static_cast<xtd::forms::dialog_result>(result)));
    delete this;
  }
private:
