...
loading_indicator loading_indicators::bar(const xtd::drawing::point& location, const xtd::drawing::size& size, bool running) noexcept {
...
loading_indicator loading_indicators::bar(const control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size, bool running) noexcept {
  auto result = loading_indicator {};
  result.loading_indicator_style(xtd::forms::loading_indicator_style::bar);
  if (location.x() != -1 && location.y() != -1) result.location(location);
