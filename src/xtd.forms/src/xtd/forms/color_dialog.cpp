...
const std::vector<xtd::drawing::color>& color_dialog::custom_colors() const noexcept {
  return data_->custom_colors;
}

color_dialog& color_dialog::custom_colors(const std::vector<xtd::drawing::color>& custom_colors)  {
