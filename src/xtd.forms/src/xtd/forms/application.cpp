...
void application::button_images(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call xtd::application::button_images() before application::run()"_t);
...
void application::dark_mode(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call xtd::application::light_mode() before application::run()"_t);
...
void application::font_size_correction(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call application::font_size_correction() before application::run()"_t);
...
void application::keep_cloned_controls(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call xtd::keep_cloned_controls::button_images() before application::run()"_t);
...
void application::menu_images(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call xtd::application::menu_images() before application::run()"_t);
...
void application::system_controls(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call application::system_controls() before application::run()"_t);
...
void application::system_font_size(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call application::system_font_size() before application::run()"_t);
...
void application::visual_styles(bool value) {
  if (application::application::message_loop_ == true) xtd::helpers::throw_helper::throws(xtd::helpers::exception_case::invalid_operation, "Call application::visual_styles() before application::run()"_t);
