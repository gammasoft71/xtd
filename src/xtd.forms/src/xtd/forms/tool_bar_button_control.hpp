...
private:
  ...
  void draw_drop_down_button(xtd::forms::paint_event_args& e) {
    ...
    e.graphics().fill_polygon(xtd::drawing::solid_brush(current_style_sheet.color()), array<xtd::drawing::point> {xtd::drawing::point {center_drop_down.x - drop_down_size.width / 2, center_drop_down.y - drop_down_size.height / 2}, xtd::drawing::point {center_drop_down.x + drop_down_size.width / 2, center_drop_down.y - drop_down_size.height / 2}, xtd::drawing::point {center_drop_down.x, center_drop_down.y + drop_down_size.height / 2} });
  }
