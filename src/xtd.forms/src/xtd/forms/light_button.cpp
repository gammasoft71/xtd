...
light_button light_button::create() {
  auto result = light_button {};
  return result;
}

light_button light_button::create(const drawing::point& location) {
  auto result = light_button {};
  result.location(location);
  return result;
}

light_button light_button::create(const drawing::point& location, const drawing::size& size) {
  auto result = light_button {};
  result.location(location);
  result.size(size);
  return result;
...
light_button light_button::create(const control& parent) {
  auto result = light_button {};
  result.parent(parent);
  return result;
}

light_button light_button::create(const control& parent, const drawing::point& location) {
  auto result = light_button {};
  result.parent(parent);
  result.location(location);
  return result;
...
light_button light_button::create(const control& parent, const drawing::point& location, const drawing::size& size) {
  auto result = light_button {};
  result.parent(parent);
  result.location(location);
  result.size(size);
...
void light_button::on_check_state_changed(const event_args& e) {
  ...
  if (can_raise_events()) {
    auto safe_ccheck_state_changed = check_state_changed;
    if (!safe_ccheck_state_changed.is_empty()) safe_ccheck_state_changed(*this, e);
  }
  if (flat_style() != xtd::forms::flat_style::system) invalidate();
}
...
void light_button::on_paint(paint_event_args& e) {
  if (flat_style() != xtd::forms::flat_style::system) {
    ...
    else if (data_->check_state == check_state::indeterminate) light_color = drawing::color_converter::dark(light_on_color());
