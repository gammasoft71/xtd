...
public:
  ...
  static const button_selectors_t& button_selectors() {
    static button_selectors_t datas = {
      ...
      {xtd::forms::style_sheets::pseudo_state::standard | xtd::forms::style_sheets::pseudo_state::disabled, xtd::forms::style_sheets::button_selector {{padding(0, 1, 0, 1), style_sheets::border_style_property(border_type::outset), border_color_property(color_property(system_colors::control_dark())), border_width_property(1), border_radius_property(5), padding(1, 1, 1, 3), color::from_argb(35, 255, 255, 255), std::nullopt, std::nullopt}, {color_property(system_colors::gray_text()), content_alignment::middle_center, system_fonts::default_font()}}},
      // :standard:default
