...
namespace xtd {
  ...
  inline namespace literals {
    ...
    /// ```
    [[nodiscard]] auto operator""_country(const char* s, xtd::usize n) -> xtd::forms::country;
    ...
    /// xtd::console::out << c << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_country(const char8* s, xtd::usize n) -> xtd::forms::country;
    ...
    /// xtd::console::out << c << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_country(const char16* s, xtd::usize n) -> xtd::forms::country;
    ...
    /// xtd::console::out << c << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_country(const char32* s, xtd::usize n) -> xtd::forms::country;
    ...
    /// xtd::console::out << c << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_country(const wchar* s, xtd::usize n) -> xtd::forms::country;
    /// @}
  }
}
