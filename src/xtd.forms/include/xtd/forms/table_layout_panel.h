...
namespace xtd {
  ...
  namespace forms {
    ...
    /// @par Examples
    /// The following code example demonstrate the use of table_layout_panel container.
    /// @include table_layout_panel.cpp
    /// @par Windows
    /// @image html table_layout_panel_w.png
    /// <br>
    /// @image html table_layout_panel_wd.png
    /// @par macOS
    /// @image html table_layout_panel_m.png
    /// <br>
    /// @image html table_layout_panel_md.png
    /// @par Gnome
    /// @image html table_layout_panel_g.png
    /// <br>
    /// @image html table_layout_panel_gd.png
