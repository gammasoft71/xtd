...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      std::string to_string() const noexcept override {return strings::format("vertical_control_layout_style=[expanded={}, align={}, size_type={}, height={}]", expanded(), align(), size_type(), height_.value_or(-1));}
