...
#pragma once
#include "item_check_event_args.hpp"
...
namespace xtd {
  ...
  namespace forms {
    /// @brief Represents the method that will handle the xtd::forms::checked_list_box::item_check event of a xtd::forms::checked_list_box or xtd::forms::checked_list_view control.
    /// ```cpp
    /// using item_check_event_handler = xtd::delegate<void(xtd::object& sender, xtd::forms::item_check_event_args& e)>;
    /// ```
    /// @param sender The source of the event.
    /// @param e An xtd::forms::item_check_event_args that contains the event data.
    /// @par Header
    /// ```cpp
