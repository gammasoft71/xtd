...
namespace xtd {
  ...
  namespace forms {
    ...
    /// @include button.cpp
    /// @par Windows
    /// @image html button_w.png <br>
    /// @image html button_wd.png <br>
    /// @par macOS
    /// @image html button_m.png <br>
    /// @image html button_md.png <br>
    /// @par Gnome
    /// @image html button_g.png <br>
    /// @image html button_gd.png <br>
