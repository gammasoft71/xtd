...
template<> struct xtd::enum_register<xtd::forms::bounds_specified> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::bounds_specified> {{xtd::forms::bounds_specified::none, "none"}, {xtd::forms::bounds_specified::x, "x"}, {xtd::forms::bounds_specified::y, "y"}, {xtd::forms::bounds_specified::width, "width"}, {xtd::forms::bounds_specified::height, "height"}};}
};
/// @endcond
