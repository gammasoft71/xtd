...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator circle_bars(const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      /// @brief Create a system-defined loading_indicator that represent circle bars loading indicator.
      /// @param parent The control that contains the loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator circle_bars(const control& parent, const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      ...
      /// @brief Create a system-defined loading_indicator that represent five lines center loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator five_lines_center(const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      /// @brief Create a system-defined loading_indicator that represent five lines center loading indicator.
      /// @param parent The control that contains the loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator five_lines_center(const control& parent, const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      ...
      /// @brief Create a system-defined loading_indicator that represent five lines pulse loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator five_lines_pulse(const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      /// @brief Create a system-defined loading_indicator that represent five lines pulse loading indicator.
      /// @param parent The control that contains the loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator five_lines_pulse(const control& parent, const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;

      /// @brief Create a system-defined loading_indicator that represent five lines wave loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator five_lines_wave(const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      /// @brief Create a system-defined loading_indicator that represent five lines wave loading indicator.
      /// @param parent The control that contains the loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator five_lines_wave(const control& parent, const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      ...
      /// @brief Create a system-defined loading_indicator that represent pulse loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
      /// @return The created loading_indicator.
      static loading_indicator pulse(const xtd::drawing::point& location = {-1, -1}, const xtd::drawing::size& size = {-1, -1}, bool running = true) noexcept;
      /// @brief Create a system-defined loading_indicator that represent pulse loading indicator.
      /// @param parent The control that contains the loading indicator.
      /// @param location The loading_indicator location in pixels.
      /// @param size The loading_indicator size in pixels.
