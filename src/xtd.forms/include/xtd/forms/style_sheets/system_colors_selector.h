...
namespace xtd {
  ...
  namespace forms {
    ...
    namespace style_sheets {
      ...
      private:
        color_data accent_;
        color_data accent_text_;
        color_data active_border_;
        color_data active_caption_;
        color_data active_caption_text_;
        color_data app_workspace_;
        color_data button_face_;
        color_data button_highlight_;
        color_data button_shadow_;
        color_data control_;
        color_data control_dark_;
        color_data control_dark_dark_;
        color_data control_light_;
        color_data control_light_light_;
        color_data control_text_;
        color_data desktop_;
        color_data gradient_active_caption_;
        color_data gradient_inactive_caption_;
        color_data gray_text_;
        color_data highlight_;
        color_data highlight_text_;
        color_data hot_track_;
        color_data inactive_border_;
        color_data inactive_caption_;
        color_data inactive_caption_text_;
        color_data info_;
        color_data info_text_;
        color_data menu_;
        color_data menu_bar_;
        color_data menu_highlight_;
        color_data menu_text_;
        color_data scroll_bar_;
        color_data text_box_;
        color_data text_box_text_;
        color_data window_;
        color_data window_frame_;
        color_data window_text_;
      };
    }
  }
}
