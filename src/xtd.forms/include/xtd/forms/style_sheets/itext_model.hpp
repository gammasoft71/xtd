  ...
  namespace forms {
    ...
    namespace style_sheets {
      ...
      public:
        ...
        [[nodiscard]] virtual auto auto_ellipsis() const noexcept -> bool = 0;
        
        /// @brief Gets the alignment of the text.
        /// @return A combination of xtd::forms::content_alignment values.
        [[nodiscard]] virtual auto text_alignment() const noexcept -> xtd::forms::content_alignment = 0;
        ...
        [[nodiscard]] virtual auto color() const noexcept -> const xtd::drawing::color& = 0;
        
        /// @brief Gets the decoration of the text.
        /// @return One of xtd::forms::style_sheets::text_decoration values.
        [[nodiscard]] virtual auto decoration() const noexcept -> xtd::forms::style_sheets::text_decoration = 0;
        
        /// @brief Gets the font of the text.
        /// @return The font of the text.
        [[nodiscard]] virtual auto font() const noexcept -> const xtd::drawing::font& = 0;
        ...
        [[nodiscard]] virtual auto shadows() const noexcept -> xtd::forms::style_sheets::shadows = 0;
        
        /// @brief Gets the transformation of the text.
        /// @return One of xtd::forms::style_sheets::text_transformation values.
        [[nodiscard]] virtual auto transformation() const noexcept -> xtd::forms::style_sheets::text_transformation = 0;
        
        /// @brief Gets how white-space inside an element is handled.
        /// @return One of xtd::forms::style_sheets::white_space values.
        [[nodiscard]] virtual auto white_space() const noexcept -> xtd::forms::style_sheets::white_space = 0;
        /// @}
        ...
        [[nodiscard]] virtual auto make_string_format() const noexcept -> xtd::drawing::string_format = 0;
        /// @}
      };
    }
  }
