...
namespace xtd {
  ...
  namespace forms {
    ...
    namespace style_sheets {
      class button_data : public xtd::object {
      public:
        button_data() = default;
        button_data(const xtd::forms::style_sheets::box_data& box, const std::shared_ptr<xtd::drawing::brush>& color) : box_(box), color_(color) {}
