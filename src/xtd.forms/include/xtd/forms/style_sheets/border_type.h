...
template<> struct xtd::enum_register<xtd::forms::style_sheets::border_type> {
  void operator()(xtd::enum_collection<xtd::forms::style_sheets::border_type>& values) {values = {{xtd::forms::style_sheets::border_type::hidden, "hidden"}, {xtd::forms::style_sheets::border_type::none, "none"}, {xtd::forms::style_sheets::border_type::solid, "solid"}, {xtd::forms::style_sheets::border_type::inset, "inset"}, {xtd::forms::style_sheets::border_type::outset, "outset"}, {xtd::forms::style_sheets::border_type::groove, "groove"}, {xtd::forms::style_sheets::border_type::ridge, "ridge"}, {xtd::forms::style_sheets::border_type::theme, "theme"}, {xtd::forms::style_sheets::border_type::dashed, "dashed"}, {xtd::forms::style_sheets::border_type::dot_dash, "dot_dash"}, {xtd::forms::style_sheets::border_type::dot_dot_dash, "dot_dot_dash"}, {xtd::forms::style_sheets::border_type::dotted, "dotted"}, {xtd::forms::style_sheets::border_type::double_border, "double_border"}};}
};
/// @endcond
