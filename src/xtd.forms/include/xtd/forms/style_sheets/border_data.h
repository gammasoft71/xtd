  ...
  namespace forms {
    ...
    namespace style_sheets {
      ...
      public:
        ...
        /// | xtd::forms::style_sheets::border_data::style  | xtd::forms::style_sheets::border_type::none                       |
        ...
        border_data(const xtd::forms::style_sheets::color_data& color, xtd::forms::style_sheets::border_type style, int32_t width, int32_t radius);
        /// @}
        ...
        xtd::forms::style_sheets::border_type style() const noexcept;
        ...
        void style(xtd::forms::style_sheets::border_type value) noexcept;
      ...
      private:
        ...
        xtd::forms::style_sheets::border_type style_ = xtd::forms::style_sheets::border_type::none;
        int32_t width_ = 3;
        int32_t radius_ = 0;
      };
    }
