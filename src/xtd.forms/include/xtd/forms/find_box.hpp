...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      inline static void show(const iwin32_window& owner, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next));}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      /// @param find_next The callback called when the user click the find button.
      template<class find_next_callback_t>
      inline static void show(const iwin32_window& owner, const xtd::string& find_string, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), find_string);}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      ...
      /// @param find_next The callback called when the user click the find button.
      template<class find_next_callback_t>
      inline static void show(const iwin32_window& owner, const xtd::string& find_string, const xtd::string& title, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), find_string, title);}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      /// @param title The find dialog title.
      ...
      /// @param find_next The callback called when the user click the find button.
      template<class find_next_callback_t>
      inline static void show(const iwin32_window& owner, const xtd::string& find_string, const xtd::string& title, bool match_case, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), find_string, title, match_case);}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      /// @param title The find dialog title.
      ...
      /// @param find_next The callback called when the user click the find button.
      template<class find_next_callback_t>
      inline static void show(const iwin32_window& owner, const xtd::string& find_string, const xtd::string& title, bool match_case, xtd::forms::search_direction search_direction, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), find_string, title, match_case, search_direction);}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      /// @param title The find dialog title.
    ...
    private:
      static void show_find_box(const iwin32_window& owner, xtd::forms::find_event_handler find_next, const xtd::string& find_string = xtd::string::empty_string, const xtd::string& title = xtd::string::empty_string, bool match_case = false, xtd::forms::search_direction search_direction = xtd::forms::search_direction::down, bool whole_word = false);
