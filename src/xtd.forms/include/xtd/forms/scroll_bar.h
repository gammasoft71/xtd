...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      /// @remarks When the user clicks in the scroll bar track on either side of the scroll box, the xtd::forms::scroll_bar::value property changes according to the value set in the xtd::forms::scroll_bar::large_chnage property.
      /// @note You can handle key press events so that when the user presses the PAGE UP or PAGE DOWN key the scroll box moves.
      /// @remarks User interface guidelines suggest that the xtd::forms::scroll_bar::small_chnage and xtd::forms::scroll_bar::large_chnage properties are set relative to the size of the view that the user sees, not to the total size including the unseen part. For example, if you have a picture box with scroll bars displaying a large image, the xtd::forms::scroll_bar::small_chnage and xtd::forms::scroll_bar::large_chnage properties should be set relative to the size of the picture box, not to the size of the image.
      ...
      /// @remarks You might consider adjusting the xtd::forms::scroll_bar::mmaximum property dynamically to match the size of the scroll bar's parent in proportion to pixel size or to the number of rows or lines displayed.
