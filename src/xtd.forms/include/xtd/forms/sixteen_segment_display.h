  ...
  namespace forms {
    ...
    protected:
      ...
      void draw_back_digit(drawing::graphics& graphics) override {
        ...
        draw_segment_a1(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        draw_segment_a2(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        draw_segment_d1(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        draw_segment_d2(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
      }
