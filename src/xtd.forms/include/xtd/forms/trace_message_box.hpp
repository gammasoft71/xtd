...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      static auto show(const xtd::string& text) -> xtd::forms::dialog_result {return show_message_dialog(nullptr, text, xtd::forms::application::product_name(), xtd::forms::message_box_buttons::ok, xtd::forms::message_box_icon::error);}
