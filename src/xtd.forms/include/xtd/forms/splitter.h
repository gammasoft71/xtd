...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      static splitter create(dock_style dockt, const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
      ...
      /// @param name The name of the xtd::forms::splitter.
      /// @return New xtd::forms::splitter created.
      static splitter create(const control& parent, dock_style dock, const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
      /// @}
