...
namespace xtd {
  namespace forms {
    ...
    class nine_segment_display : public xtd::forms::seven_segment_display {
      struct data;
    ...
    public:
      ...
      /// @param value A int32 that represent the segment thickness.
      /// @return Current seven_segment_display.
      auto thickness(xtd::int32 value) -> xtd::forms::seven_segment_display& override;
      /// @}
      ...
      [[nodiscard]] static auto create() -> nine_segment_display;
      ...
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location) -> nine_segment_display;
      ...
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size) -> nine_segment_display;
      ...
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> nine_segment_display;
      ...
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments) -> nine_segment_display;
      /// @brief A factory to create an xtd::forms::nine_segment_display with specified segments, and location.
      /// @param segments A dots_collection that represent all dots status.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments, const xtd::drawing::point& location) -> nine_segment_display;
      /// @brief A factory to create an xtd::forms::nine_segment_display with specified segments, location, and size.
      /// @param segments A dots_collection that represent all dots status.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::nine_segment_display.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments, const xtd::drawing::point& location, const xtd::drawing::size& size) -> nine_segment_display;
      ...
      /// @param name The name of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> nine_segment_display;
      ...
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments, bool show_back_segment) -> nine_segment_display;
      /// @brief A factory to create an xtd::forms::nine_segment_display with specified segments, back_segment visibility, and location.
      /// @param segments A dots_collection that represent all dots status.
      /// @param show_back_segment `true` if background segments are shown; otherwise `false`
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments, bool show_back_segment, const xtd::drawing::point& location) -> nine_segment_display;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments, bool show_back_segment, const xtd::drawing::point& location, const xtd::drawing::size& size) -> nine_segment_display;
      ...
      /// @param name The name of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(xtd::forms::segments segments, bool show_back_segment, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> nine_segment_display;
      ...
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent) -> nine_segment_display;
      /// @brief A factory to create an xtd::forms::nine_segment_display with specified parent, and location.
      /// @param parent The parent that contains the new created xtd::forms::nine_segment_display.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location) -> nine_segment_display;
      /// @brief A factory to create an xtd::forms::nine_segment_display with specified parent, location, and size.
      /// @param parent The parent that contains the new created xtd::forms::nine_segment_display.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::nine_segment_display.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size) -> nine_segment_display;
      ...
      /// @param name The name of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> nine_segment_display;
      ...
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments) -> nine_segment_display;
      /// @brief A factory to create an xtd::forms::nine_segment_display with specified parent, segments, and location.
      /// @param parent The parent that contains the new created xtd::forms::nine_segment_display.
      /// @param segments A xtd::forms::segments combination that represent nine_segment_display.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments, const xtd::drawing::point& location) -> nine_segment_display;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments, const xtd::drawing::point& location, const xtd::drawing::size& size) -> nine_segment_display;
      ...
      /// @param name The name of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> nine_segment_display;
      /// @brief A factory to create an xtd::forms::nine_segment_display with specified parent, segments, and back_segment visibility.
      /// @param parent The parent that contains the new created xtd::forms::nine_segment_display.
      /// @param segments A xtd::forms::segments combination that represent nine_segment_display.
      /// @param show_back_segment `true` if background segments are shown; otherwise `false`
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments, bool show_back_segment) -> nine_segment_display;
      ...
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments, bool show_back_segment, const xtd::drawing::point& location) -> nine_segment_display;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments, bool show_back_segment, const xtd::drawing::point& location, const xtd::drawing::size& size) -> nine_segment_display;
      ...
      /// @param name The name of the xtd::forms::nine_segment_display.
      /// @return New xtd::forms::nine_segment_display created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, xtd::forms::segments segments, bool show_back_segment, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> nine_segment_display;
      /// @}
    ...
    protected:
      ...
      virtual auto draw_segment_h(xtd::drawing::graphics& graphics, const xtd::drawing::color& color) -> void;
      
      /// @brief Draw segment ion specified graphics with specified color.
      /// @param graphics A xtd::drawing::graphics from on_paint method.
      /// @param color A xtd::drawing::color used to draw segment.
      virtual auto draw_segment_i(xtd::drawing::graphics& graphics, const xtd::drawing::color& color) -> void;
