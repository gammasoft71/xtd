...
template<> struct xtd::enum_register<xtd::forms::size_type> {
  void operator()(xtd::enum_collection<xtd::forms::size_type>& values) {values = {{xtd::forms::size_type::auto_size, "auto_size"}, {xtd::forms::size_type::absolute, "absolute"}, {xtd::forms::size_type::percent, "percent"}};}
};
/// @endcond
