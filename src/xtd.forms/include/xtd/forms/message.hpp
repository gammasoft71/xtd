...
namespace xtd {
  namespace forms {
    ...
    struct forms_export_ message : xtd::object, xtd::iequatable<message> {
      /// @cond
      message() = default;
      /// @endcond
      ...
      /// @return `true` if the specified object is equal to the current object. otherwise, `false`.
      [[nodiscard]] auto equals(const message& other) const noexcept -> bool override;
      ...
      [[nodiscard]] auto get_lparam() const noexcept -> type_t { return reinterpret_cast<type_t>(lparam); }
      
      /// @brief Returns a string that represents the msg property.
      /// @return A xtd::string that represents the msg property.
      [[nodiscard]] auto to_msg_string() const noexcept -> xtd::string;
      ...
      [[nodiscard]] static auto create(xtd::intptr hwnd, xtd::uint32 msg, xtd::intptr wparam, xtd::intptr lparam) -> message;
      /// @}
      
    private:
      friend class application;
      friend class control;
      message(xtd::intptr hwnd, xtd::uint32 msg, xtd::intptr wparam, xtd::intptr lparam, xtd::intptr result, xtd::intptr handle);
    };
  }
}
