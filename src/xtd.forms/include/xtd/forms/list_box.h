...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      static list_box create(const object_collection& items, size_t selected_index = object_collection::npos, const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::list_box.
      /// @return New xtd::forms::list_box created.
      static list_box create(const control& parent, const object_collection& items, size_t selected_index = object_collection::npos, const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
