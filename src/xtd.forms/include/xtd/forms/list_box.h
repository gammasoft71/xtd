...
namespace xtd {
  ...
  namespace forms {
    ...
    ///   <tr>
    ///     <th>Light</th>
    ///     <td>@image html control_list_box_w.png</td>
    ///     <td>@image html control_list_box_m.png</td>
    ///     <td>@image html control_list_box_g.png</td>
    ///   </tr>
    ///   <tr>
    ///     <th>Dark</th>
    ///     <td>@image html control_list_box_wd.png</td>
    ///     <td>@image html control_list_box_md.png</td>
    ///     <td>@image html control_list_box_gd.png</td>
    ///   </tr>
    /// </table>
    /// @par Examples
    ...
    public:
      ...
      static list_box create(const object_collection& items = object_collection {}, size_t selected_index = object_collection::npos, const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::list_box.
      /// @return New xtd::forms::list_box created.
      static list_box create(const control& parent, const object_collection& items = object_collection {}, size_t selected_index = object_collection::npos, const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
