...
#include "status_bar_panel_auto_size.hpp"
#include "status_bar_panel_border_style.hpp"
#include "status_bar_panel_style.hpp"
#include <xtd/event>
...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      [[nodiscard]] auto alignment() const noexcept -> xtd::forms::horizontal_alignment;
      ...
      [[nodiscard]] auto auto_size() const noexcept -> xtd::forms::status_bar_panel_auto_size;
      ...
      [[nodiscard]] auto border_style() const noexcept -> xtd::forms::status_bar_panel_border_style;
      ...
      [[nodiscard]] auto control() const noexcept -> std::optional<control_ref>;
      ...
      [[nodiscard]] auto image() const noexcept -> const xtd::drawing::image&;
      ...
      [[nodiscard]] auto min_width() const noexcept -> xtd::int32;
      ...
      [[nodiscard]] auto parent() const noexcept -> std::optional<xtd::ref<xtd::forms::status_bar>>;
      ...
      [[nodiscard]] auto style() const noexcept -> xtd::forms::status_bar_panel_style;
      ...
      /// @return `true` if the specified object is equal to the current object. otherwise, `false`.
      [[nodiscard]] auto equals(const status_bar_panel& other) const noexcept -> bool override;
      ...
      [[nodiscard]] static auto create_control(const xtd::string& text, const xtd::forms::control& control) -> status_bar_panel;
      /// @brief A factory to create a control status bar panel with specified control.
      /// @param control A xtd::forms::control to be displayed in the control status bar panel.
      /// @return New xtd::forms::status_bar_panel created.
      [[nodiscard]] static auto create_control(const xtd::forms::control& control) -> status_bar_panel;
      /// @brief A factory to create a status bar panel with specified text.
      /// @param text The text displayed on the status bar panel.
      /// @return New xtd::forms::status_bar_panel created.
      [[nodiscard]] static auto create_panel(const xtd::string& text) -> status_bar_panel;
      ...
      /// @return New xtd::forms::status_bar_panel created.
      [[nodiscard]] static auto create_panel(const xtd::drawing::image& image) -> status_bar_panel;
      /// @brief A factory to create a status bar panel with specified text and image index.
      /// @param text The text displayed on the status bar panel.
      /// @param image The xtd::drawing::image assigned to the status bar panel.
      /// @return New xtd::forms::status_bar_panel created.
      [[nodiscard]] static auto create_panel(const xtd::string& text, const xtd::drawing::image& image) -> status_bar_panel;
      /// @}
    ...
    /// xtd.forms
    /// @ingroup xtd_forms
    using status_bar_panel_ref = xtd::ref<status_bar_panel>;
  }
}
