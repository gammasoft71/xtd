...
namespace xtd {
  ...
  namespace forms {
    ...
    /// @par Header
    /// @code #include <xtd/forms/open_file_box_options> @endcode
    /// @par Namespace
    /// xtd::forms
    /// @par Library
    /// xtd.forms
