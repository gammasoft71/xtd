...
template<> struct xtd::enum_register<xtd::forms::border_style> {
  void operator()(xtd::enum_collection<xtd::forms::border_style>& values) {values = {{xtd::forms::border_style::hidden, "hidden"}, {xtd::forms::border_style::fixed_single, "fixed_single"}, {xtd::forms::border_style::fixed_3d, "fixed_3d"}, {xtd::forms::border_style::none, "none"}, {xtd::forms::border_style::solid, "solid"}, {xtd::forms::border_style::inset, "inset"}, {xtd::forms::border_style::outset, "outset"}, {xtd::forms::border_style::groove, "groove"}, {xtd::forms::border_style::ridge, "ridge"}, {xtd::forms::border_style::theme, "theme"}, {xtd::forms::border_style::dashed, "dashed"}, {xtd::forms::border_style::dot_dash, "dot_dash"}, {xtd::forms::border_style::dot_dot_dash, "dot_dot_dash"}, {xtd::forms::border_style::dotted, "dotted"}, {xtd::forms::border_style::double_border, "double_border"}, {xtd::forms::border_style::bevel_inset, "bevel_inset"}, {xtd::forms::border_style::bevel_outset, "bevel_outset"}, {xtd::forms::border_style::rounded, "rounded"}};}
};
/// @endcond
