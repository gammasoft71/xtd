...
namespace xtd {
  ...
  namespace forms {
    ...
    enum class loading_indicator_style {
      /// @brief The control appears with bar style.
      bar = 0,
      /// @brief The control appears with circle bars style.
      circle_bars,
