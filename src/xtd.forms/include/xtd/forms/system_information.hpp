...
#include "left_right_alignment.hpp"
#include "power_status.hpp"
#include "screen_orientation.hpp"
...
namespace xtd {
  ...
  namespace forms {
    ...
    /// @remarks The system_information class provides [[nodiscard]] static properties that can be used to get information about the current system environment. The class provides access to information such as Windows display element sizes, operating system settings, network availability, and the capabilities of hardware installed on the system. This class cannot be instantiated.
    ...
    public:
      ...
      [[nodiscard]] static auto arrange_direction() -> xtd::forms::arrange_direction;
      ...
      [[nodiscard]] static auto arrange_starting_position() -> xtd::forms::arrange_starting_position;
      ...
      [[nodiscard]] static auto boot_mode() -> xtd::forms::boot_mode;
      ...
      [[nodiscard]] static auto high_contrast() -> bool;
      ...
      [[nodiscard]] static auto horizontal_focus_thickness() -> xtd::int32;
      ...
      [[nodiscard]] static auto horizontal_resize_border_thickness() -> xtd::int32;
      ...
      [[nodiscard]] static auto horizontal_scroll_bar_arrow_width() -> xtd::int32;
      ...
      [[nodiscard]] static auto horizontal_scroll_bar_height() -> xtd::int32;
      ...
      [[nodiscard]] static auto horizontal_scroll_bar_thumb_width() -> xtd::int32;
      ...
      [[nodiscard]] static auto icon_horizontal_spacing() -> xtd::int32;
      ...
      [[nodiscard]] static auto icon_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto icon_spacing_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto icon_vertical_spacing() -> xtd::int32;
      ...
      [[nodiscard]] static auto is_active_window_tracking_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_combo_box_animation_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_drop_shadow_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_flat_menu_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_font_smoothing_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_hot_tracking_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_icon_title_wrapping_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_keyboard_preferred() -> bool;
      ...
      [[nodiscard]] static auto is_list_box_smooth_scrolling_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_menu_animation_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_menu_fade_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_minimize_restore_animation_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_selection_fade_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_snap_to_default_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_title_bar_gradient_enabled() -> bool;
      ...
      [[nodiscard]] static auto is_tool_tip_animation_enabled() -> bool;
      ...
      [[nodiscard]] static auto kanji_window_height() -> xtd::int32;
      ...
      [[nodiscard]] static auto keyboard_delay() -> xtd::int32;
      ...
      [[nodiscard]] static auto keyboard_speed() -> xtd::int32;
      ...
      [[nodiscard]] static auto max_window_track_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto menu_access_keys_underlined() -> bool;
      ...
      [[nodiscard]] static auto menu_bar_button_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto menu_button_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto menu_check_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto menu_height() -> xtd::int32;
      ...
      [[nodiscard]] static auto menu_show_delay() -> xtd::int32;
      ...
      [[nodiscard]] static auto mid_east_enabled() -> bool;
      ...
      [[nodiscard]] static auto minimized_window_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto minimized_window_spacing_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto minimum_window_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto min_window_track_size() -> xtd::drawing::size;
      ...
      /// @note This property is supported only on Windows 98, Windows Millennium Edition, Windows 2000, Windows XP, and the Windows Server 2003 family.
      [[nodiscard]] static auto monitor_count() -> xtd::int32;
      ...
      /// @note This property is supported only on Windows 98, Windows Millennium Edition, Windows 2000, Windows XP, and the Windows Server 2003 family.
      [[nodiscard]] static auto monitors_same_display_format() -> bool;
      ...
      [[nodiscard]] static auto mouse_buttons() -> xtd::int32;
      ...
      [[nodiscard]] static auto mouse_buttons_swapped() -> bool;
      ...
      [[nodiscard]] static auto mouse_hover_size() -> xtd::drawing::size;
      ...
      /// @remarks The mouse_hover_time property indicates the time, in milliseconds, that a mouse pointer must remain within an area the size of the MouseHoverSize property in order to generate a mouse hover message.
      /// @remarks The mouse_hover_size property indicates the size of the rectangle within which the mouse pointer has to stay for the mouse hover time before a mouse hover message is generated.
      [[nodiscard]] static auto mouse_hover_time() -> xtd::int32;
      ...
      [[nodiscard]] static auto mouse_present() -> bool;
      ...
      [[nodiscard]] static auto mouse_speed() -> xtd::int32;
      ...
      [[nodiscard]] static auto Mouse_wheel_present() -> bool;
      ...
      [[nodiscard]] static auto mouse_wheel_scroll_delta() -> xtd::int32;
      ...
      [[nodiscard]] static auto mouse_wheel_scroll_lines() -> xtd::int32;
      ...
      [[nodiscard]] static auto native_mouse_wheel_support() -> bool;
      ...
      [[nodiscard]] static auto network() -> bool;
      ...
      [[nodiscard]] static auto pen_windows() -> bool;
      ...
      [[nodiscard]] static auto popup_menu_alignment() -> xtd::forms::left_right_alignment;
      
      /// @brief Gets the current system power status.
      /// @return A xtd::forms::power_status that indicates the current system power status.
      [[nodiscard]] static auto power_status() -> xtd::forms::power_status;
      ...
      [[nodiscard]] static auto primary_monitor_maximized_window_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto primary_monitor_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto right_aligned_menus() -> bool;
      
      /// @brief Gets the orientation of the screen.
      /// @return The orientation of the screen, in degrees.
      [[nodiscard]] static auto screen_orientation() -> xtd::forms::screen_orientation;
      ...
      [[nodiscard]] static auto secure() -> bool;
      ...
      [[nodiscard]] static auto show_sounds() -> bool;
      ...
      [[nodiscard]] static auto sizing_border_width() -> xtd::int32;
      ...
      [[nodiscard]] static auto small_caption_button_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto small_icon_size() -> xtd::drawing::size;
      ...
      [[nodiscard]] static auto terminal_server_session() -> bool;
      ...
      [[nodiscard]] static auto tool_window_caption_button_size() -> xtd::drawing::size;
      
      /// @brief Gets the height, in pixels, of a tool window caption.
      /// @return The height, in pixels, of a tool window caption in pixels.
      [[nodiscard]] static auto tool_window_caption_height() -> xtd::int32;
      ...
      [[nodiscard]] static auto ui_effect_enabled() -> bool;
      ...
      [[nodiscard]] static auto vertical_focus_thickness() -> xtd::int32;
      ...
      [[nodiscard]] static auto vertical_scroll_bar_arrow_height() -> xtd::int32;
      ...
      [[nodiscard]] static auto vertical_scroll_bar_thumb_height() -> xtd::int32;
      ...
      [[nodiscard]] static auto vertical_scroll_bar_width() -> xtd::int32;
      
      /// @brief Gets the bounds of the virtual screen.
      /// @return A xtd::drawing::rectangle that specifies the bounding rectangle of the entire virtual screen.
      /// @remarks The xtd::forms::system_information::virtual_screen property indicates the bounds of the entire desktop on a multi-monitor system. You can use this property to determine the maximum visual space available on a system that has multiple monitors installed.
      ...
      [[nodiscard]] static auto virtual_screen() -> xtd::drawing::rectangle;
      ...
      /// @remarks xtd::forms::system_information::working_area always returns the work area of the primary monitor. If you need the work area of a monitor in a multiple display environment, you can call one of the overloads of xtd::forms::screen::get_working_area.
      [[nodiscard]] static auto working_area() -> xtd::drawing::rectangle;
      /// @}
    };
  }
}
