...
namespace xtd {
  ...
  namespace forms {
    ...
    class forms_export_ menu : public xtd::forms::component, public xtd::iequatable<menu> {
      struct data;
    public:
      /// @name Public Aliases
      ...
      using menu_item_collection = layout::arranged_element_collection<xtd::forms::menu_item_ref>;
      /// @}
      ...
      [[nodiscard]] virtual auto is_parent() const noexcept -> bool;
      ...
      [[nodiscard]] auto mdi_list_item() const noexcept -> const xtd::forms::menu_item&;
      ...
      [[nodiscard]] auto menu_items() const noexcept -> const menu_item_collection&;
      /// @brief Gets a value indicating the collection of menu_item objects associated with the menu.
      /// @return A menu::menu_item_collection that represents the list of menu_item objects stored in the menu.
      /// @remarks You can use this property to obtain a reference to the list of menu items that are currently stored in the menu. For main_menu and context_menu objects, the menu_items property contains the entire menu structure in the control. For the menu_item class, the menu_items property contains the list of submenu items associated with the menu_item. With the reference to the collection of menu items for the menu (provided by this property), you can add and remove menu items, determine the total number of menu items, and clear the list of menu items from the collection. For more information on maintaining the menu item collection for a menu, see the xtd::forms::menu::menu_item_collection documentation.
      [[nodiscard]] auto menu_items() noexcept -> menu_item_collection&;
      ...
      /// @cond
      auto menu_items(const std::initializer_list<menu_item_ref>& value) -> menu&;
      auto menu_items(const std::vector<menu_item_ref>& value) -> menu&;
      /// @endcond
      ...
      /// @return `true` if the specified object is equal to the current object. otherwise, `false`.
      [[nodiscard]] auto equals(const menu& other) const noexcept -> bool override;
      ...
      [[nodiscard]] auto get_context_menu() const noexcept -> std::optional<xtd::ref<xtd::forms::context_menu>>;
      ...
      [[nodiscard]] auto get_main_menu() const noexcept -> std::optional<xtd::ref<xtd::forms::main_menu>>;
    ...
    protected:
      ...
      [[nodiscard]] virtual auto create_menu_handle() -> xtd::intptr = 0;
      ...
      /// @cond
      virtual auto create_menu() -> void;
      virtual auto destroy_menu() -> void;
      auto recreate_menu() -> void;
