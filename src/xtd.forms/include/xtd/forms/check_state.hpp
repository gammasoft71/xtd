...
template<> struct xtd::enum_register<xtd::forms::check_state> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::check_state> {{xtd::forms::check_state::unchecked, "unchecked"}, {xtd::forms::check_state::checked, "checked"}, {xtd::forms::check_state::indeterminate, "indeterminate"}};}
};
/// @endcond
