...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      /// @remarks If auto_check is set to `false`, you will need to add code to update the checked or check_state values in the click event handler.
      virtual auto auto_check(bool value) -> toggle_button&;
      ...
      virtual auto check_align(xtd::forms::content_alignment value) -> toggle_button&;
      ...
      /// @param value `true` if the toggle_button is in the checked state; otherwise, `false`. The default value is `false`.
      /// @remarks When the value is `true`, the toggle_button portion of the control displays a check mark. If the appearance property is set to button, the control will appear sunken when checked is `true` and raised like a standard button when `false`.
      virtual auto checked(bool value) -> toggle_button&;
      ...
      /// | unchecked     | The CheckBox is empty.                            | The control appears raised. |
      /// | indeterminate | The CheckBox displays a check mark and is shaded. | The control appears flat.   |
      virtual auto check_state(xtd::forms::check_state value) -> toggle_button&;
      ...
      /// @brief Gets a value indicating whether the toggle_button will allow three check states rather than two.
      /// @param value `true` if the toggle_button is able to display three check states; otherwise, `false`. The default value is `false`.
      /// @remarks If the three_state property is set to `false`, the check_state property value can only be set to the indeterminate value of xtd.forms.check_state in code and not by user interaction.
      virtual auto three_state(bool value) -> toggle_button&;
      /// @}
      ...
      [[nodiscard]] static auto create() -> toggle_button;
      ...
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location) -> toggle_button;
      ...
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      ...
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text) -> toggle_button;
      /// @brief A factory to create an xtd::forms::toggle_button with specified text, and location.
      /// @param text A string that represent text of the xtd::forms::toggle_button.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, const xtd::drawing::point& location) -> toggle_button;
      /// @brief A factory to create an xtd::forms::toggle_button with specified text, location, and size.
      /// @param text A string that represent text of the xtd::forms::toggle_button.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @param name The name of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      ...
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, xtd::forms::check_state check_state) -> toggle_button;
      /// @brief A factory to create an xtd::forms::toggle_button with specified text, check_state, and location.
      /// @param text A string that represent text of the xtd::forms::toggle_button.
      /// @param check_state One of the check_state enumeration values.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, xtd::forms::check_state check_state, const xtd::drawing::point& location) -> toggle_button;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @param name The name of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      ...
      /// @param check_state One of the check_state enumeration values.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, bool three_state, xtd::forms::check_state check_state) -> toggle_button;
      ...
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, bool three_state, xtd::forms::check_state check_state, const xtd::drawing::point& location) -> toggle_button;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, bool three_state, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @param name The name of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::string& text, bool three_state, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      ...
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent) -> toggle_button;
      /// @brief A factory to create a xtd::forms::toggle_button with specified parent, and location.
      /// @param parent The parent that contains the new created xtd::forms::toggle_button.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location) -> toggle_button;
      /// @brief A factory to create a xtd::forms::toggle_button with specified parent, location, and size.
      /// @param parent The parent that contains the new created xtd::forms::toggle_button.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @param name The name of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      /// @brief A factory to create a xtd::forms::toggle_button with specified parent, and text.
      /// @param parent The parent that contains the new created xtd::forms::toggle_button.
      /// @param text A string that represent text of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text) -> toggle_button;
      /// @brief A factory to create a xtd::forms::toggle_button with specified parent, text, and location.
      /// @param parent The parent that contains the new created xtd::forms::toggle_button.
      /// @param text A string that represent text of the xtd::forms::toggle_button.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, const xtd::drawing::point& location) -> toggle_button;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @param name The name of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      /// @brief A factory to create a xtd::forms::toggle_button with specified parent, text, and check_state.
      /// @param parent The parent that contains the new created xtd::forms::toggle_button.
      /// @param text A string that represent text of the xtd::forms::toggle_button.
      /// @param check_state One of the check_state enumeration values.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, xtd::forms::check_state check_state) -> toggle_button;
      ...
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, xtd::forms::check_state check_state, const xtd::drawing::point& location) -> toggle_button;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @param name The name of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      ...
      /// @param check_state One of the check_state enumeration values.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, bool three_state, xtd::forms::check_state check_state) -> toggle_button;
      ...
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, bool three_state, xtd::forms::check_state check_state, const xtd::drawing::point& location) -> toggle_button;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, bool three_state, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size) -> toggle_button;
      ...
      /// @param name The name of the xtd::forms::toggle_button.
      /// @return New xtd::forms::toggle_button created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::string& text, bool three_state, xtd::forms::check_state check_state, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> toggle_button;
      /// @}
    ...
    protected:
      ...
      [[nodiscard]] auto state() const noexcept -> xtd::forms::visual_styles::toggle_button_state;
