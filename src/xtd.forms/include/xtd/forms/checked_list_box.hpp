...
namespace xtd {
  ...
  namespace forms {
    ...
    class forms_export_ checked_list_box : public xtd::forms::list_box {
      struct data;
      
    public:
      /// @brief Represent an item contained in the checked_list_box::object_collection collection.
      class item : public xtd::forms::list_box::item, public xtd::icomparable<item>, public xtd::iequatable<item> {
      public:
        ...
        [[nodiscard]] virtual auto checked() const -> bool;
        ...
        [[nodiscard]] virtual auto check_state() const -> xtd::forms::check_state;
        /// @}
        
        /// @name Public Methods
        
        /// @{
        using xtd::forms::list_box::item::compare_to;
        [[nodiscard]] auto compare_to(const item& value) const noexcept -> xtd::int32 override;
        using xtd::forms::list_box::item::equals;
        [[nodiscard]] auto equals(const item& value) const noexcept -> bool override;
        /// @}
        
      private:
        xtd::forms::check_state check_state_ = xtd::forms::check_state::unchecked;
      };
      ...
      [[nodiscard]] auto checked_indices() const noexcept -> checked_index_collection;
      ...
      [[nodiscard]] auto checked_items() const noexcept -> checked_item_collection;
      ...
      [[nodiscard]] auto selected_items() const noexcept -> selected_object_collection;
      ...
      [[nodiscard]] auto get_item_checked(xtd::usize index) const -> bool;
      ...
      [[nodiscard]] auto get_item_check_state(xtd::usize index) const -> xtd::forms::check_state;
      
      /// @brief Returns the text value of the current item.
      /// @param index The index of the item.
      /// @return A string that represent the text value of the current item.
      [[nodiscard]] auto get_item_text(xtd::usize index) const -> const xtd::string&;
      ...
      [[nodiscard]] static auto create() -> checked_list_box;
      ...
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location) -> checked_list_box;
      ...
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size) -> checked_list_box;
      ...
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified items.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified items, and location.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items, const xtd::drawing::point& location) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified items, location, and size.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::checked_list_box.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items, const xtd::drawing::point& location, const xtd::drawing::size& size) -> checked_list_box;
      ...
      /// @param name The name of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified items, and selected_index.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @param selected_index A zero-based index of the currently selected item. The xtd::forms::checked_list_box::object_collection::npos is returned if no item is selected.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items, xtd::usize selected_index) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified items, selected_index, and location.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @param selected_index A zero-based index of the currently selected item. The xtd::forms::checked_list_box::object_collection::npos is returned if no item is selected.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items, xtd::usize selected_index, const xtd::drawing::point& location) -> checked_list_box;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items, xtd::usize selected_index, const xtd::drawing::point& location, const xtd::drawing::size& size) -> checked_list_box;
      ...
      /// @param name The name of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const object_collection& items, xtd::usize selected_index, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> checked_list_box;
      ...
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified parent, and location.
      /// @param parent The parent that contains the new created xtd::forms::checked_list_box.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified parent, location, and size.
      /// @param parent The parent that contains the new created xtd::forms::checked_list_box.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::checked_list_box.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size) -> checked_list_box;
      ...
      /// @param name The name of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified parent, and items.
      /// @param parent The parent that contains the new created xtd::forms::checked_list_box.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified parent, items, and location.
      /// @param parent The parent that contains the new created xtd::forms::checked_list_box.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items, const xtd::drawing::point& location) -> checked_list_box;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items, const xtd::drawing::point& location, const xtd::drawing::size& size) -> checked_list_box;
      ...
      /// @param name The name of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> checked_list_box;
      /// @brief A factory to create an xtd::forms::checked_list_box with specified parent, items, and selected_index.
      /// @param parent The parent that contains the new created xtd::forms::checked_list_box.
      /// @param items The checked_list_box::object_collection collection representing the items in the checked_list_box.
      /// @param selected_index A zero-based index of the currently selected item. The xtd::forms::checked_list_box::object_collection::npos is returned if no item is selected.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items, xtd::usize selected_index) -> checked_list_box;
      ...
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items, xtd::usize selected_index, const xtd::drawing::point& location) -> checked_list_box;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items, xtd::usize selected_index, const xtd::drawing::point& location, const xtd::drawing::size& size) -> checked_list_box;
      ...
      /// @param name The name of the xtd::forms::checked_list_box.
      /// @return New xtd::forms::checked_list_box created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const object_collection& items, xtd::usize selected_index, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> checked_list_box;
      /// @}
    ...
    protected:
      ...
      /// @{
      [[nodiscard]] auto allow_selection() const noexcept -> bool override;
