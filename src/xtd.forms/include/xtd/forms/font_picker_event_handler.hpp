...
namespace xtd {
  ...
  namespace forms {
    /// @brief Represents the method that will handle the xtd::forms::font_picker::color_changed of the xtd::forms::font_picker class.
    /// ```cpp
    /// using font_picker_event_handler = xtd::delegate<void(xtd::object& sender, const xtd::forms::font_picker_event_args& e)>;
    /// ```
    /// @param sender The source of the event.
    /// @param e A xtd::forms::font_picker_event_args that contains the event data.
    /// @par Header
    /// ```cpp
