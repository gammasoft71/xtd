...
namespace xtd {
  ...
  namespace forms {
    ...
    class forms_export_ link : public xtd::object, public xtd::iequatable<link> {
      struct data;
    ...
    public:
      ...
      [[nodiscard]] auto link_data() const noexcept -> const xtd::any_object&;
      ...
      /// @return `true` if the specified object is equal to the current object. otherwise, `false`.
      [[nodiscard]] auto equals(const link& other) const noexcept -> bool override;
    ...
    private:
      friend link_label;
      [[nodiscard]] bool active_() const noexcept;
      auto active_(bool active) noexcept -> void;
