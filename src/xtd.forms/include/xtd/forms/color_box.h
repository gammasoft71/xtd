...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      /// @return ok if the user clicks OK in the dialog box; otherwise, cancel.
      /// @remarks If dialog_result is ok, the color parameter contains the new chosen color.
      static xtd::forms::dialog_result show(xtd::drawing::color& color, const xtd::forms::iwin32_window& owner, color_box_styles styles, const std::vector<int32_t>& custom_colors) {return show_color_box(color, &owner, styles, custom_colors);}
      ...
      /// @return ok if the user clicks OK in the dialog box; otherwise, cancel.
      /// @remarks If dialog_result is ok, the color parameter contains the new chosen color.
      static xtd::forms::dialog_result show(xtd::drawing::color& color, color_box_styles styles, const std::vector<int32_t>& custom_colors) {return show_color_box(color, nullptr, styles, custom_colors);}
      
    private:
      static xtd::forms::dialog_result show_color_box(xtd::drawing::color& color, const xtd::forms::iwin32_window* owner = nullptr, color_box_styles styles = color_box_styles::alpha_color|color_box_styles::allow_full_open, const std::optional<std::vector<int32_t>>& custom_colors = std::optional<std::vector<int32_t>> {}) {
