...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      /// @param find_next The callback called when the user click the find button.
      template<typename find_next_callback_t>
      static void show(const iwin32_window& owner, const xtd::ustring& find_string, const xtd::ustring& title, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), title, find_string);}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      /// @param title The find dialog title.
      ...
      /// @param find_next The callback called when the user click the find button.
      template<typename find_next_callback_t>
      static void show(const iwin32_window& owner, const xtd::ustring& find_string, const xtd::ustring& title, bool match_case, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), title, find_string, match_case);}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      /// @param title The find dialog title.
      ...
      /// @param find_next The callback called when the user click the find button.
      template<typename find_next_callback_t>
      static void show(const iwin32_window& owner, const xtd::ustring& find_string, const xtd::ustring& title, bool match_case, xtd::forms::search_direction search_direction, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), title, find_string, match_case, search_direction);}
      /// @brief Displays a find dialog box.
      /// @param owner An xtd::forms::iwin32_window that represents the owner window of the find dialog box.
      /// @param find_string The string to find.
      /// @param title The find dialog title.
      ...
      /// @param find_next The callback called when the user click the find button.
      template<typename find_next_callback_t>
      static void show(const iwin32_window& owner, const xtd::ustring& find_string, const xtd::ustring& title, bool match_case, xtd::forms::search_direction search_direction, bool whole_word, find_next_callback_t find_next) {show_find_box(owner, xtd::forms::find_event_handler(find_next), title, find_string, match_case, search_direction, whole_word);}
      /// @}
      
    private:
      static void show_find_box(const iwin32_window& owner, xtd::forms::find_event_handler find_next, const xtd::ustring& title = "", const xtd::ustring& find_string = "", bool match_case = false, xtd::forms::search_direction search_direction = xtd::forms::search_direction::down, bool whole_word = false) {
