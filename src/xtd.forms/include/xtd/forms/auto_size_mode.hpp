...
template<> struct xtd::enum_register<xtd::forms::auto_size_mode> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::auto_size_mode> {{xtd::forms::auto_size_mode::grow_and_shrink, "grow_and_shrink"}, {xtd::forms::auto_size_mode::grow_only, "grow_only"}};}
};
/// @endcond
