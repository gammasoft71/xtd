  ...
  namespace forms {
    ...
    protected:
      ...
      void draw_back_digit(drawing::graphics& graphics) override {
        ...
        draw_segment_g1(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        draw_segment_g2(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        ...
        draw_segment_j(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        draw_segment_k(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        draw_segment_l(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
        draw_segment_m(graphics, drawing::color::average(back_color(), back_segment_color(), 1.0 - back_segment_opacity()));
      }
