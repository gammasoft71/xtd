...
namespace xtd {
  ...
  namespace forms {
    ...
    ///   <tr>
    ///     <th>Light</th>
    ///     <td>@image html containers_popup_panel_w.png</td>
    ///     <td>@image html containers_popup_panel_m.png</td>
    ///     <td>@image html containers_popup_panel_g.png</td>
    ///   </tr>
    ///   <tr>
    ///     <td>Dark</td>
    ///     <td>@image html containers_popup_panel_wd.png</td>
    ///     <td>@image html containers_popup_panel_md.png</td>
    ///     <td>@image html containers_popup_panel_gd.png</td>
    ///   </tr>
    /// </table>
    /// @par Examples
    ...
    public:
      ...
      static popup_panel create(const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
      ...
      /// @param name The name of the xtd::forms::popup_panel.
      /// @return New xtd::forms::popup_panel created.
      static popup_panel create(const control& parent, const drawing::point& location = {-1, -1}, const drawing::size& size = {-1, -1}, const xtd::ustring& name = xtd::ustring::empty_string);
      /// @}
