...
template<> struct xtd::enum_register<xtd::forms::splitter_style> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::splitter_style> {{xtd::forms::splitter_style::draw_line, "draw_line"}, {xtd::forms::splitter_style::update_children, "update_children"}};}
};
/// @endcond
