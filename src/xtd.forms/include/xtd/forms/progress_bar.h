...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      virtual size_t marquee_animation_speed() {return this->marquee_animation_speed_;}
      ...
      virtual int32_t step() {return this->step_;}
      ...
      virtual progress_bar_style style() const {return this->style_;}
      ...
      void increment(int32_t value) {
        if (this->value_ + value < this->minimum_)
          this->value(this->minimum_);
        if (this->value_ + value > this->maximum_)
          this->value(this->maximum_);
        else
          this->value(this->value_ + value);
      }
