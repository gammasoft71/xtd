...
template<> struct xtd::enum_register<xtd::forms::tool_bar_text_align> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::tool_bar_text_align> {{xtd::forms::tool_bar_text_align::underneath, "underneath"}, {xtd::forms::tool_bar_text_align::right, "right"}};}
};
/// @endcond
