...
template<> struct xtd::enum_register<xtd::forms::border_sides> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::border_sides> {{xtd::forms::border_sides::none, "none"}, {xtd::forms::border_sides::top, "top"}, {xtd::forms::border_sides::bottom, "bottom"}, {xtd::forms::border_sides::left, "left"}, {xtd::forms::border_sides::right, "right"}};}
};
/// @endcond
