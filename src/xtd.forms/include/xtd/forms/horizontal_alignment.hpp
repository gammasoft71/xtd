...
template<> struct xtd::enum_register<xtd::forms::horizontal_alignment> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::horizontal_alignment> {{xtd::forms::horizontal_alignment::left, "left"}, {xtd::forms::horizontal_alignment::right, "right"}, {xtd::forms::horizontal_alignment::center, "center"}};}
};
/// @endcond
