...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      static auto show(const xtd::forms::iwin32_window& owner, find_next_callback_t find_next, replace_callback_t replace, replace_all_callback_t replace_all) -> void {show_replace_box(owner, xtd::forms::find_event_handler(find_next), xtd::forms::replace_event_handler(replace), xtd::forms::replace_event_handler(replace_all));}
      ...
      /// @param replace_all The callback called when the user click the replace all button.
      template<typename find_next_callback_t, typename replace_callback_t, typename replace_all_callback_t>
      static auto show(const xtd::forms::iwin32_window& owner, const xtd::string& find_string, find_next_callback_t find_next, replace_callback_t replace, replace_all_callback_t replace_all) -> void {show_replace_box(owner, xtd::forms::find_event_handler(find_next), xtd::forms::replace_event_handler(replace), xtd::forms::replace_event_handler(replace_all), find_string);}
      ...
      /// @param replace_all The callback called when the user click the replace all button.
      template<typename find_next_callback_t, typename replace_callback_t, typename replace_all_callback_t>
      static auto show(const xtd::forms::iwin32_window& owner, const xtd::string& find_string, const xtd::string& replace_string, find_next_callback_t find_next, replace_callback_t replace, replace_all_callback_t replace_all) -> void {show_replace_box(owner, xtd::forms::find_event_handler(find_next), xtd::forms::replace_event_handler(replace), xtd::forms::replace_event_handler(replace_all), find_string, replace_string);}
      ...
      /// @param replace_all The callback called when the user click the replace all button.
      template<typename find_next_callback_t, typename replace_callback_t, typename replace_all_callback_t>
      static auto show(const xtd::forms::iwin32_window& owner, const xtd::string& find_string, const xtd::string& replace_string, const xtd::string& title, find_next_callback_t find_next, replace_callback_t replace, replace_all_callback_t replace_all) -> void {show_replace_box(owner, xtd::forms::find_event_handler(find_next), xtd::forms::replace_event_handler(replace), xtd::forms::replace_event_handler(replace_all), find_string, replace_string, title);}
      ...
      /// @param replace_all The callback called when the user click the replace all button.
      template<typename find_next_callback_t, typename replace_callback_t, typename replace_all_callback_t>
      static auto show(const xtd::forms::iwin32_window& owner, const xtd::string& find_string, const xtd::string& replace_string, const xtd::string& title, bool match_case, find_next_callback_t find_next, replace_callback_t replace, replace_all_callback_t replace_all) -> void {show_replace_box(owner, xtd::forms::find_event_handler(find_next), xtd::forms::replace_event_handler(replace), xtd::forms::replace_event_handler(replace_all), find_string, replace_string, title, match_case);}
      ...
      /// @param replace_all The callback called when the user click the replace all button.
      template<typename find_next_callback_t, typename replace_callback_t, typename replace_all_callback_t>
      static auto show(const xtd::forms::iwin32_window& owner, const xtd::string& find_string, const xtd::string& replace_string, const xtd::string& title, bool match_case, bool whole_word, find_next_callback_t find_next, replace_callback_t replace, replace_all_callback_t replace_all) -> void {show_replace_box(owner, xtd::forms::find_event_handler(find_next), xtd::forms::replace_event_handler(replace), xtd::forms::replace_event_handler(replace_all), find_string, replace_string, title, match_case, whole_word);}
      /// @}
      
    private:
      static auto show_replace_box(const xtd::forms::iwin32_window& owner, xtd::forms::find_event_handler find_next, xtd::forms::replace_event_handler replace, xtd::forms::replace_event_handler replace_all, const xtd::string& find_string = xtd::string::empty_string, const xtd::string& replace_string = xtd::string::empty_string, const xtd::string& title = xtd::string::empty_string, bool match_case = false, bool whole_word = false) -> void;
