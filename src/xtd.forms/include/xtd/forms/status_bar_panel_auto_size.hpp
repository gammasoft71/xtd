...
template<> struct xtd::enum_register<xtd::forms::status_bar_panel_auto_size> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::status_bar_panel_auto_size> {{xtd::forms::status_bar_panel_auto_size::none, "none"}, {xtd::forms::status_bar_panel_auto_size::spring, "spring"}, {xtd::forms::status_bar_panel_auto_size::contents, "contents"}};}
};
/// @endcond
