...
namespace xtd {
  ...
  namespace forms {
    ...
    class forms_export_ splitter_panel : public xtd::forms::panel {
      friend class xtd::forms::split_container;
    protected:
      ...
      [[nodiscard]] static auto create() -> splitter_panel;
      ...
      /// @return New xtd::forms::splitter_panel created.
      [[nodiscard]] static auto create(const drawing::point& location) -> splitter_panel;
      ...
      /// @return New xtd::forms::splitter_panel created.
      [[nodiscard]] static auto create(const drawing::point& location, const drawing::size& size) -> splitter_panel;
      ...
      /// @return New xtd::forms::splitter_panel created.
      [[nodiscard]] static auto create(const drawing::point& location, const drawing::size& size, const xtd::string& name) -> splitter_panel;
      ...
      /// @return New xtd::forms::splitter_panel created.
      [[nodiscard]] static auto create(const control& parent) -> splitter_panel;
      /// @brief A factory to create an xtd::forms::splitter_panel with specified parent, and location.
      /// @param parent The parent that contains the new created xtd::forms::splitter_panel.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::splitter_panel.
      /// @return New xtd::forms::splitter_panel created.
      [[nodiscard]] static auto create(const control& parent, const drawing::point& location) -> splitter_panel;
      /// @brief A factory to create an xtd::forms::splitter_panel with specified parent, location, and size.
      /// @param parent The parent that contains the new created xtd::forms::splitter_panel.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::splitter_panel.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::splitter_panel.
      /// @return New xtd::forms::splitter_panel created.
      [[nodiscard]] static auto create(const control& parent, const drawing::point& location, const drawing::size& size) -> splitter_panel;
      ...
      /// @param name The name of the xtd::forms::splitter_panel.
      /// @return New xtd::forms::splitter_panel created.
      [[nodiscard]] static auto create(const control& parent, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> splitter_panel;
      /// @}
    };
  }
}
