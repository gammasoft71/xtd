/// @file
/// @brief Contains xtd::forms::status_bar_panel_click_event_handler handler.
...
namespace xtd {
  ...
  namespace forms {
    ...
    using status_bar_panel_click_event_handler = xtd::delegate<void(xtd::object& sender, const xtd::forms::status_bar_panel_click_event_args& e)>;
  }
}
