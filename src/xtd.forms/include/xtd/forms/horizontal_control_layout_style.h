...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      /// @param expanded true if control expanded; otherwise false.
      /// @param size_type One of the xtd::forms::size_type values that specifies how layout container of user interface (UI) elements should be sized relative to their container. The default is xtd::forms::size_type::auto_size.
      horizontal_control_layout_style(bool expanded, xtd::forms::size_type size_type) : control_layout_style(expanded, size_type) {}
      ...
      /// @param align One of the content_alignment values. The default is middle_center.
      /// @param size_type One of the xtd::forms::size_type values that specifies how layout container of user interface (UI) elements should be sized relative to their container. The default is xtd::forms::size_type::auto_size.
      horizontal_control_layout_style(bool expanded, xtd::forms::content_alignment align, xtd::forms::size_type size_type) : control_layout_style(expanded, align, size_type) {}
      ...
      /// @param size_type One of the xtd::forms::size_type values that specifies how layout container of user interface (UI) elements should be sized relative to their container. The default is xtd::forms::size_type::auto_size.
      /// @param width The preferred width, in pixels or percentage, depending on the xtd::forms::control_layout_style::size_type property.
      horizontal_control_layout_style(xtd::forms::size_type size_type, int32_t width) : control_layout_style(size_type), width_(static_cast<float>(width)) {}
      ...
      /// @param size_type One of the xtd::forms::size_type values that specifies how layout container of user interface (UI) elements should be sized relative to their container. The default is xtd::forms::size_type::auto_size.
      /// @param width The preferred width, in pixels or percentage, depending on the xtd::forms::control_layout_style::size_type property.
      horizontal_control_layout_style(bool expanded, xtd::forms::size_type size_type, int32_t width) : control_layout_style(expanded, size_type), width_(static_cast<float>(width)) {}
      ...
      /// @param size_type One of the xtd::forms::size_type values that specifies how layout container of user interface (UI) elements should be sized relative to their container. The default is xtd::forms::size_type::auto_size.
      /// @param width The preferred width, in pixels or percentage, depending on the xtd::forms::control_layout_style::size_type property.
      horizontal_control_layout_style(bool expanded, xtd::forms::content_alignment align, xtd::forms::size_type size_type, int32_t width) : control_layout_style(expanded, align, size_type), width_(static_cast<float>(width)) {}
