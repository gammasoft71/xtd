...
namespace xtd {
  ...
  namespace forms {
    ...
    class forms_export_ h_scroll_bar : public xtd::forms::scroll_bar {
    public:
      ...
      [[nodiscard]] static auto create() -> h_scroll_bar;
      ...
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const drawing::point& location) -> h_scroll_bar;
      ...
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      ...
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified value, and location.
      /// @param value A numeric value that is within the minimum and maximum range. The default value is 0.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, const drawing::point& location) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified value, location, and size.
      /// @param value A numeric value that is within the minimum and maximum range. The default value is 0.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @param name The name of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      ...
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 maximum) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified value, minimum, maximum, and location.
      /// @param value A numeric value that is within the minimum and maximum range. The default value is 0.
      /// @param maximum The upper limit of values of the scrollable range.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 maximum, const drawing::point& location) -> h_scroll_bar;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 maximum, const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @param name The name of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 maximum, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      ...
      /// @param maximum The upper limit of values of the scrollable range.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 minimum, int32 maximum) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified value, minimum, maximum, and location.
      /// @param value A numeric value that is within the minimum and maximum range. The default value is 0.
      /// @param minimum The lower limit of values of the scrollable range.
      /// @param maximum The upper limit of values of the scrollable range.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 minimum, int32 maximum, const drawing::point& location) -> h_scroll_bar;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 minimum, int32 maximum, const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @param name The name of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(int32 value, int32 minimum, int32 maximum, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      ...
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified parent, and location.
      /// @param parent The parent that contains the new created xtd::forms::h_scroll_bar.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, const drawing::point& location) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified parent, location, and size.
      /// @param parent The parent that contains the new created xtd::forms::h_scroll_bar.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @param name The name of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified parent, and value.
      /// @param parent The parent that contains the new created xtd::forms::h_scroll_bar.
      /// @param value A numeric value that is within the minimum and maximum range. The default value is 0.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified parent, value, and location.
      /// @param parent The parent that contains the new created xtd::forms::h_scroll_bar.
      /// @param value A numeric value that is within the minimum and maximum range. The default value is 0.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, const drawing::point& location) -> h_scroll_bar;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @param name The name of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      /// @brief A factory to create an xtd::forms::h_scroll_bar with specified parent, value, and maximum.
      /// @param parent The parent that contains the new created xtd::forms::h_scroll_bar.
      /// @param value A numeric value that is within the minimum and maximum range. The default value is 0.
      /// @param maximum The upper limit of values of the scrollable range.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 maximum) -> h_scroll_bar;
      ...
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 maximum, const drawing::point& location) -> h_scroll_bar;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 maximum, const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @param name The name of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 maximum, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      ...
      /// @param maximum The upper limit of values of the scrollable range.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 minimum, int32 maximum) -> h_scroll_bar;
      ...
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 minimum, int32 maximum, const drawing::point& location) -> h_scroll_bar;
      ...
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 minimum, int32 maximum, const drawing::point& location, const drawing::size& size) -> h_scroll_bar;
      ...
      /// @param name The name of the xtd::forms::h_scroll_bar.
      /// @return New xtd::forms::h_scroll_bar created.
      [[nodiscard]] static auto create(const control& parent, int32 value, int32 minimum, int32 maximum, const drawing::point& location, const drawing::size& size, const xtd::string& name) -> h_scroll_bar;
      /// @}
