...
template<> struct xtd::enum_register<xtd::forms::character_casing> {
  void operator()(xtd::enum_collection<xtd::forms::character_casing>& values) {values = {{xtd::forms::character_casing::normal, "normal"}, {xtd::forms::character_casing::upper, "upper"}, {xtd::forms::character_casing::lower, "lower"}};}
};
/// @endcond
