...
namespace xtd {
  ...
  namespace forms {
    /// @brief Represents a common dialog box that displays a file selection dialog.
    /// @par Namespace
    /// xtd::forms
    /// @par Library
    /// xtd.forms
    ...
    public:
      ...
      /// @remarks If dialog_result is ok, the output file_name parameter will contain the selected file path, otherwise it will be ignored.
      ...
      /// @param owner An iwin32_window that represents the owner window of the file dialog box.
      /// @remarks If dialog_result is ok, the output file_names parameter will contain the selected file paths, otherwise it will be ignored.
