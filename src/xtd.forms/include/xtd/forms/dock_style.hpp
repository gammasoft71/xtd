...
template<> struct xtd::enum_register<xtd::forms::dock_style> {
  static auto values() noexcept {return xtd::enum_collection<xtd::forms::dock_style> {{xtd::forms::dock_style::none, "none"}, {xtd::forms::dock_style::top, "top"}, {xtd::forms::dock_style::bottom, "bottom"}, {xtd::forms::dock_style::left, "left"}, {xtd::forms::dock_style::right, "right"}, {xtd::forms::dock_style::fill, "fill"}};}
};
/// @endcond
