...
namespace xtd {
  ...
  namespace forms {
    ...
    class horizontal_layout_panel : public xtd::forms::panel {
    public:
      ...
      [[nodiscard]] auto control_layout_styles() const noexcept -> const xtd::forms::horizontal_control_layout_style_collection&;
      ...
      [[nodiscard]] auto control_layout_style(const xtd::forms::control_ref& control) const -> const xtd::forms::horizontal_control_layout_style&;
      ...
      /// @exception xtd::argument_exception container does not contains control.
      auto control_layout_style(const xtd::forms::control_ref& control, const xtd::forms::horizontal_control_layout_style& value) -> horizontal_layout_panel&;
      /// @}
      ...
      [[nodiscard]] static auto create() -> horizontal_layout_panel;
      ...
      /// @return New xtd::forms::horizontal_layout_panel created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location) -> horizontal_layout_panel;
      ...
      /// @return New xtd::forms::horizontal_layout_panel created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size) -> horizontal_layout_panel;
      ...
      /// @return New xtd::forms::horizontal_layout_panel created.
      [[nodiscard]] static auto create(const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> horizontal_layout_panel;
      ...
      /// @return New xtd::forms::horizontal_layout_panel created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent) -> horizontal_layout_panel;
      /// @brief A factory to create an xtd::forms::horizontal_layout_panel with specified parent, and location.
      /// @param parent The parent that contains the new created xtd::forms::horizontal_layout_panel.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::horizontal_layout_panel.
      /// @return New xtd::forms::horizontal_layout_panel created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location) -> horizontal_layout_panel;
      /// @brief A factory to create an xtd::forms::horizontal_layout_panel with specified parent, location, and size.
      /// @param parent The parent that contains the new created xtd::forms::horizontal_layout_panel.
      /// @param location A xtd::drawing::point that represent location of the xtd::forms::horizontal_layout_panel.
      /// @param size A xtd::drawing::size that represent size of the xtd::forms::horizontal_layout_panel.
      /// @return New xtd::forms::horizontal_layout_panel created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size) -> horizontal_layout_panel;
      ...
      /// @param name The name of the xtd::forms::horizontal_layout_panel.
      /// @return New xtd::forms::horizontal_layout_panel created.
      [[nodiscard]] static auto create(const xtd::forms::control& parent, const xtd::drawing::point& location, const xtd::drawing::size& size, const xtd::string& name) -> horizontal_layout_panel;
      /// @}
    ...
    private:
      xtd::forms::horizontal_control_layout_style_collection control_layout_styles_;
    };
  }
}
