...
namespace xtd {
  ...
  namespace drawing {
    ...
    public:
      static xtd::drawing::image from_name(const std::string& name) {return from_name(default_theme(), name, size(32, 32));}
      ...
      static xtd::drawing::image from_name(const std::string& theme, const std::string& name) {return from_name(theme, name, size(32, 32));}
