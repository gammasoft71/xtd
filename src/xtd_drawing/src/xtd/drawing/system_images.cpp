...
map<string, vector<string>> system_images::context_names() {
  static map<string, vector<string>> context_names {
    ...
    {"Emblems", {"emblem-default", "emblem-documents", "emblem-downloads", "emblem-favorite", "emblem-important", "emblem-mail", "emblem-photos", "emblem-readonly", "emblem-shared", "emblem-symbolic-link", "emblem-synchronized", "emblem-system", "emblem-unreadable"}},
    ...
    {"xtd", {"apply", "burn-disk", "cancel", "cancel-2", "drive-removable-flash", "drive-upload", "edit", "edit-copy-2", "edit-rename", "gammasoft", "go-previous-2", "go-next-2", "media-optical-audio", "media-optical-dvd", "user", "xtd", "xtd-console", "xtd-forms"}},
  };
