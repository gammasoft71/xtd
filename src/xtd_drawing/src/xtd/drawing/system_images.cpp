...
map<string, vector<string>> system_images::context_names() {
  static map<string, vector<string>> context_names {
    ...
    {"Devices", {"audio-card", "audio-input-microphone", "battery", "camera-photo", "camera-video", "camera-web", "computer", "drive-harddisk", "drive-optical", "drive-removable-media-usb-pendrive", "drive-removable-media", "input-gaming", "input-keyboard", "input-mouse", "input-tablet", "media-flash", "media-floppy", "media-optical-audio", "media-optical-blu-ray", "media-optical-data", "media-optical-dvd", "media-optical-dvd-video", "media-optical-mixed-cd", "media-optical-recordable", "media-optical-video", "media-optical", "media-tape", "modem", "multimedia-player", "network-wired", "network-wireless", "pda", "phone", "printer", "scanner", "video-display"}},
    ...
    {"Places", {"folder", "folder-activities", "folder-bookmarks", "folder-cloud", "folder-development", "folder-documents", "folder-downloads", "folder-favorites", "folder-games", "folder-github", "folder-html", "folder-images", "folder-important", "folder-locked", "folder-music", "folder-network", "folder-public", "folder-remote", "folder-system", "folder-tar", "folder-temp", "folder-templates", "folder-texts", "folder-videos", "network-server", "network-workgroup", "start-here", "user-bookmarks", "user-desktop", "user-home", "user-trash"}},
    {"Status", {"appointment-missed", "appointment-soon", "audio-volume-high", "audio-volume-low", "audio-volume-medium", "audio-volume-muted", "battery-caution", "battery-low", "dialog-error", "dialog-information", "dialog-password", "dialog-question", "dialog-warning", "folder-drag-accept", "folder-open", "folder-print", "folder-visiting", "image-loading", "image-missing", "mail-attachment", "mail-unread", "mail-read", "mail-replied", "mail-signed", "mail-signed-verified", "media-playlist-repeat", "media-playlist-shuffle", "network-error", "network-idle", "network-offline", "network-receive", "network-transmit", "network-transmit-receive", "printer-error", "printer-printing", "security-high", "security-medium", "security-low", "software-update-available", "software-update-urgent", "sync-error", "sync-synchronizing", "task-due", "task-past-due", "user-available", "user-away", "user-idle", "user-offline", "user-trash-full", "weather-clear", "weather-clear-night", "weather-few-clouds", "weather-few-clouds-night", "weather-fog", "weather-overcast", "weather-severe-alert", "weather-showers", "weather-showers-scattered", "weather-snow", "weather-storm"}},
