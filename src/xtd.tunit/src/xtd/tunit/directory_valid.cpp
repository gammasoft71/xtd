...
void directory_valid::are_equal(const directory_entry& expected, const directory_entry& actual, const stack_frame& stack_frame) {
...
void directory_valid::are_equal(const directory_entry& expected, const directory_entry& actual, const std::string& message, const stack_frame& stack_frame) {
  try {
...
void directory_valid::are_not_equal(const directory_entry& expected, const directory_entry& actual, const stack_frame& stack_frame) {
  are_not_equal(expected, actual, "", stack_frame);
}

void directory_valid::are_not_equal(const directory_entry& expected, const directory_entry& actual, const std::string& message) {are_not_equal(expected, actual, message, stack_frame::empty());}

void directory_valid::are_not_equal(const directory_entry& expected, const directory_entry& actual, const std::string& message, const stack_frame& stack_frame) {
  try {
