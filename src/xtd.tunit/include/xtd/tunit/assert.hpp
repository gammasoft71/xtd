...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      /// @cond
      template<class value_t>
      inline static void is_empty(const std::initializer_list<value_t>& values, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {is_empty(values, xtd::string::empty_string, stack_frame);}
      template<class value_t>
      ...
      /// @cond
      template<class value_t>
      inline static void is_not_empty(const std::initializer_list<value_t>& values, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {is_not_empty(values, xtd::string::empty_string, stack_frame);}
      template<class value_t>
      inline static void is_not_empty(const std::initializer_list<value_t>& values, const xtd::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {
        if (!empty(values)) succeed(message, stack_frame);
        else fail("collection not <empty>", "<empty>", message, stack_frame);
      }
    ...
    private:
      ...
      inline static bool empty(const collection_t collection) {return collection.begin() == collection.end();}
    };
  }
}
