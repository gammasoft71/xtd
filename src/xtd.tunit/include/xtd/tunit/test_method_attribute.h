...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      test_method_attribute(const xtd::ustring& name, test_class_t& test_class, void (test_class_t::*method)()) noexcept : test_method_attribute(name, test_class, method, xtd::tunit::test_state::considered, xtd::diagnostics::stack_frame()) {}
      ...
      template<typename test_class_t>
      test_method_attribute(const xtd::ustring& name, test_class_t& test_class, void (test_class_t::*method)(), const xtd::diagnostics::stack_frame& stack_frame) noexcept : test_method_attribute(name, test_class, method, xtd::tunit::test_state::considered, stack_frame) {}
      ...
      template<typename test_class_t>
      test_method_attribute(const xtd::ustring& name, test_class_t& test_class, void (test_class_t::*method)(), xtd::tunit::test_state test_state) noexcept : test_method_attribute(name, test_class, method, test_state, xtd::diagnostics::stack_frame()) {}
      ...
      /// @param stack_frame The stack frame of test method.
      template<typename test_class_t>
      test_method_attribute(const xtd::ustring& name, test_class_t& test_class, void (test_class_t::*method)(), xtd::tunit::test_state test_state, const xtd::diagnostics::stack_frame& stack_frame) noexcept {test_class.add_test_method({name, std::bind(method, &test_class), test_state == xtd::tunit::test_state::ignored, stack_frame});}
      /// @}
    };
  }
}
