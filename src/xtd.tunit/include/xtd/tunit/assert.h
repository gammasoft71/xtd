...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      /// @cond
      template<typename value_t>
      static void is_empty(const std::initializer_list<value_t>& values) {is_empty(values, xtd::string::empty_string, xtd::diagnostics::stack_frame::empty());}
      template<typename value_t>
      static void is_empty(const std::initializer_list<value_t>& values, const xtd::diagnostics::stack_frame& stack_frame) {is_empty(values, xtd::string::empty_string, stack_frame);}
      template<typename value_t>
      static void is_empty(const std::initializer_list<value_t>& values, const xtd::string& message) {is_empty(values, message, xtd::diagnostics::stack_frame::empty());}
      template<typename value_t>
      ...
      /// @cond
      template<typename value_t>
      static void is_not_empty(const std::initializer_list<value_t>& values) {is_not_empty(values, xtd::string::empty_string, xtd::diagnostics::stack_frame::empty());}
      template<typename value_t>
      static void is_not_empty(const std::initializer_list<value_t>& values, const xtd::diagnostics::stack_frame& stack_frame) {is_not_empty(values, xtd::string::empty_string, stack_frame);}
      template<typename value_t>
      static void is_not_empty(const std::initializer_list<value_t>& values, const xtd::string& message) {is_not_empty(values, message, xtd::diagnostics::stack_frame::empty());}
      template<typename value_t>
      static void is_not_empty(const std::initializer_list<value_t>& values, const xtd::string& message, const xtd::diagnostics::stack_frame& stack_frame) {
        if (!std::empty(values))
          succeed(message, stack_frame);
        else
          fail("collection not <empty>", "<empty>", message, stack_frame);
