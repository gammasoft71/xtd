...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      template<typename value_t>
      static auto is_not_empty(const std::initializer_list<value_t>& value, const xtd::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) -> void {
        try {
          assert::is_not_empty(value, message, stack_frame);
        } catch (...) {
          error();
      ...
      /// ```
      template<typename pointer_t>
      static auto is_not_null(const xtd::wptr<pointer_t>& pointer, const xtd::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) -> void {assert::succeed(message, stack_frame);}
      /// @brief Validates that the pointer is not null.
      /// @param pointer The pointer to check is null.
      /// @param stack_frame Contains information about current file and current line.
