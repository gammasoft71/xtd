...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      /// std::vector<int> v1;
      /// std::vector<int> v2 = {0, 1, 2, 3};
      /// xtd::tunit::collection_valid:is_empty(v1, csf_); // test ok.
      /// xtd::tunit::collection_valid:is_empty(v2, csf_); // test fails
      /// @endcode
      template<typename value_t>
      ...
      /// std::vector<int> v1 = {0, 1, 2, 3};
      /// std::vector<int> v2;
      /// xtd::tunit::collection_valid:is_not_empty(v1, csf_); // test ok.
      /// xtd::tunit::collection_valid:is_not_empty(v2, csf_); // test fails
      /// @endcode
      template<typename value_t>
      ...
      /// std::vector<int> v1 = {1, 2, 3, 4};
      /// std::vector<int> v2 = {1, 2, 4, 3};
      /// xtd::tunit::collection_valid:is_ordered(v1, csf_); // test ok.
      /// xtd::tunit::collection_valid:is_ordered(v2, csf_); // test fails
      /// @endcode
      template<typename value_t>
