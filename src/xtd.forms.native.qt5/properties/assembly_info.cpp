...
assembly_title_("xtd.forms.native.qt5");
assembly_description_("xtd.forms.native.qt5 library is based on Qt 5 toolkit.");
assembly_configuration_("");
assembly_company_("Gammasoft");
assembly_product_("xtd.forms.native.qt5");
...
assembly_guid_("10d49de9-dd64-4636-acfc-b6ad2cfe27f8");
