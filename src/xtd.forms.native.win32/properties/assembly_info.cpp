...
assembly_title_("xtd.forms.native.win32");
assembly_description_("xtd.forms.native.win32 library is based on Microsoft Win32 toolkit.");
assembly_configuration_("");
assembly_company_("Gammasoft");
assembly_product_("xtd.forms.native.win32");
...
assembly_guid_("15e5156a-ca8c-4f9f-bdf2-5a02b2b7d77a");
