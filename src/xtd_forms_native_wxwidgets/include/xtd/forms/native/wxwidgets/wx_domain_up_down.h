...
#endif
          this->control_handler::create<wxDomainSpinCtrl>(reinterpret_cast<control_handler*>(create_params.parent())->main_control(), wxID_ANY, wxPoint(create_params.x(), create_params.y()), wxSize(create_params.width(), height), style_to_wx_text_box_style(create_params.style(), create_params.ex_style()), style_to_wx_spin_style(create_params.style(), create_params.ex_style()));
