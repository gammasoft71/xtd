...
int32_t interlocked::add(int32_t& location, std::int32_t value) {
...
int32_t interlocked::compare_exchange(int32_t& location, std::int32_t value, std::int32_t comparand) {
...
int32_t interlocked::exchange(int32_t& location, std::int32_t value) {
