...
int32_t socket::get_socket_ip_v6_multicast_option(intmax_t handle, int32_t socket_option_name, std::vector<uint8_t>& multicast_address, uint64_t& interface_index) {
  struct multicast {
...
int32_t socket::set_socket_ip_v6_multicast_option(intmax_t handle, int32_t socket_option_name, const std::vector<uint8_t>& multicast_address, uint64_t interface_index) {
  struct multicast {
    uint8_t multicast_address[16];
    uint64_t interface_index;
  } m;
