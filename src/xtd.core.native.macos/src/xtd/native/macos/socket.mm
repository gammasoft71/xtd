...
namespace {
  static std::int32_t native_to_socket_error(int32_t error) {
  ...
  static std::int32_t socket_error_to_native(int32_t error) {
  ...
  static std::int32_t protocol_type_to_native(int32_t protocol_type) {
  ...
  static std::int32_t socket_option_level_to_native(int32_t socket_option_level) {
  ...
  static std::int32_t socket_option_name_to_native(int32_t socket_option_name) {
  ...
  static std::int32_t socket_type_to_native(int32_t socket_type) {
...
intmax_t socket::create(int32_t address_family, std::int32_t socket_type, std::int32_t protocol_type) {
...
int32_t socket::get_raw_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t& option_length) {
...
int32_t socket::get_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t& option_length) {
...
int32_t socket::get_socket_linger_option(intmax_t handle, bool& enabled, std::uint32_t& linger_time) {
...
int32_t socket::get_socket_multicast_option(intmax_t handle, std::int32_t socket_option_name, std::uint32_t& multicast_address, std::uint32_t& interface_index) {
  struct multicast {
...
int32_t socket::get_socket_ip_v6_multicast_option(intmax_t handle, std::int32_t socket_option_name, std::vector<uint8_t>& multicast_address, std::uint64_t& interface_index) {
  struct multicast {
...
int32_t socket::io_control(intmax_t handle, std::int32_t io_control, std::vector<uint8_t>& option_in_value, std::vector<uint8_t>& option_out_value) {
  // Not implemented
  errno = ENOTSUP;
  return -1;
}
...
int32_t socket::poll(intmax_t handle, std::int32_t microseconds, std::int32_t mode) {
...
int32_t socket::receive(intmax_t handle, std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags) {
...
int32_t socket::receive_from(intmax_t handle, std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags, std::vector<uint8_t>& socket_address) {
  std::swap(socket_address[0], socket_address[1]);
  auto address_length = static_cast<socklen_t>(socket_address.size());
...
int32_t socket::select(std::vector<intmax_t>& check_read, std::vector<intmax_t>& check_write, std::vector<intmax_t>& check_error, std::int32_t microseconds) {
  auto nfds = size_t {0};
...
int32_t socket::send(intmax_t handle, const std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags) {
  return static_cast<int32_t>(::send(static_cast<int32_t>(handle), &buffer.data()[offset], size, flags));
}

int32_t socket::send_to(intmax_t handle, const std::vector<uint8_t>& buffer, size_t offset, size_t size, std::int32_t flags, const std::vector<uint8_t>& socket_address) {
  std::swap(const_cast<std::vector<uint8_t>&>(socket_address)[0], const_cast<std::vector<uint8_t>&>(socket_address)[1]);
...
int32_t socket::set_raw_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t option_length) {
...
int32_t socket::set_socket_option(intmax_t handle, std::int32_t socket_option_level, std::int32_t socket_option_name, intmax_t option, size_t option_length) {
  if (socket_option_name_to_native(socket_option_name) == -1) {
    errno = ENOTSUP;
    return -1;
  }
...
int32_t socket::set_socket_linger_option(intmax_t handle, bool enabled, std::uint32_t linger_time) {
  auto l = linger {static_cast<int32_t>(enabled), static_cast<int32_t>(linger_time)};
  return setsockopt(static_cast<int32_t>(handle), SOL_SOCKET, SO_LINGER, &l, static_cast<socklen_t>(sizeof(linger)));
}

int32_t socket::set_socket_multicast_option(intmax_t handle, std::int32_t socket_option_name, std::uint32_t multicast_address, std::uint32_t interface_index) {
  struct multicast {
    std::uint32_t multicast_address;
    std::uint32_t interface_index;
...
int32_t socket::set_socket_ip_v6_multicast_option(intmax_t handle, std::int32_t socket_option_name, const std::vector<uint8_t>& multicast_address, std::uint64_t interface_index) {
  struct multicast {
    std::uint8_t multicast_address[16];
    std::uint64_t interface_index;
  } m;
...
int32_t socket::shutdown(intmax_t handle, std::int32_t how) {
