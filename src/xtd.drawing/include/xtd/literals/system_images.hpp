...
namespace xtd {
  ...
  inline namespace literals {
    ...
    xtd::drawing::image operator""_image(const char* s, xtd::usize n);
    ...
    /// @remarks The xtd::drawing::size of the image is equal to xtd::drawing::system_images::default_size property.
    /// @note If you want load image with other size use xtd::drawing::system_images::from_name (const xtd::string& name, const xtd::drawing::size& size) method.
    xtd::drawing::image operator""_image(const char8* s, xtd::usize n);
    ...
    /// @remarks The xtd::drawing::size of the image is equal to xtd::drawing::system_images::default_size property.
    /// @note If you want load image with other size use xtd::drawing::system_images::from_name (const xtd::string& name, const xtd::drawing::size& size) method.
    xtd::drawing::image operator""_image(const char16* s, xtd::usize n);
    ...
    /// @remarks The xtd::drawing::size of the image is equal to xtd::drawing::system_images::default_size property.
    /// @note If you want load image with other size use xtd::drawing::system_images::from_name (const xtd::string& name, const xtd::drawing::size& size) method.
    xtd::drawing::image operator""_image(const char32* s, xtd::usize n);
    ...
    /// @remarks The xtd::drawing::size of the image is equal to xtd::drawing::system_images::default_size property.
    /// @note If you want load image with other size use xtd::drawing::system_images::from_name (const xtd::string& name, const xtd::drawing::size& size) method.
    xtd::drawing::image operator""_image(const wchar* s, xtd::usize n);
    /// @}
  }
}
