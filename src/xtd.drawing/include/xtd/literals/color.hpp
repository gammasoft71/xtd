...
namespace xtd {
  ...
  inline namespace literals {
    ...
    /// ```
    [[nodiscard]] auto operator""_color(const char* s, xtd::usize n) -> xtd::drawing::color;
    ...
    /// xtd::console::out << c3 << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_color(const char8* s, xtd::usize n) -> xtd::drawing::color;
    ...
    /// xtd::console::out << c3 << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_color(const char16* s, xtd::usize n) -> xtd::drawing::color;
    ...
    /// xtd::console::out << c3 << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_color(const char32* s, xtd::usize n) -> xtd::drawing::color;
    ...
    /// xtd::console::out << c3 << xtd::environment::new_line;
    /// ```
    [[nodiscard]] auto operator""_color(const wchar* s, xtd::usize n) -> xtd::drawing::color;
    /// @}
  }
}
