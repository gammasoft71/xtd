...
namespace xtd {
  /// @brief The xtd::drawing namespace provides access to GDI+ basic buffered_graphics functionality. More advanced functionality is provided in the xtd::drawing::drawing2d, xtd::drawing::imaging, and xtd::drawing::text namespaces.
  namespace drawing {
