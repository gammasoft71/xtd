...
template<> struct xtd::enum_register<xtd::drawing::graphics_unit> {
  void operator()(xtd::enum_collection<xtd::drawing::graphics_unit>& values, xtd::enum_attribute& attribute) {values = {{xtd::drawing::graphics_unit::world, "world"}, {xtd::drawing::graphics_unit::display, "display"}, {xtd::drawing::graphics_unit::pixel, "pixel"}, {xtd::drawing::graphics_unit::point, "point"}, {xtd::drawing::graphics_unit::inch, "inch"}, {xtd::drawing::graphics_unit::document, "document"}, {xtd::drawing::graphics_unit::millimeter, "millimeter"}};}
};
/// @endcond
