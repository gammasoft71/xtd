...
template<> struct xtd::enum_register<xtd::drawing::string_alignment> {
  static auto values() noexcept {return xtd::enum_collection<xtd::drawing::string_alignment> {{xtd::drawing::string_alignment::near, "near"}, {xtd::drawing::string_alignment::center, "center"}, {xtd::drawing::string_alignment::far, "far"}};}
};
/// @endcond
