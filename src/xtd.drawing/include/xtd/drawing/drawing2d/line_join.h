...
template<> struct xtd::enum_register<xtd::drawing::drawing2d::line_join> {
  void operator()(xtd::enum_collection<xtd::drawing::drawing2d::line_join>& values) {values = {{xtd::drawing::drawing2d::line_join::miter, "miter"}, {xtd::drawing::drawing2d::line_join::bevel, "bevel"}, {xtd::drawing::drawing2d::line_join::round, "round"}, {xtd::drawing::drawing2d::line_join::miter_clipped, "miter_clipped"}};}
};
/// @endcond
