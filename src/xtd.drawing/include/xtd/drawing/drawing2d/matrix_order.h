...
template<> struct xtd::enum_register<xtd::drawing::drawing2d::matrix_order> {
  void operator()(xtd::enum_collection<xtd::drawing::drawing2d::matrix_order>& values, xtd::enum_attribute& attribute) {values = {{xtd::drawing::drawing2d::matrix_order::prepend, "prepend"}, {xtd::drawing::drawing2d::matrix_order::append, "append"}};}
};
/// @endcond
