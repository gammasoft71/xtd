...
template<> struct xtd::enum_register<xtd::drawing::drawing2d::matrix_order> {
  explicit operator auto() const noexcept {return xtd::enum_collection<xtd::drawing::drawing2d::matrix_order> {{xtd::drawing::drawing2d::matrix_order::prepend, "prepend"}, {xtd::drawing::drawing2d::matrix_order::append, "append"}};}
};
/// @endcond
