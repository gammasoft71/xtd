...
namespace xtd {
  ...
  namespace drawing {
    ...
    private:
      ...
      static xtd::string from_name(const xtd::drawing::color& value);
      static bool try_parse_hex_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_hsl_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_hsla_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_hsv_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_hsva_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_html_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_named_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_rgb_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      static bool try_parse_rgba_color(const xtd::string& text, xtd::drawing::color& result) noexcept;
      /// @}
    };
  }
}
