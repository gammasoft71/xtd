...
namespace xtd {
  ...
  namespace drawing {
    ...
    public:
      ...
      [[nodiscard]] static auto from_base64_string(const xtd::string& value) -> xtd::drawing::image;
      ...
      /// @remarks The first eight bytes contain the width followed by the height of the image. The following bytes contain the ARGB components of the image pixels.
      [[nodiscard]] static auto to_array(const xtd::drawing::image& value) -> xtd::array<xtd::byte>;
      ...
      /// @remarks The first eight bytes contain the width followed by the height of the image. The following bytes contain the ARGB components of the image pixels.
      [[nodiscard]] static auto to_base64_string(const xtd::drawing::image& value) -> xtd::string;
      ...
      /// @remarks The first eight bytes contain the width followed by the height of the image. The following bytes contain the ARGB components of the image pixels.
      [[nodiscard]] static auto to_image(const xtd::array<xtd::byte>& value) -> xtd::drawing::image;
      /// @brief Convert specified bytes span to image.
      /// @param value A bytes span that contains the image.
      /// @return The converted image from byte array.
      /// @remarks The first eight bytes contain the width followed by the height of the image. The following bytes contain the ARGB components of the image pixels.
      [[nodiscard]] static auto to_image(const xtd::read_only_span<xtd::byte>& value) -> xtd::drawing::image;
      ...
      [[nodiscard]] static auto to_image(const xtd::string& filename) -> xtd::drawing::image;
      ...
      [[nodiscard]] static auto to_image(std::istream& stream) -> xtd::drawing::image;
