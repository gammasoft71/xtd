...
template<> struct xtd::enum_register<xtd::drawing::text::hotkey_prefix> {
  static auto values() noexcept {return xtd::enum_collection<xtd::drawing::text::hotkey_prefix> {{xtd::drawing::text::hotkey_prefix::none, "none"}, {xtd::drawing::text::hotkey_prefix::show, "show"}, {xtd::drawing::text::hotkey_prefix::hide, "hide"}};}
};
/// @endcond
