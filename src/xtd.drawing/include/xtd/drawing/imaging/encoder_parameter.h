  ...
  namespace drawing {
    ...
    namespace imaging {
      ...
      public:
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, byte_t value);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, int16_t value);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, int64_t value);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, byte_t value, bool undefined);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, std::vector<byte_t> value);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, std::vector<int16_t> value);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, std::vector<int32_t> value);
        /// @brief Initializes a new instance of the xtd::drawing::imaging::encoder_parameter class with the specified Encoder object and an array of signed 32-bit integers. Sets the xtd::drawing::imaging::encoder_parameter::value_type property to ValueTypeLong, and sets the xtd::drawing::imaging::encoder_parameter::number_of_values property to the number of elements in the array.
        /// @param encoder An xtd::drawing::imaging::encoder object that encapsulates the globally unique identifier of the parameter category.
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, std::vector<int64_t> value);
        ...
        /// @param undefined If true, the xtd::drawing::imaging::encoder_parameter::value_type property is set to xtd::drawing::imaging::encoder_parameter_value_type::value_type_undefined; otherwise, the xtd::drawing::imaging::encoder_parameter::value_type property is set to xtd::drawing::imaging::encoder_parameter_value_type::value_type_byte.
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, std::vector<byte_t> value, bool undefined);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, int32_t numerator, int32_t denominator);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, int32_t numerator1, int32_t denominator1, int32_t numerator2, int32_t denominator2);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, std::vector<int32_t> numerator, std::vector<int32_t> denominator);
        ...
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, std::vector<int64_t> rangebegin, std::vector<int64_t> rangeend);
        ...
        /// @param type
        /// @param value
        encoder_parameter(const xtd::drawing::imaging::encoder& encoder, int32_t number_values, xtd::drawing::imaging::encoder_parameter_value_type type, std::vector<byte_t> value);
        /// @}
