/// @file
/// @brief Contains xtd::drawing::imaging::effects::saturate_effect struct.
...
namespace xtd {
  ...
  namespace drawing {
    ...
    namespace imaging {
      ...
      namespace effects {
        /// @brief The xtd::drawing::imaging::effects::saturate_effect saturates the image with percent factor.
        /// @par Namespace
        ...
        /// @par Examples
        /// The following example code shows how tu use xtd::drawing::imaging::effects::saturate_effect with image.
        /// ```cpp
        /// const auto img = image::from_file("ball.png");
        /// auto result = image_effector::set_effect(img, saturate_effect {3.0});
        /// result.save("ball_brightness.png");
        /// ```
        struct saturate_effect : effect {
          /// @name Public Constructors
          
          /// @{
          /// @brief Initialise the new instance of xtd::drawing::imaging::saturate_effect object.
          saturate_effect() = default;
          /// @brief Initialise the new instance of xtd::drawing::imaging::saturate_effect object with specified percent.
