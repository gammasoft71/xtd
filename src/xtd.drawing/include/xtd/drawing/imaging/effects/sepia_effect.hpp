/// @file
/// @brief Contains xtd::drawing::imaging::effects::sepia_effect struct.
...
namespace xtd {
  ...
  namespace drawing {
    ...
    namespace imaging {
      ...
      namespace effects {
        /// @brief The xtd::drawing::imaging::effects::sepia_effect changes the colors of the image to grayscale colors with percent factor.
        /// @par Namespace
        ...
        /// @par Examples
        /// The following example code shows how tu use xtd::drawing::imaging::effects::sepia_effect with image.
        /// ```cpp
        /// const auto img = image::from_file("ball.png");
        /// auto result = image_effector::set_effect(img, sepia_effect {1.0});
        /// result.save("ball_sepia.png");
        /// ```
        struct sepia_effect : effect {
          /// @name Public Constructors
          
          /// @{
          /// @brief Initialise the new instance of xtd::drawing::imaging::sepia_effect object.
          sepia_effect() = default;
          /// @brief Initialise the new instance of xtd::drawing::imaging::sepia_effect object with specified percent.
          /// @param percent The percent factor in %.
          explicit sepia_effect(double percent);
          /// @}
