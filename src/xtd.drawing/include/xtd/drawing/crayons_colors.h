/// @file
/// @brief Contains xtd::drawing::crayons_colors factory.
...
namespace xtd {
  ...
  namespace drawing {
    ...
    /// @endcode
    /// @par Inheritance
    /// xtd::static_object → xtd::drawing::crayons_colors
    /// @par Namespace
    /// xtd::drawing
    /// @par Library
    /// xtd.drawing
