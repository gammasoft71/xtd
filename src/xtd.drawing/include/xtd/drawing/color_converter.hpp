...
namespace xtd {
  ...
  namespace drawing {
    ...
    public:
      ...
      [[nodiscard]] static auto alpha_blend(const xtd::drawing::color& fore_core, const xtd::drawing::color& back_color, double alpha) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto average(const xtd::drawing::color& color1, const xtd::drawing::color& color2, double weight) noexcept -> xtd::drawing::color;
      /// @brief Returns the weighted average color between the two given colors.
      /// @param color1 The first color.
      /// @param color2 The second color.
      /// @param weight The weighting factor
      ...
      [[nodiscard]] static auto average(const xtd::drawing::color& color1, const xtd::drawing::color& color2, double weight, bool average_alpha) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto bitonal(const drawing::color& color, int32 threshold, const drawing::color& upper_color, const drawing::color& lower_color) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto brightness(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      ...
      /// @param percent The percent factor in % (from 0.0 to 2.0).
      /// @return The new color.
      [[nodiscard]] static auto color(const xtd::drawing::color& color, const xtd::drawing::color& value, double percent) noexcept -> xtd::drawing::color;
      ...
      /// @return The new color.
      [[nodiscard]] static auto color_extraction(const xtd::drawing::color& color, int32 threshold, const drawing::color& extraction_color, const xtd::drawing::color& other_color) noexcept -> xtd::drawing::color;
      ...
      /// @return The new color.
      [[nodiscard]] static auto color_substitution(const xtd::drawing::color& color, int32 threshold, const drawing::color& source_color, const xtd::drawing::color& new_color) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto contrast(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      
      /// @brief Creates a new darker color of the specified color with 33% factor.
      /// @param color The color to dark.
      /// @return The new color.
      [[nodiscard]] static auto dark(const xtd::drawing::color& color) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto dark(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      ...
      /// @return The new color.
      [[nodiscard]] static auto disabled(const xtd::drawing::color& fore_color, const xtd::drawing::color& back_color) noexcept -> xtd::drawing::color;
      ...
      /// @return The new color.
      [[nodiscard]] static auto disabled(const xtd::drawing::color& fore_color, float brightness) noexcept -> xtd::drawing::color;
      ...
      /// @return The new color.
      [[nodiscard]] static auto gamma_correction(const xtd::drawing::color& color, double r, double g, double b) noexcept -> xtd::drawing::color;
      
      /// @brief Creates a new gray color of the specified color.
      /// @param color The color to grayscale.
      /// @return The new color.
      [[nodiscard]] static auto grayscale(const xtd::drawing::color& color) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto grayscale(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      ...
      /// @return The new color.
      [[nodiscard]] static auto hue_rotate(const xtd::drawing::color& color, int angle) noexcept -> xtd::drawing::color;
      
      /// @brief Creates a new inverted color of the specified color.
      /// @param color The color to invert.
      /// @return The new color.
      [[nodiscard]] static auto invert(const xtd::drawing::color& color) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto invert(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      
      /// @brief Creates a new lighter color of the specified color with 33% factor.
      /// @param color The color to light.
      /// @return The new color.
      [[nodiscard]] static auto light(const xtd::drawing::color& color) noexcept -> xtd::drawing::color;
      ...
      /// @return The new color.
      /// @remarks Thus, a percent value of `1.0` will return the xtd::drawing::color::black, while a value of `0.0` will return the color.
      [[nodiscard]] static auto light(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto saturate(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      
      /// @brief Creates a new sepia color of the specified color.
      /// @param color The color to sepia.
      /// @return The new color.
      [[nodiscard]] static auto sepia(const xtd::drawing::color& color) noexcept -> xtd::drawing::color;
      ...
      [[nodiscard]] static auto sepia(const xtd::drawing::color& color, double percent) noexcept -> xtd::drawing::color;
      
      /// @brief Creates a new black or white color of the specified color with specified threshold.
      /// @param color The color to threshold.
      /// @param threshold The threshold value (from 0 to 765).
      /// @return The new color.
      [[nodiscard]] static auto threshold(const xtd::drawing::color& color, int32 threshold) noexcept -> xtd::drawing::color;
      /// @}
    };
  }
}
