...
namespace xtd {
  ...
  namespace drawing {
    ...
    namespace [[deprecated("Replaced by xtd::drawing::drawing_2d - Will be removed in version 1.2.0.")]] drawing2d {
      ...
      /// @deprecated Replaced by xtd::drawing::drawing_2d::hatch_style - Will be removed in version 1.2.0.
      using hatch_style [[deprecated("Replaced by xtd::drawing::drawing_2d::hatch_style - Will be removed in version 1.2.0.")]] = xtd::drawing::drawing_2d::hatch_style;
    }
  }
}
