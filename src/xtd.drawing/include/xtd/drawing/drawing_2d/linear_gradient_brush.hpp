...
#include "linear_gradient_mode.hpp"
#include <xtd/array>
  ...
  namespace drawing {
    ...
    namespace drawing_2d {
      ...
      public:
        ...
        [[nodiscard]] auto linear_colors() const noexcept -> const xtd::drawing::drawing_2d::gradient_stop_collection&;
        ...
        [[nodiscard]] auto rectangle() const noexcept -> const xtd::drawing::rectangle_f&;
      ...
      private:
        [[nodiscard]] static auto linear_gradient_mode_to_angle(xtd::drawing::drawing_2d::linear_gradient_mode) -> float;
    ...
    /// @deprecated Replaced by xtd::drawing::drawing_2d - Will be removed in version 1.2.0.
    namespace [[deprecated("Replaced by xtd::drawing::drawing_2d - Will be removed in version 1.2.0.")]] drawing2d {
      /// @brief Encapsulates a xtd::drawing::brush with a linear gradient. This class cannot be inherited.
      /// @deprecated Replaced by xtd::drawing::drawing_2d::linear_gradient_brush - Will be removed in version 1.2.0.
      using linear_gradient_brush [[deprecated("Replaced by xtd::drawing::drawing_2d::linear_gradient_brush - Will be removed in version 1.2.0.")]] = xtd::drawing::drawing_2d::linear_gradient_brush;
    }
  }
}
