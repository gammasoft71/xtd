...
namespace xtd {
  ...
  namespace drawing {
    ...
    namespace [[deprecated("Replaced by xtd::drawing::drawing_2d - Will be removed in version 1.2.0.")]] drawing2d {
      /// @brief Defines a rectangular xtd::drawing::brush with a hatch style, a foreground color, and a background color. This class cannot be inherited.
      /// @deprecated Replaced by xtd::drawing::drawing_2d::hatch_brush - Will be removed in version 1.2.0.
      using hatch_brush [[deprecated("Replaced by xtd::drawing::drawing_2d::hatch_brush - Will be removed in version 1.2.0.")]] = xtd::drawing::drawing_2d::hatch_brush;
    }
  }
}
