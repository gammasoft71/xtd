...
namespace xtd {
  ...
  namespace drawing {
    ...
    namespace [[deprecated("Replaced by xtd::drawing::drawing_2d - Will be removed in version 1.2.0.")]] drawing2d {
      /// @brief Specifies the direction of a linear gradient.
      /// @deprecated Replaced by xtd::drawing::drawing_2d::linear_gradient_mode - Will be removed in version 1.2.0.
      using linear_gradient_mode [[deprecated("Replaced by xtd::drawing::drawing_2d::linear_gradient_mode - Will be removed in version 1.2.0.")]] = xtd::drawing::drawing_2d::linear_gradient_mode;
    }
  }
}
