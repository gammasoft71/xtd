...
template<> struct xtd::enum_register<xtd::drawing::drawing_2d::line_cap> {
  static auto values() noexcept {return xtd::enum_collection<xtd::drawing::drawing_2d::line_cap> {{xtd::drawing::drawing_2d::line_cap::flat, "flat"}, {xtd::drawing::drawing_2d::line_cap::square, "square"}, {xtd::drawing::drawing_2d::line_cap::round, "round"}};}
};
/// @endcond
