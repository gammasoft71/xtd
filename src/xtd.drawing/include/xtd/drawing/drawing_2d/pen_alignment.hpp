...
namespace xtd {
  ...
  namespace drawing {
    ...
    namespace [[deprecated("Replaced by xtd::drawing::drawing_2d - Will be removed in version 1.2.0.")]] drawing2d {
      /// @brief Specifies the alignment of a xtd::drawing::pen object in relation to the theoretical, zero-width line.
      /// @deprecated Replaced by xtd::drawing::drawing_2d::pen_alignment - Will be removed in version 1.2.0.
      using pen_alignment [[deprecated("Replaced by xtd::drawing::drawing_2d::pen_alignment - Will be removed in version 1.2.0.")]] = xtd::drawing::drawing_2d::pen_alignment;
    }
  }
}
