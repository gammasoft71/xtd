...
namespace xtd {
  ...
  namespace drawing {
    ...
    namespace [[deprecated("Replaced by xtd::drawing::drawing_2d - Will be removed in version 1.2.0.")]] drawing2d {
      /// @brief Specifies the type of fill a xtd::drawing::pen object uses to fill lines.
      /// @deprecated Replaced by xtd::drawing::drawing_2d::pen_type - Will be removed in version 1.2.0.
      using pen_type [[deprecated("Replaced by xtd::drawing::drawing_2d::pen_type - Will be removed in version 1.2.0.")]] = xtd::drawing::drawing_2d::pen_type;
    }
  }
}
