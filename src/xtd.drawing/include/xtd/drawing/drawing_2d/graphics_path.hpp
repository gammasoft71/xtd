  ...
  namespace drawing {
    ...
    namespace drawing_2d {
      ...
      public:
        ...
        [[nodiscard]] auto fill_mode() const noexcept -> xtd::drawing::drawing_2d::fill_mode;
        ...
        [[nodiscard]] auto get_bounds() const -> xtd::drawing::rectangle_f;
        ...
        [[nodiscard]] auto get_lat_point() const -> xtd::drawing::point_f;
        ...
        [[nodiscard]] auto is_vsible(const xtd::drawing::point& point) const -> bool;
        /// @brief Indicates whether the specified point is contained within this xtd::drawing::drawing_2d::graphics_path.
        /// @param point A xtd::drawing::point_f that represents the point to test.
        /// @return This method returns `true` if the specified point is contained within this xtd::drawing::drawing_2d::graphics_path; otherwise, `false`.
        [[nodiscard]] auto is_vsible(const xtd::drawing::point_f& point) const -> bool;
        /// @brief Indicates whether the specified point is contained within this xtd::drawing::drawing_2d::graphics_path.
        /// @param x The x-coordinate of the point to test.
        /// @param y The y-coordinate of the point to test.
        /// @return This method returns `true` if the specified point is contained within this xtd::drawing::drawing_2d::graphics_path; otherwise, `false`.
        [[nodiscard]] auto is_vsible(xtd::int32 x, xtd::int32 y) const -> bool;
        /// @brief Indicates whether the specified point is contained within this xtd::drawing::drawing_2d::graphics_path.
        /// @param x The x-coordinate of the point to test.
        /// @param y The y-coordinate of the point to test.
        /// @return This method returns `true` if the specified point is contained within this xtd::drawing::drawing_2d::graphics_path; otherwise, `false`.
        [[nodiscard]] auto is_vsible(float x, float y) const -> bool;
