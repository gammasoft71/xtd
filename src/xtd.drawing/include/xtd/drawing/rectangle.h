...
namespace xtd {
  ...
  namespace drawing {
    ...
    /// <br>The example is designed for use with xtd.forms, and it requires xtd::forms::paint_event_ergs e, which is a parameter of the xtd::control::paint event handler.<br><br>
    /// @code
