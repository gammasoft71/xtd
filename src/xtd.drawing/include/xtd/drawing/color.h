...
namespace xtd {
  ...
  namespace drawing {
    ...
    private:
      ...
      static std::tuple<xtd::byte, xtd::byte, xtd::byte> grayscale(xtd::byte r, xtd::byte g, xtd::byte b) noexcept;
