#include "../../../include/xtd/drawing/apple_colors.hpp"
...
const array<color>& apple_colors::get_colors() noexcept {
  static auto colors = array {apple_colors::black(), apple_colors::blue(), apple_colors::brown(), apple_colors::cyan(), apple_colors::green(), apple_colors::magenta(), apple_colors::orange(), apple_colors::purple(), apple_colors::red(), apple_colors::yellow(), apple_colors::white()};
  return colors;
}

const array<string>& apple_colors::get_color_names() noexcept {
  static auto color_names = array {apple_colors::black().name(), apple_colors::blue().name(), apple_colors::brown().name(), apple_colors::cyan().name(), apple_colors::green().name(), apple_colors::magenta().name(), apple_colors::orange().name(), apple_colors::purple().name(), apple_colors::red().name(), apple_colors::yellow().name(), apple_colors::white().name()};
  return color_names;
}
