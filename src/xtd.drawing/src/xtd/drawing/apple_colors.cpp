...
const std::vector<color>& apple_colors::get_colors() noexcept {
  static auto colors = std::vector {apple_colors::black(), apple_colors::blue(), apple_colors::brown(), apple_colors::cyan(), apple_colors::green(), apple_colors::magenta(), apple_colors::orange(), apple_colors::purple(), apple_colors::red(), apple_colors::yellow(), apple_colors::white()};
  return colors;
}
