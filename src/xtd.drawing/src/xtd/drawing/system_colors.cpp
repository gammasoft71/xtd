...
const vector<color>& system_colors::get_colors() {
  static vector<color> colors {system_colors::accent(), system_colors::accent_text(), system_colors::active_border(), system_colors::active_caption(), system_colors::active_caption_text(), system_colors::active_text(), system_colors::accent_text(), system_colors::app_workspace(), system_colors::button_face(), system_colors::button_highlight(), system_colors::button_shadow(), system_colors::control(), system_colors::control_dark(), system_colors::control_dark_dark(), system_colors::control_light(), system_colors::control_light_light(), system_colors::control_text(), system_colors::desktop(), system_colors::gradient_active_caption(), system_colors::gradient_inactive_caption(), system_colors::gray_text(), system_colors::highlight(), system_colors::highlight_text(), system_colors::hot_track(), system_colors::inactive_border(), system_colors::inactive_caption(), system_colors::inactive_caption_text(), system_colors::info(), system_colors::info_text(), system_colors::link_text(), system_colors::menu(), system_colors::menu_bar(), system_colors::menu_highlight(), system_colors::menu_text(), system_colors::scroll_bar(), system_colors::text_box(), system_colors::text_box_text(), system_colors::visited_text(), system_colors::window(), system_colors::window_frame(), system_colors::window_text(),};
  return colors;
}

const vector<ustring>& system_colors::get_color_names() {
  static vector<ustring> color_names {system_colors::accent().name(), system_colors::accent_text().name(), system_colors::active_border().name(), system_colors::active_caption().name(), system_colors::active_caption_text().name(), system_colors::active_text().name(), system_colors::accent_text().name(), system_colors::app_workspace().name(), system_colors::button_face().name(), system_colors::button_highlight().name(), system_colors::button_shadow().name(), system_colors::control().name(), system_colors::control_dark().name(), system_colors::control_dark_dark().name(), system_colors::control_light().name(), system_colors::control_light_light().name(), system_colors::control_text().name(), system_colors::desktop().name(), system_colors::gradient_active_caption().name(), system_colors::gradient_inactive_caption().name(), system_colors::gray_text().name(), system_colors::highlight().name(), system_colors::highlight_text().name(), system_colors::hot_track().name(), system_colors::inactive_border().name(), system_colors::inactive_caption().name(), system_colors::inactive_caption_text().name(), system_colors::info().name(), system_colors::info_text().name(), system_colors::link_text().name(), system_colors::menu().name(), system_colors::menu_bar().name(), system_colors::menu_highlight().name(), system_colors::menu_text().name(), system_colors::scroll_bar().name(), system_colors::text_box().name(), system_colors::text_box_text().name(), system_colors::visited_text().name(), system_colors::window().name(), system_colors::window_frame().name(), system_colors::window_text().name(),};
  return color_names;
}
