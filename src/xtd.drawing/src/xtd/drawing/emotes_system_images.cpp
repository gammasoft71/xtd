#include "../../../include/xtd/drawing/emotes_system_images.hpp"
...
const array<image>& emotes_system_images::get_images() noexcept {
  static auto images = get_images(default_size());
  return images;
}

array<image> emotes_system_images::get_images(const xtd::drawing::size& size) noexcept {
  return array {face_angel(size), face_angry(size), face_cool(size), face_crying(size), face_devilish(size), face_embarrassed(size), face_kiss(size), face_laugh(size), face_monkey(size), face_plain(size), face_raspberry(size), face_sad(size), face_sick(size), face_smile(size), face_smile_big(size), face_smirk(size), face_surprise(size), face_tired(size), face_uncertain(size), face_wink(size), face_worried(size), };
}

const array<string>& emotes_system_images::get_image_names() noexcept {
  static auto names = array {"face-angel"_s, "face-angry"_s, "face-cool"_s, "face-crying"_s, "face-devilish"_s, "face-embarrassed"_s, "face-kiss"_s, "face-laugh"_s, "face-monkey"_s, "face-plain"_s, "face-raspberry"_s, "face-sad"_s, "face-sick"_s, "face-smile"_s, "face-smile-big"_s, "face-smirk"_s, "face-surprise"_s, "face-tired"_s, "face-uncertain"_s, "face-wink"_s, "face-worried"_s, };
  return names;
}
