#include "../../../include/xtd/drawing/brushes.hpp"
...
const std::vector<solid_brush>& brushes::get_brushes() {
  static auto brushes = std::vector {brushes::transparent(), brushes::alice_blue(), brushes::antique_white(), brushes::aqua(), brushes::aquamarine(), brushes::azure(), brushes::beige(), brushes::bisque(), brushes::black(), brushes::blanched_almond(), brushes::blue(), brushes::blue_violet(), brushes::brown(), brushes::burly_wood(), brushes::cadet_blue(), brushes::chartreuse(), brushes::chocolate(), brushes::coral(), brushes::cornflower_blue(), brushes::cornsilk(), brushes::crimson(), brushes::cyan(), brushes::dark_blue(), brushes::dark_cyan(), brushes::dark_goldenrod(), brushes::dark_gray(), brushes::dark_green(), brushes::dark_khaki(), brushes::dark_magenta(), brushes::dark_olive_green(), brushes::dark_orange(), brushes::dark_orchid(), brushes::dark_red(), brushes::dark_salmon(), brushes::dark_sea_green(), brushes::dark_slate_blue(), brushes::dark_slate_gray(), brushes::dark_turquoise(), brushes::dark_violet(), brushes::deep_pink(), brushes::deep_sky_blue(), brushes::dim_gray(), brushes::dodger_blue(), brushes::firebrick(), brushes::floral_white(), brushes::forest_green(), brushes::fuchsia(), brushes::gainsboro(), brushes::ghost_white(), brushes::gold(), brushes::goldenrod(), brushes::gray(), brushes::green(), brushes::green_yellow(), brushes::honeydew(), brushes::hot_pink(), brushes::indian_red(), brushes::indigo(), brushes::ivory(), brushes::khaki(), brushes::lavender(), brushes::lavender_blush(), brushes::lawn_green(), brushes::lemon_chiffon(), brushes::light_blue(), brushes::light_coral(), brushes::light_cyan(), brushes::light_goldenrod_yellow(), brushes::light_gray(), brushes::light_green(), brushes::light_pink(), brushes::light_salmon(), brushes::light_sea_green(), brushes::light_sky_blue(), brushes::light_slate_gray(), brushes::light_steel_blue(), brushes::light_yellow(), brushes::lime(), brushes::lime_green(), brushes::linen(), brushes::magenta(), brushes::maroon(), brushes::medium_aquamarine(), brushes::medium_blue(), brushes::medium_orchid(), brushes::medium_purple(), brushes::medium_sea_green(), brushes::medium_slate_blue(), brushes::medium_spring_green(), brushes::medium_turquoise(), brushes::medium_violet_red(), brushes::midnight_blue(), brushes::mint_cream(), brushes::misty_rose(), brushes::moccasin(), brushes::navajo_white(), brushes::navy(), brushes::old_lace(), brushes::olive(), brushes::olive_drab(), brushes::orange(), brushes::orange_red(), brushes::orchid(), brushes::pale_goldenrod(), brushes::pale_green(), brushes::pale_turquoise(), brushes::pale_violet_red(), brushes::papaya_whip(), brushes::peach_puff(), brushes::peru(), brushes::pink(), brushes::plum(), brushes::powder_blue(), brushes::purple(), brushes::rebecca_purple(), brushes::red(), brushes::rosy_brown(), brushes::royal_blue(), brushes::saddle_brown(), brushes::salmon(), brushes::sandy_brown(), brushes::sea_green(), brushes::sea_shell(), brushes::sienna(), brushes::silver(), brushes::sky_blue(), brushes::slate_blue(), brushes::slate_gray(), brushes::snow(), brushes::spring_green(), brushes::steel_blue(), brushes::tan(), brushes::teal(), brushes::thistle(), brushes::tomato(), brushes::turquoise(), brushes::violet(), brushes::wheat(), brushes::white(), brushes::white_smoke(), brushes::yellow(), brushes::yellow_green()};
  return brushes;
}
