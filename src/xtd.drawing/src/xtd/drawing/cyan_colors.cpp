...
const std::vector<color>& cyan_colors::get_colors() noexcept {
  static auto colors = std::vector {cyan_colors::teal(), cyan_colors::dark_cyan(), cyan_colors::light_sea_green(), cyan_colors::cadet_blue(), cyan_colors::dark_turquoise(), cyan_colors::medium_turquoise(), cyan_colors::turquoise(), cyan_colors::aqua(), cyan_colors::cyan(), cyan_colors::aquamarine(), cyan_colors::pale_turquoise(), cyan_colors::light_cyan()};
  return colors;
}
