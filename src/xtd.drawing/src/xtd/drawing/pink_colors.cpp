...
const std::vector<color>& pink_colors::get_colors() noexcept {
  static auto colors = std::vector {pink_colors::medium_violet_red(), pink_colors::deep_pink(), pink_colors::pale_violet_red(), pink_colors::hot_pink(), pink_colors::light_pink(), pink_colors::pink()};
  return colors;
}
