...
const array<color>& pink_colors::get_colors() noexcept {
  static auto colors = array {pink_colors::medium_violet_red(), pink_colors::deep_pink(), pink_colors::pale_violet_red(), pink_colors::hot_pink(), pink_colors::light_pink(), pink_colors::pink()};
  return colors;
}

const array<string>& pink_colors::get_color_names() noexcept {
  static auto color_names = array {pink_colors::medium_violet_red().name(), pink_colors::deep_pink().name(), pink_colors::pale_violet_red().name(), pink_colors::hot_pink().name(), pink_colors::light_pink().name(), pink_colors::pink().name()};
  return color_names;
}
