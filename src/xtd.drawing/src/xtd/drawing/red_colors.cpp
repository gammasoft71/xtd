#include "../../../include/xtd/drawing/red_colors.hpp"
...
const array<color>& red_colors::get_colors() noexcept {
  static auto colors = array {red_colors::dark_red(), red_colors::red(), red_colors::firebrick(), red_colors::crimson(), red_colors::indian_red(), red_colors::light_coral(), red_colors::salmon(), red_colors::dark_salmon(), red_colors::light_salmon()};
  return colors;
}

const array<string>& red_colors::get_color_names() noexcept {
  static auto color_names = array {red_colors::dark_red().name(), red_colors::red().name(), red_colors::firebrick().name(), red_colors::crimson().name(), red_colors::indian_red().name(), red_colors::light_coral().name(), red_colors::salmon().name(), red_colors::dark_salmon().name(), red_colors::light_salmon().name()};
  return color_names;
}
