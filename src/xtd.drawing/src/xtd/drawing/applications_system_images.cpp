...
const std::vector<image>& applications_system_images::get_images() noexcept {
  static auto images = get_images(default_size());
  return images;
}

std::vector<image> applications_system_images::get_images(const xtd::drawing::size& size) noexcept {
