#include "../../../include/xtd/drawing/gray_colors.hpp"
...
const array<color>& gray_colors::get_colors() noexcept {
  static auto colors = array {gray_colors::black(), gray_colors::dark_slate_gray(), gray_colors::dim_gray(), gray_colors::slate_gray(), gray_colors::gray(), gray_colors::light_slate_gray(), gray_colors::dark_gray(), gray_colors::silver(), gray_colors::light_gray(), gray_colors::gainsboro()};
  return colors;
}

const array<string>& gray_colors::get_color_names() noexcept {
  static auto color_names = array {gray_colors::black().name(), gray_colors::dark_slate_gray().name(), gray_colors::dim_gray().name(), gray_colors::slate_gray().name(), gray_colors::gray().name(), gray_colors::light_slate_gray().name(), gray_colors::dark_gray().name(), gray_colors::silver().name(), gray_colors::light_gray().name(), gray_colors::gainsboro().name()};
  return color_names;
}
