...
assembly_title_("xtd.forms.native.gtk4");
assembly_description_("xtd.forms.native.gtk4 library is based on Gtk+ 4 toolkit.");
assembly_configuration_("");
assembly_company_("Gammasoft");
assembly_product_("xtd.forms.native.gtk4");
...
assembly_guid_("f8a4ea14-1540-4147-9b40-1bd1fe9660a1");
