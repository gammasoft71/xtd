...
namespace image_ico::properties {
  ...
  public:
    ...
    static const xtd::drawing::icon& gammasoft_ico() {
      static auto icon = xtd::drawing::icon {xtd::io::path::combine(xtd::environment::get_folder_path(xtd::environment::special_folder::application_resources), "gammasoft.ico")};
      return icon;
    }
