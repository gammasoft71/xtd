...
namespace image_ani::properties {
  ...
  public:
    ...
    static const xtd::drawing::bitmap& gammasoft_ani() {
      static auto bitmap = xtd::drawing::bitmap {xtd::io::path::combine(xtd::environment::get_folder_path(xtd::environment::special_folder::application_resources), "gammasoft.ani")};
      return bitmap;
    }
