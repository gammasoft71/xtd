...
namespace image_icns::properties {
  ...
  public:
    ...
    static const xtd::drawing::icon& gammasoft_icns() {
      static auto icon = xtd::drawing::icon {xtd::io::path::combine(xtd::environment::get_folder_path(xtd::environment::special_folder::application_resources), "gammasoft.icns")};
      return icon;
    }
