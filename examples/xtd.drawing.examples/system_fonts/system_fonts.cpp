...
int main() {
  cout << strings::format("caption_font       : {}", system_fonts::caption_font()) << endl;
  cout << strings::format("default_font       : {}", system_fonts::default_font()) << endl;
  cout << strings::format("dialog_font        : {}", system_fonts::dialog_font()) << endl;
  cout << strings::format("icon_title_font    : {}", system_fonts::icon_title_font()) << endl;
  cout << strings::format("menu_font          : {}", system_fonts::menu_font()) << endl;
  cout << strings::format("message_box_font   : {}", system_fonts::message_box_font()) << endl;
  cout << strings::format("small_caption_font : {}", system_fonts::small_caption_font()) << endl;
  cout << strings::format("status_font        : {}", system_fonts::status_font()) << endl;
}
