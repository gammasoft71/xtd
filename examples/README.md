...
* [Convert string](xtd.core.examples/convert_string/README.md) contains convert string examples.
...
* [User forms](xtd.forms.examples/user_forms/README.md) contains custom forms examples.
