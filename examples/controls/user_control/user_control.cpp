  ...
  protected:
    void on_paint(paint_event_args& e) override {
      ...
      switch (this->status()) {
        ...
        case operation_status::running: e.graphics().draw_string(L"☞", drawing::font(default_font().name(), 18, font_style::italic), solid_brush(color::medium_purple), 0, 0); break;
        case operation_status::succeed: e.graphics().draw_string(L"√", drawing::font(default_font().name(), 18, font_style::italic), solid_brush(color::green), 2, 0); break;
        case operation_status::failed: e.graphics().draw_string(L"X", drawing::font(default_font().name(), 18, font_style::italic), solid_brush(color::red), 5, 0); break;
      }
