...
namespace unit_tests {
  class test_class_(test) {
    void test_method_(test_case_succeed) {
      auto is = std::istringstream {"xtd::tunit::file_assume::are_not_equal example."};
      file_assume::are_not_equal(std::istringstream {"xtd::tunit::file_assume::are_not_equel example."}, is);
    }
    
    void test_method_(test_case_failed) {
      auto is = std::istringstream {"xtd::tunit::file_assume::are_not_equal example."};
      file_assume::are_not_equal(std::istringstream {"xtd::tunit::file_assume::are_not_equal example."}, is);
    }
  };
}
