...
namespace unit_tests {
  class test_class_(test) {
    void test_method_(test_case_succeed) {
      auto is = istringstream {"xtd::tunit::file_assume::are_not_equal example."};
      file_assume::are_not_equal(istringstream {"xtd::tunit::file_assume::are_not_equel example."}, is);
    }
    
    void test_method_(test_case_failed) {
      auto is = istringstream {"xtd::tunit::file_assume::are_not_equal example."};
      file_assume::are_not_equal(istringstream {"xtd::tunit::file_assume::are_not_equal example."}, is);
    }
  };
}
