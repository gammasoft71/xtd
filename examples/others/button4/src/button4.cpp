...
auto main()->int {
  ...
  button1->click += [&] {label1->text(xtd::strings::format("Button 1 clicked {} times", ++button1_clicked));};
  button2->click += [&] {label2->text(xtd::strings::format("Button 2 clicked {} times", ++button2_clicked));};
