...
namespace examples {
  ...
  private:
    void on_selected_index_changed(const event_args& e) {
      if (previous_selected_index_ != 0xFFFFFFFFFFFFFFFF) colors_[colors_.size() - 1 - previous_selected_index_]->back_color(back_color());
      if (previous_selected_index_ != 0xFFFFFFFFFFFFFFFF) colors_[colors_.size() - 1 - previous_selected_index_]->fore_color(fore_color());
