  ...
  public:
    main_form() {
      ...
      paint += [&](object& sender, paint_event_args& e) {
        ...
        e.graphics().draw_string("Hello, World!", {system_fonts::default_font(), 32, font_style::bold | font_style::italic}, solid_brush {color_transformer::dark(color::spring_green, 2.0 / 3)}, rectangle::offset(e.clip_rectangle(), {2, 2}), string_format().alignment(string_alignment::center).line_alignment(string_alignment::center));
