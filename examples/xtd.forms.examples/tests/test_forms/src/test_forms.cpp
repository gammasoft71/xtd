...
protected:
  drawing::color default_back_color() const noexcept override {return xtd::drawing::color::black;}
  drawing::font default_font() const noexcept override {return xtd::drawing::font(xtd::drawing::font_family::generic_monospace(), 10);}
  drawing::color default_fore_color() const noexcept override {return xtd::drawing::color::lime;}
  drawing::size default_size() const noexcept override {return {300, 200};}
