...
private:
  void on_menu_click(object& sender, const event_args& e) {
    ...
    if (main_menu1.menu_items()[3].get().menu_items()[4].get() == sender) about_box::show(*this, "Shows some controls in light mode", "Light mode example", xtd::drawing::system_icons::xtd_logo(), environment::version().to_string(2), environment::version().to_string(), "Copyright (c) 2023 Gammasoft.", "https://gammasoft71.wixsite.com/xtdpro", "xtd");
  }
  ...
  void on_tool_bar_button_click(object& sender, const tool_bar_button_click_event_args& e) {
    ...
    if (e.button() == help_tool_bar_button) about_box::show(*this, "Shows some controls in light mode", "Light mode example", xtd::drawing::system_icons::xtd_logo(), environment::version().to_string(2), environment::version().to_string(), "Copyright (c) 2023 Gammasoft.", "https://gammasoft71.wixsite.com/xtdpro", "xtd");
  }
