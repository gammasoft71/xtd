...
private:
  void menu_click(object& sender, const event_args& e) {
    ...
    if (*menu_items[28] == sender) about_box::show(*this, "Shows some controls in light mode", "Light mode example", xtd::drawing::system_icons::xtd_logo(), environment::version().to_string(2), environment::version().to_string(), "Copygight (c) 2023 Gammasoft.", "https://gammasoft71.wixsite.com/xtdpro", "xtd");
  }
