...
private:
  void menu_click(object& sender, const event_args& e) {
    ...
    if (*menu_items[28] == sender) about_box::show(*this, "Shows some controls in dark mode", "Dark mode example", xtd::drawing::system_icons::xtd_logo(), environment::version().to_string(2), environment::version().to_string(), "Copygight (c) 2022 Gammasoft.", "https://gammasoft71.wixsite.com/xtdpro", "xtd");
  }
  ...
  void tool_bar_button_click(object& sender, const tool_bar_button_click_event_args& e) {
    ...
    if (e.button() == help_tool_bar_button) about_box::show(*this, "Shows some controls in dark mode", "Dark mode example", xtd::drawing::system_icons::xtd_logo(), environment::version().to_string(2), environment::version().to_string(), "Copygight (c) 2022 Gammasoft.", "https://gammasoft71.wixsite.com/xtdpro", "xtd");
  }
