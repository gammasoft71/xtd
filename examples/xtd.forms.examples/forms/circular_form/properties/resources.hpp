...
namespace circular_form::properties {
  ...
  public:
    ...
    static const xtd::drawing::icon& ball_ico() {
      static auto icon = xtd::drawing::icon {xtd::io::path::combine(xtd::environment::get_folder_path(xtd::environment::special_folder::application_resources), "ball.ico")};
      return icon;
    }

    /// @brief Looks up a localized resource of type xtd::drawing::bitmap.
    static const xtd::drawing::bitmap& ball_png() {
