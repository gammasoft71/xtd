...
public:
  ...
  form1() {
    ...
    label1.mouse_down += delegate_(object & sender, const mouse_event_args & e) {
      mouse_location = e.location();
      label1.cursor(cursors::no_move_2d());
    };
    
    label1.mouse_up += delegate_(object & sender, const mouse_event_args & e) {
      mouse_location = point::empty;
      label1.cursor(cursors::default_cursor());
    };
    
    label1.mouse_move += delegate_(object & sender, const mouse_event_args & e) {
