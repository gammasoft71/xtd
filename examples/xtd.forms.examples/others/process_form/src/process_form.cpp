...
public:
  main_form() {
    ...
    layout_panel.controls().push_back_range({xtd_web_button, open_home_folder_button, open_readme_txt_file_button, open_calculator_button});
    ...
    xtd_web_button.size({100, 250});
    xtd_web_button.text("xtd web...");
