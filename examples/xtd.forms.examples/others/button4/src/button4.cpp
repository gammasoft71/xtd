...
auto main() -> int {
  ...
  button1.click += [&] {label1.text(xtd::string::format("Button 1 clicked {} times", ++button1_clicked));};
  button2.auto_repeat(true).click += [&] {label2.text(xtd::string::format("Button 2 clicked {} times", ++button2_clicked));};
