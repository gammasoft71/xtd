...
namespace example {
  ...
  public:
    form1() {
      ...
      label_picture_gnome_theme.back_color(label_picture_gnome_theme.text() == application::system_style_sheet().theme().name() ? system_colors::accent() : system_colors::window());
      label_picture_gnome_theme.fore_color(label_picture_gnome_theme.text() == application::system_style_sheet().theme().name()? system_colors::accent() : system_colors::window_text());
      ...
      label_picture_macos_theme.back_color(label_picture_macos_theme.text() == application::system_style_sheet().theme().name() ? system_colors::accent() : system_colors::window());
      label_picture_macos_theme.fore_color(label_picture_macos_theme.text() == application::system_style_sheet().theme().name()? system_colors::accent() : system_colors::window_text());
      ...
      label_picture_symbolic_theme.back_color(label_picture_symbolic_theme.text() == application::system_style_sheet().theme().name() ? system_colors::accent() : system_colors::window());
      label_picture_symbolic_theme.fore_color(label_picture_symbolic_theme.text() == application::system_style_sheet().theme().name()? system_colors::accent() : system_colors::window_text());
      ...
      label_picture_windows_theme.back_color(label_picture_windows_theme.text() == application::system_style_sheet().theme().name() ? system_colors::accent() : system_colors::window());
      label_picture_windows_theme.fore_color(label_picture_windows_theme.text() == application::system_style_sheet().theme().name()? system_colors::accent() : system_colors::window_text());
      ...
      label_picture_xtd_theme.back_color(label_picture_xtd_theme.text() == application::system_style_sheet().theme().name() ? system_colors::accent() : system_colors::window());
      label_picture_xtd_theme.fore_color(label_picture_xtd_theme.text() == application::system_style_sheet().theme().name()? system_colors::accent() : system_colors::window_text());
