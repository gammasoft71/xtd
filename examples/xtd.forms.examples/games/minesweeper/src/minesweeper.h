...
namespace minesweeper {
  class form_minesweeper : public xtd::forms::form {
    ...
    public:
      ...
      static int height() {return size_.height();};
      ...
      static xtd::drawing::size size() {return size_;};
      ...
      static int width() {return size_.width();};
  ...
  private:
    ...
    void draw_cell(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      using namespace xtd;
      using namespace xtd::forms;
      std::map<cell_state, delegate<void(paint_event_args&, int, int, form_minesweeper::cell)>> draw_state {{cell_state::unchecked, {*this, &form_minesweeper::do_draw_unchecked}}, {cell_state::checked, {*this, &form_minesweeper::do_draw_checked}}, {cell_state::flag, {*this, &form_minesweeper::do_draw_flag}}, {cell_state::question, {*this, &form_minesweeper::do_draw_question}}, {cell_state::mine, {*this, &form_minesweeper::do_draw_mine}}, {cell_state::exploded_mine, {*this, &form_minesweeper::do_draw_exploded_mine}}, {cell_state::error, {*this, &form_minesweeper::do_draw_error}}};
      draw_state[cell.state()](e, x, y, cell);
    }

    void do_draw_unchecked(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      draw_border_unchecked(e, x, y);
    }
    
    void do_draw_checked(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      using namespace xtd::drawing;
    ...
    void do_draw_flag(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      using namespace xtd::drawing;
      draw_border_unchecked(e, x, y);
    ...
    void do_draw_question(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      using namespace xtd::drawing;
      draw_border_unchecked(e, x, y);
      rectangle rect(x, y, cell::width(), cell::height());
    ...
    void do_draw_mine(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      using namespace xtd::drawing;
      draw_border_checked(e, x, y);
      rectangle rect(x, y, cell::width(), cell::height());
    ...
    void do_draw_exploded_mine(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      using namespace xtd::drawing;
      e.graphics().fill_rectangle(brushes::red(), x, y, cell::width(), cell::height());
      do_draw_mine(e, x, y, cell);
    }
    
    void do_draw_error(xtd::forms::paint_event_args& e, int x, int y, form_minesweeper::cell cell) {
      using namespace xtd::drawing;
      draw_border_checked(e, x, y);
      do_draw_mine(e, x, y, cell);
      rectangle rect(x, y, cell::width(), cell::height());
