...
namespace context_menu_example {
  ...
  private:
    ...
    menu_item file_new_menu_item {texts::new_(), event_handler {*this, &form1::on_menu_click}, menu_images::file_new()};
    menu_item file_separator1_menu_item {"-"};
    menu_item file_open_menu_item {texts::open(), event_handler {*this, &form1::on_menu_click}, menu_images::file_open()};
    ...
    menu_item file_close_menu_item {texts::close(), event_handler {*this, &form1::on_menu_click}};
    menu_item file_separator2_menu_item {"-"};
    menu_item file_save_menu_item {texts::save(), event_handler {*this, &form1::on_menu_click}, menu_images::file_save()};
    ...
    menu_item file_print_menu_item {texts::print(), event_handler {*this, &form1::on_menu_click}, menu_images::file_print()};
    ...
    menu_item file_exit_menu_item {texts::exit(), event_handler {*this, &form1::on_menu_click}, menu_images::file_exit()};
    
    menu_item edit_undo_menu_item {texts::undo(), event_handler {*this, &form1::on_menu_click}, menu_images::edit_undo()};
    menu_item edit_redo_menu_item {texts::redo(), event_handler {*this, &form1::on_menu_click}, menu_images::edit_redo()};
    menu_item edit_separator1_menu_item {"-"};
    menu_item edit_cut_menu_item {texts::cut(), event_handler {*this, &form1::on_menu_click}, menu_images::edit_cut()};
    menu_item edit_copy_menu_item {texts::copy(), event_handler {*this, &form1::on_menu_click}, menu_images::edit_copy()};
    menu_item edit_paste_menu_item {texts::paste(), event_handler {*this, &form1::on_menu_click}, menu_images::edit_paste()};
    menu_item edit_separator2_menu_item {"-"};
    menu_item edit_select_all_menu_item {texts::select_all(), event_handler {*this, &form1::on_menu_click}};
    ...
    menu_item options_value_a_menu_item {"Value A", event_handler {*this, &form1::on_menu_click}, menu_item_kind::check, true};
    menu_item options_value_b_menu_item {"Value B", event_handler {*this, &form1::on_menu_click}, menu_item_kind::check};
    menu_item options_value_c_menu_item {"Value C", event_handler {*this, &form1::on_menu_click}, menu_item_kind::check, true};
    menu_item options_separator1_menu_item {"-"};
    menu_item options_value_d_menu_item {"Value D", event_handler {*this, &form1::on_menu_click}, menu_item_kind::radio};
    menu_item options_value_e_menu_item {"Value E", event_handler {*this, &form1::on_menu_click}, menu_item_kind::radio, true};
    menu_item options_value_f_menu_item {"Value F", event_handler {*this, &form1::on_menu_click}, menu_item_kind::radio};
    menu_item options_separator2_menu_item {"-"};
    menu_item options_value_g_menu_item {"Value G", event_handler {*this, &form1::on_menu_click}, menu_item_kind::radio};
