  ...
  public:
    form1() {
      ...
      toggle_button1.click += [&] {
        ...
        toggle_button1.text(format("{}", toggle_button1.check_state()));
      };
      ...
      toggle_button2.check_state_changed += [&] {
        toggle_button2.text(format("{}", toggle_button2.check_state()));
      };
      ...
      toggle_button3.check_state_changed += [&] {
        toggle_button3.text(format("{}", toggle_button3.check_state()));
      };
