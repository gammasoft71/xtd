...
namespace picture_box::properties {
  ...
  public:
    ...
    static const xtd::drawing::bitmap& logo() {
      static auto bitmap = xtd::drawing::bitmap {xtd::io::path::combine(xtd::environment::get_folder_path(xtd::environment::special_folder::application_resources), "logo.png")};
      return bitmap;
    }
