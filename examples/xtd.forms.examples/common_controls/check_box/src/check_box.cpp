  ...
  public:
    form1() {
      ...
      check_box1.click += [&] {
        ...
        check_box1.text(format("{}", check_box1.check_state()));
      };
      check_box1.location({30, 30});
      check_box1.text(format("{}", check_box1.check_state()));

      check_box2.check_state_changed += [&] {
        check_box2.text(format("{}", check_box2.check_state()));
      };
      ...
      check_box3.check_state_changed += [&] {
        check_box3.text(format("{}", check_box3.check_state()));
      };
      ...
      check_box4.check_state_changed += [&] {
        check_box4.text(format("{}", check_box4.check_state()));
      };
      ...
      check_box5.click += [&] {
        ...
        check_box5.text(format("{}", check_box5.check_state()));
      };
