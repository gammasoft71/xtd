...
public:
  form1() {
    ...
    button_try_it.click += [&] {
      ...
      label_dialog_result.text(format("result = {}", message_box::show(*this, text_message.text(), text_caption.text(), any_cast<message_box_buttons>(choice_buttons.selected_item().tag()), any_cast<message_box_icon>(choice_icons.selected_item().tag()))));
    };
