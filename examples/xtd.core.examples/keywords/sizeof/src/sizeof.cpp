...
auto main()->int {
  ...
  console::write_line("│ xtd::usize               = {,2} │ xtd::usize_object        = {,2} │ n/a                                                     │ size_t             = {,2} │", sizeof_<xtd::usize>(), sizeof_<xtd::usize_object>(), sizeof_<size_t>());
...
// │ xtd::usize               =  8 │ xtd::usize_object        = 40 │ n/a                                                     │ size_t             =  8 │
