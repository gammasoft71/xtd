...
auto main() -> int {
  ...
  println("arg1_1 result => {}", arg1_1(10));
  ...
  println("arg1_2 result => {}", arg1_2(10));
  ...
  println("arg1_3 result => {}", arg1_3(10));
  ...
  println("expr2 result => {}", expr2(10, 20, 30));
  auto expr3 = _ + _2 + _3;  // The _ is an alias on xtd::expressions::expression::arg<1>.
  println("expr3 result => {}", expr3(10, 20, 30));

  println();
  auto expr4 = _1 + arg<2> + expression::arg<3>;
  println("expr4 result => {}", expr4(10, 20, 30));
}
