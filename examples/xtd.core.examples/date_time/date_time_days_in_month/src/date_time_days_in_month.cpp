...
public:
  static auto main() {
    ...
    unsigned int days_in_feb = xtd::date_time::days_in_month(1998, xtd::month_of_year::february);
    xtd::console::write_line(days_in_feb);
    
    // days_in_feb_leap gets 29 because the year 1996 was a leap year.
    unsigned int days_in_feb_leap = xtd::date_time::days_in_month(1996, xtd::month_of_year::february);
