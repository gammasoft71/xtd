...
auto main() -> int {
  auto numbers = array {10, 6, 5, 7, 8, 2, 9, 3, 1, 4};
  numbers.sort();
  println("numbers = {}", numbers);
  
  auto fruits = array<string> {"Orange", "Apple", "Banana", "Strawberry", "Watermelon", "Pear", "Coconut", "Kiwi", "Plum", "Grapes"};
  fruits.sort();
  println("fruits = {}", fruits);
  
  auto superheroes = array<superhero> {
  ...
  auto supervillains = array<supervillain> {
