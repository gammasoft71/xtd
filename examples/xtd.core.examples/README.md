...
* [format_sequence_containers](format/format_asequence_containers/README.md) shows how to use [xtd::format](../../src/xtd.core/include/xtd/format.h) method with sequence containers (std::initilizer_list, std::array, sttd::forward_list, std::list, std::deque and std::vector).
