...
* [format_charecter](format/format_charecter/README.md) shows how to use [xtd::format](../../src/xtd.core/include/xtd/format.h) method with characters (char, wchar_t, char8_t, char16_t and char32_t).
