...
* [using_xtd_tunit_assert_without_tunit_app](using_xtd_tunit_assert_without_tunit_app/README.md) shows how to use xtd.tunit assert methods like [xtd::tunit::assert](https://gammasoft71.github.io/xtd/reference_guides/latest/classxtd_1_1tunit_1_1assert) in a xtd.console or xtd.forms application.
