...
public:
  form1() {
    ...
    split_container_left.location({10, 10});
    split_container_left.dock(dock_style::fill);
    split_container_left.panel1().back_color(drawing::color::light_blue);
    split_container_left.splitter_distance(70);
    
    split_container_right.dock(dock_style::fill);
    split_container_right.location({10, 10});
    split_container_right.panel2().back_color(drawing::color::light_yellow);
    ...
    split_container_center.location({10, 10});
    split_container_center.panel1().back_color(drawing::color::pink);
    split_container_center.panel2().back_color(drawing::color::light_green);
