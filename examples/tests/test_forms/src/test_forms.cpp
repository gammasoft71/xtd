...
int main() {
  ...
  list_box_items.items().push_back_range({"Item 1", "Item2", "Item3"});
  ...
  list_box_disabled.items().push_back_range({"Item 1", "Item2", "Item3"});
  ...
  checked_list_box_items.items().push_back_range({{"Item 1", true}, {"Item2", true}, {"Item3", false}});
  ...
  checked_list_box_disabled.items().push_back_range({{"Item 1", true}, {"Item2", true}, {"Item3", false}});
  ...
  combo_box_drop_down.items().push_back_range({"Item 1", "Item2", "Item3"});
  ...
  combo_box_drop_down_list.items().push_back_range({"Item 1", "Item2", "Item3"});
  ...
  combo_box_simple.items().push_back_range({"Item 1", "Item2", "Item3"});
  ...
  label_font.text(L"The quick brown fox jumps over the lazy dog.\n"
