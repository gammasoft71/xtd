    ...
    namespace native {
      ...
      public:
        wx_track_bar(const forms::create_params& create_params) {
          ...
          this->control_handler::create<wxSlider>(reinterpret_cast<control_handler*>(create_params.parent())->control(), wxID_ANY, 0, 0, 10, wxPoint(create_params.x(), create_params.y()), wxSize(create_params.width(), create_params.height()), track_bar_to_wx_style(create_params.style(), create_params.ex_style()));
        }
