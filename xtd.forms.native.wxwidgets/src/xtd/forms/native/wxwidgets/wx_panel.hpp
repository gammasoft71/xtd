    ...
    namespace native {
      ...
      public:
        wx_panel(const forms::create_params& create_params) {
          ...
          this->control_handler::create<wxPanel>(reinterpret_cast<control_handler*>(create_params.parent())->control(), wxID_ANY, wxPoint(create_params.x(), create_params.y()), wxSize(create_params.width(), create_params.height()), panel_to_wx_style(create_params.style(), create_params.ex_style()));
