...
int main() {
  ...
  cout << strings::format("color = {}", color::light(color::light(color::from_argb(128, 128, 128)))) << endl;
  cout << strings::format("color = {}", color::light(color::from_argb(128, 128, 128))) << endl;
  cout << strings::format("color = {}", color::from_argb(128, 128, 128)) << endl;
  cout << strings::format("color = {}", color::dark(color::from_argb(128, 128, 128))) << endl;
  cout << strings::format("color = {}", color::dark(color::dark(color::from_argb(128, 128, 128)))) << endl;
