...
namespace xtd::forms::style_sheets::tests {
  class test_class_(style_sheet_tests) {
    void test_method_(style_sheets) {
      ...
      assert::are_not_equal(styles.end(), styles.find("KDE (dark)"));
      assert::are_not_equal(styles.end(), styles.find("KDE (light)"));
      assert::are_not_equal(styles.end(), styles.find("macOS (light)"));
      assert::are_not_equal(styles.end(), styles.find("macOS (dark)"));
      assert::are_not_equal(styles.end(), styles.find("Symbolic (light)"));
    ...
    void test_method_(color_from_css_with_hash_and_nine_and_more_hex) {
      ...
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "#1234567890", color::empty));
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "#12345678901", color::empty));
    ...
    void test_method_(color_from_css_with_bad_rgb_color) {
      ...
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "rgb(42, 84)", color::empty));
    ...
    void test_method_(color_from_css_with_bad_rgba_color) {
      ...
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "rgba(42, 84, 0.5)", color::empty));
    ...
    void test_method_(color_from_css_with_bad_hsv_color) {
      ...
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "hsv(204, 62)", color::empty));
    ...
    void test_method_(color_from_css_with_bad_hsva_color) {
      ...
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "hsva(204, 62, 0.5)", color::empty));
    ...
    void test_method_(color_from_css_with_bad_hsl_color) {
      ...
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "hsl(204, 62)", color::empty));
    ...
    void test_method_(color_from_css_with_bad_hsla_color) {
      ...
      assert::are_equal(color::empty, __test_style_sheet__::color_from_css(style, "hsla(204, 62, 0.5)", color::empty));
    ...
    void test_method_(uri_from_css) {
      auto styles = style_sheet::style_sheets();
      auto style = styles.find("macOS (dark)")->second;
      assert::are_equal("https://gammasoft71.github.io/xtd", __test_style_sheet__::uri_from_css(style, "url(https://gammasoft71.github.io/xtd)", uri("https://gammasoft71.wixsite.com/gammasoft")).to_string());
    }
    
    void test_method_(uri_from_css_with_bad_format) {
      auto styles = style_sheet::style_sheets();
      auto style = styles.find("macOS (dark)")->second;
      assert::are_equal("https://gammasoft71.wixsite.com/gammasoft", __test_style_sheet__::string_from_css(style, "https://gammasoft71.github.io/xtd", "https://gammasoft71.wixsite.com/gammasoft"));
    }
