...
namespace unit_tests {
  ...
  public:
    ...
    void test_method_(system_colors) {
      ...
      assert::are_equal(color::from_argb(215, 0, 0, 0), style.system_colors().active_caption_text(), csf_);
      ...
      assert::are_equal(color::from_argb(215, 0, 0, 0), style.system_colors().control_text(), csf_);
      ...
      assert::are_equal(color::from_argb(62, 0, 0, 0), style.system_colors().gray_text(), csf_);
      ...
      assert::are_equal(color::from_argb(215, 0, 0, 0), style.system_colors().inactive_caption_text(), csf_);
      assert::are_equal(color::from_argb(0xFFE7E7E7), style.system_colors().info(), csf_);
      assert::are_equal(color::from_argb(215, 0, 0, 0), style.system_colors().info_text(), csf_);
      ...
      assert::are_equal(color::from_argb(215, 0, 0, 0), style.system_colors().menu_text(), csf_);
      ...
      assert::are_equal(color::from_argb(215, 0, 0, 0), style.system_colors().window_text(), csf_);
    }
  };
}
