...
namespace xtd::forms::tests {
  class test_class_(form_tests) {
    ...
    auto test_method_(form_handle_destroyed) {
    ...
    auto test_method_(new_form_back_color) {
      form_for_test form;
      assert::are_equal(form.default_back_color(), form.back_color());
    }
    
    auto test_method_(new_form_client_size) {
      form_for_test form;
