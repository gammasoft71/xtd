...
namespace xtd::forms::tests {
  ...
  public:
    ...
    auto test_method_(title_background) {
    ...
    auto test_method_(next_month_button) {
    ...
    auto test_method_(prev_month_button) {
    ...
    auto test_method_(calendar_background) {
    ...
    auto test_method_(next_month_date) {
    ...
    auto test_method_(prev_month_date) {
    ...
    auto test_method_(week_numbers) {
