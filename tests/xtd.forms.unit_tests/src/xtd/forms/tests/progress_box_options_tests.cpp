...
namespace xtd::forms::tests {
  ...
  public:
    ...
    auto test_method_(show_cancel_button) {
    ...
    auto test_method_(show_skip_button) {
    ...
    auto test_method_(show_elapsed_time) {
    ...
    auto test_method_(show_estimated_time) {
    ...
    auto test_method_(show_remaining_time) {
