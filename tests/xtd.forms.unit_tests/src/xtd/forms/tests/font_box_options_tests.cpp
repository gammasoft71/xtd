...
namespace xtd::forms::tests {
  ...
  public:
    ...
    auto test_method_(allow_simulations) {
    ...
    auto test_method_(allow_vector_fonts) {
    ...
    auto test_method_(allow_vertical_fonts) {
    ...
    auto test_method_(allow_script_change) {
    ...
    auto test_method_(fixed_pitch_only) {
    ...
    auto test_method_(scripts_only) {
    ...
    auto test_method_(show_effects) {
