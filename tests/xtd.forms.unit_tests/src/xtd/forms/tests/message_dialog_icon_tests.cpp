...
namespace xtd::forms::tests {
  ...
  public:
    ...
    void test_method_(error) {
      ...
      assert::are_equal("error", enum_object<>::to_string(message_dialog_icon::error), csf_);
      assert::are_equal(message_dialog_icon::error, enum_object<>::parse<message_dialog_icon>("error"), csf_);
    }
    ...
    void test_method_(warning) {
      ...
      assert::are_equal("warning", enum_object<>::to_string(message_dialog_icon::warning), csf_);
      assert::are_equal(message_dialog_icon::warning, enum_object<>::parse<message_dialog_icon>("warning"), csf_);
    }
    
    void test_method_(information) {
      assert::are_equal(64, enum_object<>::to_int32(message_dialog_icon::information), csf_);
      assert::are_equal("information", enum_object<>::to_string(message_dialog_icon::information), csf_);
      assert::are_equal(message_dialog_icon::information, enum_object<>::parse<message_dialog_icon>("information"), csf_);
    }

    void test_method_(hand) {
      assert::are_equal(16, enum_object<>::to_int32(message_dialog_icon::hand), csf_);
      assert::are_equal("error", enum_object<>::to_string(message_dialog_icon::hand), csf_);
      assert::are_equal(message_dialog_icon::hand, enum_object<>::parse<message_dialog_icon>("error"), csf_);
    }
    
    void test_method_(stop) {
      assert::are_equal(16, enum_object<>::to_int32(message_dialog_icon::stop), csf_);
      assert::are_equal("error", enum_object<>::to_string(message_dialog_icon::stop), csf_);
      assert::are_equal(message_dialog_icon::stop, enum_object<>::parse<message_dialog_icon>("error"), csf_);
    }
    
    void test_method_(exclamation) {
      assert::are_equal(48, enum_object<>::to_int32(message_dialog_icon::exclamation), csf_);
      assert::are_equal("warning", enum_object<>::to_string(message_dialog_icon::exclamation), csf_);
      assert::are_equal(message_dialog_icon::exclamation, enum_object<>::parse<message_dialog_icon>("warning"), csf_);
    }
    
    void test_method_(asterisk) {
      assert::are_equal(64, enum_object<>::to_int32(message_dialog_icon::asterisk), csf_);
      assert::are_equal("information", enum_object<>::to_string(message_dialog_icon::asterisk), csf_);
      assert::are_equal(message_dialog_icon::asterisk, enum_object<>::parse<message_dialog_icon>("information"), csf_);
    }
  };
}
