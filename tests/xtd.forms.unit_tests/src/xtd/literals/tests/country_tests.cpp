  ...
  inline namespace literals {
    namespace tests {
      class test_class_(country_tests) {
        void test_method_(_country_operator_on_char_ptr_from_name) {
        ...
        void test_method_(_country_operator_on_char32_ptr_from_name) {
          auto v = U"Belgium"_country;
          assert::is_instance_of<country>(v);
          assert::are_equal("country [name=Belgium, alpha_2_code=BE, alpha_3_code=BEL, numeric_code=56]", v.to_string());
        }
        
        void test_method_(_country_operator_on_wchar_ptr_from_name) {
        ...
        void test_method_(_country_operator_on_char32_ptr_from_alpha_2_code) {
          auto v = U"BE"_country;
          assert::is_instance_of<country>(v);
          assert::are_equal("country [name=Belgium, alpha_2_code=BE, alpha_3_code=BEL, numeric_code=56]", v.to_string());
        }
        
        void test_method_(_country_operator_on_wchar_ptr_from_alpha_2_code) {
        ...
        void test_method_(_country_operator_on_char32_ptr_from_alpha_3_code) {
          auto v = U"BEL"_country;
          assert::is_instance_of<country>(v);
          assert::are_equal("country [name=Belgium, alpha_2_code=BE, alpha_3_code=BEL, numeric_code=56]", v.to_string());
        }
        
        void test_method_(_country_operator_on_wchar_ptr_from_alpha_3_code) {
