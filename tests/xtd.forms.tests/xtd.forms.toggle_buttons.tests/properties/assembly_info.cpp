...
assembly_title_("xtd.forms.toggle_buttons.tests");
assembly_description_("xtd.forms.toggle_buttons.tests contains xtd::forms::toggle_button manual tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.forms.toggle_buttons.tests");
...
assembly_guid_("ac932322-cc59-4932-87e8-f74582e0fe27");
