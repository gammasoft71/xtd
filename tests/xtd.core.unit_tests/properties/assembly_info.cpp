...
assembly_title_("xtd.core.unit_tests");
assembly_description_("xtd.core.unit_tests contains xtd.core unit tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.core.unit_tests");
...
assembly_guid_("1965d1b0-680e-4ab6-87ad-96aeae4c7224");
