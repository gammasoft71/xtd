...
namespace unit_tests {
  ...
  public:
    void test_method_(default_creator) {
      ...
      assert::are_equal_("Exceed implementation defined length limits.", e.message());
      assert::are_equal_("xtd::length_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::length_exception : Exceed implementation defined length limits.", e.to_string());
      assert::are_equal_("Exceed implementation defined length limits.", e.what());
    }
    ...
    void test_method_(default_creator_with_current_stack_frame) {
      ...
      assert::are_equal_("xtd::length_exception : Exceed implementation defined length limits.\n" + info.to_string(), e.to_string());
      assert::are_equal_("Exceed implementation defined length limits.", e.what());
    }
    ...
    void test_method_(creator_with_empty_message) {
      ...
      assert::are_equal_("xtd::length_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::length_exception", e.to_string());
      assert::are_equal_("xtd::length_exception", e.what());
    }
    ...
    void test_method_(creator_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal_("xtd::length_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::length_exception\n" + info.to_string(), e.to_string());
      assert::are_equal_("xtd::length_exception", e.what());
    }
    ...
    void test_method_(creator_with_message) {
      ...
      assert::are_equal_("xtd::length_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::length_exception : Test excpetion message.", e.to_string());
    ...
    void test_method_(creator_with_message_and_stack_frame) {
      ...
      assert::are_equal_("xtd::length_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::length_exception : Test excpetion message.\n" + info.to_string(), e.to_string());
      assert::are_equal_("Test excpetion message.", e.what());
    }
