...
namespace unit_tests {
  ...
  public:
    ...
    void test_method_(append_all_lines) {
      assert::does_not_throw([] {file::append_all_lines(test_file_name, {"Line 1"});}, line_info_);
      assert::does_not_throw([] {file::append_all_lines(test_file_name, {"Line 2", "Line 3"});}, line_info_);
    ...
    void test_method_(append_all_text) {
      assert::does_not_throw([] {file::append_all_text(test_file_name, "This is a text ");}, line_info_);
      assert::does_not_throw([] {file::append_all_text(test_file_name, "to append");}, line_info_);
      
      ifstream file(test_file_name);
      string contents {istreambuf_iterator<char> {file}, istreambuf_iterator<char> {}};
      assert::are_equal("This is a text to append", contents, line_info_);
    }
    ...
    void test_method_(copy) {
      ...
      assert::does_not_throw([] {file::copy(test_file_name, "file2.txt");}, line_info_);
      
      assert::is_true(ifstream(test_file_name).good(), line_info_);
      ifstream file("file2.txt");
      string contents {istreambuf_iterator<char> {file}, istreambuf_iterator<char> {}};
      assert::are_equal("Text", contents, line_info_);
      ::remove("file2.txt");
    }
    ...
    void test_method_(copy_with_override) {
      ...
      existing_file.close();
      assert::does_not_throw([] {file::append_all_text(test_file_name, "Text");}, line_info_);
      assert::does_not_throw([] {file::copy(test_file_name, "file2.txt", true);}, line_info_);
    ...
    void test_method_(copy_with_override_false) {
      ...
      existing_file.close();
      assert::does_not_throw([] {file::append_all_text(test_file_name, "Text");}, line_info_);
      assert::throws<argument_exception>([] {file::copy(test_file_name, "file2.txt", false);}, line_info_);
      
      assert::is_true(ifstream(test_file_name).good(), line_info_);
      ifstream file("file2.txt");
      string contents {istreambuf_iterator<char> {file}, istreambuf_iterator<char> {}};
      assert::are_equal("Existing", contents, line_info_);
      file.close();
      ::remove("file2.txt");
    }
    ...
    void test_method_(create) {
      ...
      assert::is_true(file.good(), line_info_);
      file.seekp(0, ios::end);
      assert::are_equal(0, file.tellp(), line_info_);
    }
    ...
    void test_method_(exists) {
      assert::is_false(file::exists(test_file_name), line_info_);
      ofstream file(test_file_name);
      file.close();
      assert::is_true(file::exists(test_file_name), line_info_);
    }
    
    void test_method_(get_attributes_directory) {
      assert::is_true((file::get_attributes(".") & file_attributes::directory) == file_attributes::directory, line_info_);
    }
    
    void test_method_(get_attributes_normal) {
      ofstream file(test_file_name);
      file.close();
      assert::is_true((file::get_attributes(test_file_name) & file_attributes::normal) == file_attributes::normal || (file::get_attributes(test_file_name) & file_attributes::archive) == file_attributes::archive, line_info_);
    }
    ...
    void test_method_(open_mode_out_with_existing_file) {
      ...
      assert::is_true(file.good(), line_info_);
      string contents {istreambuf_iterator<char> {file}, istreambuf_iterator<char> {}};
      assert::is_empty(contents, line_info_);
    }
    ...
    void test_method_(read_all_bytes) {
      ...
      assert::are_equal(4U, bytes.size(), line_info_);
      assert::are_equal(0x42, bytes[0], line_info_);
      assert::are_equal(0x24, bytes[1], line_info_);
      assert::are_equal(0x12, bytes[2], line_info_);
      assert::are_equal(0x84, bytes[3], line_info_);
    }
    ...
    void test_method_(read_all_lines) {
      ...
      assert::are_equal(3U, lines.size(), line_info_);
      assert::are_equal("Line 1", lines[0], line_info_);
      assert::are_equal("Line 2", lines[1], line_info_);
      assert::are_equal("Line 3", lines[2], line_info_);
    }
    ...
    void test_method_(read_all_text) {
      ...
      assert::are_equal("This is a \nmultiline text", text, line_info_);
    }
    ...
    void test_method_(replace) {
      ...
      assert::does_not_throw([&] {file::replace(file_name1, file_name2, file_name3);}, line_info_);
      
      assert::is_false(ifstream(file_name1).good(), line_info_);
      assert::is_true(ifstream(file_name2).good(), line_info_);
      assert::is_true(ifstream(file_name3).good(), line_info_);
      ifstream file2(file_name2);
      string contents {istreambuf_iterator<char> {file2}, istreambuf_iterator<char> {}};
      assert::are_equal("Text1", contents, line_info_);
      ifstream file3(file_name3);
      contents = {istreambuf_iterator<char> {file3}, istreambuf_iterator<char> {}};
      assert::are_equal("Text2", contents, line_info_);
    ...
    void test_method_(replace_without_source) {
      ...
      existing_file2.close();
      auto file_name3 = "file2.bak";
      assert::throws<file_not_found_exception>([&] {file::replace(file_name1, file_name2, file_name3);}, line_info_);
      
      assert::is_false(ifstream(file_name1).good(), line_info_);
      assert::is_true(ifstream(file_name2).good(), line_info_);
      assert::is_false(ifstream(file_name3).good(), line_info_);
      ifstream file2(file_name2);
      string contents {istreambuf_iterator<char> {file2}, istreambuf_iterator<char> {}};
      assert::are_equal("Text2", contents, line_info_);
    ...
    void test_method_(replace_without_destination) {
      ...
      assert::is_true(ifstream(file_name1).good(), line_info_);
      assert::is_false(ifstream(file_name2).good(), line_info_);
      assert::is_false(ifstream(file_name3).good(), line_info_);
    ...
    void test_method_(write_all_text) {
      ...
      ifstream file(test_file_name);
      string contents {istreambuf_iterator<char> {file}, istreambuf_iterator<char> {}};
      assert::are_equal("to write", contents, line_info_);
    }
  };
}
