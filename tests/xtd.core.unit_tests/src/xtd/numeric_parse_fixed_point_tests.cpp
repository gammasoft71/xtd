...
namespace unit_tests {
  ...
  test_class_attribute<numeric_parse_string_fixed_point_tests<unsigned char>> numeric_parse_string_fixed_point_tests_class_unsigned_char_attr {"numeric_parse_string_fixed_point_tests<unsigned char>"};
  ...
  test_class_attribute<numeric_parse_string_fixed_point_tests<unsigned short>> numeric_parse_string_fixed_point_tests_class_unsigned_short_attr {"numeric_parse_string_fixed_point_tests<unsigned short>"};
  ...
  test_class_attribute<numeric_parse_string_fixed_point_tests<unsigned int>> numeric_parse_string_fixed_point_tests_class_unsigned_int_attr {"numeric_parse_string_fixed_point_tests<unsigned int>"};
  ...
  test_class_attribute<numeric_parse_string_fixed_point_tests<unsigned long>> numeric_parse_string_fixed_point_tests_class_unsigned_long_attr {"numeric_parse_string_fixed_point_tests<unsigned long>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<long long>> numeric_parse_string_fixed_point_tests_class_long_long_attr {"numeric_parse_string_fixed_point_tests<long long>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<unsigned long long>> numeric_parse_string_fixed_point_tests_class_unsigned_long_long_attr {"numeric_parse_string_fixed_point_tests<unsigned long long>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<int8_t>> numeric_parse_string_fixed_point_tests_class_int8_t_attr {"numeric_parse_string_fixed_point_tests<int8_t>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<int16_t>> numeric_parse_string_fixed_point_tests_class_int16_t_attr {"numeric_parse_string_fixed_point_tests<int16_t>"};
  ...
  test_class_attribute<numeric_parse_string_fixed_point_tests<uint8_t>> numeric_parse_string_fixed_point_tests_class_uint8_t_attr {"numeric_parse_string_fixed_point_tests<uint8_t>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<uint16_t>> numeric_parse_string_fixed_point_tests_class_uint16_t_attr {"numeric_parse_string_fixed_point_tests<uint16_t>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<uint32_t>> numeric_parse_string_fixed_point_tests_class_uint32_t_attr {"numeric_parse_string_fixed_point_tests<uint32_t>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<uint64_t>> numeric_parse_string_fixed_point_tests_class_uint64_t_attr {"numeric_parse_string_fixed_point_tests<uint64_t>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<uintptr_t>> numeric_parse_string_fixed_point_tests_class_uintptr_t_attr {"numeric_parse_string_fixed_point_tests<uintptr_t>"};
  ...
  public:
    ...
    void test_method_(parse_styles_fixed_point_with_two_leading_plus_sign) {
      assert::throws<format_exception>([] {xtd::parse<Value>("++42", number_styles::fixed_point);}, csf_);
    }
    ...
    void test_method_(parse_styles_fixed_point_with_decimal_point) {
      assert::are_equal(static_cast<Value>(42), xtd::parse<Value>("42.0", number_styles::fixed_point), csf_);
    }
    
    void test_method_(parse_styles_fixed_point_with_two_decimal_point) {
      assert::throws<format_exception>([] {xtd::parse<Value>("4.2.0", number_styles::fixed_point);}, csf_);
    }
    ...
    void test_method_(parse_styles_fixed_point_with_thousands) {
      if (!std::is_same<Value, int8_t>::value && !std::is_same<Value, char>::value && !std::is_same<Value, unsigned char>::value)
        assert::throws<format_exception>([] {xtd::parse<Value>("1,234", number_styles::fixed_point);}, csf_);
    }
    ...
    void test_method_(parse_styles_fixed_point_with_exponent) {
      assert::are_equal(static_cast<Value>(40), xtd::parse<Value>("4E+01", number_styles::fixed_point), csf_);
    }
    ...
    void test_method_(parse_styles_fixed_point_with_binary_specifier) {
      assert::throws<format_exception>([] {xtd::parse<Value>("0b101010", number_styles::fixed_point);}, csf_);
    }
    
    void test_method_(parse_styles_fixed_point_with_octal_specifier) {
      assert::are_equal(static_cast<Value>(52), xtd::parse<Value>("052", number_styles::fixed_point), csf_);
    }
    
    void test_method_(parse_styles_fixed_point_with_hexa_specifier) {
      assert::throws<format_exception>([] {xtd::parse<Value>("0x2A", number_styles::fixed_point);}, csf_);
    }
    
    void test_method_(parse_styles_fixed_point_invalid) {
      assert::throws<format_exception>([] {xtd::parse<Value>("z42", number_styles::fixed_point);}, csf_);
    }
  };
}
