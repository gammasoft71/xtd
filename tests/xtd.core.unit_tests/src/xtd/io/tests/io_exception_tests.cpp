...
namespace xtd::io::tests {
  class test_class_(io_exception_tests) {
    ...
    auto test_method_(default_constructor) {
      ...
      assert::are_equal(h_result::COR_E_IO, e.h_result());
      ...
      assert::are_equal("I/O error occurred.", e.message());
      ...
      string_assert::starts_with("xtd::io::io_exception : I/O error occurred.", e.to_string());
    ...
    auto test_method_(constructor_with_empty_message) {
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number());
      assert::is_not_empty(e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::io::io_exception", e.to_string());
      assert::are_equal("xtd::io::io_exception", e.what());
    }
    ...
    auto test_method_(constructor_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      assert::are_equal("xtd::io::io_exception" + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("xtd::io::io_exception", e.what());
    }
    ...
    auto test_method_(constructor_with_message) {
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number());
      assert::is_not_empty(e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::io::io_exception : Test excpetion message.", e.to_string());
    ...
    auto test_method_(constructor_with_message_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      assert::are_equal("xtd::io::io_exception : Test excpetion message." + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("Test excpetion message.", e.what());
    }
