...
namespace xtd::io::tests {
  class test_class_(io_exception_tests) {
    ...
    static void test_initialize_(test_initialize) {
      ...
      stack_trace_enabled = io_exception::enable_stack_trace();
      io_exception::enable_stack_trace(false);
    }
    
    static void test_cleanup_(test_cleanup) {
      std::locale::global(previous_locale);
      io_exception::enable_stack_trace(stack_trace_enabled);
    }
    
    void test_method_(default_constructor) {
      auto e = io_exception {};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      ...
      string_assert::starts_with("xtd::io::io_exception : I/O error occurred.", e.to_string(), csf_);
    ...
    void test_method_(default_constructor_with_stack_frame) {
      ...
      auto e = io_exception {stack_frame};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
      ...
      assert::are_equal("xtd::io::io_exception : I/O error occurred." + environment::new_line() + stack_frame.to_string(), e.to_string(), csf_);
      assert::are_equal("I/O error occurred.", e.what(), csf_);
    }
    
    void test_method_(constructor_with_nullopt_message) {
      auto e = io_exception {nullopt};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
    ...
    void test_method_(constructor_with_nullopt_message_and_stack_frame) {
      auto stack_frame = current_stack_frame_;
      auto e = io_exception {nullopt, stack_frame};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
    ...
    void test_method_(constructor_with_empty_message) {
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::is_not_empty(e.get_last_stack_frame().get_method(), csf_);
      string_assert::starts_with("xtd::io::io_exception", e.to_string(), csf_);
    ...
    void test_method_(constructor_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method(), csf_);
      assert::are_equal("xtd::io::io_exception" + environment::new_line() + stack_frame.to_string(), e.to_string(), csf_);
      assert::are_equal("xtd::io::io_exception", e.what(), csf_);
    }
    
    void test_method_(constructor_with_message) {
      auto e = io_exception {"Test excpetion message."};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::is_not_empty(e.get_last_stack_frame().get_method(), csf_);
      string_assert::starts_with("xtd::io::io_exception : Test excpetion message.", e.to_string(), csf_);
      assert::are_equal("Test excpetion message.", e.what(), csf_);
    }
    
    void test_method_(constructor_with_message_and_stack_frame) {
      auto stack_frame = current_stack_frame_;
      auto e = io_exception {"Test excpetion message.", stack_frame};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method(), csf_);
      assert::are_equal("xtd::io::io_exception : Test excpetion message." + environment::new_line() + stack_frame.to_string(), e.to_string(), csf_);
      assert::are_equal("Test excpetion message.", e.what(), csf_);
    }
    
    void test_method_(constructor_with_nullopt_message_and_inner_exception) {
      auto inner_exception = argument_exception {};
      auto e = io_exception {nullopt, inner_exception};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
    ...
    void test_method_(constructor_with_nullopt_message_and_stack_frame_inner_exception) {
      auto inner_exception = argument_exception {};
      auto stack_frame = current_stack_frame_;
      auto e = io_exception {nullopt, inner_exception, stack_frame};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
    ...
    void test_method_(constructor_with_message_inner_exception_and_stack_frame) {
      auto inner_exception = argument_exception {};
      auto stack_frame = current_stack_frame_;
      auto e = io_exception {"Test excpetion message.", inner_exception, stack_frame};
      assert::are_equal("xtd::io::io_exception", e.get_type().full_name(), csf_);
      assert::is_empty(e.help_link(), csf_);
      assert::are_equal(h_result::COR_E_IO, e.h_result(), csf_);
      assert::are_equal(h_result::h_result_category(), e.error_code().category(), csf_);
