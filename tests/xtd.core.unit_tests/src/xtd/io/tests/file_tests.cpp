...
namespace xtd::io::tests {
  class test_class_(file_tests) {
    ...
    auto test_method_(open_mode_in_without_existing_file) {
      assert::throws<file_not_found_exception>([] {[[maybe_unused]] auto _ = file::open(test_file_name, std::ios::in);});
    }
    ...
    auto test_method_(open_read_without_existing_file) {
      assert::throws<file_not_found_exception>([] {[[maybe_unused]] auto _ = file::open_read(test_file_name);});
    }
    ...
    auto test_method_(open_text_without_existing_file) {
      assert::throws<file_not_found_exception>([] {[[maybe_unused]] auto _ = file::open_text(test_file_name);});
    }
    ...
    auto test_method_(read_all_bytes_with_unexisting_file) {
      assert::throws<file_not_found_exception>([] {[[maybe_unused]] auto _ = file::read_all_bytes(test_file_name);});
    }
    ...
    auto test_method_(read_all_lines_with_unexisting_file) {
      assert::throws<file_not_found_exception>([] {[[maybe_unused]] auto _ = file::read_all_lines(test_file_name);});
    }
    ...
    auto test_method_(read_all_text_with_unexisting_file) {
      assert::throws<file_not_found_exception>([] {[[maybe_unused]] auto _ = file::read_all_text(test_file_name);});
    }
