...
namespace xtd::io::tests {
  class test_class_(drive_not_found_exception_tests) {
    ...
    static void test_initialize_(test_initialize) {
      ...
      stack_trace_enabled = drive_not_found_exception::enable_stack_trace();
      drive_not_found_exception::enable_stack_trace(false);
    }
    ...
    void test_method_(default_constructor) {
      ...
      assert::are_equal(h_result::COR_E_DRIVENOTFOUND, e.h_result(), csf_);
      ...
      assert::are_equal("Could not find the drive. The drive might not be ready or might not be mapped.", e.message(), csf_);
      ...
      string_assert::starts_with("xtd::io::drive_not_found_exception : Could not find the drive. The drive might not be ready or might not be mapped.", e.to_string(), csf_);
    ...
    void test_method_(default_constructor_with_stack_frame) {
      ...
      assert::are_equal("xtd::io::drive_not_found_exception : Could not find the drive. The drive might not be ready or might not be mapped." + environment::new_line() + stack_frame.to_string(), e.to_string(), csf_);
      assert::are_equal("Could not find the drive. The drive might not be ready or might not be mapped.", e.what(), csf_);
    }
    ...
    void test_method_(constructor_with_empty_message) {
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::is_not_empty(e.get_last_stack_frame().get_method(), csf_);
      string_assert::starts_with("xtd::io::drive_not_found_exception", e.to_string(), csf_);
    ...
    void test_method_(constructor_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method(), csf_);
      assert::are_equal("xtd::io::drive_not_found_exception" + environment::new_line() + stack_frame.to_string(), e.to_string(), csf_);
      assert::are_equal("xtd::io::drive_not_found_exception", e.what(), csf_);
    }
    ...
    void test_method_(constructor_with_message) {
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::is_not_empty(e.get_last_stack_frame().get_method(), csf_);
      string_assert::starts_with("xtd::io::drive_not_found_exception : Test excpetion message.", e.to_string(), csf_);
    ...
    void test_method_(constructor_with_message_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number(), csf_);
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method(), csf_);
      assert::are_equal("xtd::io::drive_not_found_exception : Test excpetion message." + environment::new_line() + stack_frame.to_string(), e.to_string(), csf_);
      assert::are_equal("Test excpetion message.", e.what(), csf_);
    }
