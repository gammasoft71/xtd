...
namespace unit_tests {
  ...
  public:
    void test_method_(default_creator) {
      ...
      assert::are_equal("I/O error occured.", e.message(), csf_);
      assert::are_equal("xtd::io::io_exception", e.name(), csf_);
      assert::is_empty(e.stack_trace(), csf_);
      assert::are_equal("xtd::io::io_exception : I/O error occured.", e.to_string(), csf_);
      assert::are_equal("I/O error occured.", e.what(), csf_);
    }
    ...
    void test_method_(default_creator_with_current_stack_frame) {
      ...
      assert::are_equal("xtd::io::io_exception : I/O error occured.\n" + info.to_string(), e.to_string(), csf_);
      assert::are_equal("I/O error occured.", e.what(), csf_);
    }
