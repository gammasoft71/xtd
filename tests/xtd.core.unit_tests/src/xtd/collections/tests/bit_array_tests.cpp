...
namespace xtd::collections::tests {
  class test_class_(bit_array_tests) {
    ...
    auto test_method_(and_) {
      ...
      assert::throws<argument_exception>([&] {[[maybe_unused]] auto __ = bits.and_({true, false, true});});
      assert::throws<argument_exception>([&] {[[maybe_unused]] auto __ = bits.and_({true, false, true, false, true});});
    }
    ...
    auto test_method_(get) {
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto __ = bits.get(4);});
    ...
    auto test_method_(or_) {
      ...
      assert::throws<argument_exception>([&] {[[maybe_unused]] auto __ = bits.or_({true, false, true});});
      assert::throws<argument_exception>([&] {[[maybe_unused]] auto __ = bits.or_({true, false, true, false, true});});
    }
    ...
    auto test_method_(xor_) {
      ...
      assert::throws<argument_exception>([&] {[[maybe_unused]] auto __ = bits.xor_({true, false, true});});
      assert::throws<argument_exception>([&] {[[maybe_unused]] auto __ = bits.xor_({true, false, true, false, true});});
    }
