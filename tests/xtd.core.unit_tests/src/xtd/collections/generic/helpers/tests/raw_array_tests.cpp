...
namespace xtd::collections::generic::helpers::tests {
  class test_class_(raw_array_tests) {
    ...
    auto test_method_(const_back) {
      ...
      assert::throws<std::out_of_range>([] {[[maybe_unused]] auto __ = raw_array<int> {}.back();});
    }
    
    auto test_method_(const_back_with_bool) {
      assert::are_equal(true, raw_array {true, false, true}.back());
      assert::throws<std::out_of_range>([] {[[maybe_unused]] auto __ = raw_array<bool> {}.back();});
    }
    ...
    auto test_method_(back) {
      ...
      auto empty_items = raw_array<int> {};
    ...
    auto test_method_(back_with_bool) {
      ...
      auto empty_items = raw_array<bool> {};
    ...
    auto test_method_(front_const) {
      ...
      assert::throws<std::out_of_range>([&] {[[maybe_unused]] auto __ = raw_array<int> {}.front();});
    }
    
    auto test_method_(front_const_with_bool) {
      auto items = raw_array {true, false, true};
      assert::are_equal(true, items.front());
      assert::throws<std::out_of_range>([&] {[[maybe_unused]] auto __ = raw_array<bool> {}.front();});
    }
    ...
    auto test_method_(at) {
      ...
      assert::throws<std::out_of_range>([&] {[[maybe_unused]] auto __ = items.at(3);});
    ...
    auto test_method_(operator_index) {
      ...
      //assert::throws<std::out_of_range>([&] {[[maybe_unused]] auto __ = items[3];});
    ...
    auto test_method_(operator_base_type) {
      ...
      bt = items;
      assert::are_equal(typeof_<raw_array<int>::base_type>(), typeof_(bt));
    ...
    auto test_method_(operator_base_type_with_bool) {
      ...
      bt = items;
      assert::are_equal(typeof_<raw_array<bool>::base_type>(), typeof_(bt));
