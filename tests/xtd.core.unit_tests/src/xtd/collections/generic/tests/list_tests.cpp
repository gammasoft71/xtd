...
namespace xtd::collections::generic::tests {
  class test_class_(list_tests) {
    ...
    auto test_method_(value_type_bool) {
    ...
    auto test_method_(base_type_bool) {
    ...
    auto test_method_(constructor_with_list) {
    ...
    auto test_method_(constructor_with_move_list) {
      auto l = list {84, 42, 21};
    ...
    auto test_method_(items_some_operations) {
    ...
    auto test_method_(add_with_move) {
      auto items = list<int> {};
    ...
    auto test_method_(add_range_with_ienumerable) {
      auto items = list<int> {};
    ...
    auto test_method_(add_range_with_initializer_list) {
      auto items = list<int> {};
    ...
    auto test_method_(add_range_with_list) {
      auto items = list<int> {};
    ...
    auto test_method_(add_range_with_same_list) {
    ...
    auto test_method_(add_range_with_same_list_as_ienumerable) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(as_read_only) {
      auto items = list {84, 42, 21};
    ...
    auto test_method_(find_index_with_start_index) {
      auto items = list {84, 42, 21, 33};
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_index(5, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(find_index_with_start_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_index(3, 2, [](auto n) {return n % 2 != 0;});});
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_index(5, 1, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(find_last_index) {
      auto items = list {84, 42, 21, 33};
    ...
    auto test_method_(find_last_index_with_start_index) {
      auto items = list {84, 42, 21, 33};
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_last_index(4, [](auto n) {return n % 2 != 0;});});
      assert::are_equal(items.npos, items.find_last_index(3, [](auto n) {return n == 65;}));
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_last_index(5, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(find_last_index_with_start_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_last_index(0, 2, [](auto n) {return n % 2 != 0;});});
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_last_index(4, 0, [](auto n) {return n % 2 != 0;});});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_last_index(0, 4, [](auto n) {return n % 2 != 0;});});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.find_last_index(5, 1, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(range_based_for_loop) {
      auto items = list {1, 2, 3, 4, 5};
      auto accumulator = 0;
      for (auto item : items)
        accumulator += item;
    ...
    auto test_method_(modifying_list_during_iteration) {
      auto items = list {1, 2, 3, 4, 5};
      auto accumulator = 0;
      auto caught = false;
      try {
    ...
    auto test_method_(modifying_list_items_during_iteration) {
      auto items = list {1, 2, 3, 4, 5};
      auto accumulator = 0;
      auto caught = false;
      try {
    ...
    auto test_method_(get_range) {
      auto items = list {1, 2, 3, 4, 5};
      collection_assert::are_equal({1, 2, 3, 4, 5}, items.get_range(0, 5));
      collection_assert::are_equal({2, 3, 4}, items.get_range(1, 3));
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.get_range(0, 6);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.get_range(6, 0);});
    }
    ...
    auto test_method_(index_of_with_index) {
      auto items = list {1, 2, 3, 4, 5};
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.index_of(1, 6);});
    }
    ...
    auto test_method_(index_of_with_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.index_of(1, 1, 5);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.index_of(1, 5, 1);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.index_of(1, 0, 6);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.index_of(1, 6, 0);});
    }
    ...
    auto test_method_(insert_range_with_ienumerable) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(insert_range_with_list) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(insert_range_with_initializer_list) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(insert_range_with_same_list) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(insert_range_with_same_list_as_ienumerable) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(last_index_of) {
      assert::are_equal(list<int>::npos, list<int> {}.index_of(0));
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(last_index_of_with_index) {
      auto items = list {1, 2, 3, 4, 5};
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.last_index_of(1, 6);});
    }
    ...
    auto test_method_(last_index_of_with_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.last_index_of(1, 5, 1);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.last_index_of(1, 1, 5);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.last_index_of(1, 6, 0);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.last_index_of(1, 0, 6);});
    }
    ...
    auto test_method_(resize_with_value) {
      auto items = list {84, 42, 21};
      items.resize(4, -1);
    ...
    auto test_method_(remove_range) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(slice) {
      auto items = list {1, 2, 3, 4, 5};
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.slice(6, 0);});
      assert::throws<argument_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items.slice(0, 6);});
    ...
    auto test_method_(sort_with_icomparer) {
      auto items = list {1, 5, 3, 4, 2};
      collection_assert::are_equal({1, 2, 3, 4, 5}, items.sort(comparer<int>::default_comparer));
      collection_assert::are_equal({1, 2, 3, 4, 5}, items);
    }
    
    auto test_method_(sort_with_index_count_and_icomparer) {
      auto items = list {1, 5, 3, 4, 2};
    ...
    auto test_method_(true_for_all) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(equal_operator_with_list) {
      auto items = list {1, 2, 3, 4, 5};
    ...
    auto test_method_(equal_operator_with_move_list) {
      auto items = list {1, 2, 3, 4, 5};
      auto result = list<int> {};
      collection_assert::is_empty(result);
    ...
    auto test_method_(index_operators) {
      auto items = list {84, 42, 21};
      
      assert::are_equal(84, items[0]);
      assert::are_equal(42, items[1]);
      assert::are_equal(21, items[2]);
      assert::throws<index_out_of_range_exception>(delegate_ {[[maybe_unused]] auto __ = items[3];});
