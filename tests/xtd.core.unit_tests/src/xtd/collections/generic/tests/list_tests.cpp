...
namespace xtd::collections::generic::tests {
  class test_class_(list_tests) {
    ...
    auto test_method_(find_index_with_start_index) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_index(5, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(find_index_with_start_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_index(3, 2, [](auto n) {return n % 2 != 0;});});
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_index(5, 1, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(find_last_index_with_start_index) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_last_index(4, [](auto n) {return n % 2 != 0;});});
      assert::are_equal(items.npos, items.find_last_index(3, [](auto n) {return n == 65;}));
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_last_index(5, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(find_last_index_with_start_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_last_index(0, 2, [](auto n) {return n % 2 != 0;});});
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_last_index(4, 0, [](auto n) {return n % 2 != 0;});});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_last_index(0, 4, [](auto n) {return n % 2 != 0;});});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.find_last_index(5, 1, [](auto n) {return n % 2 != 0;});});
    }
    ...
    auto test_method_(get_range) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.get_range(0, 6);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.get_range(6, 0);});
    }
    ...
    auto test_method_(index_of_with_index) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.index_of(1, 6);});
    }
    ...
    auto test_method_(index_of_with_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.index_of(1, 1, 5);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.index_of(1, 5, 1);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.index_of(1, 0, 6);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.index_of(1, 6, 0);});
    }
    ...
    auto test_method_(last_index_of_with_index) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.last_index_of(1, 6);});
    }
    ...
    auto test_method_(last_index_of_with_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.last_index_of(1, 5, 1);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.last_index_of(1, 1, 5);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.last_index_of(1, 6, 0);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.last_index_of(1, 0, 6);});
    }
    ...
    auto test_method_(slice) {
      auto items = list {1, 2, 3, 4, 5};
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.slice(6, 0);});
      assert::throws<argument_out_of_range_exception>(delegate_ {auto __ = items.slice(0, 6);});
    ...
    auto test_method_(index_operators) {
      ...
      assert::throws<index_out_of_range_exception>(delegate_ {auto __ = items[3];});
