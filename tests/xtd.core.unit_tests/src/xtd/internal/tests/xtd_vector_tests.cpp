...
#include <xtd/internal/__xtd_vector.hpp>
...
namespace xtd::internal::tests {
  class test_class_(xtd_vector_tests) {
    void test_method_(value_type) {
      assert::are_equal(typeof_<int>(), typeof_<__xtd_vector__<int>::value_type>());
    }
    
    void test_method_(value_type_with_bool) {
      assert::are_equal(typeof_<bool>(), typeof_<__xtd_vector__<bool>::value_type>());
    }
    
    void test_method_(base_type) {
      assert::are_equal(typeof_<std::vector<int>>(), typeof_<__xtd_vector__<int>::base_type > ());
    }
    
    void test_method_(base_type_with_bool) {
      assert::are_equal(typeof_<std::vector<byte>>(), typeof_<__xtd_vector__<bool>::base_type > ());
    }
    
    void test_method_(size_type) {
      assert::are_equal(typeof_<xtd::size>(), typeof_<__xtd_vector__<int>::size_type>());
    }
    
    void test_method_(size_type_with_bool) {
      assert::are_equal(typeof_<__xtd_vector__<bool>::base_type::size_type>(), typeof_<__xtd_vector__<int>::size_type>());
    }
    
    void test_method_(difference_type) {
      assert::are_equal(typeof_<xtd::ptrdiff>(), typeof_<__xtd_vector__<int>::difference_type>());
    }
    
    void test_method_(difference_type_with_bool) {
      assert::are_equal(typeof_<__xtd_vector__<bool>::base_type::difference_type>(), typeof_<__xtd_vector__<int>::difference_type>());
    }
    
    void test_method_(reference) {
      assert::are_equal(typeof_<int&>(), typeof_<__xtd_vector__<int>::reference>());
    }
    ...
    void test_method_(pointer_with_bool) {
      assert::are_equal(typeof_<bool*>(), typeof_<__xtd_vector__<bool>::pointer>());
    }
    
    void test_method_(const_pointer) {
      assert::are_equal(typeof_<const int*>(), typeof_<__xtd_vector__<int>::const_pointer>());
    }
    
    void test_method_(const_pointer_with_bool) {
      assert::are_equal(typeof_<const bool*>(), typeof_<__xtd_vector__<bool>::const_pointer>());
    }
    ...
    void test_method_(default_constructor_with_bool) {
      auto items = __xtd_vector__<bool> {};
      assert::is_zero(items.capacity());
      assert::is_zero(items.size());
      collection_assert::is_empty(items);
    }
    ...
    void test_method_(constructor_with_count) {
      auto items = __xtd_vector__<int>(3);
    ...
    void test_method_(constructor_with_bool_and_count) {
      auto items = __xtd_vector__<bool>(3);
      assert::are_equal(3_z, items.size());
      collection_assert::are_equal({false, false, false}, items);
    }
    ...
    void test_method_(empty_with_bool) {
      assert::is_true(__xtd_vector__<bool> {}.empty());
      assert::is_false(__xtd_vector__<bool> {true}.empty());
    ...
    void test_method_(front_const) {
      ...
      assert::throws<std::out_of_range>([&] {__xtd_vector__<int> {}.front();});
    }
    
    void test_method_(front_const_with_bool) {
      auto items = __xtd_vector__ {true, false, true};
      assert::are_equal(true, items.front());
      assert::throws<std::out_of_range>([&] {__xtd_vector__<bool> {}.front();});
    }
    ...
    void test_method_(items_const) {
      assert::are_equal(typeof_<__xtd_vector__<int>::base_type>(), typeof_(__xtd_vector__ {1, 2, 3, 4, 5}.items()));
      collection_assert::are_equal({1, 2, 3, 4, 5}, __xtd_vector__ {1, 2, 3, 4, 5}.items());
    }
    
    void test_method_(items_const_with_bool) {
      assert::are_equal(typeof_<__xtd_vector__<bool>::base_type>(), typeof_(__xtd_vector__ {true, false, true, false}.items()));
      collection_assert::are_equal({true, false, true, false}, __xtd_vector__ {true, false, true, false}.items());
    }
    
    void test_method_(items) {
      auto items = __xtd_vector__ {84, 42, 21};
      assert::are_equal(typeof_<__xtd_vector__<int>::base_type>(), typeof_(items.items()));
    ...
    void test_method_(items_with_bool) {
      auto items = __xtd_vector__ {true, false, true};
      assert::are_equal(typeof_<__xtd_vector__<bool>::base_type>(), typeof_(items.items()));
    ...
    void test_method_(max_size) {
      assert::is_not_zero(__xtd_vector__<int> {}.max_size());
    }
    
    void test_method_(max_size_with_bool) {
      assert::is_not_zero(__xtd_vector__<bool> {}.max_size());
    }
    ...
    void test_method_(get_allocator) {
      ...
      assert::are_equal(typeof_<__xtd_vector__<int>::allocator_type>(), typeof_(allocator));
    }
    
    void test_method_(get_allocator_with_bool) {
      auto items = __xtd_vector__ {true, false, true};
      auto allocator = items.get_allocator();
      assert::are_equal(typeof_<__xtd_vector__<bool>::allocator_type>(), typeof_(allocator));
    }
    
    void test_method_(get_base_type) {
      auto items = __xtd_vector__ {84, 42, 21};
      auto bt = items.get_base_type();
      assert::are_equal(typeof_<__xtd_vector__<int>::base_type>(), typeof_(bt));
    ...
    void test_method_(get_base_type_with_bool) {
      auto items = __xtd_vector__ {true, false, true};
      auto bt = items.get_base_type();
      assert::are_equal(typeof_<__xtd_vector__<bool>::base_type>(), typeof_(bt));
    ...
    void test_method_(swap) {
      auto items1 = __xtd_vector__ {84, 42, 21};
      auto items2 = __xtd_vector__ {63, 75, 96};
      items1.swap(items2);
    ...
    void test_method_(swap_with_bool) {
      auto items1 = __xtd_vector__ {true, false, true};
      auto items2 = __xtd_vector__ {false, true, false};
      items1.swap(items2);
    ...
    void test_method_(operator_base_type) {
      auto items = __xtd_vector__ {84, 42, 21};
      auto bt = __xtd_vector__<int>::base_type {};
      bt = items;
      assert::are_equal(typeof_<__xtd_vector__<int>::base_type>(), typeof_(bt));
      collection_assert::are_equal({84, 42, 21}, bt);
    }
    ...
    void test_method_(operator_base_type_with_bool) {
      auto items = __xtd_vector__ {true, false, true};
      auto bt = __xtd_vector__<bool>::base_type {};
      bt = items;
      assert::are_equal(typeof_<__xtd_vector__<bool>::base_type>(), typeof_(bt));
      collection_assert::are_equal({true, false, true}, bt);
    }
