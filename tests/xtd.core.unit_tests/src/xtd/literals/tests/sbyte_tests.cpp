    ...
    namespace tests {
      class test_class_(sbyte_tests) {
        ...
        auto test_method_(_i8_operator_on_unsigned_long_long_with_overflow) {
          assert::throws<xtd::overflow_exception>([] {[[maybe_unused]] auto __ = 128_i8;});
        }
        ...
        auto test_method_(_i8_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = "42str"_i8;});
        }
        ...
        auto test_method_(_i8_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u8"42str"_i8;});
        }
        ...
        auto test_method_(_i8_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u"42str"_i8;});
        }
        ...
        auto test_method_(_i8_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = L"42str"_i8;});
        }
        ...
        auto test_method_(_s8_operator_on_unsigned_long_long_with_overflow) {
          assert::throws<xtd::overflow_exception>([] {[[maybe_unused]] auto __ = 128_s8;});
        }
        ...
        auto test_method_(_s8_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = "42str"_s8;});
        }
        ...
        auto test_method_(_s8_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u8"42str"_s8;});
        }
        ...
        auto test_method_(_s8_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u"42str"_s8;});
        }
        ...
        auto test_method_(_s8_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = L"42str"_s8;});
        }
      };
    }
  }
