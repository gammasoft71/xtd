    ...
    namespace tests {
      class test_class_(int64_tests) {
        ...
        auto test_method_(_i64_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = "42str"_i64;});
        }
        ...
        auto test_method_(_i64_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = u8"42str"_i64;});
        }
        ...
        auto test_method_(_i64_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = u"42str"_i64;});
        }
        ...
        auto test_method_(_i64_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = L"42str"_i64;});
        }
        ...
        auto test_method_(_s64_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = "42str"_s64;});
        }
        ...
        auto test_method_(_s64_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = u8"42str"_s64;});
        }
        ...
        auto test_method_(_s64_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = u"42str"_s64;});
        }
        ...
        auto test_method_(_s64_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {auto __ = L"42str"_s64;});
        }
      };
    }
  }
