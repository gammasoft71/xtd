  ...
  inline namespace literals {
    namespace tests {
      class test_class_(int64_tests) {
        auto test_method_(_i64_operator_on_long_double) {
          auto v = 42.0_i64;
          assert::is_true(is<int64>(v));
          assert::are_equal(42_i64, v);
        }
        
        auto test_method_(_i64_operator_on_unsigned_long_long) {
          auto v = 42_i64;
          assert::is_true(is<int64>(v));
          assert::are_equal(42_i64, v);
        }
        
        auto test_method_(_i64_operator_on_char_ptr) {
          auto v = "42"_i64;
          assert::is_true(is<int64>(v));
          assert::are_equal(42_i64, v);
        }
        ...
        auto test_method_(_i64_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = "42str"_i64;});
        }
        ...
        auto test_method_(_i64_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u8"42str"_i64;});
        }
        ...
        auto test_method_(_i64_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u"42str"_i64;});
        }
        ...
        auto test_method_(_i64_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = L"42str"_i64;});
        }
        ...
        auto test_method_(_s64_operator_on_unsigned_long_long) {
          auto v = 42_s64;
          assert::is_true(is<int64>(v));
          assert::are_equal(42_s64, v);
        }
        
        auto test_method_(_s64_operator_on_char_ptr) {
          auto v = "42"_s64;
          assert::is_true(is<int64>(v));
          assert::are_equal(42_s64, v);
        }
        ...
        auto test_method_(_s64_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = "42str"_s64;});
        }
        ...
        auto test_method_(_s64_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u8"42str"_s64;});
        }
        ...
        auto test_method_(_s64_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u"42str"_s64;});
        }
        ...
        auto test_method_(_s64_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = L"42str"_s64;});
        }
      };
    }
  }
