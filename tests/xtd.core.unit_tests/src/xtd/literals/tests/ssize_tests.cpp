    ...
    namespace tests {
      class test_class_(ssize_tests) {
        ...
        auto test_method_(_sz_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = "42str"_sz;});
        }
        ...
        auto test_method_(_sz_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u8"42str"_sz;});
        }
        ...
        auto test_method_(_sz_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u"42str"_sz;});
        }
        ...
        auto test_method_(_sz_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = L"42str"_sz;});
        }
      };
    }
  }
