    ...
    namespace tests {
      class test_class_(int16_tests) {
        ...
        auto test_method_(_i16_operator_on_unsigned_long_long_with_overflow) {
          assert::throws<xtd::overflow_exception>([] {[[maybe_unused]] auto _ = 32768_i8;});
        }
        ...
        auto test_method_(_i16_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = "42str"_i16;});
        }
        ...
        auto test_method_(_i16_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u8"42str"_i16;});
        }
        ...
        auto test_method_(_i16_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u"42str"_i16;});
        }
        ...
        auto test_method_(_i16_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = L"42str"_i16;});
        }
        ...
        auto test_method_(_s16_operator_on_unsigned_long_long_with_overflow) {
          assert::throws<xtd::overflow_exception>([] {[[maybe_unused]] auto _ = 32768_s16;});
        }
        ...
        auto test_method_(_s16_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = "42str"_s16;});
        }
        ...
        auto test_method_(_s16_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u8"42str"_s16;});
        }
        ...
        auto test_method_(_s16_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u"42str"_s16;});
        }
        ...
        auto test_method_(_s16_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = L"42str"_s16;});
        }
      };
    }
  }
