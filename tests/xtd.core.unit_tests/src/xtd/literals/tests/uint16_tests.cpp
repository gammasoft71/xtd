    ...
    namespace tests {
      class test_class_(uint16_tests) {
        ...
        auto test_method_(_u16_operator_on_unsigned_long_long_with_overflow) {
          assert::throws<xtd::overflow_exception>([] {[[maybe_unused]] auto _ = 65536_u16;});
        }
        ...
        auto test_method_(_u16_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = "42str"_u16;});
        }
        ...
        auto test_method_(_u16_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u8"42str"_u16;});
        }
        ...
        auto test_method_(_u16_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u"42str"_u16;});
        }
        ...
        auto test_method_(_u16_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = L"42str"_u16;});
        }
      };
    }
  }
