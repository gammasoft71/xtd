    ...
    namespace tests {
      class test_class_(double_tests) {
        ...
        auto test_method_(_d_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = "42str"_d;});
        }
        ...
        auto test_method_(_d_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u8"42str"_d;});
        }
        ...
        auto test_method_(_d_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = u"42str"_d;});
        }
        ...
        auto test_method_(_d_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto _ = L"42str"_d;});
        }
      };
    }
  }
