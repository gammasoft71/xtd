    ...
    namespace tests {
      class test_class_(int32_tests) {
        ...
        auto test_method_(_i32_operator_on_unsigned_long_long_with_overflow) {
          assert::throws<xtd::overflow_exception>([] {[[maybe_unused]] auto __ = 2147483648_i32;});
        }
        ...
        auto test_method_(_i32_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = "42str"_i32;});
        }
        ...
        auto test_method_(_i32_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u8"42str"_i32;});
        }
        ...
        auto test_method_(_i32_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u"42str"_i32;});
        }
        ...
        auto test_method_(_i32_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = L"42str"_i32;});
        }
        ...
        auto test_method_(_s32_operator_on_unsigned_long_long_with_overflow) {
          assert::throws<xtd::overflow_exception>([] {[[maybe_unused]] auto __ = 2147483648_s32;});
        }
        ...
        auto test_method_(_s32_operator_on_invalid_char_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = "42str"_s32;});
        }
        ...
        auto test_method_(_s32_operator_on_invalid_char8_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u8"42str"_s32;});
        }
        ...
        auto test_method_(_s32_operator_on_invalid_char16_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = u"42str"_s32;});
        }
        ...
        auto test_method_(_s32_operator_on_invalid_wchar_ptr) {
          assert::throws<xtd::format_exception>([] {[[maybe_unused]] auto __ = L"42str"_s32;});
        }
      };
    }
  }
