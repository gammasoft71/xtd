...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_fixed_point_tests<int64>> numeric_parse_string_fixed_point_tests_class_int64_t_attr {"numeric_parse_string_fixed_point_tests<int64>"};
  test_class_attribute<numeric_parse_string_fixed_point_tests<intptr>> numeric_parse_string_fixed_point_tests_class_intptr_t_attr {"numeric_parse_string_fixed_point_tests<intptr>"};
