...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_fixed_point_tests<uint64>> numeric_parse_string_fixed_point_tests_class_uint64_t_attr {"numeric_parse_string_fixed_point_tests<uint64>"};
