...
namespace xtd::tests {
  class test_class_(convert_tests) {
    ...
    auto test_method_(to_any_from_char8) {
      char8 value = u8'a';
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_any(value);});
      }
        ...
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_boolean(value);});
      }
    ...
    auto test_method_(to_boolean_from_string) {
      ...
      assert::is_false(convert::to_boolean(value));
      value = "bad value";
      assert::throws<format_exception>([&] {auto __ = convert::to_boolean(value);});
    }
    ...
    auto test_method_(to_byte_from_any_failed) {
      ...
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_byte(value);});
    }
    ...
    auto test_method_(to_byte_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_byte(value));
        value = u'\u01FF';
        assert::throws<overflow_exception>([&] {auto __ = convert::to_byte(value);});
      }
        ...
        assert::is_zero(convert::to_byte(value));
        value = "bad value";
        assert::throws<format_exception>([&] {auto __ = convert::to_byte(value);});
      }
        ...
        assert::throws<argument_exception>([&] {auto __ = convert::to_byte(L"42", 4);});
      }
        ...
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_char(value);});
      }
    ...
    auto test_method_(to_char_from_char16) {
      ...
      assert::is_zero(convert::to_char(value));
      value = u'\u01FF';
      assert::throws<overflow_exception>([&] {auto __ = convert::to_char(value);});
    }
    ...
    auto test_method_(to_char_from_string) {
      ...
      assert::are_equal('a', convert::to_char(value));
      value = "ab";
      assert::throws<format_exception>([&] {auto __ = convert::to_char(value);});
    }
    ...
    auto test_method_(to_char8_from_any_failed) {
      any value = "not a char";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_char8(value);});
    }
    ...
    auto test_method_(to_char8_from_char16) {
      ...
      assert::are_equal(u8'a', convert::to_char8(value));
        ...
        assert::is_zero(convert::to_char8(value));
        value = u'\u01FF';
        assert::throws<overflow_exception>([&] {auto __ = convert::to_char8(value);});
      }
    ...
    auto test_method_(to_char8_from_ullong) {
      ...
      assert::are_equal(u8'a', convert::to_char8(value));
        ...
        assert::are_equal(u8'a', convert::to_char8(value));
      value = "ab";
      assert::throws<format_exception>([&] {auto __ = convert::to_char8(value);});
    }
    ...
    auto test_method_(to_char16_from_any_failed) {
      any value = "not a char";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_char16(value);});
    }
    ...
    auto test_method_(to_char16_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_char16(value));
        value = U'\U0001FFFF';
        assert::throws<overflow_exception>([&] {auto __ = convert::to_char16(value);});
      }
        ...
        assert::are_equal(u'a', convert::to_char16(value));
        value = "ab";
        assert::throws<format_exception>([&] {auto __ = convert::to_char16(value);});
      }
        ...
        any value = "not a char";
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_char32(value);});
      }
    ...
    auto test_method_(to_char32_from_decimal) {
      ...
      assert::is_zero(convert::to_char32(value));
      value = -0.1l;
      assert::throws<overflow_exception>([&] {auto __ = convert::to_char32(value);});
      value = 4294967296.0l;
      assert::throws<overflow_exception>([&] {auto __ = convert::to_char32(value);});
    }
    ...
    auto test_method_(to_char32_from_string) {
      ...
      assert::are_equal(U'a', convert::to_char32(value));
      value = "ab";
      assert::throws<format_exception>([&] {auto __ = convert::to_char32(value);});
    }
    ...
    auto test_method_(to_wchar_from_any_failed) {
      any value = "not a char";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_wchar(value);});
    }
    ...
    auto test_method_(to_wchar_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_wchar(value));
        value = U'\U0001FFFF';
        assert::throws<overflow_exception>([&] {auto __ = convert::to_wchar(value);});
      }
        ...
        assert::are_equal(L'a', convert::to_wchar(value));
        value = "ab";
        assert::throws<format_exception>([&] {auto __ = convert::to_wchar(value);});
      }
        ...
        any value = "not a byte";
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_decimal(value);});
      }
    ...
    auto test_method_(to_decimal_from_string) {
      ...
      assert::is_zero(convert::to_decimal(value));
      value = "bad value";
      assert::throws<format_exception>([&] {auto __ = convert::to_decimal(value);});
    }
    ...
    auto test_method_(to_double_from_any_failed) {
      any value = "not a byte";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_double(value);});
    }
    ...
    auto test_method_(to_double_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_double(value));
        value = "bad value";
        assert::throws<format_exception>([&] {auto __ = convert::to_double(value);});
      }
        ...
        any value = "not a byte";
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_single(value);});
      }
    ...
    auto test_method_(to_single_from_string) {
      ...
      assert::is_zero(convert::to_single(value));
      value = "bad value";
      assert::throws<format_exception>([&] {auto __ = convert::to_single(value);});
    }
    ...
    auto test_method_(to_int16_from_any_failed) {
      any value = "not a byte";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_int16(value);});
    }
    ...
    auto test_method_(to_int16_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_int16(value));
        value = U'\U0001FFFF';
        assert::throws<overflow_exception>([&] {auto __ = convert::to_int16(value);});
      }
        ...
        assert::is_zero(convert::to_int16(value));
        value = "bad value";
        assert::throws<format_exception>([&] {auto __ = convert::to_int16(value);});
      }
        ...
        assert::throws<argument_exception>([&] {auto __ = convert::to_int16(L"42", 4);});
      }
        ...
        any value = "not a byte";
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_int32(value);});
      }
    ...
    auto test_method_(to_int32_from_decimal) {
      ...
      assert::is_zero(convert::to_int32(value));
      value = 2147483648.0l;
      assert::throws<overflow_exception>([&] {auto __ = convert::to_int32(value);});
    }
    ...
    auto test_method_(to_int32_from_string) {
      ...
      assert::is_zero(convert::to_int32(value));
      value = "bad value";
      assert::throws<format_exception>([&] {auto __ = convert::to_int32(value);});
    }
    ...
    auto test_method_(to_int32_from_string_with_base) {
      ...
      assert::throws<argument_exception>([&] {auto __ = convert::to_int32(L"42", 4);});
    }
    ...
    auto test_method_(to_int64_from_any_failed) {
      any value = "not a byte";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_int64(value);});
    }
    ...
    auto test_method_(to_int64_from_char8) {
      char8 value = u8'a';
        ...
        assert::throws<overflow_exception>([&] {auto __ = convert::to_int64(value);});
      }
        ...
        assert::is_zero(convert::to_int64(value));
        value = "bad value";
        assert::throws<format_exception>([&] {auto __ = convert::to_int64(value);});
      }
        ...
        assert::throws<argument_exception>([&] {auto __ = convert::to_int64(L"42", 4);});
      }
        ...
        any value = "not a byte";
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_llong(value);});
      }
    ...
    auto test_method_(to_llong_from_uint64) {
      ...
      assert::is_zero(convert::to_llong(value));
      value = 9223372036854775808lu;
      assert::throws<overflow_exception>([&] {auto __ = convert::to_llong(value);});
    }
    ...
    auto test_method_(to_llong_from_string) {
      ...
      assert::is_zero(convert::to_llong(value));
      value = "bad value";
      assert::throws<format_exception>([&] {auto __ = convert::to_llong(value);});
    }
    ...
    auto test_method_(to_llong_from_string_with_base) {
      ...
      assert::throws<argument_exception>([&] {auto __ = convert::to_llong(L"42", 4);});
    }
    ...
    auto test_method_(to_sbyte_from_any_failed) {
      any value = "not a byte";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_sbyte(value);});
    }
    ...
    auto test_method_(to_sbyte_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_sbyte(value));
        value = u'\u0080';
        assert::throws<overflow_exception>([&] {auto __ = convert::to_sbyte(value);});
      }
        ...
        assert::is_zero(convert::to_sbyte(value));
        value = "bad value";
        assert::throws<format_exception>([&] {auto __ = convert::to_sbyte(value);});
      }
        ...
        assert::throws<argument_exception>([&] {auto __ = convert::to_sbyte(L"42", 4);});
      }
        ...
        any value = "not a byte";
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_uint16(value);});
      }
    ...
    auto test_method_(to_uint16_from_char32) {
      ...
      assert::is_zero(convert::to_uint16(value));
      value = U'\U0001FFFF';
      assert::throws<overflow_exception>([&] {auto __ = convert::to_uint16(value);});
    }
    ...
    auto test_method_(to_uint16_from_string) {
      ...
      assert::is_zero(convert::to_uint16(value));
      value = "bad value";
      assert::throws<format_exception>([&] {auto __ = convert::to_uint16(value);});
    }
    ...
    auto test_method_(to_uint16_from_string_with_base) {
      ...
      assert::throws<argument_exception>([&] {auto __ = convert::to_uint16(L"42", 4);});
    }
    ...
    auto test_method_(to_uint32_from_any_failed) {
      any value = "not a byte";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_uint32(value);});
    }
    ...
    auto test_method_(to_uint32_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_uint32(value));
        value = 4294967296.0l;
        assert::throws<overflow_exception>([&] {auto __ = convert::to_uint32(value);});
      }
        ...
        assert::is_zero(convert::to_uint32(value));
        value = "bad value";
        assert::throws<format_exception>([&] {auto __ = convert::to_uint32(value);});
      }
        ...
        assert::throws<argument_exception>([&] {auto __ = convert::to_uint32(L"42", 4);});
      }
        ...
        any value = "not a byte";
        assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_uint64(value);});
      }
    ...
    auto test_method_(to_uint64_from_string) {
      ...
      assert::is_zero(convert::to_uint64(value));
      value = "bad value";
      assert::throws<format_exception>([&] {auto __ = convert::to_uint64(value);});
    }
    ...
    auto test_method_(to_uint64_from_string_with_base) {
      ...
      assert::throws<argument_exception>([&] {auto __ = convert::to_uint64(L"42", 4);});
    }
    ...
    auto test_method_(to_ullong_from_any_failed) {
      any value = "not a byte";
      assert::throws<invalid_cast_exception>([&] {auto __ = convert::to_ullong(value);});
    }
    ...
    auto test_method_(to_ullong_from_char8) {
      char8 value = u8'a';
        ...
        assert::is_zero(convert::to_ullong(value));
        value = "bad value";
        assert::throws<format_exception>([&] {auto __ = convert::to_ullong(value);});
      }
        ...
        assert::throws<argument_exception>([&] {auto __ = convert::to_ullong(L"42", 4);});
      }
