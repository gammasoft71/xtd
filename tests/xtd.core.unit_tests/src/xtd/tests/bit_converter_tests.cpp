                    ...
                    using_(array<xtd::byte> bytes = bit_converter::get_bytes(U'{')) {
                      ...
                      using_(array<xtd::byte> bytes = bit_converter::get_bytes(L'[')) {
                        ...
                        using_(array<xtd::byte> bytes = bit_converter::get_bytes(L'{')) {
                          ...
                          assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_boolean(array<byte> {0}, 1);});
                          ...
                          assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_char(array<byte> {0x00, 0x00, 0x00, 0x00}, 4);});
                          assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_char(array<byte> {0x00, 0x00, 0x00, 0x00}, 1);});
                          ...
                          assert::are_equal(U'[', bit_converter::to_char(array<byte> {0x5B, 0x00, 0x00, 0x00}, 0));
                            ...
                            assert::are_equal(U'{', bit_converter::to_char(array<byte> {0x7B, 0x00, 0x00, 0x00}, 0));
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_double(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 8);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_double(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_int16(array<byte> {0x00, 0x00}, 2);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_int16(array<byte> {0x00, 0x00}, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_int32(array<byte> {0x00, 0x00, 0x00, 0x00}, 4);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_int32(array<byte> {0x00, 0x00, 0x00, 0x00}, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_int64(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 8);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_int64(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_single(array<byte> {0x00, 0x00, 0x00, 0x00}, 4);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_single(array<byte> {0x00, 0x00, 0x00, 0x00}, 1);});
                              ...
                              assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = bit_converter::to_string(vectorOne, 3);});
                              
                              array<xtd::byte> vectorEmpty;
                              assert::is_empty(bit_converter::to_string(vectorEmpty, 0));
                              assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = bit_converter::to_string(vectorEmpty, 1);});
                            }
                              ...
                              assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = bit_converter::to_string(vectorOne, 0, 4);});
                              ...
                              assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = bit_converter::to_string(vectorOne, 1, 3);});
                              
                              assert::is_empty(bit_converter::to_string(vectorOne, 2, 0));
                              assert::are_equal("09", bit_converter::to_string(vectorOne, 2, 1));
                              assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = bit_converter::to_string(vectorOne, 2, 2);});
                              
                              assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = bit_converter::to_string(vectorOne, 3, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_uint16(array<byte> {0x00, 0x00}, 2);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_uint16(array<byte> {0x00, 0x00}, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_uint32(array<byte> {0x00, 0x00, 0x00, 0x00}, 4);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_uint32(array<byte> {0x00, 0x00, 0x00, 0x00}, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_uint64(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 8);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_uint64(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 1);});
                              ...
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_size(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 8);});
                              assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = bit_converter::to_size(array<byte> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 1);});
