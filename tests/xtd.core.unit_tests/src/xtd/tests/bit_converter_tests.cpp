...
namespace xtd::tests {
  class test_class_(bit_converter_tests) {
    ...
    void test_method_(to_boolean) {
      assert::throws<std::out_of_range>([] {bit_converter::to_boolean({0}, 1);}, csf_);
    ...
    void test_method_(to_char) {
      assert::throws<std::out_of_range>([] {bit_converter::to_char({0x00, 0x00, 0x00, 0x00}, 4);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_char({0x00, 0x00, 0x00, 0x00}, 1);}, csf_);
    ...
    void test_method_(to_double) {
      assert::throws<std::out_of_range>([] {bit_converter::to_double({0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 8);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_double({0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 1);}, csf_);
    ...
    void test_method_(to_int16) {
      assert::throws<std::out_of_range>([] {bit_converter::to_int16({0x00, 0x00}, 2);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_int16({0x00, 0x00}, 1);}, csf_);
    ...
    void test_method_(to_int32) {
      assert::throws<std::out_of_range>([] {bit_converter::to_int32({0x00, 0x00, 0x00, 0x00}, 4);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_int32({0x00, 0x00, 0x00, 0x00}, 1);}, csf_);
      ...
      assert::are_equal(std::numeric_limits<int32>::lowest(), bit_converter::to_int32({0x00, 0x00, 0x00, 0x80}, 0), csf_);
      assert::are_equal(std::numeric_limits<int32>::max(), bit_converter::to_int32({0xFF, 0xFF, 0xFF, 0x7F}, 0), csf_);
    }
    
    void test_method_(to_int64) {
      assert::throws<std::out_of_range>([] {bit_converter::to_int64({0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 8);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_int64({0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 1);}, csf_);
      ...
      assert::are_equal(std::numeric_limits<int64>::lowest(), bit_converter::to_int64({0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80}, 0), csf_);
      assert::are_equal(std::numeric_limits<int64>::max(), bit_converter::to_int64({0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F}, 0), csf_);
    }
    
    void test_method_(to_single) {
      assert::throws<std::out_of_range>([] {bit_converter::to_single({0x00, 0x00, 0x00, 0x00}, 4);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_single({0x00, 0x00, 0x00, 0x00}, 1);}, csf_);
    ...
    void test_method_(to_uint16) {
      assert::throws<std::out_of_range>([] {bit_converter::to_uint16({0x00, 0x00}, 2);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_uint16({0x00, 0x00}, 1);}, csf_);
      ...
      assert::are_equal(std::numeric_limits<uint16>::lowest(), bit_converter::to_uint16({0x00, 0x00}, 0), csf_);
      assert::are_equal(std::numeric_limits<uint16>::max(), bit_converter::to_uint16({0xFF, 0xFF}, 0), csf_);
    }
    
    void test_method_(to_uint32) {
      assert::throws<std::out_of_range>([] {bit_converter::to_uint32({0x00, 0x00, 0x00, 0x00}, 4);}, csf_);
      assert::throws<std::out_of_range>([] {bit_converter::to_uint32({0x00, 0x00, 0x00, 0x00}, 1);}, csf_);
