...
namespace xtd::tests {
  ...
  public:
    ...
    static void are_equal(value_t b, const std::vector<bytes_t>& bytes) {are_equal(b, bytes, xtd::string::empty_string, xtd::diagnostics::stack_frame());}
    
    template<typename value_t, typename bytes_t>
    static void are_equal(value_t b, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame) {are_equal(b, bytes, xtd::string::empty_string, stack_frame);}
    ...
    static void are_equal(value1_t b1, value2_t b2, const std::vector<bytes_t>& bytes) {are_equal(b1, b2, bytes, xtd::string::empty_string, xtd::diagnostics::stack_frame());}
    
    template<typename value1_t, typename value2_t, typename bytes_t>
    static void are_equal(value1_t b1, value2_t b2, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame) {are_equal(b1, b2, bytes, xtd::string::empty_string, stack_frame);}
    ...
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, const std::vector<bytes_t>& bytes) {are_equal(b1, b2, b3, b4, bytes, xtd::string::empty_string, xtd::diagnostics::stack_frame());}
    
    template<typename value1_t, typename value2_t, typename value3_t, typename value4_t, typename bytes_t>
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame) {are_equal(b1, b2, b3, b4, bytes, xtd::string::empty_string, stack_frame);}
    ...
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, value5_t b5, value6_t b6, value7_t b7, value8_t b8, const std::vector<bytes_t>& bytes) {are_equal(b1, b2, b3, b4, b5, b6, b7, b8, bytes, xtd::string::empty_string, xtd::diagnostics::stack_frame());}
    
    template<typename value1_t, typename value2_t, typename value3_t, typename value4_t, typename value5_t, typename value6_t, typename value7_t, typename value8_t, typename bytes_t>
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, value5_t b5, value6_t b6, value7_t b7, value8_t b8, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame) {are_equal(b1, b2, b3, b4, b5, b6, b7, b8, bytes, xtd::string::empty_string, stack_frame);}
