...
namespace xtd::tests {
  class test_class_(unregistered_enum_struct_flags_tests) {
    auto test_method_(format) {
      assert::are_equal("0", string::format("{}", unregistered_enum_struct_flags_test::none));
      assert::are_equal("1", string::format("{}", unregistered_enum_struct_flags_test::one));
      assert::are_equal("2", string::format("{}", unregistered_enum_struct_flags_test::two));
      assert::are_equal("4", string::format("{}", unregistered_enum_struct_flags_test::three));
      assert::are_equal("8", string::format("{}", unregistered_enum_struct_flags_test::four));
      assert::are_equal("3", string::format("{}", unregistered_enum_struct_flags_test::one | unregistered_enum_struct_flags_test::two));
      assert::are_equal("12", string::format("{}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
    }
    ...
    auto test_method_(format_with_specified_format) {
      assert::are_equal("0b1100", string::format("0b{:b}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("0b1100", string::format("0b{:B}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("12", string::format("{:d}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("12", string::format("{:D}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("12", string::format("{:g}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("12", string::format("{:G}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("014", string::format("0{:o}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("014", string::format("0{:O}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("0xc", string::format("0x{:x}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
      assert::are_equal("0xC", string::format("0x{:X}", unregistered_enum_struct_flags_test::three | unregistered_enum_struct_flags_test::four));
    }
    ...
    auto test_method_(parse_with_invalid_enum) {
      ...
      assert::throws <format_exception>([] {[[maybe_unused]] auto __ = string::parse<unregistered_enum_struct_flags_test> ("one");});
    }
  };
}
