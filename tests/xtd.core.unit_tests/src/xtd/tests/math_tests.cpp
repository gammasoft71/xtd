...
namespace xtd::tests {
  class test_class_(math_tests) {
    ...
    auto test_method_(abs_int16) {
      ...
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto __ = math::abs(std::numeric_limits<int16>::lowest());});
    }
    ...
    auto test_method_(abs_int32) {
      ...
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto __ = math::abs(std::numeric_limits<int32>::lowest());});
    }
    ...
    auto test_method_(abs_int64) {
      ...
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto __ = math::abs(std::numeric_limits<int64>::lowest());});
    }
    ...
    auto test_method_(abs_sbyte) {
      ...
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto __ = math::abs(std::numeric_limits<sbyte>::lowest());});
    }
    ...
    auto test_method_(abs_llong) {
      ...
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto __ = math::abs(std::numeric_limits<slong>::lowest());});
    }
    ...
    auto test_method_(sign_decimal) {
      ...
      assert::are_equal(1.0l, math::sign(10.0l));
      assert::throws<arithmetic_exception>([] {[[maybe_unused]] auto __ = math::sign(std::numeric_limits<decimal>::quiet_NaN());});
    }
    ...
    auto test_method_(sign_double) {
      ...
      assert::are_equal(1.0, math::sign(10.0));
      assert::throws<arithmetic_exception>([] {[[maybe_unused]] auto __ = math::sign(double_object::NaN);});
    }
    ...
    auto test_method_(sign_single) {
      ...
      assert::are_equal(1.0f, math::sign(10.0f));
      assert::throws<arithmetic_exception>([] {[[maybe_unused]] auto __ = math::sign(std::numeric_limits<float>::quiet_NaN());});
    }
