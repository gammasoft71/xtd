...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_number_tests<unsigned char>> numeric_parse_string_number_tests_class_unsigned_char_attr {"numeric_parse_string_number_tests<unsigned_char>"};
  ...
  test_class_attribute<numeric_parse_string_number_tests<unsigned short>> numeric_parse_string_number_tests_class_unsigned_short_attr {"numeric_parse_string_number_tests<unsigned_short>"};
  ...
  test_class_attribute<numeric_parse_string_number_tests<unsigned int>> numeric_parse_string_number_tests_class_unsigned_int_attr {"numeric_parse_string_number_tests<unsigned_int>"};
