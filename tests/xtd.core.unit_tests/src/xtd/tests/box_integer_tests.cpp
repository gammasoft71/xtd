...
namespace xtd::tests {
  generic_test_class_(box_integer_typeests, signed char, unsigned char, short, unsigned short, int, unsigned int, long, unsigned long, long long, unsigned long long, sbyte, int16, int32, int64, intptr, ptrdiff, usize, byte, uint16, uint32, uint64, uintptr) {
    ...
    auto test_method_(parse) {
      ...
      assert::throws<format_exception>([]{auto __ = box_integer<type_t>::parse("value");});
    }
    ...
    auto test_method_(parse_with_number_style) {
      ...
      assert::throws<format_exception>([]{auto __ = box_integer<type_t>::parse("value", number_styles::hex_number);});
    }
