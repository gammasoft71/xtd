...
namespace xtd::tests {
  class test_class_(unregistered_enum_tests) {
    auto test_method_(format) {
      ...
      assert::are_equal("3", string::format("{}", unregistered_enum_test::three));
    ...
    auto test_method_(format_with_specified_format) {
      ...
      assert::are_equal("4", string::format("{:D}", unregistered_enum_test::four));
      assert::are_equal("4", string::format("{:g}", unregistered_enum_test::four));
      assert::are_equal("4", string::format("{:G}", unregistered_enum_test::four));
      assert::are_equal("04", string::format("0{:o}", unregistered_enum_test::four));
      assert::are_equal("04", string::format("0{:O}", unregistered_enum_test::four));
    ...
    auto test_method_(parse) {
      ...
      assert::are_equal(unregistered_enum_test::three, string::parse<unregistered_enum_test>("3"));
    ...
    auto test_method_(parse_with_invalid_enum) {
      ...
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = string::parse<unregistered_enum_test>("one");});
    }
  };
}
