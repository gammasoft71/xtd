...
namespace xtd::tests {
  ...
  public:
    ...
    void test_method_(get_entries_as_byte) {
      collection_assert::are_equal(enum_collection<byte> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_byte<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_entries_as_int16) {
      collection_assert::are_equal(enum_collection<int16> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_int16<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_entries_as_int32) {
      collection_assert::are_equal(enum_collection<int32> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_int32<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_entries_as_int64) {
      collection_assert::are_equal(enum_collection<int64> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_int64<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_entries_as_sbyte) {
      collection_assert::are_equal(enum_collection<sbyte> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_sbyte<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_entries_as_uint16) {
      collection_assert::are_equal(enum_collection<uint16> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_uint16<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_entries_as_uint32) {
      collection_assert::are_equal(enum_collection<uint32> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_uint32<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_entries_as_uint64) {
      collection_assert::are_equal(enum_collection<uint64> {{0, "none"}, {1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}}, enum_object<>::get_entries_as_uint64<enum_object_with_registered_enum_test>(), csf_);
    }
    ...
    void test_method_(get_values) {
      auto expected_entries = vector<enum_object_with_registered_enum_test> {enum_object_with_registered_enum_test::none, enum_object_with_registered_enum_test::one, enum_object_with_registered_enum_test::two, enum_object_with_registered_enum_test::three, enum_object_with_registered_enum_test::four};
      auto actual_entries = enum_object<>::get_values<enum_object_with_registered_enum_test>();
      assert::is_true(std::equal(actual_entries.begin(), actual_entries.end(), expected_entries.begin(), expected_entries.end()), csf_);
    }
    
    void test_method_(get_values_as_byte) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_byte<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_values_as_int16) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_int16<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_values_as_int32) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_int32<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_values_as_int64) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_int64<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_values_as_sbyte) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_sbyte<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_values_as_uint16) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_uint16<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_values_as_uint32) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_uint32<enum_object_with_registered_enum_test>(), csf_);
    }
    
    void test_method_(get_values_as_uint64) {
      collection_assert::are_equal({0, 1, 2, 3, 4}, enum_object<>::get_values_as_uint64<enum_object_with_registered_enum_test>(), csf_);
    }
