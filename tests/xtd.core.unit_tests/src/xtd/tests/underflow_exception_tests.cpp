#include <xtd/underflow_exception>
...
namespace xtd::tests {
  class test_class_(underflow_exception_tests) {
  ...
  public:
    ...
    void test_method_(default_creator) {
      ...
      assert::are_equal("xtd::underflow_exception", e.name(), csf_);
      assert::is_empty(e.stack_trace(), csf_);
      assert::are_equal("xtd::underflow_exception : Arithmetic operation resulted in an underflow.", e.to_string(), csf_);
      assert::are_equal("Arithmetic operation resulted in an underflow.", e.what(), csf_);
    }
    ...
    void test_method_(default_creator_with_current_stack_frame) {
      ...
      assert::are_equal("xtd::underflow_exception : Arithmetic operation resulted in an underflow.\n" + info.to_string(), e.to_string(), csf_);
      assert::are_equal("Arithmetic operation resulted in an underflow.", e.what(), csf_);
    }
    ...
    void test_method_(creator_with_empty_message) {
      ...
      assert::are_equal("xtd::underflow_exception", e.name(), csf_);
      assert::is_empty(e.stack_trace(), csf_);
      assert::are_equal("xtd::underflow_exception", e.to_string(), csf_);
      assert::are_equal("xtd::underflow_exception", e.what(), csf_);
    }
    ...
    void test_method_(creator_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal("xtd::underflow_exception", e.name(), csf_);
      assert::are_equal(info.to_string(), e.stack_trace(), csf_);
      assert::are_equal("xtd::underflow_exception\n" + info.to_string(), e.to_string(), csf_);
      assert::are_equal("xtd::underflow_exception", e.what(), csf_);
    }
    ...
    void test_method_(creator_with_message) {
      ...
      assert::are_equal("xtd::underflow_exception", e.name(), csf_);
      assert::is_empty(e.stack_trace(), csf_);
      assert::are_equal("xtd::underflow_exception : Test excpetion message.", e.to_string(), csf_);
    ...
    void test_method_(creator_with_message_and_stack_frame) {
      ...
      assert::are_equal("xtd::underflow_exception", e.name(), csf_);
      assert::are_equal(info.to_string(), e.stack_trace(), csf_);
      assert::are_equal("xtd::underflow_exception : Test excpetion message.\n" + info.to_string(), e.to_string(), csf_);
      assert::are_equal("Test excpetion message.", e.what(), csf_);
    }
