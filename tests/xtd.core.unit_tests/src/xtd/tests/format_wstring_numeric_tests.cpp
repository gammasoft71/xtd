...
namespace xtd::tests {
  ...
  auto register_format_wstring_numeric_tests = register_test_class_types<format_wstring_numeric_tests, unsigned char, short, unsigned short, int, unsigned int, long, unsigned long, long long, unsigned long long, sbyte, int16, int32, int64, intptr, ptrdiff, size, byte, uint16, uint32, uint64, uintptr> {};
