...
namespace xtd::tests {
  class test_class_(convert_pointer_tests) {
    ...
    auto test_method_(const_object_to_invalid_other_ptr) {
      ...
      assert::throws<invalid_cast_exception>([&] {[[maybe_unused]] auto __ = convert_pointer::to_ptr<string>(*g);});
      delete g;
    }
    ...
    auto test_method_(const_object_to_invalid_other_ref) {
      ...
      assert::throws<invalid_cast_exception>([&] {[[maybe_unused]] auto __ = convert_pointer::to_ref<string>(*g);});
      delete g;
    }
    ...
    auto test_method_(const_null_pointer_to_ref) {
      const guid* g1 = null;
      assert::throws<argument_null_exception>([&] {[[maybe_unused]] auto __ = convert_pointer::to_ref<guid>(g1);});
    }
    ...
    auto test_method_(null_pointer_to_ref) {
      guid* g = null;
      assert::throws<argument_null_exception>([&] {[[maybe_unused]] auto __ = convert_pointer::to_ref<guid>(g);});
    }
    ...
    auto test_method_(const_null_pointer_to_other_ref) {
      const guid* g = null;
      assert::throws<argument_null_exception>([&] {[[maybe_unused]] auto __ = convert_pointer::to_ref<object>(g);});
    }
    ...
    auto test_method_(to_unique_ptr_invalid) {
      xtd::uptr<guid> g = xtd::new_uptr<guid>();
      assert::throws<invalid_cast_exception>([&] {[[maybe_unused]] auto __ = convert_pointer::to_unique_ptr<string>(g);});
    }
    ...
    auto test_method_(move_to_unique_ptr_invalid) {
      assert::throws<invalid_cast_exception>([] {[[maybe_unused]] auto __ = convert_pointer::to_unique_ptr<string>(xtd::new_uptr<guid>());});
    }
    ...
    auto test_method_(to_shared_ptr_invalid) {
      xtd::sptr<guid> g = xtd::new_sptr<guid>();
      assert::throws<invalid_cast_exception>([&] {[[maybe_unused]] auto __ = convert_pointer::to_shared_ptr<string>(g);});
    }
    ...
    auto test_method_(move_to_shared_ptr_invalid) {
      assert::throws<invalid_cast_exception>([] {[[maybe_unused]] auto __ = convert_pointer::to_shared_ptr<string>(xtd::new_sptr<guid>());});
    }
  };
}
