...
namespace xtd::tests {
  class test_class_(string_comparer_tests) {
    auto test_method_(string_comparer_current_culture) {
      assert::throws<not_implemented_exception>([] {[[maybe_unused]] auto _ = string_comparer::current_culture();});
    ...
    auto test_method_(string_comparer_current_culture_ignore_case) {
      assert::throws<not_implemented_exception>([] {[[maybe_unused]] auto _ = string_comparer::current_culture_ignore_case();});
    ...
    auto test_method_(invariant_culture) {
      assert::throws<not_implemented_exception>([] {[[maybe_unused]] auto _ = string_comparer::invariant_culture();});
    ...
    auto test_method_(invariant_culture_ignore_case) {
      assert::throws<not_implemented_exception>([] {[[maybe_unused]] auto _ = string_comparer::invariant_culture_ignore_case();});
    ...
    auto test_method_(from_comparison) {
      ...
      assert::throws<argument_exception>([] {[[maybe_unused]] auto _ = string_comparer::from_comparison(static_cast<string_comparison>(42));});
    }
  };
}
