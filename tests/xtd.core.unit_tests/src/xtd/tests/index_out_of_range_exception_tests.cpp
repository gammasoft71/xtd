...
namespace xtd::tests {
  class test_class_(index_out_of_range_exception_tests) {
    ...
    static void test_initialize_(test_initialize) {
      ...
      stack_trace_enabled = index_out_of_range_exception::enable_stack_trace();
      index_out_of_range_exception::enable_stack_trace(false);
    }
    
    static void test_cleanup_(test_cleanup) {
      xtd::globalization::culture_info::current_culture(previous_culture);
      index_out_of_range_exception::enable_stack_trace(stack_trace_enabled);
    }
    
    auto test_method_(default_constructor) {
      auto e = index_out_of_range_exception {};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      ...
      assert::are_equal("Index was outside the bounds of the array.", e.message());
      ...
      string_assert::starts_with("xtd::index_out_of_range_exception : Index was outside the bounds of the array.", e.to_string());
      assert::are_equal("Index was outside the bounds of the array.", e.what());
    }
    
    auto test_method_(default_constructor_with_stack_frame) {
      auto stack_frame = xtd::diagnostics::stack_frame::current();
      auto e = index_out_of_range_exception {stack_frame};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
      ...
      assert::are_equal("xtd::index_out_of_range_exception : Index was outside the bounds of the array." + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("Index was outside the bounds of the array.", e.what());
    }
    
    auto test_method_(constructor_with_nullopt_message) {
      auto e = index_out_of_range_exception {nullopt};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
    ...
    auto test_method_(constructor_with_nullopt_message_and_stack_frame) {
      auto stack_frame = xtd::diagnostics::stack_frame::current();
      auto e = index_out_of_range_exception {nullopt, stack_frame};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::index_out_of_range_exception : Index was outside the bounds of the array." + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("Index was outside the bounds of the array.", e.what());
    }
    ...
    auto test_method_(constructor_with_empty_message) {
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number());
      assert::is_not_empty(e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::index_out_of_range_exception", e.to_string());
      assert::are_equal("xtd::index_out_of_range_exception", e.what());
    }
    ...
    auto test_method_(constructor_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      assert::are_equal("xtd::index_out_of_range_exception" + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("xtd::index_out_of_range_exception", e.what());
    }
    
    auto test_method_(constructor_with_message) {
      auto e = index_out_of_range_exception {"Test excpetion message."};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number());
      assert::is_not_empty(e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::index_out_of_range_exception : Test excpetion message.", e.to_string());
      assert::are_equal("Test excpetion message.", e.what());
    }
    
    auto test_method_(constructor_with_message_and_stack_frame) {
      auto stack_frame = xtd::diagnostics::stack_frame::current();
      auto e = index_out_of_range_exception {"Test excpetion message.", stack_frame};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      assert::are_equal("xtd::index_out_of_range_exception : Test excpetion message." + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("Test excpetion message.", e.what());
    }
    
    auto test_method_(constructor_with_nullopt_message_and_inner_exception) {
      auto inner_exception = argument_exception {};
      auto e = index_out_of_range_exception {nullopt, inner_exception};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
    ...
    auto test_method_(constructor_with_nullopt_message_and_stack_frame_inner_exception) {
      auto inner_exception = argument_exception {};
      auto stack_frame = xtd::diagnostics::stack_frame::current();
      auto e = index_out_of_range_exception {nullopt, inner_exception, stack_frame};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
    ...
    auto test_method_(constructor_with_message_and_inner_exception) {
      auto inner_exception = argument_exception {};
      auto e = index_out_of_range_exception {"Test excpetion message.", inner_exception};
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
      assert::are_equal(e.h_result(), e.error_code().value());
    ...
    auto test_method_(constructor_with_message_inner_exception_and_stack_frame) {
      auto inner_exception = argument_exception {};
      auto stack_frame = xtd::diagnostics::stack_frame::current();
      auto e = index_out_of_range_exception {"Test excpetion message.", inner_exception, stack_frame};
      assert::are_equal("xtd::index_out_of_range_exception", e.get_type().full_name());
      assert::is_empty(e.help_link());
      assert::are_equal(h_result::COR_E_INDEXOUTOFRANGE, e.h_result());
      assert::are_equal(h_result::h_result_category(), e.error_code().category());
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::index_out_of_range_exception : Test excpetion message." + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("Test excpetion message.", e.what());
    }
  };
}
