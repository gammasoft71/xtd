...
namespace xtd::tests {
  class test_class_(invalid_cast_exception_tests) {
    ...
    static void test_initialize_(test_initialize) {
      ...
      stack_trace_enabled = invalid_cast_exception::enable_stack_trace();
      invalid_cast_exception::enable_stack_trace(false);
    }
    
    static void test_cleanup_(test_cleanup) {
      xtd::globalization::culture_info::current_culture(previous_culture);
      invalid_cast_exception::enable_stack_trace(stack_trace_enabled);
    }
  };
}
