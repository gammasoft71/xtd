...
namespace xtd::tests {
  class test_class_(console_tests) {
    ...
    auto test_method_(cursor_visible) {
      ...
      assert::is_true(console::cursor_visible());
    ...
    auto test_method_(is_error_redirected) {
      ...
      assert::is_true(console::is_error_redirected());
      es.close();
    ...
    auto test_method_(is_input_redirected) {
      ...
      console::set_in(is);
      assert::is_true(console::is_input_redirected());
      is.close();
    ...
    auto test_method_(is_output_redirected) {
      ...
      console::set_out(os);
      assert::is_true(console::is_output_redirected());
      os.close();
    ...
    auto test_method_(treat_control_c_as_input) {
      ...
      assert::is_true(console::treat_control_c_as_input());
      console::treat_control_c_as_input(treat_control_c_as_input);
      assert::are_equal(treat_control_c_as_input, console::treat_control_c_as_input());
    }
    ...
    auto test_method_(window_height) {
      ...
      //assert::are_equal(40, console::window_height());
      console::window_height(window_height);
      assert::are_equal(window_height, console::window_height());
    }
    */
    ...
    auto test_method_(window_height_with_invalid_values) {
      ...
      assert::throws<argument_out_of_range_exception>([] {console::window_height(as<int32>(int16_object::max_value) + 1);});
    }
    ...
    auto test_method_(window_left) {
      ...
      //assert::are_equal(5, console::window_left());
      console::window_left(window_left);
      assert::are_equal(window_left, console::window_left());
    }
    */
    ...
    auto test_method_(window_top) {
      ...
      // assert::are_equal(5, console::window_top());
      console::window_top(window_top);
      assert::are_equal(window_top, console::window_top());
    }
    */
    ...
    auto test_method_(window_width) {
      ...
      //assert::are_equal(100, console::window_width());
      console::window_width(window_width);
      assert::are_equal(window_width, console::window_width());
    }
    */
    ...
    auto test_method_(get_cursor_position) {
      ...
      console::cursor_left(20);
      console::cursor_top(10);
      assert::are_equal(std::make_pair(20, 10), console::get_cursor_position());
    ...
    auto test_method_(read_line) {
      ...
      assert::are_equal("line 1", console::read_line());
      assert::are_equal("line 2", console::read_line());
      assert::are_equal("line 3", console::read_line());
    ...
    auto test_method_(set_error) {
      ...
      auto es = xtd::io::file::open_write(ep);
      console::set_error(es);
      assert::are_not_equal(std::cerr.rdbuf(), console::error.rdbuf());
      assert::is_true(console::is_error_redirected());
      es.close();
      console::set_error(console::open_standard_error());
      assert::is_false(console::is_error_redirected());
    ...
    auto test_method_(set_in) {
      ...
      auto is = xtd::io::file::open_read(ip);
      console::set_in(is);
      assert::are_not_equal(std::cin.rdbuf(), console::in.rdbuf());
      assert::is_true(console::is_input_redirected());
      is.close();
      console::set_in(console::open_standard_input());
      assert::is_false(console::is_input_redirected());
    ...
    auto test_method_(set_out) {
      ...
      auto os = xtd::io::file::open_write(op);
      console::set_out(os);
      assert::are_not_equal(std::cout.rdbuf(), console::out.rdbuf());
      assert::is_true(console::is_output_redirected());
      os.close();
      console::set_out(console::open_standard_output());
      assert::is_false(console::is_output_redirected());
    ...
    auto test_method_(set_window_position) {
      ...
      //assert::are_equal(20, console::window_left());
      //assert::are_equal(10, console::window_top());
    ...
    */
    ...
    auto test_method_(set_window_position_with_invalid_values) {
      ...
      assert::throws<argument_out_of_range_exception>([] {console::set_window_position(0, console::buffer_height());});
    }
    ...
    auto test_method_(set_window_size) {
      ...
      //assert::are_equal(20, console::window_width());
      //assert::are_equal(10, console::window_height());
    ...
    */
    ...
    auto test_method_(set_window_size_with_invalid_values) {
      ...
      assert::throws<argument_out_of_range_exception>([] {console::set_window_size(10, 0);});
      assert::throws<argument_out_of_range_exception>([] {console::set_window_size(10, -1);});
    ...
    auto test_method_(write) {
      ...
      console::write("Item3");
      os.close();
      assert::are_equal("Item1Item2Item3", file::read_all_text(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
    ...
    auto test_method_(write_literal_strings) {
      ...
      os.close();
      assert::are_equal("Item1Item2Item3Item4Item5", file::read_all_text(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
    ...
    auto test_method_(write_strings) {
      ...
      os.close();
      assert::are_equal("Item1Item2Item3Item4Item5Item6", file::read_all_text(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
    ...
    auto test_method_(write_some_objects) {
      ...
      console::write({1, 2, 3});
      os.close();
      assert::are_equal("03:42:353fcf73d9-6c77-4bd1-a030-1e1fad500a47[1, 2, 3]", file::read_all_text(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
    ...
    auto test_method_(write_line) {
      ...
      os.close();
      collection_assert::are_equal({"Item1", "Item2", "Item3"}, file::read_all_lines(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
    ...
    auto test_method_(write_line_literal_strings) {
      ...
      os.close();
      collection_assert::are_equal({"Item1", "Item2", "Item3", "Item4", "Item5"}, file::read_all_lines(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
    ...
    auto test_method_(write_line_strings) {
      ...
      os.close();
      collection_assert::are_equal({"Item1", "Item2", "Item3", "Item4", "Item5", "Item6"}, file::read_all_lines(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
    ...
    auto test_method_(write_line_some_objects) {
      ...
      os.close();
      collection_assert::are_equal({"03:42:35", "3fcf73d9-6c77-4bd1-a030-1e1fad500a47", "[1, 2, 3]"}, file::read_all_lines(op));
      file::remove(op);
      console::set_out(console::open_standard_output());
    }
