...
namespace xtd::tests {
  class test_class_(unique_ptr_object_tests) {
    ...
    void test_method_(deleter_type) {
    ...
    void test_method_(pointer_type) {
    ...
    void test_method_(create_with_empty_unique_ptr_object) {
      auto s = unique_ptr_object<int> {unique_ptr_object<int> {}};
      assert::is_null(s.get());
    }

    void test_method_(create_with_empty_std_unique_ptr) {
      auto s = unique_ptr_object<int> {std::unique_ptr<int> {}};
      assert::is_null(s.get());
    }

    void test_method_(create_with_unique_ptr_object) {
      auto p = new int {42};
      auto s = unique_ptr_object<int> {unique_ptr_object<int> {p}};
      assert::are_equal(p, s.get());
    }

    void test_method_(create_with_std_unique_ptr) {
      auto p = new int {42};
      auto s = unique_ptr_object<int> {std::unique_ptr<int> {p}};
      assert::are_equal(p, s.get());
    }

    void test_method_(create_with_different_type_of_unique_ptr_object) {
      auto p = new string {"value"};
      auto s = unique_ptr_object<object> {unique_ptr_object<string> {p}};
      assert::are_equal(p, s.get());
    }

    void test_method_(create_with_different_type_of_std_unique_ptr) {
      auto p = new string {"value"};
    ...
    void test_method_(assignment_operator_with_moved_unique_ptr_object) {
      auto s = unique_ptr_object<int> {};
      s = unique_ptr_object<int> {new int {42}};
      assert::is_not_null(s.to_pointer());
    }
    
    void test_method_(assignment_operator_with_moved_unique_ptr_object_and_different_type) {
      auto s = unique_ptr_object<object> {};
      s = unique_ptr_object<string> {new string {"value"}};
      assert::is_not_null(s.to_pointer());
    }
    
    void test_method_(assignment_operator_with_moved_std_unique_ptr) {
      auto s = unique_ptr_object<int> {};
