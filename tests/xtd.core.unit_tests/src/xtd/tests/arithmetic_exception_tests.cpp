...
namespace xtd::tests {
  class test_class_(arithmetic_exception_tests) {
    ...
    void test_method_(default_creator) {
      ...
      assert::are_equal("Overflow or underflow in the arithmetic operation.", e.message(), csf_);
      assert::are_equal("xtd::arithmetic_exception", e.name(), csf_);
      assert::is_empty(e.stack_trace(), csf_);
      assert::are_equal("xtd::arithmetic_exception : Overflow or underflow in the arithmetic operation.", e.to_string(), csf_);
      assert::are_equal("Overflow or underflow in the arithmetic operation.", e.what(), csf_);
    }
    ...
    void test_method_(default_creator_with_current_stack_frame) {
      ...
      assert::are_equal("xtd::arithmetic_exception : Overflow or underflow in the arithmetic operation.\n" + info.to_string(), e.to_string(), csf_);
      assert::are_equal("Overflow or underflow in the arithmetic operation.", e.what(), csf_);
    }
    ...
    void test_method_(creator_with_empty_message) {
      ...
      assert::are_equal("xtd::arithmetic_exception", e.name(), csf_);
      assert::is_empty(e.stack_trace(), csf_);
      assert::are_equal("xtd::arithmetic_exception", e.to_string(), csf_);
      assert::are_equal("xtd::arithmetic_exception", e.what(), csf_);
    }
    ...
    void test_method_(creator_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal("xtd::arithmetic_exception", e.name(), csf_);
      assert::are_equal(info.to_string(), e.stack_trace(), csf_);
      assert::are_equal("xtd::arithmetic_exception\n" + info.to_string(), e.to_string(), csf_);
      assert::are_equal("xtd::arithmetic_exception", e.what(), csf_);
    }
    ...
    void test_method_(creator_with_message) {
      ...
      assert::are_equal("xtd::arithmetic_exception", e.name(), csf_);
      assert::is_empty(e.stack_trace(), csf_);
      assert::are_equal("xtd::arithmetic_exception : Test excpetion message.", e.to_string(), csf_);
    ...
    void test_method_(creator_with_message_and_stack_frame) {
      ...
      assert::are_equal("xtd::arithmetic_exception", e.name(), csf_);
      assert::are_equal(info.to_string(), e.stack_trace(), csf_);
      assert::are_equal("xtd::arithmetic_exception : Test excpetion message.\n" + info.to_string(), e.to_string(), csf_);
      assert::are_equal("Test excpetion message.", e.what(), csf_);
    }
