...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_default_tests<intptr>> numeric_parse_string_default_tests_class_intptr_t_attr {"numeric_parse_string_default_tests<intptr>"};
