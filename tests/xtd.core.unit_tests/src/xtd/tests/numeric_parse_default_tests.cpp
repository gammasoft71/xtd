...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_default_tests<int32>> numeric_parse_string_default_tests_class_int32_t_attr {"numeric_parse_string_default_tests<int32>"};
  test_class_attribute<numeric_parse_string_default_tests<int64>> numeric_parse_string_default_tests_class_int64_t_attr {"numeric_parse_string_default_tests<int64>"};
  test_class_attribute<numeric_parse_string_default_tests<intptr_t>> numeric_parse_string_default_tests_class_intptr_t_attr {"numeric_parse_string_default_tests<intptr_t>"};
  ...
  test_class_attribute<numeric_parse_string_default_tests<uint16_t>> numeric_parse_string_default_tests_class_uint16_t_attr {"numeric_parse_string_default_tests<uint16_t>"};
  test_class_attribute<numeric_parse_string_default_tests<uint32_t>> numeric_parse_string_default_tests_class_uint32_t_attr {"numeric_parse_string_default_tests<uint32_t>"};
