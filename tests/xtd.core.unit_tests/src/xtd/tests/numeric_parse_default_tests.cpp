...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_default_tests<uint8_t>> numeric_parse_string_default_tests_class_uint8_t_attr {"numeric_parse_string_default_tests<uint8_t>"};
