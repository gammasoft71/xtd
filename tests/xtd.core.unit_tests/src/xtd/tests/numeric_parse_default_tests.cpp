...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_default_tests<uintptr>> numeric_parse_string_default_tests_class_uintptr_t_attr {"numeric_parse_string_default_tests<uintptr>"};
