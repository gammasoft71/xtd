...
namespace xtd::tests {
  class test_class_(operating_system_tests) {
    auto test_method_(create_with_default_ctor) {
    ...
    auto test_method_(create_with_platform_id_and_version) {
    ...
    auto test_method_(create_with_platform_id_version_and_service_pack) {
    ...
    auto test_method_(create_with_platform_id_version_service_pack_and_desktop_environment) {
    ...
    auto test_method_(create_with_platform_id_version_service_pack_desktop_environment_and_desktop_theme) {
    ...
    auto test_method_(create_with_platform_id_version_service_pack_desktop_environment_desktop_theme_and_is_64_bit_to_false) {
    ...
    auto test_method_(create_with_platform_id_version_service_pack_desktop_environment_desktop_theme_and_is_64_bit_to_true) {
    ...
    auto test_method_(create_with_platform_id_version_service_pack_desktop_environment_desktop_theme_is_64_bit_and_distribution) {
    ...
    auto test_method_(desktop_environment) {
    ...
    auto test_method_(desktop_theme) {
    ...
    auto test_method_(distribution) {
    ...
    auto test_method_(service_pack) {
    ...
    auto test_method_(version_string) {
    ...
    auto test_method_(is_apple_platform) {
    ...
    auto test_method_(is_bsd_platform) {
    ...
    auto test_method_(is_serenityos) {
    ...
    auto test_method_(is_macos_platform) {
    ...
    auto test_method_(is_posix_platform) {
    ...
    auto test_method_(is_unix_platform) {
    ...
    auto test_method_(is_windows_ce) {
    ...
    auto test_method_(is_windows_platform) {
