...
namespace xtd::tests {
  class test_class_(target_id_tests) {
    ...
    auto test_method_(console_application) {
    ...
    auto test_method_(gui_application) {
    ...
    auto test_method_(test_application) {
    ...
    auto test_method_(interface_library) {
    ...
    auto test_method_(module_library) {
    ...
    auto test_method_(shared_library) {
    ...
    auto test_method_(static_library) {
    ...
    auto test_method_(custom_target) {
