...
namespace xtd::tests {
  class test_class_(string_tests) {
    ...
    auto test_method_(remove_start_index_out_of_range) {
      assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = string("0123456").remove(10);});
    }
    
    auto test_method_(remove_start_index_count_out_of_range) {
      assert::throws<index_out_of_range_exception>([] {[[maybe_unused]] auto _ = string("0123456").remove(3, 10);});
    }
    ...
    auto test_method_(substring_start_index_out_of_range) {
      assert::throws<argument_out_of_range_exception>([] {[[maybe_unused]] auto _ = string("0123456").substring(10);});
    }
    
    auto test_method_(substring_count_out_of_range) {
      assert::throws<argument_out_of_range_exception>([] {[[maybe_unused]] auto _ = string("0123456").substring(2, 10);});
    }
