...
namespace xtd::tests {
  ...
  public:
    ...
    void test_method_(ctor_witth_cpp20) {
      ...
      assert::are_equal(202002, cl.value(), csf_);
    ...
    void test_method_(ctor_witth_cpp17) {
      ...
      assert::are_equal(201703, cl.value(), csf_);
    ...
    void test_method_(ctor_witth_cpp14) {
      ...
      assert::are_equal(201402, cl.value(), csf_);
    ...
    void test_method_(ctor_witth_cpp11) {
      ...
      assert::are_equal(201103, cl.value(), csf_);
    ...
    void test_method_(ctor_witth_cpp98) {
      ...
      assert::are_equal(199711, cl.value(), csf_);
    ...
    void test_method_(ctor_witth_cpp_pre98) {
      ...
      assert::are_equal(1, cl.value(), csf_);
    ...
    void test_method_(ctor_with_cpp20_experimental) {
      ...
      assert::are_equal(201707, cl.value(), csf_);
