...
namespace xtd::tests {
  class test_class_(enum_object_with_registered_enum_class_tests) {
    void test_method_(enum_object_with_registered_enum_class_test_default_ctor) {
      ...
      assert::is_false(e.has_flag(enum_object_with_registered_enum_class_test::one));
      assert::are_equal(enum_object_with_registered_enum_class_test::none, e);
      assert::are_equal(enum_object_with_registered_enum_class_test::none, e.value());
    ...
    void test_method_(enum_object_with_registered_enum_class_test_ctor_with_one) {
      ...
      assert::is_false(e.has_flag(enum_object_with_registered_enum_class_test::two));
      assert::are_equal(enum_object_with_registered_enum_class_test::one, e);
      assert::are_equal(enum_object_with_registered_enum_class_test::one, e.value());
    ...
    void test_method_(enum_object_with_registered_enum_class_test_ctor_with_two) {
      ...
      assert::is_false(e.has_flag(enum_object_with_registered_enum_class_test::one));
      assert::are_equal(enum_object_with_registered_enum_class_test::two, e);
      assert::are_equal(enum_object_with_registered_enum_class_test::two, e.value());
    ...
    void test_method_(enum_object_with_registered_enum_class_test_ctor_with_three) {
      ...
      assert::is_false(e.has_flag(enum_object_with_registered_enum_class_test::four));
      assert::are_equal(enum_object_with_registered_enum_class_test::three, e);
      assert::are_equal(enum_object_with_registered_enum_class_test::three, e.value());
    ...
    void test_method_(enum_object_with_registered_enum_class_test_ctor_with_four) {
      ...
      assert::is_false(e.has_flag(enum_object_with_registered_enum_class_test::one));
      assert::are_equal(enum_object_with_registered_enum_class_test::four, e);
      assert::are_equal(enum_object_with_registered_enum_class_test::four, e.value());
    ...
    void test_method_(enum_object_with_registered_enum_class_test_ctor_with_invalid_value) {
      ...
      assert::is_false(e.has_flag(enum_object_with_registered_enum_class_test::two));
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(5), e);
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(5), e.value());
    ...
    void test_method_(equals) {
      ...
      assert::is_false(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one) != enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one));
      assert::is_false(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one) == enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::two));
      assert::is_true(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one) != enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::two));
      
      assert::is_true(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one).equals(enum_object_with_registered_enum_class_test::one));
      assert::is_false(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one).equals(enum_object_with_registered_enum_class_test::two));
      assert::is_true(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one) == enum_object_with_registered_enum_class_test::one);
      assert::is_false(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one) != enum_object_with_registered_enum_class_test::one);
      assert::is_false(enum_object<enum_object_with_registered_enum_class_test>(enum_object_with_registered_enum_class_test::one) == enum_object_with_registered_enum_class_test::two);
    ...
    void test_method_(get_name) {
      ...
      assert::are_equal("three", enum_object<>::get_name(enum_object_with_registered_enum_class_test::three));
      assert::are_equal("four", enum_object<>::get_name(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(get_name_enum_object) {
      ...
      assert::are_equal("three", enum_object<>::get_name(enum_object<enum_object_with_registered_enum_class_test> {enum_object_with_registered_enum_class_test::three}));
      assert::are_equal("four", enum_object<>::get_name(enum_object<enum_object_with_registered_enum_class_test> {enum_object_with_registered_enum_class_test::four}));
    ...
    void test_method_(get_name_int32) {
      ...
      assert::are_equal("three", enum_object<>::get_name<enum_object_with_registered_enum_class_test>(as<int32>(3)));
      assert::are_equal("four", enum_object<>::get_name<enum_object_with_registered_enum_class_test>(as<int32>(4)));
    ...
    void test_method_(get_name_int64) {
      ...
      assert::are_equal("three", enum_object<>::get_name<enum_object_with_registered_enum_class_test>(as<int64>(3)));
      assert::are_equal("four", enum_object<>::get_name<enum_object_with_registered_enum_class_test>(as<int64>(4)));
    ...
    void test_method_(is_defined) {
      ...
      assert::is_true(enum_object<>::is_defined(enum_object_with_registered_enum_class_test::three));
      assert::is_true(enum_object<>::is_defined(enum_object_with_registered_enum_class_test::four));
      
      assert::is_true(enum_object<>::is_defined(as<enum_object_with_registered_enum_class_test>(0)));
      assert::is_true(enum_object<>::is_defined(as<enum_object_with_registered_enum_class_test>(1)));
      assert::is_true(enum_object<>::is_defined(as<enum_object_with_registered_enum_class_test>(2)));
      assert::is_true(enum_object<>::is_defined(as<enum_object_with_registered_enum_class_test>(3)));
      assert::is_true(enum_object<>::is_defined(as<enum_object_with_registered_enum_class_test>(4)));
    ...
    void test_method_(is_defined_enum_object) {
      ...
      assert::is_true(enum_object<>::is_defined(enum_object<enum_object_with_registered_enum_class_test> {enum_object_with_registered_enum_class_test::three}));
      assert::is_true(enum_object<>::is_defined(enum_object<enum_object_with_registered_enum_class_test> {enum_object_with_registered_enum_class_test::four}));
      
      assert::is_true(enum_object<>::is_defined(enum_object<enum_object_with_registered_enum_class_test> {as<enum_object_with_registered_enum_class_test>(0)}));
      assert::is_true(enum_object<>::is_defined(enum_object<enum_object_with_registered_enum_class_test> {as<enum_object_with_registered_enum_class_test>(1)}));
      assert::is_true(enum_object<>::is_defined(enum_object<enum_object_with_registered_enum_class_test> {as<enum_object_with_registered_enum_class_test>(2)}));
      assert::is_true(enum_object<>::is_defined(enum_object<enum_object_with_registered_enum_class_test> {as<enum_object_with_registered_enum_class_test>(3)}));
      assert::is_true(enum_object<>::is_defined(enum_object<enum_object_with_registered_enum_class_test> {as<enum_object_with_registered_enum_class_test>(4)}));
    ...
    void test_method_(parse) {
      ...
      assert::are_equal(enum_object_with_registered_enum_class_test::three, enum_object<>::parse<enum_object_with_registered_enum_class_test>("three"));
      assert::are_equal(enum_object_with_registered_enum_class_test::four, enum_object<>::parse<enum_object_with_registered_enum_class_test>("four"));
      
      assert::are_equal(enum_object_with_registered_enum_class_test::none, enum_object<>::parse<enum_object_with_registered_enum_class_test>("0"));
      assert::are_equal(enum_object_with_registered_enum_class_test::one, enum_object<>::parse<enum_object_with_registered_enum_class_test>("1"));
      assert::are_equal(enum_object_with_registered_enum_class_test::two, enum_object<>::parse<enum_object_with_registered_enum_class_test>("2"));
      assert::are_equal(enum_object_with_registered_enum_class_test::three, enum_object<>::parse<enum_object_with_registered_enum_class_test>("3"));
    ...
    void test_method_(to_byte) {
      ...
      assert::are_equal(as<byte>(3), enum_object<>::to_byte(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<byte>(4), enum_object<>::to_byte(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(to_int16) {
      ...
      assert::are_equal(as<int16>(3), enum_object<>::to_int16(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<int16>(4), enum_object<>::to_int16(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(to_int32) {
      ...
      assert::are_equal(as<int32>(3), enum_object<>::to_int32(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<int32>(4), enum_object<>::to_int32(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(to_int64) {
      ...
      assert::are_equal(as<int64>(3), enum_object<>::to_int64(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<int64>(4), enum_object<>::to_int64(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(to_sbyte) {
      ...
      assert::are_equal(as<sbyte>(3), enum_object<>::to_sbyte(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<sbyte>(4), enum_object<>::to_sbyte(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(to_uint16) {
      ...
      assert::are_equal(as<uint16>(3), enum_object<>::to_uint16(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<uint16>(4), enum_object<>::to_uint16(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(to_uint32) {
      ...
      assert::are_equal(as<uint32>(3), enum_object<>::to_uint32(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<uint32>(4), enum_object<>::to_uint32(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(to_uint64) {
      ...
      assert::are_equal(as<uint64>(3), enum_object<>::to_uint64(enum_object_with_registered_enum_class_test::three));
      assert::are_equal(as<uint64>(4), enum_object<>::to_uint64(enum_object_with_registered_enum_class_test::four));
    ...
    void test_method_(try_parse) {
      ...
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("one", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::one, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("two", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::two, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("three", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::three, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("four", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::four, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("0", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::none, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("1", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::one, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("2", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::two, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("3", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::three, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("4", result));
      assert::are_equal(enum_object_with_registered_enum_class_test::four, result);
    }
    ...
    void test_method_(try_parse_with_invalid_enum) {
      ...
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_false(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("five", result));
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(-1), result);
      
      assert::is_false(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("OnE", result));
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(-1), result);
    }
    ...
    void test_method_(try_parse_with_ignore_case_to_false) {
      ...
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_false(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("OnE", false, result));
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(-1), result);
      
      assert::is_false(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("TWO", false, result));
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(-1), result);
      
      assert::is_false(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("tHREE", false, result));
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(-1), result);
      
      assert::is_false(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("Four", false, result));
      assert::are_equal(as<enum_object_with_registered_enum_class_test>(-1), result);
    }
    ...
    void test_method_(try_parse_with_ignore_case_to_true) {
      ...
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("OnE", true, result));
      assert::are_equal(enum_object_with_registered_enum_class_test::one, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("TWO", true, result));
      assert::are_equal(enum_object_with_registered_enum_class_test::two, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("tHREE", true, result));
      assert::are_equal(enum_object_with_registered_enum_class_test::three, result);
      
      result = as<enum_object_with_registered_enum_class_test>(-1);
      assert::is_true(enum_object<>::try_parse<enum_object_with_registered_enum_class_test>("Four", true, result));
      assert::are_equal(enum_object_with_registered_enum_class_test::four, result);
    }
  };
}
