...
namespace xtd::tests {
  class test_class_(time_span_tests) {
    auto test_method_(nanoseconds_per_tick) {
      assert::are_equal(100ll, time_span::nanoseconds_per_tick);
    }
    
    auto test_method_(ticks_per_microsecond) {
      assert::are_equal(10ll, time_span::ticks_per_microsecond);
    }
    
    auto test_method_(ticks_per_millisecond) {
    ...
    auto test_method_(ticks_per_second) {
    ...
    auto test_method_(ticks_per_minute) {
    ...
    auto test_method_(ticks_per_hour) {
    ...
    auto test_method_(ticks_per_day) {
    ...
    auto test_method_(ctor_with_ticks) {
    ...
    auto test_method_(ctor_with_ticks_duration) {
      assert::are_equal(42ll, time_span {xtd::ticks {42}}.ticks());
      assert::are_equal(-42ll, time_span {xtd::ticks {-42}}.ticks());
    }
    
    auto test_method_(ctor_with_hours_minutes_seconds) {
    ...
    auto test_method_(operator_minus_equal) {
      auto ts = time_span {42};
      ts -= time_span {24};
      assert::are_equal(18, ts.ticks());
    }
    
    auto test_method_(operator_multiply) {
    ...
    auto test_method_(operator_plus) {
      assert::are_equal(66, (time_span {42} + time_span {24}).ticks());
      assert::are_equal(18, (time_span {42} + time_span {-24}).ticks());
      assert::are_equal(-18, (time_span {-42} + time_span {24}).ticks());
      assert::are_equal(-66, (time_span {-42} + time_span {-24}).ticks());
    ...
    auto test_method_(total_days_duration) {
    ...
    auto test_method_(divide_by_zero_exception) {
      assert::throws<divided_by_zero_exception>([] {[[maybe_unused]] auto _ = time_span {42}.divide(time_span {0});});
      assert::throws<divided_by_zero_exception>([] {[[maybe_unused]] auto _ = time_span {42}.divide(.0);});
    }
    ...
    auto test_method_(from_ticks_duration) {
    ...
    auto test_method_(parse_with_overflow_exception) {
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto _ = time_span::parse("25:12:00");});
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto _ = time_span::parse("6:61:00");});
      assert::throws<overflow_exception>([] {[[maybe_unused]] auto _ = time_span::parse("6:00:61");});
    }
    
    auto test_method_(parse_with_format_exception) {
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = time_span::parse("6.12:14:45.344");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = time_span::parse("6.12:14:45.344000");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = time_span::parse("6.12:14:45.34400000");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = time_span::parse("6.2:12:14:45.3440000");});
    }
    ...
    auto test_method_(to_string_with_format_c) {
    ...
    auto test_method_(to_string_with_format_d) {
    ...
    auto test_method_(to_string_with_format_f) {
    ...
    auto test_method_(to_string_with_format_g) {
    ...
    auto test_method_(to_string_with_format_h) {
    ...
    auto test_method_(to_string_with_format_l) {
    ...
    auto test_method_(to_string_with_format_m) {
    ...
    auto test_method_(to_string_with_format_o) {
    ...
    auto test_method_(to_string_with_format_s) {
    ...
    auto test_method_(to_string_with_format_t) {
