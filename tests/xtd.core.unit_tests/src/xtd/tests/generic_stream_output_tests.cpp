...
namespace xtd::tests {
  class test_class_(generic_stream_output_tests) {
    ...
    auto test_method_(write_bool_true) {
      auto result = std::stringstream {};
      auto co = console_output {result};
      console::write(true);
    ...
    auto test_method_(write_bool_false) {
      auto result = std::stringstream {};
      auto co = console_output {result};
      console::write(false);
    ...
    /*
    auto test_method_(write_invalid_argument) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_duration) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_forward_list) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_initializer_list) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_multimap) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_multiset) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_optional_without_value) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_optional_with_value) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_unordered_map) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_unordered_multimap) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_unordered_multiset) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_unordered_set) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_valarray) {
      auto result = std::stringstream {};
      auto co = console_output {result};
    ...
    auto test_method_(write_vector) {
      auto result = std::stringstream {};
      auto co = console_output {result};
