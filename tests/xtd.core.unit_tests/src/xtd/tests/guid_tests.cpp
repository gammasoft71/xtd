...
namespace xtd::tests {
  class test_class_(guid_tests) {
    ...
    void test_method_(create_guid_from_byte_array) {
      assert::are_equal("10203040-5060-7080-90a0-b0c0d0e0f001", guid(std::vector<xtd::byte> {0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF0, 0x01}).to_string());
    }
    ...
    void test_method_(constructor) {
      ...
      assert::are_equal("10203040-5060-7080-90a0-b0c0d0e0f001", guid(0x10203040, 0x5060, 0x7080, std::vector<xtd::byte> {0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF0, 0x01}).to_string());
