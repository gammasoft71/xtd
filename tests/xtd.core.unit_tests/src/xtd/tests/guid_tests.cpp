...
namespace xtd::tests {
  ...
  public:
    ...
    void test_method_(constructor) {
      ...
      assert::are_equal("10203040-5060-7080-90a0-b0c0d0e0f001", guid(uint32_t(0x10203040), uint16(0x5060), uint16(0x7080), 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF0, 0x01).to_string(), csf_);
    }
    ...
    void test_method_(constructor2) {
      ...
      assert::are_equal(xtd::guid(uint32_t(0x00000000), uint16(0x0000), uint16(0x0000), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01).compare_to(xtd::guid(uint32_t(0x00000000), uint16(0x0000), uint16(0x0000), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01)), 0);
      assert::is_less(xtd::guid(uint32_t(0x00000000), uint16(0x0000), uint16(0x0000), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01).compare_to(xtd::guid(uint32_t(0x00000000), uint16(0x0000), uint16(0x0000), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02)), 0, csf_);
      assert::is_greater(xtd::guid(uint32_t(0x00000000), uint16(0x0000), uint16(0x0000), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02).compare_to(xtd::guid(uint32_t(0x00000000), uint16(0x0000), uint16(0x0000), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01)), 0, csf_);
    }
