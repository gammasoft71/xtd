...
namespace xtd::tests {
  class test_class_(reference_wrapper_object_tests) {
    ...
    auto test_method_(empty) {
      ...
      assert::throws<null_pointer_exception>([] {auto __ = reference_wrapper_object<int>::empty.get();});
    }
    
    auto test_method_(create_with_no_param) {
      auto r = reference_wrapper_object<int> {};
      assert::is_true(r.is_empty());
      assert::throws<null_pointer_exception>([&] {auto __ = r.get();});
    }
    ...
    auto test_method_(create_with_empty_reference_wrapper_object) {
      ...
      assert::throws<null_pointer_exception>([&] {auto __ = r2.get();});
    }
    ...
    auto test_method_(reference) {
      ...
      assert::throws<null_pointer_exception>([] {auto __ = reference_wrapper_object<int>::empty.reference();});
    }
    ...
    auto test_method_(to_object) {
      ...
      assert::throws<null_pointer_exception>([] {auto __ = reference_wrapper_object<object> {}.to_object();});
    }
    ...
    auto test_method_(to_object_with_specified_type) {
      ...
      assert::throws<null_pointer_exception>([] {auto __ = reference_wrapper_object<object> {}.to_object<string>();});
    }
    ...
    auto test_method_(to_reference) {
      ...
      assert::throws<null_pointer_exception>([] {auto __ = reference_wrapper_object<object> {}.to_reference();});
    }
    ...
    auto test_method_(to_reference_with_specified_type) {
      ...
      assert::throws<null_pointer_exception>([] {auto __ = reference_wrapper_object<object> {}.to_reference<string>();});
    }
