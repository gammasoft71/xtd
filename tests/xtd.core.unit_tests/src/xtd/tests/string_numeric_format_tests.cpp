...
namespace xtd::tests {
  ...
  test_class_attribute<string_numeric_format_tests<char>> string_numeric_format_tests_class_char_attr {"string_numeric_format_tests<char>"};
  test_class_attribute<string_numeric_format_tests<unsigned char>> string_numeric_format_tests_class_unsigned_char_attr {"string_numeric_format_tests<unsigned char>"};
  ...
  test_class_attribute<string_numeric_format_tests<unsigned short>> string_numeric_format_tests_class_unsigned_short_attr {"string_numeric_format_tests<unsigned short>"};
  ...
  test_class_attribute<string_numeric_format_tests<unsigned int>> string_numeric_format_tests_class_unsigned_int_attr {"string_numeric_format_tests<unsigned int>"};
  ...
  test_class_attribute<string_numeric_format_tests<unsigned long>> string_numeric_format_tests_class_unsigned_long_attr {"string_numeric_format_tests<unsigned long>"};
  test_class_attribute<string_numeric_format_tests<long long>> string_numeric_format_tests_class_long_long_attr {"string_numeric_format_tests<long long>"};
  test_class_attribute<string_numeric_format_tests<unsigned long long>> string_numeric_format_tests_class_unsigned_long_long_attr {"string_numeric_format_tests<unsigned long long>"};
  ...
  public:
    ...
    void test_method_(format_with_default_argument) {
      if (std::is_same<Value, char>::value)
        assert::are_equal("*", ustring::format("{0}", static_cast<Value>(42)), csf_);
      else
        assert::are_equal("42", ustring::format("{0}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_left_alignment) {
      if (std::is_same<Value, char>::value)
        assert::are_equal("   *", ustring::format("{0,4}", static_cast<Value>(42)), csf_);
      else
        assert::are_equal("  42", ustring::format("{0,4}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_left_alignment_to_zero) {
      if (std::is_same<Value, char>::value)
        assert::are_equal("*", ustring::format("{0,0}", static_cast<Value>(42)), csf_);
      else
        assert::are_equal("42", ustring::format("{0,0}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_binary_argument) {
      assert::are_equal("101010", ustring::format("{0:b}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_binary_argument_and_one_digit_precision) {
      assert::are_equal("00101010", ustring::format("{0:B8}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_binary_argument_and_two_digits_precision) {
      assert::are_equal("0000101010", ustring::format("{0:B10}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_currency_argument) {
      assert::are_equal("$42.00", ustring::format("{0:c}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_currency_argument_and_one_digit_precision) {
      assert::are_not_equal("$42.00000", ustring::format("{0:C5}", static_cast<Value>(42)), "The precision of currency format  is ignored", csf_);
      assert::are_equal("$42.00", ustring::format("{0:C5}", static_cast<Value>(42)), "The precision of currency format is ignored", csf_);
    }
    
    void test_method_(format_with_currency_argument_and_two_digits_precision) {
      assert::are_not_equal("$42.00000", ustring::format("{0:C10}", static_cast<Value>(42)), "The precision of currency format  is ignored", csf_);
      assert::are_equal("$42.00", ustring::format("{0:C10}", static_cast<Value>(42)), "The precision of currency format is ignored", csf_);
    }
    ...
    void test_method_(format_with_decimal_argument) {
      assert::are_equal("42", ustring::format("{0:d}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_decimal_argument_and_one_digit_precision) {
      assert::are_equal("00042", ustring::format("{0:D5}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_decimal_argument_and_two_digits_precision) {
      assert::are_equal("0000000042", ustring::format("{0:D10}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_negative_with_decimal_argument_and_two_digits_precision) {
      if (std::is_signed<Value>::value)
        assert::are_equal("-0000000123", ustring::format("{0:D10}", static_cast<Value>(-123)), csf_);
    }
    ...
    void test_method_(format_with_exponencial_argument_and_one_digit_precision) {
      assert::are_equal("4.20000000E+01", ustring::format("{0:E8}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_exponencial_argument_and_two_digits_precision) {
      assert::are_equal("4.2000000000E+01", ustring::format("{0:E10}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_fixed_point_argument) {
      assert::are_equal("42.00", ustring::format("{0:f}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_fixed_point_argument_and_one_digit_precision) {
      assert::are_equal("42.0000", ustring::format("{0:F4}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_fixed_point_argument_and_two_digits_precision) {
      assert::are_equal("42.0000000000", ustring::format("{0:F10}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_general_argument) {
      assert::are_equal("42", ustring::format("{0:g}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_general_argument_and_one_digit_precision) {
      assert::are_equal("42", ustring::format("{0:G2}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_general_argument_and_two_digits_precision) {
      assert::are_equal("42", ustring::format("{0:G10}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_number_argument) {
      if (std::is_same<Value, char>::value || std::is_same<Value, unsigned char>::value || std::is_same<Value, int8_t>::value || std::is_same<Value, uint8_t>::value)
        ...
        assert::are_equal("1,234,567.00", ustring::format("{0:n}", static_cast<Value>(1234567)), csf_);
    }
    ...
    void test_method_(format_with_number_argument_and_one_digit_precision) {
      if (std::is_same<Value, char>::value || std::is_same<Value, unsigned char>::value || std::is_same<Value, int8_t>::value || std::is_same<Value, uint8_t>::value)
        ...
        assert::are_equal("1,234,567.0000", ustring::format("{0:N4}", static_cast<Value>(1234567)), csf_);
    }
    ...
    void test_method_(format_with_number_argument_and_two_digits_precision) {
      if (std::is_same<Value, char>::value || std::is_same<Value, unsigned char>::value || std::is_same<Value, int8_t>::value || std::is_same<Value, uint8_t>::value)
        ...
        assert::are_equal("1,234,567.0000000000", ustring::format("{0:N10}", static_cast<Value>(1234567)), csf_);
    }
    ...
    void test_method_(format_with_octal_argument) {
      assert::are_equal("52", ustring::format("{0:o}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_octal_argument_and_one_digit_precision) {
      assert::are_equal("00052", ustring::format("{0:O5}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_octal_argument_and_two_digits_precision) {
      assert::are_equal("0000000052", ustring::format("{0:O10}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_percent_argument) {
      assert::are_equal("100.00 %", ustring::format("{0:p}", static_cast<Value>(1)), csf_);
    }
    
    void test_method_(format_with_percent_argument_and_one_digit_precision) {
      assert::are_equal("600.0000 %", ustring::format("{0:P4}", static_cast<Value>(6)), csf_);
    }
    
    void test_method_(format_with_percent_argument_and_two_digits_precision) {
      assert::are_equal("600.0000000000 %", ustring::format("{0:P10}", static_cast<Value>(6)), csf_);
    }
    ...
    void test_method_(format_with_hexadecimal_argument) {
      assert::are_equal("2a", ustring::format("{0:x}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_hexadecimal_argument_and_one_digit_precision) {
      assert::are_equal("002A", ustring::format("{0:X4}", static_cast<Value>(42)), csf_);
    }
    
    void test_method_(format_with_hexadecimal_argument_and_two_digits_precision) {
      assert::are_equal("000000002A", ustring::format("{0:X10}", static_cast<Value>(42)), csf_);
    }
    ...
    void test_method_(format_with_alignment_before_format) {
      assert::are_equal("    42", ustring::format("{0,6:D}", static_cast<Value>(42)), csf_);
    }
