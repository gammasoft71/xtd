...
namespace xtd::tests {
  class test_class_(registered_enum_struct_tests) {
    auto test_method_(format) {
      ...
      assert::are_equal("three", string::format("{}", registered_enum_struct_test::three));
    ...
    auto test_method_(format_with_specified_format) {
      ...
      assert::are_equal("4", string::format("{:D}", registered_enum_struct_test::four));
      assert::are_equal("four", string::format("{:g}", registered_enum_struct_test::four));
      assert::are_equal("four", string::format("{:G}", registered_enum_struct_test::four));
      assert::are_equal("04", string::format("0{:o}", registered_enum_struct_test::four));
      assert::are_equal("04", string::format("0{:O}", registered_enum_struct_test::four));
    ...
    auto test_method_(parse) {
      ...
      assert::are_equal(registered_enum_struct_test::three, string::parse<registered_enum_struct_test>("three"));
      assert::are_equal(registered_enum_struct_test::four, string::parse<registered_enum_struct_test>("four"));
      
      assert::are_equal(registered_enum_struct_test::none, string::parse<registered_enum_struct_test>("0"));
      assert::are_equal(registered_enum_struct_test::one, string::parse<registered_enum_struct_test>("1"));
      assert::are_equal(registered_enum_struct_test::two, string::parse<registered_enum_struct_test>("2"));
      assert::are_equal(registered_enum_struct_test::three, string::parse<registered_enum_struct_test>("3"));
    ...
    auto test_method_(parse_with_invalid_enum) {
      ...
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = string::parse<registered_enum_struct_test>("five");});
    }
  };
}
