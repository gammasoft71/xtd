...
namespace xtd::tests {
  ...
  public:
    ...
    void test_method_(parse) {
      ...
      //assert::are_equal(registered_enum_class_flags_test::one | registered_enum_class_flags_test::two, ustring::parse<registered_enum_class_flags_test>("oone, two"), csf_);
