...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_integer_tests<unsigned char>> numeric_parse_string_integer_tests_class_unsigned_char_attr {"numeric_parse_string_integer_tests<unsigned char>"};
  ...
  test_class_attribute<numeric_parse_string_integer_tests<unsigned short>> numeric_parse_string_integer_tests_class_unsigned_short_attr {"numeric_parse_string_integer_tests<unsigned short>"};
  ...
  test_class_attribute<numeric_parse_string_integer_tests<unsigned int>> numeric_parse_string_integer_tests_class_unsigned_int_attr {"numeric_parse_string_integer_tests<unsigned int>"};
  ...
  test_class_attribute<numeric_parse_string_integer_tests<unsigned long>> numeric_parse_string_integer_tests_class_unsigned_long_attr {"numeric_parse_string_integer_tests<unsigned long>"};
  test_class_attribute<numeric_parse_string_integer_tests<long long>> numeric_parse_string_integer_tests_class_long_long_attr {"numeric_parse_string_integer_tests<long long>"};
  test_class_attribute<numeric_parse_string_integer_tests<unsigned long long>> numeric_parse_string_integer_tests_class_unsigned_long_long_attr {"numeric_parse_string_integer_tests<unsigned long long>"};
