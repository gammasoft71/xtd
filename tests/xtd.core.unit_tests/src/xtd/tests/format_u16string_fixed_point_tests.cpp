...
namespace xtd::tests {
  ...
  class format_u16string_fixed_point_tests;
  
  test_class_attribute<format_u16string_fixed_point_tests<float>> format_u16string_fixed_point_tests_class_float_attr {"format_u16string_fixed_point_tests<float>"};
  test_class_attribute<format_u16string_fixed_point_tests<double>> format_u16string_fixed_point_tests_class_double_attr {"format_u16string_fixed_point_tests<double>"};
  test_class_attribute<format_u16string_fixed_point_tests<long double>> format_u16string_fixed_point_tests_class_long_double_attr {"format_u16string_fixed_point_tests<long_double>"};
