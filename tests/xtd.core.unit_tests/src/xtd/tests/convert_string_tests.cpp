...
namespace xtd::tests {
  ...
  public:
    ...
    void test_method_(literal_u32_to_wstring) {
      if (sizeof(wchar_t) > 2) {
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar_t>(0x1F428)}, convert_string::to_wstring(U"aeiouàçéèêëïî\U0001F428"), csf_);
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar_t>(0x1F428)}, convert_string::to_wstring(const_cast<char32*>(U"aeiouàçéèêëïî\U0001F428")), csf_);
      } else {
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar_t>(0xD83D), static_cast<wchar_t>(0xDC28)}, convert_string::to_wstring(U"aeiouàçéèêëïî\U0001F428"), csf_);
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar_t>(0xD83D), static_cast<wchar_t>(0xDC28)}, convert_string::to_wstring(const_cast<char32*>(U"aeiouàçéèêëïî\U0001F428")), csf_);
      }
    }
