...
namespace xtd::tests {
  class test_class_(convert_string_tests) {
    ...
    void test_method_(std_string_to_string) {
    ...
    void test_method_(std_string_to_u8string) {
    ...
    void test_method_(std_string_to_u16string) {
    ...
    void test_method_(std_u32string_to_u32string) {
    ...
    void test_method_(std_string_to_wstring) {
      if (sizeof(wchar) > 2)
