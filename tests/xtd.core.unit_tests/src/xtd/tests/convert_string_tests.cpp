  ...
  public:
    ...
    void test_method_(literal_u16_to_wstring) {
      if (sizeof(wchar_t) > 2) {
        ...
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar_t>(0x1F428)}, convert_string::to_wstring(const_cast<char16*>(u"aeiouàçéèêëïî\U0001F428")), csf_);
      } else {
        ...
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar_t>(0xD83D), static_cast<wchar_t>(0xDC28)}, convert_string::to_wstring(const_cast<char16*>(u"aeiouàçéèêëïî\U0001F428")), csf_);
      }
    }
