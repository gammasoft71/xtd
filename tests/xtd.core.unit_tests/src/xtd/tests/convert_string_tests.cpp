...
namespace xtd::tests {
  class test_class_(convert_string_tests) {
    ...
    void test_method_(string_to_string) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_string(std::string("aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
#if defined(__xtd__cpp_lib_char8_t)
    void test_method_(u8string_to_string) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_string(std::u8string(u8"aeiouàçéèêëïî\U0001F428")), csf_);
    }
#endif
    
    void test_method_(u16string_to_string) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_string(std::u16string(u"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(u32string_to_string) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_string(std::u32string(U"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(wstring_to_string) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_string(std::wstring(L"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    ...
    void test_method_(string_to_ustring) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_ustring(std::string("aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
#if defined(__xtd__cpp_lib_char8_t)
    void test_method_(u8string_to_ustring) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_ustring(std::u8string(u8"aeiouàçéèêëïî\U0001F428")), csf_);
    }
#endif
    
    void test_method_(u16string_to_ustring) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_ustring(std::u16string(u"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(u32string_to_ustring) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_ustring(std::u32string(U"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(wstring_to_ustring) {
      collection_assert::are_equal({'a', 'e', 'i', 'o', 'u', '\xC3', '\xA0', '\xC3', '\xA7', '\xC3', '\xA9', '\xC3', '\xA8', '\xC3', '\xAA', '\xC3', '\xAB', '\xC3', '\xAF', '\xC3', '\xAE', '\xF0', '\x9F', '\x90', '\xA8'}, convert_string::to_ustring(std::wstring(L"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    ...
    void test_method_(string_to_u8string) {
      collection_assert::are_equal({u8'a', u8'e', u8'i', u8'o', u8'u', static_cast<char8>(0xC3), static_cast<char8>(0xA0), static_cast<char8>(0xC3), static_cast<char8>(0xA7), static_cast<char8>(0xC3), static_cast<char8>(0xA9), static_cast<char8>(0xC3), static_cast<char8>(0xA8), static_cast<char8>(0xC3), static_cast<char8>(0xAA), static_cast<char8>(0xC3), static_cast<char8>(0xAB), static_cast<char8>(0xC3), static_cast<char8>(0xAF), static_cast<char8>(0xC3), static_cast<char8>(0xAE), static_cast<char8>(0xF0), static_cast<char8>(0x9F), static_cast<char8>(0x90), static_cast<char8>(0xA8)}, convert_string::to_u8string(std::string("aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(u8string_to_u8string) {
      collection_assert::are_equal({u8'a', u8'e', u8'i', u8'o', u8'u', static_cast<char8>(0xC3), static_cast<char8>(0xA0), static_cast<char8>(0xC3), static_cast<char8>(0xA7), static_cast<char8>(0xC3), static_cast<char8>(0xA9), static_cast<char8>(0xC3), static_cast<char8>(0xA8), static_cast<char8>(0xC3), static_cast<char8>(0xAA), static_cast<char8>(0xC3), static_cast<char8>(0xAB), static_cast<char8>(0xC3), static_cast<char8>(0xAF), static_cast<char8>(0xC3), static_cast<char8>(0xAE), static_cast<char8>(0xF0), static_cast<char8>(0x9F), static_cast<char8>(0x90), static_cast<char8>(0xA8)}, convert_string::to_u8string(std::u8string(u8"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    ...
    void test_method_(u32string_to_u8string) {
      collection_assert::are_equal({u8'a', u8'e', u8'i', u8'o', u8'u', static_cast<char8>(0xC3), static_cast<char8>(0xA0), static_cast<char8>(0xC3), static_cast<char8>(0xA7), static_cast<char8>(0xC3), static_cast<char8>(0xA9), static_cast<char8>(0xC3), static_cast<char8>(0xA8), static_cast<char8>(0xC3), static_cast<char8>(0xAA), static_cast<char8>(0xC3), static_cast<char8>(0xAB), static_cast<char8>(0xC3), static_cast<char8>(0xAF), static_cast<char8>(0xC3), static_cast<char8>(0xAE), static_cast<char8>(0xF0), static_cast<char8>(0x9F), static_cast<char8>(0x90), static_cast<char8>(0xA8)}, convert_string::to_u8string(std::u32string(U"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(wstring_to_u8string) {
      collection_assert::are_equal({u8'a', u8'e', u8'i', u8'o', u8'u', static_cast<char8>(0xC3), static_cast<char8>(0xA0), static_cast<char8>(0xC3), static_cast<char8>(0xA7), static_cast<char8>(0xC3), static_cast<char8>(0xA9), static_cast<char8>(0xC3), static_cast<char8>(0xA8), static_cast<char8>(0xC3), static_cast<char8>(0xAA), static_cast<char8>(0xC3), static_cast<char8>(0xAB), static_cast<char8>(0xC3), static_cast<char8>(0xAF), static_cast<char8>(0xC3), static_cast<char8>(0xAE), static_cast<char8>(0xF0), static_cast<char8>(0x9F), static_cast<char8>(0x90), static_cast<char8>(0xA8)}, convert_string::to_u8string(std::wstring(L"aeiouàçéèêëïî\U0001F428")), csf_);
    }
#endif
    ...
    void test_method_(string_to_u16string) {
      collection_assert::are_equal({u'a', u'e', u'i', u'o', u'u', u'à', u'ç', u'é', u'è', u'ê', u'ë', u'ï', u'î', u'\xD83D', u'\xDC28'}, convert_string::to_u16string(std::string("aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
#if defined(__xtd__cpp_lib_char8_t)
    void test_method_(u8string_to_u16string) {
      collection_assert::are_equal({u'a', u'e', u'i', u'o', u'u', u'à', u'ç', u'é', u'è', u'ê', u'ë', u'ï', u'î', u'\xD83D', u'\xDC28'}, convert_string::to_u16string(std::u8string(u8"aeiouàçéèêëïî\U0001F428")), csf_);
    }
#endif
    
    void test_method_(u16string_to_u16string) {
      collection_assert::are_equal({u'a', u'e', u'i', u'o', u'u', u'à', u'ç', u'é', u'è', u'ê', u'ë', u'ï', u'î', u'\xD83D', u'\xDC28'}, convert_string::to_u16string(std::u16string(u"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(u32string_to_u16string) {
      collection_assert::are_equal({u'a', u'e', u'i', u'o', u'u', u'à', u'ç', u'é', u'è', u'ê', u'ë', u'ï', u'î', u'\xD83D', u'\xDC28'}, convert_string::to_u16string(std::u32string(U"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(wstring_to_u16string) {
      collection_assert::are_equal({u'a', u'e', u'i', u'o', u'u', u'à', u'ç', u'é', u'è', u'ê', u'ë', u'ï', u'î', u'\xD83D', u'\xDC28'}, convert_string::to_u16string(std::wstring(L"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    ...
    void test_method_(string_to_u32string) {
      collection_assert::are_equal({U'a', U'e', U'i', U'o', U'u', U'à', U'ç', U'é', U'è', U'ê', U'ë', U'ï', U'î', U'\x1F428'}, convert_string::to_u32string(std::string("aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
#if defined(__xtd__cpp_lib_char8_t)
    void test_method_(u8string_to_u32string) {
      collection_assert::are_equal({U'a', U'e', U'i', U'o', U'u', U'à', U'ç', U'é', U'è', U'ê', U'ë', U'ï', U'î', U'\x1F428'}, convert_string::to_u32string(std::u8string(u8"aeiouàçéèêëïî\U0001F428")), csf_);
    }
#endif
    
    void test_method_(u16string_to_u32string) {
      collection_assert::are_equal({U'a', U'e', U'i', U'o', U'u', U'à', U'ç', U'é', U'è', U'ê', U'ë', U'ï', U'î', U'\x1F428'}, convert_string::to_u32string(std::u16string(u"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(u32string_to_u32string) {
      collection_assert::are_equal({U'a', U'e', U'i', U'o', U'u', U'à', U'ç', U'é', U'è', U'ê', U'ë', U'ï', U'î', U'\x1F428'}, convert_string::to_u32string(std::u32string(U"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(wstring_to_u32string) {
      collection_assert::are_equal({U'a', U'e', U'i', U'o', U'u', U'à', U'ç', U'é', U'è', U'ê', U'ë', U'ï', U'î', U'\x1F428'}, convert_string::to_u32string(std::wstring(L"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    ...
    void test_method_(string_to_wstring) {
      if (sizeof(wchar) > 2)
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0x1F428)}, convert_string::to_wstring(std::string("aeiouàçéèêëïî\U0001F428")), csf_);
      else
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0xD83D), static_cast<wchar>(0xDC28)}, convert_string::to_wstring(std::string("aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
#if defined(__xtd__cpp_lib_char8_t)
    void test_method_(u8string_to_wstring) {
      if (sizeof(wchar) > 2)
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0x1F428)}, convert_string::to_wstring(std::u8string(u8"aeiouàçéèêëïî\U0001F428")), csf_);
      else
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0xD83D), static_cast<wchar>(0xDC28)}, convert_string::to_wstring(std::u8string(u8"aeiouàçéèêëïî\U0001F428")), csf_);
    }
#endif
    
    void test_method_(u16string_to_wstring) {
      if (sizeof(wchar) > 2)
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0x1F428)}, convert_string::to_wstring(std::u16string(u"aeiouàçéèêëïî\U0001F428")), csf_);
      else
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0xD83D), static_cast<wchar>(0xDC28)}, convert_string::to_wstring(std::u16string(u"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(u32string_to_wstring) {
      if (sizeof(wchar) > 2)
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0x1F428)}, convert_string::to_wstring(std::u32string(U"aeiouàçéèêëïî\U0001F428")), csf_);
      else
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0xD83D), static_cast<wchar>(0xDC28)}, convert_string::to_wstring(std::u32string(U"aeiouàçéèêëïî\U0001F428")), csf_);
    }
    
    void test_method_(wstring_to_wstring) {
      if (sizeof(wchar) > 2)
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0x1F428)}, convert_string::to_wstring(std::wstring(L"aeiouàçéèêëïî\U0001F428")), csf_);
      else
        collection_assert::are_equal({L'a', L'e', L'i', L'o', L'u', L'à', L'ç', L'é', L'è', L'ê', L'ë', L'ï', L'î', static_cast<wchar>(0xD83D), static_cast<wchar>(0xDC28)}, convert_string::to_wstring(std::wstring(L"aeiouàçéèêëïî\U0001F428")), csf_);
    }
  };
}
