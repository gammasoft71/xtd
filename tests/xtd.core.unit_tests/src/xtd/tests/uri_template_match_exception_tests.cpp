#include <xtd/uri_template_match_exception>
...
namespace xtd::tests {
  class test_class_(uri_template_match_exception_tests) {
    ...
    static void test_initialize_(test_initialize) {
      ...
      stack_trace_enabled = uri_template_match_exception::enable_stack_trace();
      uri_template_match_exception::enable_stack_trace(false);
    }
    ...
    auto test_method_(default_constructor) {
      ...
      assert::are_equal(h_result::COR_E_SYSTEM, e.h_result());
      ...
      assert::are_equal("System error.", e.message());
      ...
      string_assert::starts_with("xtd::uri_template_match_exception : System error.", e.to_string());
    ...
    auto test_method_(default_constructor_with_stack_frame) {
      ...
      assert::are_equal("xtd::uri_template_match_exception : System error." + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("System error.", e.what());
    }
    ...
    auto test_method_(constructor_with_nullopt_message_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::uri_template_match_exception : System error." + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("System error.", e.what());
    }
    ...
    auto test_method_(constructor_with_empty_message) {
      ...
      assert::is_not_zero(e.get_last_stack_frame().get_file_line_number());
      assert::is_not_empty(e.get_last_stack_frame().get_method());
      string_assert::starts_with("xtd::uri_template_match_exception", e.to_string());
    ...
    auto test_method_(constructor_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal(stack_frame.get_file_line_number(), e.get_last_stack_frame().get_file_line_number());
      assert::are_equal(stack_frame.get_method(), e.get_last_stack_frame().get_method());
      assert::are_equal("xtd::uri_template_match_exception" + environment::new_line() + stack_frame.to_string(), e.to_string());
      assert::are_equal("xtd::uri_template_match_exception", e.what());
    }
