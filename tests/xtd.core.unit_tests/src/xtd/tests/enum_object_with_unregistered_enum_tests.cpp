...
namespace xtd::tests {
  class test_class_(enum_object_with_unregistered_enum_tests) {
    ...
    auto test_method_(parse_with_invalid_enum) {
      ...
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("none");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("one");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("two");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("three");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("four");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto _ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("five");});
    }
