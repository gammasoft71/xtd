...
namespace xtd::tests {
  class test_class_(enum_object_with_unregistered_enum_tests) {
    auto test_method_(enum_object_with_unregistered_enum_test_default_ctor) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_test_ctor_with_one) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_test_ctor_with_two) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_test_ctor_with_three) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_test_ctor_with_four) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_test_ctor_with_invalid_value) {
    ...
    auto test_method_(parse_with_invalid_enum) {
      ...
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("none");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("one");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("two");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("three");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("four");});
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = enum_object<>::parse<enum_object_with_unregistered_enum_test>("five");});
    }
