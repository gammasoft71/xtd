...
namespace xtd::tests {
  class test_class_(h_result_tests) {
    ...
    auto test_method_(get_message_with_COR_E_BADEXEFORMAT) {
      assert::are_equal("Format of the executable (.exe) cannot be run.", h_result::get_message(h_result::COR_E_BADEXEFORMAT));
    }
    
    auto test_method_(get_message_with_COR_E_BADIMAGEFORMAT) {
    ...
    auto test_method_(get_message_with_COR_E_CANNOTUNLOADAPPDOMAIN) {
      assert::are_equal("Attempt to unload the AppDomain failed.", h_result::get_message(h_result::COR_E_CANNOTUNLOADAPPDOMAIN));
    }
    
    auto test_method_(get_message_with_COR_E_CODECONTRACTFAILED) {
    ...
    auto test_method_(get_message_with_COR_E_CONTEXTMARSHAL) {
    ...
    auto test_method_(get_message_with_COR_E_CUSTOMATTRIBUTEFORMAT) {
    ...
    auto test_method_(get_message_with_COR_E_DATAMISALIGNED) {
    ...
    auto test_method_(get_message_with_COR_E_DIRECTORYNOTFOUND) {
    ...
    auto test_method_(get_message_with_COR_E_INSUFFICIENTMEMORY) {
    ...
    auto test_method_(get_message_with_COR_E_INVALIDCAST) {
      assert::are_equal("Specified cast is not valid.", h_result::get_message(h_result::COR_E_INVALIDCAST));
    }
    
    auto test_method_(get_message_with_COR_E_INVALIDCOMOBJECT) {
    ...
    auto test_method_(get_message_with_COR_E_MULTICASTNOTSUPPORTED) {
    ...
    auto test_method_(get_message_with_COR_E_REFLECTIONTYPELOAD) {
    ...
    auto test_method_(get_message_with_COR_E_RUNTIMEWRAPPED) {
    ...
    auto test_method_(get_message_with_COR_E_TARGETPARAMCOUNT) {
    ...
    auto test_method_(make_error_code_with_MSEE_E_ASSEMBLYLOADINPROGRESS) {
    ...
    auto test_method_(make_error_code_with_ERROR_UNRECOGNIZED_VOLUME) {
    ...
    auto test_method_(make_error_code_with_ERROR_LOCK_VIOLATION) {
    ...
    auto test_method_(make_error_code_with_ERROR_SHARING_VIOLATION) {
    ...
    auto test_method_(make_error_code_with_ERROR_TOO_MANY_OPEN_FILES) {
    ...
    auto test_method_(make_error_code_with_FUSION_E_REF_DEF_MISMATCH) {
    ...
    auto test_method_(make_error_code_with_CTL_E_FILENOTFOUND) {
    ...
    auto test_method_(make_error_code_with_RPC_E_CHANGED_MODE) {
    ...
    auto test_method_(make_error_code_with_RO_E_CLOSED) {
    ...
    auto test_method_(make_error_code_with_ERROR_MRM_MAP_NOT_FOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_AMBIGUOUSIMPLEMENTATION) {
    ...
    auto test_method_(make_error_code_with_COR_E_INDEXOUTOFRANGE) {
    ...
    auto test_method_(make_error_code_with_E_CHANGED_STATE) {
    ...
    auto test_method_(make_error_code_with_COR_E_FIELDACCESS) {
    ...
    auto test_method_(make_error_code_with_E_BOUNDS) {
    ...
    auto test_method_(make_error_code_with_DISP_E_TYPEMISMATCH) {
    ...
    auto test_method_(make_error_code_with_COR_E_WAITHANDLECANNOTBEOPENED) {
    ...
    auto test_method_(make_error_code_with_CTL_E_PATHNOTFOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_VERIFICATION) {
    ...
    auto test_method_(make_error_code_with_E_POINTER) {
    ...
    auto test_method_(make_error_code_with_COR_E_THREADSTATE) {
    ...
    auto test_method_(make_error_code_with_COR_E_THREADSTART) {
    ...
    auto test_method_(make_error_code_with_COR_E_ENTRYPOINTNOTFOUND) {
    ...
    auto test_method_(make_error_code_with_CO_E_NOTINITIALIZED) {
    ...
    auto test_method_(make_error_code_with_COR_E_THREADINTERRUPTED) {
    ...
    auto test_method_(make_error_code_with_COR_E_THREADABORTED) {
    ...
    auto test_method_(make_error_code_with_E_UNEXPECTED) {
    ...
    auto test_method_(make_error_code_with_COR_E_SYNCHRONIZATIONLOCK) {
    ...
    auto test_method_(make_error_code_with_E_FAIL) {
    ...
    auto test_method_(make_error_code_with_COR_E_TYPELOAD) {
    ...
    auto test_method_(make_error_code_with_COR_E_STACKOVERFLOW) {
    ...
    auto test_method_(make_error_code_with_TYPE_E_TYPEMISMATCH) {
    ...
    auto test_method_(make_error_code_with_COR_E_SERIALIZATION) {
    ...
    auto test_method_(make_error_code_with_COR_E_SECURITY) {
    ...
    auto test_method_(make_error_code_with_COR_E_SAFEARRAYTYPEMISMATCH) {
    ...
    auto test_method_(make_error_code_with_E_ABORT) {
    ...
    auto test_method_(make_error_code_with_COR_E_SAFEARRAYRANKMISMATCH) {
    ...
    auto test_method_(make_error_code_with_COR_E_INSUFFICIENTMEMORY) {
    ...
    auto test_method_(make_error_code_with_COR_E_REFLECTIONTYPELOAD) {
    ...
    auto test_method_(make_error_code_with_COR_E_PLATFORMNOTSUPPORTED) {
    ...
    auto test_method_(make_error_code_with_COR_E_PATHTOOLONG) {
    ...
    auto test_method_(make_error_code_with_COR_E_APPLICATION) {
    ...
    auto test_method_(make_error_code_with_COR_E_OPERATIONCANCELED) {
    ...
    auto test_method_(make_error_code_with_DISP_E_OVERFLOW) {
    ...
    auto test_method_(make_error_code_with_COR_E_OBJECTCLOSED) {
    ...
    auto test_method_(make_error_code_with_COR_E_NOTSUPPORTED) {
    ...
    auto test_method_(make_error_code_with_COR_E_NOTFINITENUMBER) {
    ...
    auto test_method_(make_error_code_with_COR_E_MULTICASTNOTSUPPORTED) {
    ...
    auto test_method_(make_error_code_with_COR_E_MISSINGMETHOD) {
    ...
    auto test_method_(make_error_code_with_COR_E_MISSINGMEMBER) {
    ...
    auto test_method_(make_error_code_with_ERROR_DISK_CORRUPT) {
    ...
    auto test_method_(make_error_code_with_COR_E_OUTOFMEMORY) {
    ...
    auto test_method_(make_error_code_with_COR_E_MISSINGFIELD) {
    ...
    auto test_method_(make_error_code_with_ERROR_TIMEOUT) {
    ...
    auto test_method_(make_error_code_with_COR_E_METHODACCESS) {
    ...
    auto test_method_(make_error_code_with_COR_E_ARGUMENT) {
    ...
    auto test_method_(make_error_code_with_COR_E_OVERFLOW) {
    ...
    auto test_method_(make_error_code_with_COR_E_APPDOMAINUNLOADED) {
    ...
    auto test_method_(make_error_code_with_COR_E_KEYNOTFOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_INVALIDPROGRAM) {
    ...
    auto test_method_(make_error_code_with_COR_E_INVALIDFILTERCRITERIA) {
    ...
    auto test_method_(make_error_code_with_COR_E_MISSINGSATELLITEASSEMBLY) {
    ...
    auto test_method_(make_error_code_with_COR_E_INVALIDCAST) {
    ...
    auto test_method_(make_error_code_with_COR_E_UNAUTHORIZEDACCESS) {
    ...
    auto test_method_(make_error_code_with_COR_E_FORMAT) {
    ...
    auto test_method_(make_error_code_with_COR_E_FILELOAD) {
    ...
    auto test_method_(make_error_code_with_COR_E_DIVIDEBYZERO) {
    ...
    auto test_method_(make_error_code_with_COR_E_TYPEUNLOADED) {
    ...
    auto test_method_(make_error_code_with_COR_E_FAILFAST) {
    ...
    auto test_method_(make_error_code_with_COR_E_EXCEPTION) {
    ...
    auto test_method_(make_error_code_with_COR_E_DLLNOTFOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_EXECUTIONENGINE) {
    ...
    auto test_method_(make_error_code_with_COR_E_DIRECTORYNOTFOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_CONTEXTMARSHAL) {
    ...
    auto test_method_(make_error_code_with_COR_E_ARGUMENTOUTOFRANGE) {
    ...
    auto test_method_(make_error_code_with_COR_E_AMBIGUOUSMATCH) {
    ...
    auto test_method_(make_error_code_with_COR_E_DRIVENOTFOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_BADEXEFORMAT) {
    ...
    auto test_method_(make_error_code_with_COR_E_INSUFFICIENTEXECUTIONSTACK) {
    ...
    auto test_method_(make_error_code_with_COR_E_CANNOTUNLOADAPPDOMAIN) {
    ...
    auto test_method_(make_error_code_with_COR_E_TARGETINVOCATION) {
    ...
    auto test_method_(make_error_code_with_COR_E_CODECONTRACTFAILED) {
    ...
    auto test_method_(make_error_code_with_S_OK) {
    ...
    auto test_method_(make_error_code_with_COR_E_BADIMAGEFORMAT) {
    ...
    auto test_method_(make_error_code_with_COR_E_TYPEACCESS) {
    ...
    auto test_method_(make_error_code_with_DISP_E_PARAMNOTFOUND) {
    ...
    auto test_method_(make_error_code_with_FUSION_E_INVALID_NAME) {
    ...
    auto test_method_(make_error_code_with_COR_E_ENDOFSTREAM) {
    ...
    auto test_method_(make_error_code_with_COR_E_DUPLICATEWAITOBJECT) {
    ...
    auto test_method_(make_error_code_with_COR_E_RUNTIMEWRAPPED) {
    ...
    auto test_method_(make_error_code_with_COR_E_TARGET) {
    ...
    auto test_method_(make_error_code_with_COR_E_DATAMISALIGNED) {
    ...
    auto test_method_(make_error_code_with_COR_E_TYPEINITIALIZATION) {
    ...
    auto test_method_(make_error_code_with_COR_E_ARITHMETIC) {
    ...
    auto test_method_(make_error_code_with_COR_E_INVALIDOLEVARIANTTYPE) {
    ...
    auto test_method_(make_error_code_with_COR_E_MISSINGMANIFESTRESOURCE) {
    ...
    auto test_method_(make_error_code_with_COR_E_TIMEOUT) {
    ...
    auto test_method_(make_error_code_with_COR_E_FILENOTFOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_TARGETPARAMCOUNT) {
    ...
    auto test_method_(make_error_code_with_COR_E_ARRAYTYPEMISMATCH) {
    ...
    auto test_method_(make_error_code_with_E_NOTIMPL) {
    ...
    auto test_method_(make_error_code_with_COR_E_MARSHALDIRECTIVE) {
    ...
    auto test_method_(make_error_code_with_DISP_E_BADVARTYPE) {
    ...
    auto test_method_(make_error_code_with_COR_E_IO) {
    ...
    auto test_method_(make_error_code_with_ERROR_OPEN_FAILED) {
    ...
    auto test_method_(make_error_code_with_COR_E_ABANDONEDMUTEX) {
    ...
    auto test_method_(make_error_code_with_ERROR_DLL_INIT_FAILED) {
    ...
    auto test_method_(make_error_code_with_COR_E_CUSTOMATTRIBUTEFORMAT) {
    ...
    auto test_method_(make_error_code_with_S_FALSE) {
    ...
    auto test_method_(make_error_code_with_COR_E_MEMBERACCESS) {
    ...
    auto test_method_(make_error_code_with_COR_E_RANK) {
    ...
    auto test_method_(make_error_code_with_COR_E_INVALIDCOMOBJECT) {
    ...
    auto test_method_(make_error_code_with_E_HANDLE) {
    ...
    auto test_method_(make_error_code_with_COR_E_INVALIDOPERATION) {
    ...
    auto test_method_(make_error_code_with_STG_E_PATHNOTFOUND) {
    ...
    auto test_method_(make_error_code_with_COR_E_SYSTEM) {
    ...
    auto test_method_(make_error_code_with_unknown_value) {
