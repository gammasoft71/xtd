...
namespace xtd::tests {
  class test_class_(h_result_tests) {
    ...
    void test_method_(get_messages) {
      ...
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_FILE_INVALID, "File invalid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::MSEE_E_ASSEMBLYLOADINPROGRESS, "Assembly load in progress."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_UNRECOGNIZED_VOLUME, "Unrecognized volume."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_LOCK_VIOLATION, "Lock violations."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_SHARING_VIOLATION, "Sharing violation."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_TOO_MANY_OPEN_FILES, "Too many open files."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::FUSION_E_REF_DEF_MISMATCH, "Fusion the reference definition is incompatible."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::CTL_E_FILENOTFOUND, "Unable to find the specified file."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::RPC_E_CHANGED_MODE, "Cannot change the current thread mode."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::RO_E_CLOSED, "The object has been closed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_MRM_MAP_NOT_FOUND, "Resource map not found."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_AMBIGUOUSIMPLEMENTATION, "Ambiguous implementation found."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INDEXOUTOFRANGE, "Index was outside the bounds of the array."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_CHANGED_STATE, "The state has been modified."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FIELDACCESS, "Attempted to access a field that is not accessible by the caller."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_BOUNDS, "Bounds exception"}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_TYPEMISMATCH, "Attempt to access a variable with an incompatible type."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_WAITHANDLECANNOTBEOPENED, "No handle of the given name exists."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::CTL_E_PATHNOTFOUND, "Attempted to access a path that is not on the disk."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_VERIFICATION, "Operation could destabilize the runtime."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_POINTER, "Attempted to read or write protected memory. This is often an indication that other memory is corrupt."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADSTATE, "Thread was in an invalid state for the operation being executed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADSTART, "Thread start failure."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ENTRYPOINTNOTFOUND, "Entry point was not found."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::CO_E_NOTINITIALIZED, "Not initialized"}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADINTERRUPTED, "Thread was interrupted from a waiting state."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADABORTED, "Thread was aborted."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_UNEXPECTED, "Unexpected failure."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SYNCHRONIZATIONLOCK, "Object synchronization method was called from an unsynchronized block of code."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_FAIL, "Unspecified failure."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPELOAD, "Failure has occurred while loading a type."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_STACKOVERFLOW, "Operation caused a stack overflow."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::TYPE_E_TYPEMISMATCH, "Incompatible type."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SERIALIZATION, "Serialization error."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SECURITY, "Security error."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SAFEARRAYTYPEMISMATCH, "Specified array was not of the expected type."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_ABORT, "Operation aborted."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SAFEARRAYRANKMISMATCH, "Specified array was not of the expected rank."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INSUFFICIENTMEMORY, "Insufficient memory to continue the execution of the program."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_REFLECTIONTYPELOAD, "Exception of type 'xtd::reflection::reflection_type_load_exception' was thrown."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_PLATFORMNOTSUPPORTED, "Operation is not supported on this platform."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_PATHTOOLONG, "The specified file name or path is too long, or a component of the specified path is too long."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_APPLICATION, "Error in the application."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OPERATIONCANCELED, "The operation was canceled."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_OVERFLOW, "Arithmetic operation resulted in an overflow."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OBJECTCLOSED, "Cannot access a closed object."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_NOTSUPPORTED, "Specified method is not supported."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_NOTFINITENUMBER, "Number encountered was not a finite quantity."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MULTICASTNOTSUPPORTED, "Attempted to add multiple callbacks to a delegate that does not support multicast."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGMETHOD, "Attempted to access a missing method."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGMEMBER, "Attempted to access a missing member."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_DISK_CORRUPT, "Disk corrupt."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OUTOFMEMORY, "Insufficient memory to continue the execution of the program."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGFIELD, "Attempted to access a non-existing field."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_TIMEOUT, "The operation has timed out."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_METHODACCESS, "Attempt to access the method failed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARGUMENT, "Value does not fall within the expected range."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OVERFLOW, "Arithmetic operation resulted in an overflow."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_APPDOMAINUNLOADED, "Attempted to access an unloaded AppDomain."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_KEYNOTFOUND, "The given key was not present in the dictionary."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDPROGRAM, "xtd detected an invalid program."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDFILTERCRITERIA, "Specified filter criteria was invalid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGSATELLITEASSEMBLY, "Resource lookup fell back to the ultimate fallback resources in a satellite assembly, but that satellite either was not found or could not be loaded. Please consider reinstalling or repairing the application."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDCAST, "Specified cast is not valid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_UNAUTHORIZEDACCESS, "Attempted to perform an unauthorized operation."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FORMAT, "One of the identified items was in an invalid format."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FILELOAD, "Could not load the specified file."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DIVIDEBYZERO, "Attempted to divide by zero."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPEUNLOADED, "Type had been unloaded."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FAILFAST, "Fail fast."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_EXCEPTION, "Exception of type 'xtd::exception' was thrown."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DLLNOTFOUND, "Dll was not found."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_EXECUTIONENGINE, "Internal error in the runtime."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DIRECTORYNOTFOUND, "Attempted to access a path that is not on the disk."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CONTEXTMARSHAL, "Attempted to marshal an object across a context boundary."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARGUMENTOUTOFRANGE, "Specified argument was out of the range of valid values."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_AMBIGUOUSMATCH, "Ambiguous match found."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DRIVENOTFOUND, "Could not find the drive. The drive might not be ready or might not be mapped."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_BADEXEFORMAT, "Format of the executable (.exe) cannot be run."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INSUFFICIENTEXECUTIONSTACK, "Insufficient stack to continue executing the program safely. This can happen from having too many functions on the call stack or function on the stack using too much stack space."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CANNOTUNLOADAPPDOMAIN, "Attempt to unload the AppDomain failed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TARGETINVOCATION, "Exception has been thrown by the target of an invocation."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CODECONTRACTFAILED, "A code contract (ie, precondition, postcondition, invariant, or assert) failed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::S_OK, "Operation successful."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_BADIMAGEFORMAT, "Format of the executable (.exe) or library (.dll) is invalid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPEACCESS, "Attempt to access the type failed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_PARAMNOTFOUND, "Could not find the parameter."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::FUSION_E_INVALID_NAME, "Fusion invalid name exception."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ENDOFSTREAM, "Attempted to read past the end of the stream."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DUPLICATEWAITOBJECT, "Duplicate objects in argument."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_RUNTIMEWRAPPED, "An object that does not derive from xtd:oobject has been wrapped in a runtime_wrapped_exception."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TARGET, "Exception of type 'xtd::reflection::target_exception' was thrown."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DATAMISALIGNED, "A datatype misalignment was detected in a load or store instruction."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPEINITIALIZATION, "The type initializer for 'value' threw an exception."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARITHMETIC, "Overflow or underflow in the arithmetic operation."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDOLEVARIANTTYPE, "Specified OLE variant was invalid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGMANIFESTRESOURCE, "Attempted to access a missing manifest resource."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TIMEOUT, "The operation has timed out."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FILENOTFOUND, "Unable to find the specified file."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TARGETPARAMCOUNT, "Number of parameters specified does not match the expected number."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARRAYTYPEMISMATCH, "Attempted to access an element as a type incompatible with the array."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_NOTIMPL, "The method or operation is not implemented."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MARSHALDIRECTIVE, "Marshaling directives are invalid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_BADVARTYPE, "Invalid variable type."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_IO, "I/O error occurred."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_OPEN_FAILED, "Open failed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ABANDONEDMUTEX, "The wait completed due to an abandoned mutex."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_DLL_INIT_FAILED, "DLL init failed."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CUSTOMATTRIBUTEFORMAT, "Binary format of the specified custom attribute was invalid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::S_FALSE, "Operation successful but returned no results."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MEMBERACCESS, "Cannot access member."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_RANK, "Attempted to operate on an array with the incorrect number of dimensions."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDCOMOBJECT, "Attempt has been made to use a COM object that does not have a backing class factory."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_HANDLE, "The handle is invalid."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDOPERATION, "Operation is not valid due to the current state of the object."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::STG_E_PATHNOTFOUND, "Attempted to access a path that is not on the disk."}}, h_result::get_messages());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SYSTEM, "System error."}}, h_result::get_messages());
    }
    ...
    void test_method_(get_names) {
      ...
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_FILE_INVALID, "ERROR_FILE_INVALID"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::MSEE_E_ASSEMBLYLOADINPROGRESS, "MSEE_E_ASSEMBLYLOADINPROGRESS"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_UNRECOGNIZED_VOLUME, "ERROR_UNRECOGNIZED_VOLUME"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_LOCK_VIOLATION, "ERROR_LOCK_VIOLATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_SHARING_VIOLATION, "ERROR_SHARING_VIOLATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_TOO_MANY_OPEN_FILES, "ERROR_TOO_MANY_OPEN_FILES"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::FUSION_E_REF_DEF_MISMATCH, "FUSION_E_REF_DEF_MISMATCH"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::CTL_E_FILENOTFOUND, "CTL_E_FILENOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::RPC_E_CHANGED_MODE, "RPC_E_CHANGED_MODE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::RO_E_CLOSED, "RO_E_CLOSED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_MRM_MAP_NOT_FOUND, "ERROR_MRM_MAP_NOT_FOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_AMBIGUOUSIMPLEMENTATION, "COR_E_AMBIGUOUSIMPLEMENTATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INDEXOUTOFRANGE, "COR_E_INDEXOUTOFRANGE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_CHANGED_STATE, "E_CHANGED_STATE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FIELDACCESS, "COR_E_FIELDACCESS"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_BOUNDS, "E_BOUNDS"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_TYPEMISMATCH, "DISP_E_TYPEMISMATCH"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_WAITHANDLECANNOTBEOPENED, "COR_E_WAITHANDLECANNOTBEOPENED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::CTL_E_PATHNOTFOUND, "CTL_E_PATHNOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_VERIFICATION, "COR_E_VERIFICATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_POINTER, "E_POINTER"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADSTATE, "COR_E_THREADSTATE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADSTART, "COR_E_THREADSTART"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ENTRYPOINTNOTFOUND, "COR_E_ENTRYPOINTNOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::CO_E_NOTINITIALIZED, "CO_E_NOTINITIALIZED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADINTERRUPTED, "COR_E_THREADINTERRUPTED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_THREADABORTED, "COR_E_THREADABORTED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_UNEXPECTED, "E_UNEXPECTED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SYNCHRONIZATIONLOCK, "COR_E_SYNCHRONIZATIONLOCK"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_FAIL, "E_FAIL"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPELOAD, "COR_E_TYPELOAD"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_STACKOVERFLOW, "COR_E_STACKOVERFLOW"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::TYPE_E_TYPEMISMATCH, "TYPE_E_TYPEMISMATCH"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SERIALIZATION, "COR_E_SERIALIZATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SECURITY, "COR_E_SECURITY"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SAFEARRAYTYPEMISMATCH, "COR_E_SAFEARRAYTYPEMISMATCH"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_ABORT, "E_ABORT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SAFEARRAYRANKMISMATCH, "COR_E_SAFEARRAYRANKMISMATCH"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INSUFFICIENTMEMORY, "COR_E_INSUFFICIENTMEMORY"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_REFLECTIONTYPELOAD, "COR_E_REFLECTIONTYPELOAD"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_PLATFORMNOTSUPPORTED, "COR_E_PLATFORMNOTSUPPORTED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_PATHTOOLONG, "COR_E_PATHTOOLONG"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_APPLICATION, "COR_E_APPLICATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OPERATIONCANCELED, "COR_E_OPERATIONCANCELED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_OVERFLOW, "DISP_E_OVERFLOW"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OBJECTCLOSED, "COR_E_OBJECTCLOSED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_NOTSUPPORTED, "COR_E_NOTSUPPORTED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_NOTFINITENUMBER, "COR_E_NOTFINITENUMBER"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MULTICASTNOTSUPPORTED, "COR_E_MULTICASTNOTSUPPORTED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGMETHOD, "COR_E_MISSINGMETHOD"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGMEMBER, "COR_E_MISSINGMEMBER"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_DISK_CORRUPT, "ERROR_DISK_CORRUPT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OUTOFMEMORY, "COR_E_OUTOFMEMORY"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGFIELD, "COR_E_MISSINGFIELD"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_TIMEOUT, "ERROR_TIMEOUT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_METHODACCESS, "COR_E_METHODACCESS"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARGUMENT, "COR_E_ARGUMENT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_OVERFLOW, "COR_E_OVERFLOW"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_APPDOMAINUNLOADED, "COR_E_APPDOMAINUNLOADED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_KEYNOTFOUND, "COR_E_KEYNOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDPROGRAM, "COR_E_INVALIDPROGRAM"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDFILTERCRITERIA, "COR_E_INVALIDFILTERCRITERIA"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGSATELLITEASSEMBLY, "COR_E_MISSINGSATELLITEASSEMBLY"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDCAST, "COR_E_INVALIDCAST"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_UNAUTHORIZEDACCESS, "COR_E_UNAUTHORIZEDACCESS"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FORMAT, "COR_E_FORMAT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FILELOAD, "COR_E_FILELOAD"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DIVIDEBYZERO, "COR_E_DIVIDEBYZERO"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPEUNLOADED, "COR_E_TYPEUNLOADED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FAILFAST, "COR_E_FAILFAST"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_EXCEPTION, "COR_E_EXCEPTION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DLLNOTFOUND, "COR_E_DLLNOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_EXECUTIONENGINE, "COR_E_EXECUTIONENGINE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DIRECTORYNOTFOUND, "COR_E_DIRECTORYNOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CONTEXTMARSHAL, "COR_E_CONTEXTMARSHAL"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARGUMENTOUTOFRANGE, "COR_E_ARGUMENTOUTOFRANGE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_AMBIGUOUSMATCH, "COR_E_AMBIGUOUSMATCH"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DRIVENOTFOUND, "COR_E_DRIVENOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_BADEXEFORMAT, "COR_E_BADEXEFORMAT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INSUFFICIENTEXECUTIONSTACK, "COR_E_INSUFFICIENTEXECUTIONSTACK"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CANNOTUNLOADAPPDOMAIN, "COR_E_CANNOTUNLOADAPPDOMAIN"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TARGETINVOCATION, "COR_E_TARGETINVOCATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CODECONTRACTFAILED, "COR_E_CODECONTRACTFAILED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::S_OK, "S_OK"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_BADIMAGEFORMAT, "COR_E_BADIMAGEFORMAT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPEACCESS, "COR_E_TYPEACCESS"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_PARAMNOTFOUND, "DISP_E_PARAMNOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::FUSION_E_INVALID_NAME, "FUSION_E_INVALID_NAME"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ENDOFSTREAM, "COR_E_ENDOFSTREAM"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DUPLICATEWAITOBJECT, "COR_E_DUPLICATEWAITOBJECT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_RUNTIMEWRAPPED, "COR_E_RUNTIMEWRAPPED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TARGET, "COR_E_TARGET"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_DATAMISALIGNED, "COR_E_DATAMISALIGNED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TYPEINITIALIZATION, "COR_E_TYPEINITIALIZATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARITHMETIC, "COR_E_ARITHMETIC"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDOLEVARIANTTYPE, "COR_E_INVALIDOLEVARIANTTYPE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MISSINGMANIFESTRESOURCE, "COR_E_MISSINGMANIFESTRESOURCE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TIMEOUT, "COR_E_TIMEOUT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_FILENOTFOUND, "COR_E_FILENOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_TARGETPARAMCOUNT, "COR_E_TARGETPARAMCOUNT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ARRAYTYPEMISMATCH, "COR_E_ARRAYTYPEMISMATCH"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_NOTIMPL, "E_NOTIMPL"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MARSHALDIRECTIVE, "COR_E_MARSHALDIRECTIVE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::DISP_E_BADVARTYPE, "DISP_E_BADVARTYPE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_IO, "COR_E_IO"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_OPEN_FAILED, "ERROR_OPEN_FAILED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_ABANDONEDMUTEX, "COR_E_ABANDONEDMUTEX"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::ERROR_DLL_INIT_FAILED, "ERROR_DLL_INIT_FAILED"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_CUSTOMATTRIBUTEFORMAT, "COR_E_CUSTOMATTRIBUTEFORMAT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::S_FALSE, "S_FALSE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_MEMBERACCESS, "COR_E_MEMBERACCESS"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_RANK, "COR_E_RANK"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDCOMOBJECT, "COR_E_INVALIDCOMOBJECT"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::E_HANDLE, "E_HANDLE"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_INVALIDOPERATION, "COR_E_INVALIDOPERATION"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::STG_E_PATHNOTFOUND, "STG_E_PATHNOTFOUND"}}, h_result::get_names());
      collection_assert::contains({key_value_pair<int32, string> {h_result::COR_E_SYSTEM, "COR_E_SYSTEM"}}, h_result::get_names());
    }
