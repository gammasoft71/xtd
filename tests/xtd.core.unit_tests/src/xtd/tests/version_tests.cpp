...
namespace xtd::tests {
  class test_class_(version_tests) {
    auto test_method_(create_version_with_default_constructor) {
      version version;
    ...
    auto test_method_(create_version_with_string_that_contains_major_and_minor) {
      assert::are_equal(version(1, 2), version("1.2"));
    }
    
    auto test_method_(create_version_with_string_that_contains_major_minor_and_build) {
      assert::are_equal(version(1, 2, 3), version("1.2.3"));
    }
    
    auto test_method_(create_version_with_string_that_contains_major_minor_build_and_revision) {
      assert::are_equal(version(1, 2, 3, 4), version("1.2.3.4"));
    }
    
    auto test_method_(create_version_with_string_that_contains_invalid_major_minor_build_and_revision) {
      assert::throws<argument_exception>([] {version("-1.2.3.4");});
    }
    
    auto test_method_(create_version_with_major_and_minor) {
      version version(1, 2);
    ...
    auto test_method_(create_version_with_invalid_major_and_minor) {
      assert::throws<argument_exception>([] {version version(-1, 2);});
    }
    
    auto test_method_(create_version_with_major_and_invalid_minor) {
      assert::throws<argument_exception>([] {version version(1, -2);});
    }
    
    auto test_method_(create_version_with_major_minor_and_build) {
    ...
    auto test_method_(create_version_with_major_minor_build_and_revision) {
    ...
    auto test_method_(copy_version_with_copy_operator) {
    ...
    auto test_method_(create_version_from_version) {
      version version1(1, 2, 3, 4);
    ...
    auto test_method_(inequality_operator) {
      version version1(1, 2, 3, 4);
      version version2 = version1;
      version version3;
    ...
    auto test_method_(parse_version_with_bad_major_and_minor) {
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = version::parse("one.2");});
    }
    ...
    auto test_method_(parse_version_with_major_minor_build_and_revision) {
    ...
    auto test_method_(parse_version_with_major_minor_build_revision_and_bad_value) {
      assert::throws<argument_exception>([] {[[maybe_unused]] auto __ = version::parse("1.2.3.4.5");});
      assert::throws<argument_exception>([] {[[maybe_unused]] auto __ = version::parse("01.02.03.04.05");});
    }
    
    auto test_method_(parse_version_with_bad_value) {
      assert::throws<argument_exception>([] {[[maybe_unused]] auto __ = version::parse("one");});
    }
    ...
    auto test_method_(try_parse_version_with_bad_string_value) {
      version vers;
      assert::is_false(version::try_parse("one", vers));
      assert::are_equal(version(), vers);
    }
    
    auto test_method_(to_string_with_empty_version) {
      assert::are_equal("0.0", version().to_string());
    }
    
    auto test_method_(to_string_with_major_and_minor) {
      assert::are_equal("1.2", version(1, 2).to_string());
    }
    
    auto test_method_(to_string_with_major_minor_and_build) {
      assert::are_equal("1.2.3", version(1, 2, 3).to_string());
    }
    
    auto test_method_(to_string_with_major_minor_build_and_revision) {
      assert::are_equal("1.2.3.4", version(1, 2, 3, 4).to_string());
    }
    
    auto test_method_(to_string_field_0_with_empty_version) {
      assert::is_empty(version().to_string(0));
    }
    
    auto test_method_(to_string_field_0_with_full_version) {
      assert::is_empty(version(1, 2, 3, 4).to_string(0));
    }
    
    auto test_method_(to_string_field_1_with_empty_version) {
      assert::are_equal("0", version().to_string(1));
    }
    
    auto test_method_(to_string_field_1_with_full_version) {
      assert::are_equal("1", version(1, 2, 3, 4).to_string(1));
    }
    
    auto test_method_(to_string_field_2_with_empty_version) {
      assert::are_equal("0.0", version().to_string(2));
    }
    
    auto test_method_(to_string_field_2_with_full_version) {
      assert::are_equal("1.2", version(1, 2, 3, 4).to_string(2));
    }
    
    auto test_method_(to_string_field_3_with_empty_version) {
      assert::throws<argument_exception>([] {[[maybe_unused]] auto __ = version().to_string(3);});
    }
    ...
    auto test_method_(to_string_field_4_with_empty_version) {
      assert::throws<argument_exception>([] {[[maybe_unused]] auto __ = version().to_string(4);});
    }
    ...
    auto test_method_(to_string_field_greater_than_4) {
      assert::throws<argument_exception>([] {[[maybe_unused]] auto __ = version().to_string(5);});
    }
  };
}
