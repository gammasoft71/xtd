...
namespace xtd::tests {
  class test_class_(array_tests) {
    ...
    auto test_method_(index_of_with_array_value_type_and_index) {
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto v = array<>::index_of(array<int> {}, 42, 1);});
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto v = array<>::index_of(array<int> {84, 42, 21, 42}, 42, 5);});
    ...
    auto test_method_(index_of_with_array_value_type_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto v = array<>::index_of(array<int> {}, 42, 1, 0);});
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto v = array<>::index_of(array<int> {}, 42, 0, 1);});
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto v = array<>::index_of(array<int> {84, 42, 21, 42}, 42, 4, 1);});
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto v = array<>::index_of(array<int> {84, 42, 21, 42}, 42, 5, 0);});
