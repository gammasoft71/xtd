...
namespace xtd::tests {
  class test_class_(array_tests) {
    void test_method_(value_type) {
      assert::are_equal(typeof_<int>(), typeof_<array_<int>::value_type>());
    }
    
    void test_method_(value_type_of_boolean) {
      assert::are_equal(typeof_<bool>(), typeof_<array_<bool>::value_type>());
    }
    
    void test_method_(base_type) {
      assert::are_equal(typeof_<std::vector<int>>(), typeof_<array_<int>::base_type>());
    }
    
    void test_method_(base_type_boolean) {
      assert::are_equal(typeof_<std::vector<byte>>(), typeof_<array_<bool>::base_type>());
    }
    
    void test_method_(size_type) {
      assert::are_equal(typeof_<xtd::size>(), typeof_<array_<int>::size_type>());
    }
    
    void test_method_(difference_type) {
      assert::are_equal(typeof_<xtd::ptrdiff>(), typeof_<array_<int>::difference_type>());
    }
    
    void test_method_(reference) {
      assert::are_equal(typeof_<int&>(), typeof_<array_<int>::reference>());
    }
    
    void test_method_(reference_of_boolean) {
      assert::are_equal(typeof_<bool&>(), typeof_<array_<bool>::reference>());
    }

    void test_method_(const_reference) {
      assert::are_equal(typeof_<const int&>(), typeof_<array_<int>::const_reference>());
    }
    
    void test_method_(const_reference_of_boolean) {
      assert::are_equal(typeof_<const bool&>(), typeof_<array_<bool>::const_reference>());
    }
    
    void test_method_(pointer) {
      assert::are_equal(typeof_<int*>(), typeof_<array_<int>::pointer>());
    }
    
    void test_method_(pointer_of_boolean) {
      assert::are_equal(typeof_<bool*>(), typeof_<array_<bool>::pointer>());
    }
    
    void test_method_(const_pointer) {
      assert::are_equal(typeof_<const int*>(), typeof_<array_<int>::const_pointer>());
    }
    
    void test_method_(const_pointer_of_boolean) {
      assert::are_equal(typeof_<const bool*>(), typeof_<array_<bool>::const_pointer>());
    }
    
    void test_method_(iterator) {
      assert::are_equal(typeof_<ilist<int>::iterator>(), typeof_<array_<int>::iterator>());
    }
    
    void test_method_(iterator_of_boolean) {
      assert::are_equal(typeof_<ilist<bool>::iterator>(), typeof_<array_<bool>::iterator>());
    }

    void test_method_(const_iterator) {
      assert::are_equal(typeof_<ilist<int>::const_iterator>(), typeof_<array_<int>::const_iterator>());
    }
    
    void test_method_(const_iterator_of_boolean) {
      assert::are_equal(typeof_<ilist<bool>::const_iterator>(), typeof_<array_<bool>::const_iterator>());
    }
    
    void test_method_(reverse_iterator) {
      assert::are_equal(typeof_<array_<int>::base_type::reverse_iterator>(), typeof_<array_<int>::reverse_iterator>());
    }
    
    void test_method_(reverse_iterator_of_boolean) {
      assert::are_equal(typeof_<array_<bool>::base_type::reverse_iterator>(), typeof_<array_<bool>::reverse_iterator>());
    }
    
    void test_method_(const_reverse_iterator) {
      assert::are_equal(typeof_<array_<int>::base_type::const_reverse_iterator>(), typeof_<array_<int>::const_reverse_iterator>());
    }
    
    void test_method_(const_reverse_iterator_of_boolean) {
      assert::are_equal(typeof_<array_<bool>::base_type::const_reverse_iterator>(), typeof_<array_<bool>::const_reverse_iterator>());
    }
    
    void test_method_(default_constructor) {
      collection_assert::is_empty(array_<int> {});
    }
    
    void test_method_(default_constructor_of_boolean) {
      collection_assert::is_empty(array_<bool> {});
    }
    
    void test_method_(constructor_with_initializer_lit) {
      collection_assert::are_equal({1, 2, 3, 4, 5}, array_ {1, 2, 3, 4, 5});
    }
    
    void test_method_(constructor_with_initializer_lit_of_booleans) {
      collection_assert::are_equal({true, false, false, true, false}, array_ {true, false, false, true, false});
    }
    
    void test_method_(constructor_with_array) {
      collection_assert::are_equal({1, 2, 3, 4, 5}, array_ {array_ {1, 2, 3, 4, 5}});
    }
    
    void test_method_(constructor_with_array_of_booleans) {
      collection_assert::are_equal({true, false, false, true, false}, array_ {array_ {true, false, false, true, false}});
    }
    
    void test_method_(constructor_with_size) {
      collection_assert::are_equal({0, 0, 0, 0, 0}, array_<int>(5));
    }

    void test_method_(constructor_with_size_of_booleans) {
      collection_assert::are_equal({false, false, false, false, false}, array_<bool>(5));
    }

    void test_method_(constructor_with_native_array) {
      int a[] = {1, 2, 3, 4, 5};
      collection_assert::are_equal({1, 2, 3, 4, 5}, array_<int>(a));
    }
    
    void test_method_(constructor_with_native_array_of_booleans) {
      bool a[] = {true, false, false, true, false};
      collection_assert::are_equal({true, false, false, true, false}, array_<bool>(a));
    }

    void test_method_(constructor_with_const_pointer_and_length) {
      int a[] = {1, 2, 3, 4, 5};
      collection_assert::are_equal({1, 2, 3, 4, 5}, array_<int>(a, 5));
    }

    void test_method_(constructor_with_const_pointer_and_length_of_booleans) {
      bool a[] = {true, false, false, true, false};
      collection_assert::are_equal({true, false, false, true, false}, array_<bool>(a, 5));
    }

    void test_method_(constructor_with_ienumerable) {
      collection_assert::are_equal({1, 2, 3, 4, 5}, array_<int> {as<ienumerable<int>>(list {1, 2, 3, 4, 5})});
    }
    
    void test_method_(constructor_with_ienumerable_of_booleans) {
      collection_assert::are_equal({true, false, false, true, false}, array_<bool> {as<ienumerable<bool>>(list {true, false, false, true, false})});
    }

    void test_method_(constructor_with_ilist) {
      collection_assert::are_equal({1, 2, 3, 4, 5}, array_<int> {as<ilist<int>>(list {1, 2, 3, 4, 5})});
    }
    
    void test_method_(constructor_with_ilist_of_booleans) {
      collection_assert::are_equal({true, false, false, true, false}, array_<bool> {as<ilist<bool>>(list {true, false, false, true, false})});
    }
    
    void test_method_(const_back) {
      assert::are_equal(21, array_ {84, 42, 21}.back());
      assert::throws<index_out_of_range_exception>([] {array_<int> {}.back();});
    }
    ...
    void test_method_(empty) {
      assert::is_true(array_<int> {}.empty());
      assert::is_false(array_<int> {42}.empty());
    ...
    void test_method_(is_fixed_size) {
      // Is always true;
      assert::is_true(array_<int> {}.is_fixed_size());
    }
    
    void test_method_(is_read_only) {
      // Is always false;
      assert::is_false(array_<int> {}.is_read_only());
    }
    
    void test_method_(is_synchronized) {
      // Is always false;
      assert::is_false(array_<int> {}.is_synchronized());
    }

    void test_method_(items_const) {
      assert::are_equal(typeof_<array_<int>::base_type>(), typeof_(array_ {1, 2, 3, 4, 5}.items()));
      collection_assert::are_equal({1, 2, 3, 4, 5}, array_ {1, 2, 3, 4, 5}.items());
    }
    ...
    void test_method_(max_size) {
      assert::are_equal(environment::os_version().is_linux() ? size_object::max_value / 8 : size_object::max_value / 4, array_<int> {}.max_size());
    }

    void test_method_(rank) {
      assert::are_equal(1_z, array_<int> {}.rank());
    }

    void test_method_(rank_of_boolean) {
      assert::are_equal(1_z, array_<bool> {}.rank());
    }
    ...
    void test_method_(get_value_with_indexes_array) {
      auto items = array_ {1, 2, 3, 4, 5};
      assert::are_equal(1, items.get_value(array_ {0_z}));
      assert::are_equal(2, items.get_value(array_ {1_z}));
      assert::are_equal(3, items.get_value(array_ {2_z}));
      assert::are_equal(4, items.get_value(array_ {3_z}));
      assert::are_equal(5, items.get_value(array_ {4_z}));
      assert::throws<index_out_of_range_exception>([&]{[[maybe_unused]] auto i = items.get_value(array_ {5_z});});
    }
    
    void test_method_(index_of_with_value_type) {
      assert::are_equal(array_<int>::npos, array_<int> {}.index_of(42));
      assert::are_equal(1_z, array_ {84, 42, 21, 42}.index_of(42));
      assert::are_equal(array_<int>::npos, array_ {84, 42, 21, 42}.index_of(0));
    }
    ...
    void test_method_(reverse_with_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::reverse(items, 6, 0);});
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::reverse(items, 1, 5);});
    }
    ...
    void test_method_(set_value_with_indexes_array) {
      ...
      assert::throws<index_out_of_range_exception>([&]{items.set_value(11, array_ {5_z});});
      collection_assert::are_equal({6, 7, 8, 9, 10}, items);
    }
    ...
    void test_method_(to_string) {
      assert::are_equal("[1, 2, 3, 4, 5]", array_ {1, 2, 3, 4, 5}.to_string());
      assert::are_equal("[one, two, three, four, five]", array_ {"one", "two", "three", "four", "five"}.to_string());
    }

    void test_method_(index_of_with_array_and_value_type) {
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_<int> {}, 42));
      assert::are_equal(1_z, array_<int>::index_of(array_ {84, 42, 21, 42}, 42));
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_ {84, 42, 21, 42}, 0));
    }

    void test_method_(index_of_with_array_value_type_and_index) {
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_<int> {}, 42, 0));
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::index_of(array_<int> {}, 42, 1);});
      assert::are_equal(1_z, array_<int>::index_of(array_ {84, 42, 21, 42}, 42, 0));
      assert::are_equal(3_z, array_<int>::index_of(array_ {84, 42, 21, 42}, 42, 2));
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_ {84, 42, 21, 42}, 42, 4));
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::index_of(array_<int> {84, 42, 21, 42}, 42, 5);});
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_ {84, 42, 21, 42}, 0, 0));
    }

    void test_method_(index_of_with_array_value_type_index_and_count) {
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_<int> {}, 42, 0, 0));
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::index_of(array_<int> {}, 42, 1, 0);});
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::index_of(array_<int> {}, 42, 0, 1);});
      assert::are_equal(1_z, array_<int>::index_of(array_ {84, 42, 21, 42}, 42, 0, 4));
      assert::are_equal(3_z, array_<int>::index_of(array_ {84, 42, 21, 42}, 42, 2, 2));
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_ {84, 42, 21, 42}, 42, 4, 0));
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::index_of(array_<int> {84, 42, 21, 42}, 42, 4, 1);});
      assert::throws<argument_out_of_range_exception>([&]{array_<int>::index_of(array_<int> {84, 42, 21, 42}, 42, 5, 0);});
      assert::are_equal(array_<int>::npos, array_<int>::index_of(array_ {84, 42, 21, 42}, 0, 0, 4));
    }
    ...
    void test_method_(indexes_array_functor) {
      ...
      assert::are_equal(84, items(array_ {0_z}));
      assert::are_equal(42, items(array_ {1_z}));
      assert::are_equal(21, items(array_ {2_z}));
      assert::throws<index_out_of_range_exception>([&]{[[maybe_unused]] auto i = items(array_ {3_z});});
      
      items(array_ {0_z}) = 63;
      items(array_ {1_z}) = 31;
      items(array_ {2_z}) = 10;
      assert::throws<index_out_of_range_exception>([&]{items(array_ {3_z}) = 5;});
