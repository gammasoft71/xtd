...
namespace xtd::tests {
  class test_class_(array_tests) {
    ...
    auto test_method_(items) {
      ...
      //assert::throws<index_out_of_range_exception>([&]{[[maybe_unused]] auto _ = inners[3];});
    ...
    auto test_method_(get_length) {
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items.get_length(1);});
    }
    
    auto test_method_(get_long_length) {
      auto items = array {84, 42, 21};
      assert::are_equal(3, items.get_long_length(0));
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items.get_long_length(1);});
    }
    
    auto test_method_(get_lower_bound) {
      auto items = array {84, 42, 21};
      assert::is_zero(items.get_lower_bound(0));
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items.get_lower_bound(1);});
    }
    
    auto test_method_(get_upper_bound) {
      auto items = array {84, 42, 21};
      assert::are_equal(2_z, items.get_upper_bound(0));
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items.get_upper_bound(1);});
    }
    ...
    auto test_method_(get_value_with_index) {
      ...
      assert::throws<index_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items.get_value(5);});
    }
    ...
    auto test_method_(get_value_with_indexes_array) {
      ...
      assert::throws<index_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items.get_value(array {5_z});});
    }
    ...
    auto test_method_(index_of_with_array_value_type_and_index) {
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = array<>::index_of(array<int> {}, 42, 1);});
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = array<>::index_of(array<int> {84, 42, 21, 42}, 42, 5);});
    ...
    auto test_method_(index_of_with_array_value_type_index_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = array<>::index_of(array<int> {}, 42, 1, 0);});
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = array<>::index_of(array<int> {}, 42, 0, 1);});
      ...
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = array<>::index_of(array<int> {84, 42, 21, 42}, 42, 4, 1);});
      assert::throws<argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = array<>::index_of(array<int> {84, 42, 21, 42}, 42, 5, 0);});
    ...
    auto test_method_(index_operator) {
      ...
      assert::throws<index_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items[3];});
    ...
    auto test_method_(indexes_array_functor) {
      ...
      assert::throws<index_out_of_range_exception>([&] {[[maybe_unused]] auto _ = items(array {3_z});});
