...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_currency_tests<intptr>> numeric_parse_string_currency_tests_class_intptr_t_attr {"numeric_parse_string_currency_tests<intptr>"};
  ...
  test_class_attribute<numeric_parse_string_currency_tests<uint16>> numeric_parse_string_currency_tests_class_uint16_t_attr {"numeric_parse_string_currency_tests<uint16>"};
  test_class_attribute<numeric_parse_string_currency_tests<uint32>> numeric_parse_string_currency_tests_class_uint32_t_attr {"numeric_parse_string_currency_tests<uint32>"};
  test_class_attribute<numeric_parse_string_currency_tests<uint64>> numeric_parse_string_currency_tests_class_uint64_t_attr {"numeric_parse_string_currency_tests<uint64>"};
  test_class_attribute<numeric_parse_string_currency_tests<uintptr>> numeric_parse_string_currency_tests_class_uintptr_t_attr {"numeric_parse_string_currency_tests<uintptr>"};
