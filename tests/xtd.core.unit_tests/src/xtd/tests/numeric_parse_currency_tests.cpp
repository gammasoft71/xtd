...
namespace xtd::tests {
  ...
  test_class_attribute<numeric_parse_string_currency_tests<unsigned char>> numeric_parse_string_currency_tests_class_unsigned_char_attr {"numeric_parse_string_currency_tests<unsigned char>"};
  ...
  test_class_attribute<numeric_parse_string_currency_tests<unsigned short>> numeric_parse_string_currency_tests_class_unsigned_short_attr {"numeric_parse_string_currency_tests<unsigned short>"};
  ...
  test_class_attribute<numeric_parse_string_currency_tests<unsigned int>> numeric_parse_string_currency_tests_class_unsigned_int_attr {"numeric_parse_string_currency_tests<unsigned int>"};
  ...
  test_class_attribute<numeric_parse_string_currency_tests<unsigned long>> numeric_parse_string_currency_tests_class_unsigned_long_attr {"numeric_parse_string_currency_tests<unsigned long>"};
  test_class_attribute<numeric_parse_string_currency_tests<long long>> numeric_parse_string_currency_tests_class_long_long_attr {"numeric_parse_string_currency_tests<long long>"};
  test_class_attribute<numeric_parse_string_currency_tests<unsigned long long>> numeric_parse_string_currency_tests_class_unsigned_long_long_attr {"numeric_parse_string_currency_tests<unsigned long long>"};
  test_class_attribute<numeric_parse_string_currency_tests<int8_t>> numeric_parse_string_currency_tests_class_int8_t_attr {"numeric_parse_string_currency_tests<int8_t>"};
  test_class_attribute<numeric_parse_string_currency_tests<int16_t>> numeric_parse_string_currency_tests_class_int16_t_attr {"numeric_parse_string_currency_tests<int16_t>"};
  test_class_attribute<numeric_parse_string_currency_tests<int32_t>> numeric_parse_string_currency_tests_class_int32_t_attr {"numeric_parse_string_currency_tests<int32_t>"};
  test_class_attribute<numeric_parse_string_currency_tests<int64_t>> numeric_parse_string_currency_tests_class_int64_t_attr {"numeric_parse_string_currency_tests<int64_t>"};
  ...
  test_class_attribute<numeric_parse_string_currency_tests<uint8_t>> numeric_parse_string_currency_tests_class_uint8_t_attr {"numeric_parse_string_currency_tests<uint8_t>"};
