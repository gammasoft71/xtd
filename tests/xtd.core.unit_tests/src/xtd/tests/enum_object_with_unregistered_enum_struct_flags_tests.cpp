...
namespace xtd::tests {
  class test_class_(enum_object_with_unregistered_enum_struct_flags_tests) {
    ...
    auto test_method_(parse_with_invalid_enum) {
      ...
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("none");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("one");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("two");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("three");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("four");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("one, two");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("three, four");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto e = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("five");});
    }
