...
namespace xtd::tests {
  class test_class_(enum_object_with_unregistered_enum_struct_flags_tests) {
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_default_ctor) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_ctor_with_one) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_ctor_with_two) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_ctor_with_three) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_ctor_with_four) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_ctor_with_one_and_two) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_ctor_with_three_and_four) {
    ...
    auto test_method_(enum_object_with_unregistered_enum_struct_flags_test_ctor_with_invalid_value) {
    ...
    auto test_method_(parse_with_invalid_enum) {
      ...
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("none");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("one");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("two");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("three");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("four");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("one, two");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("three, four");});
      assert::throws<format_exception> ([] {[[maybe_unused]] auto __ = enum_object < >::parse < enum_object_with_unregistered_enum_struct_flags_test > ("five");});
    }
