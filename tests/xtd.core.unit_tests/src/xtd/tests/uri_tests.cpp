...
namespace xtd::tests {
  class test_class_(uri_tests) {
    auto test_method_(constructor_with_absolute_uri) {
      assert::does_not_throw([] {uri("http://www.contoso.com");});
    }
    
    auto test_method_(constructor_with_absolute_uri_and_uri_kind_relative_or_absolute_specified) {
      assert::does_not_throw([] {uri("http://www.contoso.com", uri_kind::relative_or_absolute);});
    }
    
    auto test_method_(constructor_with_absolute_uri_and_uri_kind_absolute_specified) {
      assert::does_not_throw([] {uri("http://www.contoso.com", uri_kind::absolute);});
    }
    
    auto test_method_(constructor_with_absolute_uri_and_uri_kind_relative_specified) {
      assert::throws<uri_format_exception>([] {uri("http://www.contoso.com", uri_kind::relative);});
    }
    
    auto test_method_(constructor_with_relativeUri) {
      assert::throws<uri_format_exception>([] {uri("www.contoso.com");});
    }
    
    auto test_method_(constructor_with_relative_uri_and_uri_kind_relative_or_absolute_specified) {
      assert::does_not_throw([] {uri("www.contoso.com", uri_kind::relative_or_absolute);});
    }
    
    auto test_method_(constructor_with_relative_uri_and_uri_kind_absolute_specified) {
      assert::throws<uri_format_exception>([] {uri("www.contoso.com", uri_kind::absolute);});
    }
    
    auto test_method_(constructor_with_relative_uri_and_uri_kind_relative_specified) {
      assert::does_not_throw([] {uri("www.contoso.com", uri_kind::relative);});
    }
    
    auto test_method_(constructor_with_invalid_uri) {
      assert::throws<uri_format_exception>([] {uri("://www.contoso.com");});
    }
    ...
    auto test_method_(check_scheme_name) {
    ...
    auto test_method_(absolute_path) {
    ...
    auto test_method_(absolute_uri) {
    ...
    auto test_method_(get_components) {
    ...
    auto test_method_(dns_safe_host) {
    ...
    auto test_method_(host_name_type) {
    ...
    auto test_method_(get_left_part) {
    ...
    auto test_method_(original_string) {
    ...
    auto test_method_(path_and_query) {
    ...
    auto test_method_(is_default_port) {
    ...
    auto test_method_(unescape_data_string) {
