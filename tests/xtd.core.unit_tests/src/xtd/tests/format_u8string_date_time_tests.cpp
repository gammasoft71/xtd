...
namespace xtd::tests {
  class test_class_(format_u8string_date_time_tests) {
    ...
    void test_method_(format_date_time_local_with_std_tm_with_default_argument) {
      ...
      assert::are_equal(u8"Wed Jan  2 03:04:05 2019", format(u8"{0}", date_time {2019, 1, 2, 3, 4, 5}));
      #elif defined(_WIN32)
    ...
    void test_method_(format_date_time_local_with_left_alignment) {
      #if defined(__APPLE__)
      assert::are_equal(u8"           Wed Jan  2 03:04:05 2019", format(u8"{0, 35}", date_time {2019, 1, 2, 3, 4, 5}));
      #elif defined(_WIN32)
      assert::are_equal(u8"                1/2/2019 3:04:05 AM", format(u8"{0, 35}", date_time {2019, 1, 2, 3, 4, 5}));
      #else
      string_assert::starts_with("    Wed 02 Jan 2019 03:04:05 AM", format(u8"{0, 35}", date_time {2019, 1, 2, 3, 4, 5}));
      #endif
    }
    ...
    void test_method_(format_date_time_local_with_left_to_zero) {
      #if defined(__APPLE__)
      assert::are_equal(u8"Wed Jan  2 03:04:05 2019", format(u8"{0,0}", date_time {2019, 1, 2, 3, 4, 5}));
      #elif defined(_WIN32)
      assert::are_equal(u8"1/2/2019 3:04:05 AM", format(u8"{0,0}", date_time {2019, 1, 2, 3, 4, 5}));
      #else
      string_assert::starts_with("Wed 02 Jan 2019 03:04:05 AM", format(u8"{0,0}", date_time {2019, 1, 2, 3, 4, 5}));
      #endif
    }
    ...
    void test_method_(format_date_time_local_with_alignment_empty) {
      ...
      assert::are_equal(u8"1/2/2019 3:04:05 AM", format(u8"{0,}", date_time {2019, 1, 2, 3, 4, 5}));
      #else
      string_assert::starts_with("Wed 02 Jan 2019 03:04:05 AM", format(u8"{0,}", date_time {2019, 1, 2, 3, 4, 5}));
      #endif
    }
