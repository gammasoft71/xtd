...
namespace xtd::tests {
  class test_class_(format_u8string_date_time_tests) {
    ...
    void test_method_(format_with_none) {
      assert::are_equal(u8"1/2/2019 03:04", format(u8"{}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_with_sequence_number) {
      assert::are_equal(u8"1/2/2019 03:04", format(u8"{0}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_with_none_and_left_alignment) {
      assert::are_equal(u8"                     1/2/2019 03:04", format(u8"{, 35}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_with_sequence_number_and_left_alignment) {
      assert::are_equal(u8"                     1/2/2019 03:04", format(u8"{0, 35}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_with_sequence_number_and_left_alignment_to_zero) {
      assert::are_equal(u8"1/2/2019 03:04", format(u8"{0, 0}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_full_date_short_time_with_none) {
      assert::are_equal(u8"Wednesday, January 2, 2019 03:04", format(u8"{:f}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_full_date_short_time_with_sequence_number) {
      assert::are_equal(u8"Wednesday, January 2, 2019 03:04", format(u8"{0:f}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_full_date_long_time_with_none) {
      assert::are_equal(u8"Wednesday, January 2, 2019 03:04:05", format(u8"{:F}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_full_date_long_time_with_sequence_number) {
      assert::are_equal(u8"Wednesday, January 2, 2019 03:04:05", format(u8"{0:F}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_general_short_with_none) {
      assert::are_equal(u8"1/2/2019 03:04", format(u8"{:g}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_general_short_with_sequence_number) {
      assert::are_equal(u8"1/2/2019 03:04", format(u8"{0:g}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_general_long_with_none) {
      assert::are_equal(u8"1/2/2019 03:04:05", format(u8"{:G}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_general_long_with_sequence_number) {
      assert::are_equal(u8"1/2/2019 03:04:05", format(u8"{0:G}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_rfc1123_with_none) {
      assert::are_equal(u8"Wed, 02 Jan 2019 03:04:05 G1T", format(u8"{:r}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_rfc1123_with_sequence_number) {
      assert::are_equal(u8"Wed, 02 Jan 2019 03:04:05 G1T", format(u8"{0:r}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_short_time_with_none) {
      assert::are_equal(u8"03:04", format(u8"{:t}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_short_time_with_sequence_number) {
      assert::are_equal(u8"03:04", format(u8"{0:t}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_long_time_with_none) {
      assert::are_equal(u8"03:04:05", format(u8"{:T}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_universal_sortable_with_none) {
      assert::are_equal(u8"2019-01-02 03:04:05Z", format(u8"{:u}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_universal_sortable_with_sequence_number) {
      assert::are_equal(u8"2019-01-02 03:04:05Z", format(u8"{0:u}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_universal_full_with_none) {
      assert::are_equal(u8"Wednesday, January 2, 2019 03:04:05", format(u8"{:U}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_universal_full_with_sequence_number) {
      assert::are_equal(u8"Wednesday, January 2, 2019 03:04:05", format(u8"{0:U}", date_time {2019, 1, 2, 3, 4, 5}));
    }
