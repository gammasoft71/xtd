...
namespace xtd::tests {
  class test_class_(format_u8string_date_time_tests) {
    ...
    void test_method_(format_with_none) {
      assert::are_equal(u8"1/2/2019 03:04:05", format(u8"{}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_with_sequence_number) {
      assert::are_equal(u8"1/2/2019 03:04:05", format(u8"{0}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    
    void test_method_(format_with_none_and_left_alignment) {
      assert::are_equal(u8"                  1/2/2019 03:04:05", format(u8"{, 35}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_with_sequence_number_and_left_alignment) {
      assert::are_equal(u8"                  1/2/2019 03:04:05", format(u8"{0, 35}", date_time {2019, 1, 2, 3, 4, 5}));
    }
    ...
    void test_method_(format_with_sequence_number_and_left_alignment_to_zero) {
      assert::are_equal(u8"1/2/2019 03:04:05", format(u8"{0, 0}", date_time {2019, 1, 2, 3, 4, 5}));
    }
