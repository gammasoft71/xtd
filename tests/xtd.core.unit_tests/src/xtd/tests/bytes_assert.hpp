...
namespace xtd::tests {
  ...
  public:
    ...
    static void are_equal(value_t b, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {are_equal(b, bytes, xtd::string::empty_string, stack_frame);}
    
    template<class value_t, class bytes_t>
    static void are_equal(value_t b, const std::vector<bytes_t>& bytes, const std::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {
    ...
    static void are_equal(value1_t b1, value2_t b2, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {are_equal(b1, b2, bytes, xtd::string::empty_string, stack_frame);}
    
    template<class value1_t, class value2_t, class bytes_t>
    static void are_equal(value1_t b1, value2_t b2, const std::vector<bytes_t>& bytes, const std::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {
    ...
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {are_equal(b1, b2, b3, b4, bytes, xtd::string::empty_string, stack_frame);}
    
    template<class value1_t, class value2_t, class value3_t, class value4_t, class bytes_t>
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, const std::vector<bytes_t>& bytes, const std::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {
    ...
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, value5_t b5, value6_t b6, value7_t b7, value8_t b8, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {are_equal(b1, b2, b3, b4, b5, b6, b7, b8, bytes, xtd::string::empty_string, stack_frame);}
    
    template<class value1_t, class value2_t, class value3_t, class value4_t, class value5_t, class value6_t, class value7_t, class value8_t, class bytes_t>
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, value5_t b5, value6_t b6, value7_t b7, value8_t b8, const std::vector<bytes_t>& bytes, const std::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {
    ...
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, value5_t b5, value6_t b6, value7_t b7, value8_t b8, value9_t b9, value10_t b10, value11_t b11, value12_t b12, value13_t b13, value14_t b14, value15_t b15, value16_t b16, const std::vector<bytes_t>& bytes, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {are_equal(b1, b2, b3, b4, b5, b6, b7, b8, b10, b11, b12, b13, b14, b15, b16, bytes, xtd::string::empty_string, stack_frame);}
    
    template<class value1_t, class value2_t, class value3_t, class value4_t, class value5_t, class value6_t, class value7_t, class value8_t, class value9_t, class value10_t, class value11_t, class value12_t, class value13_t, class value14_t, class value15_t, class value16_t, class bytes_t>
    static void are_equal(value1_t b1, value2_t b2, value3_t b3, value4_t b4, value5_t b5, value6_t b6, value7_t b7, value8_t b8, value9_t b9, value10_t b10, value11_t b11, value12_t b12, value13_t b13, value14_t b14, value15_t b15, value16_t b16, const std::vector<bytes_t>& bytes, const std::string& message, const xtd::diagnostics::stack_frame& stack_frame = xtd::diagnostics::stack_frame::current()) {
