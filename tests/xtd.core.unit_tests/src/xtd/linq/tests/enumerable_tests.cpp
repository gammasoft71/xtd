...
namespace xtd::linq::tests {
  class test_class_(enumerable_tests) {
    ...
    auto test_method_(average_with_enumerable_decimal) {
      ...
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto _ = enumerable::average(array<decimal> {});});
    }
    
    auto test_method_(average_with_enumerable_double) {
      assert::are_equal(.3, enumerable::average(array {.1, .2, .3, .4, .5}));
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto _ = enumerable::average(array<double> {});});
    }
    
    auto test_method_(average_with_enumerable_float) {
      assert::are_equal(.3f, enumerable::average(array {.1f, .2f, .3f, .4f, .5f}));
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto _ = enumerable::average(array<float> {});});
    }
    
    auto test_method_(average_with_enumerable_int32) {
      assert::are_equal(3.0, enumerable::average(array {1, 2, 3, 4, 5}));
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto _ = enumerable::average(array<int32> {});});
    }
    ...
    auto test_method_(average_with_enumerable_int64) {
      ...
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto _ = enumerable::average(array<int64> {});});
    }
    ...
    auto test_method_(average_with_enumerable_optional_double) {
    ...
    auto test_method_(average_with_enumerable_optional_float) {
    ...
    auto test_method_(average_with_enumerable_optional_int32) {
    ...
    auto test_method_(average_with_enumerable_optional_int64) {
    ...
    auto test_method_(chunk_with_enumerable) {
      ...
      assert::throws<xtd::argument_out_of_range_exception>([&] {[[maybe_unused]] auto _ = enumerable::chunk(s, 0);});
    }
    ...
    auto test_method_(contains_with_enumerable_and_iequality_comparer) {
    ...
    auto test_method_(count_with_enumerable) {
    ...
    auto test_method_(first_or_default_with_enumerable) {
    ...
    auto test_method_(range_with_count) {
      ...
      assert::throws<argument_out_of_range_exception>([] {[[maybe_unused]] auto _ = enumerable::range(-1);});
    }
    ...
    auto test_method_(range_with_start_and_count) {
      ...
      assert::throws<argument_out_of_range_exception>([] {[[maybe_unused]] auto _ = enumerable::range(1, -1);});
    }
    ...
    auto test_method_(range_with_start_count_end_step) {
      ...
      collection_assert::are_equal({-1, -3, -5, -7, -9}, enumerable::range(-1, 5, -2));
      assert::throws<argument_exception>([] {[[maybe_unused]] auto _ = enumerable::range(1, 5, 0);});
      assert::throws<argument_out_of_range_exception>([] {[[maybe_unused]] auto _ = enumerable::range(1, -1, 1);});
    }
