...
namespace xtd::linq::tests {
  class test_class_(enumerable_tests) {
    ...
    auto test_method_(append_with_enumerable_and_element) {
      collection_assert::are_equal({1, 2, 3}, enumerable::append(array {1, 2}, 3).to_array());
    }
    ...
    auto test_method_(average_with_enumerable_decimal) {
      ...
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto __ = enumerable::average(array<decimal> {});});
    }
    
    auto test_method_(average_with_enumerable_double) {
      assert::are_equal(.3, enumerable::average(array {.1, .2, .3, .4, .5}));
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto __ = enumerable::average(array<double> {});});
    }
    
    auto test_method_(average_with_enumerable_float) {
      assert::are_equal(.3f, enumerable::average(array {.1f, .2f, .3f, .4f, .5f}));
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto __ = enumerable::average(array<float> {});});
    }
    
    auto test_method_(average_with_enumerable_int32) {
      assert::are_equal(3.0, enumerable::average(array {1, 2, 3, 4, 5}));
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto __ = enumerable::average(array<int32> {});});
    }
    ...
    auto test_method_(average_with_enumerable_int64) {
      ...
      assert::throws<invalid_operation_exception>([] {[[maybe_unused]] auto __ = enumerable::average(array<int64> {});});
    }
