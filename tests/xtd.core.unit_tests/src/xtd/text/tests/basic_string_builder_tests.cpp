...
namespace xtd::tests {
  ...
  public:
    ...
    void test_method_(chars) {
      ...
      collection_assert::are_equal(std::initializer_list<char_t> {'A', ' ', 't', 'e', 's', 't', ' ', 's', 't', 'r', 'i', 'n', 'g'}, basic_string_builder<char_t> {"A test string"}.chars(), csf_);
    }
    ...
    void test_method_(get_base_type) {
      ...
      collection_assert::are_equal(std::initializer_list<char_t> {'A', ' ', 't', 'e', 's', 't', ' ', 's', 't', 'r', 'i', 'n', 'g'}, basic_string_builder<char_t> {"A test string"}.get_base_type(), csf_);
    }
    ...
    void test_method_(cast_operator_base_type) {
      ...
      s = basic_string_builder<char_t>("A test string");
      collection_assert::are_equal(std::initializer_list<char_t> {'A', ' ', 't', 'e', 's', 't', ' ', 's', 't', 'r', 'i', 'n', 'g'}, s, csf_);
    }
