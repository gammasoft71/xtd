...
namespace xtd::threading::tests {
  class test_class_(barrier_tests) {
    ...
    auto test_method_(add_participant) {
      barrier b {5};
      assert::are_equal(5, b.participant_count());
      assert::are_equal(5, b.participants_remaining());
      b.add_participant();
      assert::are_equal(6, b.participant_count());
      assert::are_equal(6, b.participants_remaining());
      b.add_participant();
    ...
    auto test_method_(add_participants) {
      ...
      assert::are_equal(8, b.participant_count());
      assert::are_equal(8, b.participants_remaining());
      b.add_participants(10);
      assert::are_equal(18, b.participant_count());
      assert::are_equal(18, b.participants_remaining());
    ...
    auto test_method_(add_participants_invalid) {
      barrier b {5};
      assert::throws<argument_exception>([&] {b.add_participants(-1);});
      assert::throws<argument_exception>([&] {b.add_participants(32763);});
    }
    
    auto test_method_(remove_participant) {
      barrier b {20};
      assert::are_equal(20, b.participant_count());
      assert::are_equal(20, b.participants_remaining());
      b.remove_participant();
      assert::are_equal(19, b.participant_count());
      assert::are_equal(19, b.participants_remaining());
      b.remove_participant();
      assert::are_equal(18, b.participant_count());
      assert::are_equal(18, b.participants_remaining());
    }
    ...
    auto test_method_(remove_participants) {
      ...
      assert::are_equal(15, b.participant_count());
      assert::are_equal(15, b.participants_remaining());
    ...
    auto test_method_(remove_participants_invalid) {
      barrier b {5};
      assert::throws<argument_exception>([&] {b.remove_participants(-1);});
      assert::throws<argument_exception>([&] {b.remove_participants(6);});
    }
    
    auto test_method_(signal_and_wait_with_one_participant) {
      barrier b {1};
      assert::are_equal(0, b.current_phase_number());
      assert::is_true(b.signal_and_wait(0));
      assert::are_equal(1, b.current_phase_number());
      assert::is_true(b.signal_and_wait(0));
      assert::are_equal(2, b.current_phase_number());
    }
    ...
    auto test_method_(signal_and_wait_with_one_participant_and_post_phase_action) {
      ...
      assert::is_true(b.signal_and_wait(0));
      assert::are_equal(1, b.current_phase_number());
      assert::are_equal(1, post_phase_action_count);
      assert::is_true(b.signal_and_wait(0));
      assert::are_equal(2, b.current_phase_number());
      assert::are_equal(2, post_phase_action_count);
    }
