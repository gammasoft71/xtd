...
namespace xtd::net::sockets::tests {
  class test_class_(socket_flags_tests) {
    ...
    auto test_method_(max_io_vector_length) {
    ...
    auto test_method_(control_data_truncated) {
