#include <xtd/net/sockets/io_control_code.h>
...
namespace xtd::tests {
  ...
  public:
    void test_method_(enable_circular_queuing) {
      assert::are_equal(671088642, enum_object<>::to_int32(io_control_code::enable_circular_queuing), csf_);
    ...
    void test_method_(flush) {
      assert::are_equal(671088644, enum_object<>::to_int32(io_control_code::flush), csf_);
    ...
    void test_method_(address_list_change) {
      assert::are_equal(671088663, enum_object<>::to_int32(io_control_code::address_list_change), csf_);
    ...
    void test_method_(data_to_read) {
      assert::are_equal(1074030207, enum_object<>::to_int32(io_control_code::data_to_read), csf_);
    ...
    void test_method_(oob_data_read) {
      assert::are_equal(1074033415, enum_object<>::to_int32(io_control_code::oob_data_read), csf_);
    ...
    void test_method_(get_broadcast_address) {
      assert::are_equal(1207959557, enum_object<>::to_int32(io_control_code::get_broadcast_address), csf_);
    ...
    void test_method_(address_list_query) {
      assert::are_equal(1207959574, enum_object<>::to_int32(io_control_code::address_list_query), csf_);
    ...
    void test_method_(query_target_pnp_handle) {
      assert::are_equal(1207959576, enum_object<>::to_int32(io_control_code::query_target_pnp_handle), csf_);
    ...
    void test_method_(async_io) {
      assert::are_equal(-2147195267, enum_object<>::to_int32(io_control_code::async_io), csf_);
    ...
    void test_method_(non_blocking_io) {
      assert::are_equal(-2147195266, enum_object<>::to_int32(io_control_code::non_blocking_io), csf_);
    ...
    void test_method_(associate_handle) {
      assert::are_equal(-2013265919, enum_object<>::to_int32(io_control_code::associate_handle), csf_);
    ...
    void test_method_(multipoint_loopback) {
      assert::are_equal(-2013265911, enum_object<>::to_int32(io_control_code::multipoint_loopback), csf_);
    ...
    void test_method_(multicast_scope) {
      assert::are_equal(-2013265910, enum_object<>::to_int32(io_control_code::multicast_scope), csf_);
    ...
    void test_method_(set_qos) {
      assert::are_equal(-2013265909, enum_object<>::to_int32(io_control_code::set_qos), csf_);
    ...
    void test_method_(set_group_qos) {
      assert::are_equal(-2013265908, enum_object<>::to_int32(io_control_code::set_group_qos), csf_);
    ...
    void test_method_(routing_interface_change) {
      assert::are_equal(-2013265899, enum_object<>::to_int32(io_control_code::routing_interface_change), csf_);
    ...
    void test_method_(namespace_change) {
      assert::are_equal(-2013265895, enum_object<>::to_int32(io_control_code::namespace_change), csf_);
    ...
    void test_method_(receive_all) {
      assert::are_equal(-1744830463, enum_object<>::to_int32(io_control_code::receive_all), csf_);
    ...
    void test_method_(receive_all_multicast) {
      assert::are_equal(-1744830462, enum_object<>::to_int32(io_control_code::receive_all_multicast), csf_);
    ...
    void test_method_(receive_all_igmp_multicast) {
      assert::are_equal(-1744830461, enum_object<>::to_int32(io_control_code::receive_all_igmp_multicast), csf_);
    ...
    void test_method_(keep_alive_values) {
      assert::are_equal(-1744830460, enum_object<>::to_int32(io_control_code::keep_alive_values), csf_);
    ...
    void test_method_(absorb_router_alert) {
      assert::are_equal(-1744830459, enum_object<>::to_int32(io_control_code::absorb_router_alert), csf_);
    ...
    void test_method_(unicast_interface) {
      assert::are_equal(-1744830458, enum_object<>::to_int32(io_control_code::unicast_interface), csf_);
    ...
    void test_method_(limit_broadcasts) {
      assert::are_equal(-1744830457, enum_object<>::to_int32(io_control_code::limit_broadcasts), csf_);
    ...
    void test_method_(bind_to_interface) {
      assert::are_equal(-1744830456, enum_object<>::to_int32(io_control_code::bind_to_interface), csf_);
    ...
    void test_method_(multicast_interface) {
      assert::are_equal(-1744830455, enum_object<>::to_int32(io_control_code::multicast_interface), csf_);
    ...
    void test_method_(add_multicast_group_on_interface) {
      assert::are_equal(-1744830454, enum_object<>::to_int32(io_control_code::add_multicast_group_on_interface), csf_);
    ...
    void test_method_(delete_multicast_group_from_interface) {
      assert::are_equal(-1744830453, enum_object<>::to_int32(io_control_code::delete_multicast_group_from_interface), csf_);
    ...
    void test_method_(get_extension_function_pointer) {
      assert::are_equal(-939524090, enum_object<>::to_int32(io_control_code::get_extension_function_pointer), csf_);
    ...
    void test_method_(get_qos) {
      assert::are_equal(-939524089, enum_object<>::to_int32(io_control_code::get_qos), csf_);
    ...
    void test_method_(get_group_qos) {
      assert::are_equal(-939524088, enum_object<>::to_int32(io_control_code::get_group_qos), csf_);
    ...
    void test_method_(translate_handle) {
      assert::are_equal(-939524083, enum_object<>::to_int32(io_control_code::translate_handle), csf_);
    ...
    void test_method_(routing_interface_query) {
      assert::are_equal(-939524076, enum_object<>::to_int32(io_control_code::routing_interface_query), csf_);
    ...
    void test_method_(address_list_sort) {
      assert::are_equal(-939524071, enum_object<>::to_int32(io_control_code::address_list_sort), csf_);
