...
namespace xtd::net::sockets::tests {
  class test_class_(transmit_file_options_tests) {
    auto test_method_(use_default_worker_thread) {
    ...
    auto test_method_(reuse_socket) {
    ...
    auto test_method_(write_behind) {
    ...
    auto test_method_(use_system_thread) {
    ...
    auto test_method_(use_kernel_apc) {
