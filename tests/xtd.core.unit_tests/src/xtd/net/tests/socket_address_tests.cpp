...
namespace xtd::net::tests {
  class test_class_(socket_address_tests) {
    auto test_method_(create_socket_address_with_address_family_unnown) {
    ...
    auto test_method_(create_socket_address_with_address_family_unspecified) {
    ...
    auto test_method_(create_socket_address_with_address_family_unix) {
    ...
    auto test_method_(create_socket_address_with_address_family_inter_network) {
    ...
    auto test_method_(create_socket_address_with_address_family_sna) {
    ...
    auto test_method_(create_socket_address_with_address_family_dec_net) {
    ...
    auto test_method_(create_socket_address_with_address_family_apple_talk) {
    ...
    auto test_method_(create_socket_address_with_address_family_inter_network_v6) {
    ...
    auto test_method_(create_socket_address_with_address_family_max) {
    ...
    auto test_method_(create_socket_address_with_address_family_inter_network_and_size_16) {
    ...
    auto test_method_(create_socket_address_with_address_family_inter_network_and_size_1) {
      assert::throws<argument_out_of_range_exception>([] {socket_address sa(address_family::inter_network, 1);});
    }
    
    auto test_method_(socket_address_value_operator) {
      socket_address sa(address_family::inter_network);
    ...
    auto test_method_(socket_address_value_operator_with_out_of_range_index) {
      socket_address sa(address_family::inter_network);
      assert::throws<index_out_of_range_exception>([&] {sa[32] = 42;});
    }
    
    auto test_method_(socket_address_to_string) {
      socket_address sa(address_family::inter_network);
