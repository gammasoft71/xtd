...
namespace xtd::net::tests {
  class test_class_(ip_address_tests) {
    ...
    auto test_method_(constructor_with_uint32_t) {
    ...
    auto test_method_(constructors_wtith_bytes_array_ip_v4) {
    ...
    auto test_method_(constructors_with_invalid_bytes_array) {
    ...
    auto test_method_(address_family) {
    ...
    auto test_method_(get_scope_id) {
      assert::throws<socket_exception>([] {[[maybe_unused]] auto __ = ip_address(xtd::array<xtd::byte> {172, 16, 10, 30}).scope_id();});
    ...
    auto test_method_(is_ip_v4_mapped_to_ip_v6) {
    
    }
    
    auto test_method_(is_ip_v6_link_local) {
    
    }
    
    auto test_method_(is_ip_v6_multicast) {
    
    }
    
    auto test_method_(is_ip_v6_site_local) {
    
    }
    
    auto test_method_(is_ip_v6_teredo) {
    ...
    auto test_method_(operator_equals) {
    ...
    auto test_method_(operator_not_equals) {
    ...
    auto test_method_(get_address_bytes) {
    ...
    auto test_method_(host_to_network_order) {
    ...
    auto test_method_(network_to_host_order) {
      if (bit_converter::is_little_endian) {
    ...
    auto test_method_(parse_with_bad_string) {
      assert::throws<format_exception>([] {[[maybe_unused]] auto __ = ip_address::parse("172.16.12.24.1");});
    }
  };
}
