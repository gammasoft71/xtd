...
namespace unit_tests {
  ...
  public:
    ...
    void test_method_(creator_with_empty_message) {
      ...
      assert::are_equal_("xtd::invalid_operation_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::invalid_operation_exception", e.to_string());
      assert::are_equal_("xtd::invalid_operation_exception", e.what());
    }
    ...
    void test_method_(creator_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal_("xtd::invalid_operation_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::invalid_operation_exception\n" + info.to_string(), e.to_string());
      assert::are_equal_("xtd::invalid_operation_exception", e.what());
    }
