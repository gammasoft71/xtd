...
namespace unit_tests {
  class test_class_(test_time_out_exception) {
  public:
    void test_method_(default_creator) {
      ...
      assert::are_equal_("The operation has timed out.", e.message());
      assert::are_equal_("xtd::time_out_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::time_out_exception : The operation has timed out.", e.to_string());
      assert::are_equal_("The operation has timed out.", e.what());
    }
    ...
    void test_method_(default_creator_with_current_stack_frame) {
      ...
      assert::are_equal_("xtd::time_out_exception : The operation has timed out.\n" + info.to_string(), e.to_string());
      assert::are_equal_("The operation has timed out.", e.what());
    }
    ...
    void test_method_(creator_with_empty_message) {
      ...
      assert::are_equal_("xtd::time_out_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::time_out_exception", e.to_string());
      assert::are_equal_("xtd::time_out_exception", e.what());
    }
    ...
    void test_method_(creator_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal_("xtd::time_out_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::time_out_exception\n" + info.to_string(), e.to_string());
      assert::are_equal_("xtd::time_out_exception", e.what());
    }
    ...
    void test_method_(creator_with_message) {
      ...
      assert::are_equal_("xtd::time_out_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::time_out_exception : Test excpetion message.", e.to_string());
    ...
    void test_method_(creator_with_message_and_stack_frame) {
      ...
      assert::are_equal_("xtd::time_out_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::time_out_exception : Test excpetion message.\n" + info.to_string(), e.to_string());
      assert::are_equal_("Test excpetion message.", e.what());
    }
