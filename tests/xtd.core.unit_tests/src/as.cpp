...
namespace unit_tests {
  ...
  public:
    ...
    void test_method_(char8_t_as_int) {
      assert::is_true(is<int>(as<int>((char8_t)'a')));
    }
    
    void test_method_(char16_t_as_int) {
      assert::is_true(is<int>(as<int>((char16_t)'a')));
    }
    
    void test_method_(char32_t_as_int) {
      assert::is_true(is<int>(as<int>((char32_t)'a')));
    }
    
    void test_method_(wchar_t_as_int) {
      assert::is_true(is<int>(as<int>((wchar_t)'a')));
    }
    ...
    void test_method_(int8_t_as_double) {
      assert::is_true(is<double>(as<double>((int8_t)42)));
    }

    void test_method_(int16_t_as_double) {
      assert::is_true(is<double>(as<double>((int16_t)42)));
    }

    void test_method_(int32_t_as_double) {
      assert::is_true(is<double>(as<double>((int32_t)42)));
    }

    void test_method_(int64_t_as_double) {
      assert::is_true(is<double>(as<double>((int64_t)42)));
    }

    void test_method_(llong_t_as_double) {
      assert::is_true(is<double>(as<double>((llong_t)42)));
    }
    ...
    void test_method_(uint8_t_as_double) {
      assert::is_true(is<double>(as<double>((uint8_t)42)));
    }
    
    void test_method_(uint16_t_as_double) {
      assert::is_true(is<double>(as<double>((uint16_t)42)));
    }
    
    void test_method_(uint32_t_as_double) {
      assert::is_true(is<double>(as<double>((uint32_t)42)));
    }
    
    void test_method_(uint64_t_as_double) {
      assert::is_true(is<double>(as<double>((uint64_t)42)));
    }
    
    void test_method_(ullong_t_as_double) {
      assert::is_true(is<double>(as<double>((ullong_t)42)));
    }
    ...
    void test_method_(intptr_t_as_int) {
      assert::is_true(is<int>(as<int>((intptr_t)42)));
    }

    void test_method_(uintptr_t_as_int) {
      assert::is_true(is<int>(as<int>((uintptr_t)42)));
    }
    ...
    void test_method_(decimal_as_int) {
      assert::is_true(is<int>(as<int>((decimal_t)42.)));
    }
