...
namespace unit_tests {
  class test_class_(test_underflow_exception) {
  public:
    void test_method_(default_creator) {
      ...
      assert::are_equal_("Arithmetic operation resulted in an underflow.", e.message());
      assert::are_equal_("xtd::underflow_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::underflow_exception : Arithmetic operation resulted in an underflow.", e.to_string());
      assert::are_equal_("Arithmetic operation resulted in an underflow.", e.what());
    }
    ...
    void test_method_(default_creator_with_current_stack_frame) {
      ...
      assert::are_equal_("xtd::underflow_exception : Arithmetic operation resulted in an underflow.\n" + info.to_string(), e.to_string());
      assert::are_equal_("Arithmetic operation resulted in an underflow.", e.what());
    }
    ...
    void test_method_(creator_with_empty_message) {
      ...
      assert::are_equal_("xtd::underflow_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::underflow_exception", e.to_string());
      assert::are_equal_("xtd::underflow_exception", e.what());
    }
    ...
    void test_method_(creator_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal_("xtd::underflow_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::underflow_exception\n" + info.to_string(), e.to_string());
      assert::are_equal_("xtd::underflow_exception", e.what());
    }
    ...
    void test_method_(creator_with_message) {
      ...
      assert::are_equal_("xtd::underflow_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::underflow_exception : Test excpetion message.", e.to_string());
    ...
    void test_method_(creator_with_message_and_stack_frame) {
      ...
      assert::are_equal_("xtd::underflow_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::underflow_exception : Test excpetion message.\n" + info.to_string(), e.to_string());
      assert::are_equal_("Test excpetion message.", e.what());
    }

    void test_method_(creator_with_message_error_and_stack_frame) {
      auto info = current_stack_frame_;
      underflow_exception e("Test excpetion message.", std::error_code(EBUSY, std::generic_category()), info);
    ...
    void test_method_(creator_with_message_inner_exception_error_and_stack_frame) {
      system_exception inner_exception;
      auto info = current_stack_frame_;
      underflow_exception e("Test excpetion message.", inner_exception, std::error_code(EBUSY, std::generic_category()), info);
      assert::are_equal_(EBUSY, e.error().value());
      assert::are_equal_(std::generic_category(), e.error().category());
      assert::are_equal_(info.get_file_name(), e.file_path());
      assert::is_empty_(e.help_link());
