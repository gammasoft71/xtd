...
namespace unit_tests {
  ...
  public:
    void test_method_(format_with_default_argument) {
      assert::are_equal("1.02:03:32:024000500", xtd::strings::format("{0}", 26h + 3min + 32s + 24ms + 500ns));
    }
    
    void test_method_(format_with_default_argument_without_days_milliseconds_and_nanoseconds) {
      assert::are_equal("02:03:32", xtd::strings::format("{0}", 2h + 3min + 32s));
    }
    
    void test_method_(format_without_format_argument_separator) {
      assert::throws<std::invalid_argument>([]{strings::format("{0G}", 2h + 3min + 32s);});
    }
    
    void test_method_(format_with_left_alignment) {
      assert::are_equal("  02:03:32", strings::format("{0,10}", 2h + 3min + 32s));
    }
    ...
    void test_method_(format_with_left_alignment_to_zero) {
      assert::are_equal("02:03:32", strings::format("{0,0}", 2h + 3min + 32s));
    }
    ...
    void test_method_(format_with_alignment_invalid) {
      assert::throws<std::invalid_argument>([]{strings::format("{0,a}",2h + 3min + 32s);});
    }
