...
namespace unit_tests {
  class test_class_(test_argument_null_exception) {
  public:
    void test_method_(default_creator) {
      ...
      assert::are_equal_("Value cannot be null.", e.message());
      assert::are_equal_("xtd::argument_null_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::argument_null_exception : Value cannot be null.", e.to_string());
      assert::are_equal_("Value cannot be null.", e.what());
    }
    ...
    void test_method_(default_creator_with_current_stack_frame) {
      ...
      assert::are_equal_("xtd::argument_null_exception : Value cannot be null.\n" + info.to_string(), e.to_string());
      assert::are_equal_("Value cannot be null.", e.what());
    }
    ...
    void test_method_(creator_with_empty_message) {
      ...
      assert::are_equal_("xtd::argument_null_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::argument_null_exception", e.to_string());
      assert::are_equal_("xtd::argument_null_exception", e.what());
    }
    ...
    void test_method_(creator_with_message_empty_and_stack_frame) {
      ...
      assert::are_equal_("xtd::argument_null_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::argument_null_exception\n" + info.to_string(), e.to_string());
      assert::are_equal_("xtd::argument_null_exception", e.what());
    }
    ...
    void test_method_(creator_with_message) {
      ...
      assert::are_equal_("xtd::argument_null_exception", e.name());
      assert::is_empty(e.stack_trace());
      assert::are_equal_("xtd::argument_null_exception : Test excpetion message.", e.to_string());
    ...
    void test_method_(creator_with_message_and_stack_frame) {
      ...
      assert::are_equal_("xtd::argument_null_exception", e.name());
      assert::are_equal_(info.to_string(), e.stack_trace());
      assert::are_equal_("xtd::argument_null_exception : Test excpetion message.\n" + info.to_string(), e.to_string());
      assert::are_equal_("Test excpetion message.", e.what());
    }
    ...
    void test_method_(creator_with_message_help_link_and_stack_frame) {
      auto info = current_stack_frame_;
      argument_null_exception e("Test excpetion message.", "https://codedocs.xyz/gammasoft71/xtd_core/", info);
      assert::are_equal_(0, e.error().value());
      assert::are_equal_(std::system_category(), e.error().category());
      assert::are_equal_(info.get_file_name(), e.file_path());
    ...
    void test_method_(creator_with_message_error_help_link_and_stack_frame) {
      auto info = current_stack_frame_;
      argument_null_exception e("Test excpetion message.", std::error_code(EBUSY, std::generic_category()), "https://codedocs.xyz/gammasoft71/xtd_core/", info);
      assert::are_equal_(EBUSY, e.error().value());
      assert::are_equal_(std::generic_category(), e.error().category());
      assert::are_equal_(info.get_file_name(), e.file_path());
      assert::are_equal_("https://codedocs.xyz/gammasoft71/xtd_core/", e.help_link());
    ...
    void test_method_(creator_with_message_inner_exception_help_link_and_stack_frame) {
      system_exception inner_exception;
      auto info = current_stack_frame_;
      argument_null_exception e("Test excpetion message.", inner_exception, "https://codedocs.xyz/gammasoft71/xtd_core/", info);
      assert::are_equal_(0, e.error().value());
      assert::are_equal_(std::system_category(), e.error().category());
      assert::are_equal_(info.get_file_name(), e.file_path());
      assert::are_equal_("https://codedocs.xyz/gammasoft71/xtd_core/", e.help_link());
    ...
    void test_method_(creator_with_message_inner_exception_error_help_link_and_stack_frame) {
      system_exception inner_exception;
      auto info = current_stack_frame_;
      argument_null_exception e("Test excpetion message.", inner_exception, std::error_code(EBUSY, std::generic_category()), "https://codedocs.xyz/gammasoft71/xtd_core/", info);
      assert::are_equal_(EBUSY, e.error().value());
      assert::are_equal_(std::generic_category(), e.error().category());
      assert::are_equal_(info.get_file_name(), e.file_path());
      assert::are_equal_("https://codedocs.xyz/gammasoft71/xtd_core/", e.help_link());
    ...
    void test_method_(copy_constructor) {
      system_exception inner_exception;
      auto info = current_stack_frame_;
      argument_null_exception e = argument_null_exception("Test excpetion message.", inner_exception, std::error_code(EBUSY, std::generic_category()), "https://codedocs.xyz/gammasoft71/xtd_core/", info);
      assert::are_equal_(EBUSY, e.error().value());
      assert::are_equal_(std::generic_category(), e.error().category());
      assert::are_equal_(info.get_file_name(), e.file_path());
      assert::are_equal_("https://codedocs.xyz/gammasoft71/xtd_core/", e.help_link());
    ...
    void test_method_(copy_operator) {
      ...
      auto info = current_stack_frame_;
      argument_null_exception e;
      e = argument_null_exception("Test excpetion message.", inner_exception, std::error_code(EBUSY, std::generic_category()), "https://codedocs.xyz/gammasoft71/xtd_core/", info);
      assert::are_equal_(EBUSY, e.error().value());
      assert::are_equal_(std::generic_category(), e.error().category());
      assert::are_equal_(info.get_file_name(), e.file_path());
      assert::are_equal_("https://codedocs.xyz/gammasoft71/xtd_core/", e.help_link());
