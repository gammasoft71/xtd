...
assembly_title_("xtd.tunit.unit_tests");
assembly_description_("xtd.tunit.unit_tests contains xtd.tunit unit tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.tunit.unit_tests");
...
assembly_guid_("7691ca6d-a8ca-427f-a437-a163edaa898e");
