...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_failed) {
      ...
      xtd::tunit::assert::are_equal(0.6l, ld, 0.001l, xtd::tunit::line_info {"test_assert_are_equal_long_double_with_tolerence_failed.cpp", 9});
    }
  };
}
...
void test_(test_assert_are_equal_long_double_with_tolerence_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_are_equal_long_double_with_tolerence_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: 0.6\n"
                "But was:  0.599\n"
                "error: test_assert_are_equal_long_double_with_tolerence_failed.cpp:9\n"
                "\n"
                "  End 1 test from test_assert_are_equal_long_double_with_tolerence_failed\n"
                "\n"
                "  Summary :\n"
                "    SUCCEED 0 test.\n"
