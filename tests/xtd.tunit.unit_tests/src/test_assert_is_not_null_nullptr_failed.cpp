...
void test_(test_assert_is_not_null_nullptr_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_is_not_null_nullptr_failed\n"
                "    FAILED test_case_failed\n"
                "\n"
                "Expected: not null\n"
                "But was:  null\n"
                "error: test_assert_is_not_null_nullptr_failed.cpp:8\n"
                "\n"
                "  End 1 test from test_assert_is_not_null_nullptr_failed\n"
                "\n"
                "  Summary :\n"
                "    PASSED 0 test.\n"
