...
namespace xtd::tunit::tests {
  class test_class_(collection_valid_are_equivalent_vector_failed_tests) {
  public:
...
void test_(collection_valid_are_equivalent_vector_failed_tests, test_output) {
  auto [output, result] = run_test_("collection_valid_are_equivalent_vector_failed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  FAILED  collection_valid_are_equivalent_vector_failed_tests.test_case_failed\n"
