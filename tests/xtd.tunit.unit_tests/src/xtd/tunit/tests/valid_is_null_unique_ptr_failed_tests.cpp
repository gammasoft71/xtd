...
namespace xtd::tunit::tests {
  ...
  void test_(valid_is_null_unqiue_ptr_failed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::tests::valid_is_null_unqiue_ptr_failed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "  FAILED  xtd::tunit::tests::valid_is_null_unqiue_ptr_failed_tests.test_case_failed\n"
                  "    Expected: null\n"
                  "    But was:  not null\n"
