...
void test_(collection_valid_is_ordered_vector_succeed_tests, test_output) {
  auto [output, result] = run_test_("collection_valid_is_ordered_vector_succeed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  SUCCEED collection_valid_is_ordered_vector_succeed_tests.test_case_succeed\n"
