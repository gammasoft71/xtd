...
void test_(string_assume_are_equal_ignoring_case_const_wchar_t_pointer_failed_tests, test_output) {
  auto [output, result] = run_test_("string_assume_are_equal_ignoring_case_const_wchar_t_pointer_failed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  ABORTED string_assume_are_equal_ignoring_case_const_wchar_t_pointer_failed_tests.test_case_failed\n"
    "    Test aborted\n"
