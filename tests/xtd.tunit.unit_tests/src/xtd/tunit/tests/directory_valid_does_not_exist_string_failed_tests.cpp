...
void test_(directory_valid_does_not_exist_string_failed_tests, test_output) {
  auto [output, result] = run_test_("xtd::tunit::tests::directory_valid_does_not_exist_string_failed_tests.*");
  #if defined (_WIN32)
  assert_value_("Start 1 test from 1 test case\n"
    "  FAILED  xtd::tunit::tests::directory_valid_does_not_exist_string_failed_tests.test_case_failed\n"
