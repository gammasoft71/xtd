...
namespace xtd::tunit::tests {
  ...
  public:
    auto test_method_(test_case_failed) {
      ...
      std::filesystem::directory_entry d2(std::filesystem::path(xtd::environment::get_folder_path(xtd::environment::special_folder::common_application_data).chars().c_str()) / "subdir");
  ...
  void test_(directory_assume_are_equal_filesystem_directory_entry_failed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::tests::directory_assume_are_equal_filesystem_directory_entry_failed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "  ABORTED xtd::tunit::tests::directory_assume_are_equal_filesystem_directory_entry_failed_tests.test_case_failed\n"
                  "    Test aborted\n"
