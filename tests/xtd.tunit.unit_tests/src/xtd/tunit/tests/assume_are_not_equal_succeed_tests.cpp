...
void test_(assume_are_not_equal_succeed_tests, test_output) {
  auto [output, result] = run_test_("xtd::tunit::tests::assume_are_not_equal_succeed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  SUCCEED xtd::tunit::tests::assume_are_not_equal_succeed_tests.test_case_succeed\n"
