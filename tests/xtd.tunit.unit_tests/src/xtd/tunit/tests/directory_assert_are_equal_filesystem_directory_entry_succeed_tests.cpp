...
namespace xtd::tunit::tests {
  class test_class_(directory_assert_are_equal_filesystem_directory_entry_succeed_tests) {
  public:
    void test_method_(test_case_succeed) {
      ...
      std::filesystem::directory_entry d2(std::filesystem::path(xtd::environment::get_folder_path(xtd::environment::special_folder::common_application_data)));
...
void test_(directory_assert_are_equal_filesystem_directory_entry_succeed_tests, test_output) {
  ...
  xtd::tunit::settings::default_settings().filter_tests("directory_assert_are_equal_filesystem_directory_entry_succeed_tests.*");
  std::stringstream ss;
