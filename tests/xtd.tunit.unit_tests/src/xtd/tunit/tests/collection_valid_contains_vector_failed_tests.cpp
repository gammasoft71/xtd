...
void test_(collection_valid_contains_vector_failed_tests, test_output) {
  auto [output, result] = run_test_("xtd::tunit::tests::collection_valid_contains_vector_failed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  FAILED  xtd::tunit::tests::collection_valid_contains_vector_failed_tests.test_case_failed\n"
