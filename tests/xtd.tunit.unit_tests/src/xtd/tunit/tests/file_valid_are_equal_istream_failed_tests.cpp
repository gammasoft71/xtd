...
void test_(file_valid_are_equal_istream_failed_tests, test_output) {
  auto [output, result] = run_test_("file_valid_are_equal_istream_failed_tests.*");
  assert_value_("Start 2 tests from 1 test case\n"
    "  FAILED  file_valid_are_equal_istream_failed_tests.test_case_lenght_failed\n"
    "    Expected: istream length 39\n"
    "    But was:  38\n"
    "  FAILED  file_valid_are_equal_istream_failed_tests.test_case_letter_failed\n"
