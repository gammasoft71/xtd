...
void test_(file_assert_are_not_equal_string_failed_tests, test_output) {
  auto [output, result] = run_test_("xtd::tunit::tests::file_assert_are_not_equal_string_failed_tests.*");
  assert_value_(xtd::ustring::format("Start 1 test from 1 test case\n"
      "  FAILED  xtd::tunit::tests::file_assert_are_not_equal_string_failed_tests.test_case_failed\n"
