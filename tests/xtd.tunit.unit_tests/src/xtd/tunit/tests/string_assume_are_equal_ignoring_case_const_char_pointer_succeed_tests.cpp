...
namespace xtd::tunit::tests {
  ...
  void test_(string_assume_are_equal_ignoring_case_const_char_pointer_succeed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::tests::string_assume_are_equal_ignoring_case_const_char_pointer_succeed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "  SUCCEED xtd::tunit::tests::string_assume_are_equal_ignoring_case_const_char_pointer_succeed_tests.test_case_succeed\n"
