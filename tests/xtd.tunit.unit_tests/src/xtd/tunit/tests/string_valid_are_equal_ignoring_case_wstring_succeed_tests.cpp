...
void test_(string_valid_are_equal_ignoring_case_wstring_succeed_tests, test_output) {
  auto [output, result] = run_test_("string_valid_are_equal_ignoring_case_wstring_succeed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  SUCCEED string_valid_are_equal_ignoring_case_wstring_succeed_tests.test_case_succeed\n"
