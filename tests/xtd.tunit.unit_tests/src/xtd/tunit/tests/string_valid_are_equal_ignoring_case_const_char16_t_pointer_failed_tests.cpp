...
namespace xtd::tunit::tests {
  ...
  void test_(string_valid_are_equal_ignoring_case_const_char16_t_pointer_failed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::tests::string_valid_are_equal_ignoring_case_const_char16_t_pointer_failed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "  FAILED  xtd::tunit::tests::string_valid_are_equal_ignoring_case_const_char16_t_pointer_failed_tests.test_case_failed\n"
