...
namespace xtd::tunit::tests {
  ...
  void test_(collection_assume_all_items_are_unique_vector_failed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::tests::collection_assume_all_items_are_unique_vector_failed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "  ABORTED xtd::tunit::tests::collection_assume_all_items_are_unique_vector_failed_tests.test_case_failed\n"
                  "    Test aborted\n"
