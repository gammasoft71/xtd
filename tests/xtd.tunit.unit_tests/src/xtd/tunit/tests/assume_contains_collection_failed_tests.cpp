...
void test_(assume_contains_collection_failed_tests, test_output) {
  auto [output, result] = run_test_("xtd::tunit::tests::assume_contains_collection_failed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  ABORTED xtd::tunit::tests::assume_contains_collection_failed_tests.test_case_failed\n"
    "    Test aborted\n"
