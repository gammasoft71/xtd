...
namespace xtd::tunit::tests {
  ...
  void test_(asume_is_not_instance_of_succeed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::tests::asume_is_not_instance_of_succeed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "  SUCCEED xtd::tunit::tests::asume_is_not_instance_of_succeed_tests.test_case_succeed\n"
