...
namespace xtd::tunit::tests {
  ...
  public:
    auto test_method_(test_case_succeed) {
      ...
      xtd::tunit::valid::does_not_throw([&] {[[maybe_unused]] auto __ = a[2];});
    }
  };
  
  void test_(valid_does_not_throw_succeed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::tests::valid_does_not_throw_succeed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "  SUCCEED xtd::tunit::tests::valid_does_not_throw_succeed_tests.test_case_succeed\n"
