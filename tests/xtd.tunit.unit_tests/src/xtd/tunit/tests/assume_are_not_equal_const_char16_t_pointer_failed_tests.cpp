...
void test_(assume_are_not_equal_const_char16_t_pointer_failed_tests, test_output) {
  auto [output, result] = run_test_("assume_are_not_equal_const_char16_t_pointer_failed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  ABORTED assume_are_not_equal_const_char16_t_pointer_failed_tests.test_case_failed\n"
    "    Test aborted\n"
