...
void test_(valid_is_null_unique_ptr_succeed_tests, test_output) {
  auto [output, result] = run_test_("xtd::tunit::tests::valid_is_null_unique_ptr_succeed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  SUCCEED xtd::tunit::tests::valid_is_null_unique_ptr_succeed_tests.test_case_succeed\n"
