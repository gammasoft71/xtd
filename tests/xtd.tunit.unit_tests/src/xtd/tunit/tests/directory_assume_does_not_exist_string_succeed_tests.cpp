...
void test_(directory_assume_does_not_exist_string_succeed_tests, test_output) {
  auto [output, result] = run_test_("directory_assume_does_not_exist_string_succeed_tests.*");
  assert_value_("Start 1 test from 1 test case\n"
    "  SUCCEED directory_assume_does_not_exist_string_succeed_tests.test_case_succeed\n"
