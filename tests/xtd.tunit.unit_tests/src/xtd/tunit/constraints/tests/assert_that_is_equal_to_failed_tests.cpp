...
namespace xtd::tunit::constraints::tests {
  ...
  void test_(assert_that_is_equal_to_failed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::constraints::tests::assert_that_is_equal_to_failed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "   FAILED xtd::tunit::constraints::tests::assert_that_is_equal_to_failed_tests.test_case_failed\n"
                  "    Expected: 23\n"
                  "    But was:  24\n"
