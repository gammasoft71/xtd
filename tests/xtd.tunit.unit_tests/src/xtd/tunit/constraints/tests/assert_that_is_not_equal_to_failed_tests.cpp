...
namespace xtd::tunit::contraints::tests {
  ...
  void test_(assert_that_is_not_equal_to_failed_tests, test_output) {
    auto [output, result] = run_test_("xtd::tunit::contraints::tests::assert_that_is_not_equal_to_failed_tests.*");
    assert_value_("Start 1 test from 1 test case\n"
                  "   FAILED xtd::tunit::contraints::tests::assert_that_is_not_equal_to_failed_tests.test_case_failed\n"
                  "    Expected: not 24\n"
                  "    But was:  24\n"
