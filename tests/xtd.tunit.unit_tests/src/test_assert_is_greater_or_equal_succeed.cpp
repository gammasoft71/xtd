...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_succeed) {
      int i = 42;
      xtd::tunit::assert::is_greater_or_equal_(i, 24, xtd::tunit::line_info {"test_assert_is_greater_or_equal_succeed.cpp", 9});
      xtd::tunit::assert::is_greater_or_equal_(i, 42, xtd::tunit::line_info {"test_assert_is_greater_or_equal_succeed.cpp", 10});
    }
  };
}
...
void test_(test_assert_is_greater_or_equal_succeed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_is_greater_or_equal_succeed\n"
                "    PASSED test_case_succeed\n"
                "  End 1 test from test_assert_is_greater_or_equal_succeed\n"
                "\n"
                "  Summary :\n"
                "    PASSED 1 test.\n"
