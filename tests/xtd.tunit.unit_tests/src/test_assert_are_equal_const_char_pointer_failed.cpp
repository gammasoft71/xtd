...
void test_(test_assert_are_equal_const_char_pointer_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_are_equal_const_char_pointer_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: \"str\"\n"
                "But was:  \"string\"\n"
                "error: test_assert_are_equal_const_char_pointer_failed.cpp:9\n"
                "\n"
                "  End 1 test from test_assert_are_equal_const_char_pointer_failed\n"
                "\n"
                "  Summary :\n"
