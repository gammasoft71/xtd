...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_succeed) {
      ...
      xtd::tunit::assert::are_not_equal(u"str", s, xtd::tunit::line_info {"test_assert_are_not_equal_const_char16_t_pointer_succeed.cpp", 9});
    }
  };
}
...
void test_(test_assert_are_not_equal_const_char16_t_pointer_succeed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_are_not_equal_const_char16_t_pointer_succeed\n"
                "    SUCCEED test_case_succeed\n"
                "  End 1 test from test_assert_are_not_equal_const_char16_t_pointer_succeed\n"
                "\n"
                "  Summary :\n"
                "    SUCCEED 1 test.\n"
