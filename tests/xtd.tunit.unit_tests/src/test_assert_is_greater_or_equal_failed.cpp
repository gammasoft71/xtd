...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_failed) {
      int i = 42;
      xtd::tunit::assert::is_greater_or_equal(i, 84, xtd::tunit::line_info {"test_assert_is_greater_or_equal_failed.cpp", 9});
    }
  };
}
...
void test_(test_assert_is_greater_or_equal_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_is_greater_or_equal_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: greater than or equal to 84\n"
                "But was:  42\n"
                "error: test_assert_is_greater_or_equal_failed.cpp:9\n"
                "\n"
                "  End 1 test from test_assert_is_greater_or_equal_failed\n"
                "\n"
                "  Summary :\n"
                "    SUCCEED 0 test.\n"
