...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_failed) {
      int a = 24;
      int b =  24;
      xtd::tunit::assert::are_same(b, a, xtd::tunit::line_info {"test_assert_are_same_failed.cpp", 10});
    }
  };
}
...
void test_(test_assert_are_same_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_are_same_failed\n"
                "    FAILED test_case_failed\n"
                "\n"
                "Expected: same as 24\n"
                "But was:  24\n"
                "error: test_assert_are_same_failed.cpp:10\n"
                "\n"
                "  End 1 test from test_assert_are_same_failed\n"
                "\n"
                "  Summary :\n"
                "    PASSED 0 test.\n"
