...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_succeed) {
      ...
      xtd::tunit::assert::is_not_empty(v, xtd::tunit::line_info {"test_assert_is_not_empty_collection_succeed.cpp", 10});
    }
  };
}
...
void test_(test_assert_is_not_empty_collection_succeed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_is_not_empty_collection_succeed\n"
                "    PASSED test_case_succeed\n"
                "  End 1 test from test_assert_is_not_empty_collection_succeed\n"
                "\n"
                "  Summary :\n"
                "    PASSED 1 test.\n"
