...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_failed) {
      int i = 24;
      xtd::tunit::assert::are_not_equal(24, i, xtd::tunit::line_info {"test_assert_are_not_equal_failed.cpp", 9});
    }
  };
}
...
void test_(test_assert_are_not_equal_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_are_not_equal_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: not 24\n"
                "But was:  24\n"
                "error: test_assert_are_not_equal_failed.cpp:9\n"
                "\n"
                "  End 1 test from test_assert_are_not_equal_failed\n"
                "\n"
                "  Summary :\n"
