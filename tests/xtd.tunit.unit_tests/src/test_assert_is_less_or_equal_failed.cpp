...
void test_(test_assert_is_less_or_equal_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_is_less_or_equal_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: less than or equal to 24\n"
                "But was:  42\n"
                "error: test_assert_is_less_or_equal_failed.cpp:9\n"
                "\n"
                "  End 1 test from test_assert_is_less_or_equal_failed\n"
