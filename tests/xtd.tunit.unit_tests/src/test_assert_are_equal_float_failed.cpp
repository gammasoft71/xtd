...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_failed) {
      float f = 0.2f;
      xtd::tunit::assert::are_equal(0.4f, f, xtd::tunit::line_info {"test_assert_are_equal_float_failed.cpp", 9});
    }
  };
}
...
void test_(test_assert_are_equal_float_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_are_equal_float_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: 0.4\n"
                "But was:  0.2\n"
                "error: test_assert_are_equal_float_failed.cpp:9\n"
                "\n"
                "  End 1 test from test_assert_are_equal_float_failed\n"
