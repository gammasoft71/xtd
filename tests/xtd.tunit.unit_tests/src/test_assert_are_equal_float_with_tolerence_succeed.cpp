...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_succeed) {
      float f = 0.599999999999999;
      xtd::tunit::assert::are_equal(0.6f, f, 0.000000000000001f, xtd::tunit::line_info {"test_assert_are_equal_float_with_tolerence_succeed.cpp", 9});
    }
  };
}
...
void test_(test_assert_are_equal_float_with_tolerence_succeed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_are_equal_float_with_tolerence_succeed\n"
                "    PASSED test_case_succeed\n"
                "  End 1 test from test_assert_are_equal_float_with_tolerence_succeed\n"
                "\n"
                "  Summary :\n"
                "    PASSED 1 test.\n"
