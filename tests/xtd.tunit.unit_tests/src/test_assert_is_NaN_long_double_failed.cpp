...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_failed) {
      ...
      xtd::tunit::assert::is_NaN(ld, xtd::tunit::line_info {"test_assert_is_NaN_long_double_failed.cpp", 9});
    }
  };
}
...
void test_(test_assert_is_NaN_long_double_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_is_NaN_long_double_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: NaN\n"
                "But was:  3.14159\n"
                "error: test_assert_is_NaN_long_double_failed.cpp:9\n"
                "\n"
                "  End 1 test from test_assert_is_NaN_long_double_failed\n"
                "\n"
                "  Summary :\n"
