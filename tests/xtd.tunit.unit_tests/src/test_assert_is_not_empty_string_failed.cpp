...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_failed) {
      std::string s;
      xtd::tunit::assert::is_not_empty(s, xtd::tunit::line_info {"test_assert_is_not_empty_string_failed.cpp", 10});
    }
  };
}
...
void test_(test_assert_is_not_empty_string_failed, test_output) {
  ...
  assert_value_("Start 1 test from 1 test case\n"
                "  Start 1 test from test_assert_is_not_empty_string_failed\n"
                "    FAILED  test_case_failed\n"
                "\n"
                "Expected: collection not <empty>\n"
                "But was:  <empty>\n"
                "error: test_assert_is_not_empty_string_failed.cpp:10\n"
                "\n"
                "  End 1 test from test_assert_is_not_empty_string_failed\n"
                "\n"
                "  Summary :\n"
                "    SUCCEED 0 test.\n"
