...
int main() {
  ...
  auto panel1 = control::create<panel>(*form_main, "panel1", {10, 10}, {100, 100});
  ...
  auto panel2 = control::create<panel>(*form_main, "panel2", {10, 10}, {100, 100});
