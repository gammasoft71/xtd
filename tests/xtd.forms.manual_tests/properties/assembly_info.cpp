...
assembly_title_("xtd.forms.manual_tests");
assembly_description_("xtd.forms.manual_tests contains xtd.forms manual tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.forms.manual_tests");
