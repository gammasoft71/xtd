...
assembly_title_("xtd.drawing.unit_tests");
assembly_description_("xtd.drawing.unit_tests contains xtd.drawing unit tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.drawing.unit_tests");
...
assembly_guid_("c4bc4ea6-262b-4b02-a17d-8f3e582902a0");
