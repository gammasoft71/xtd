...
namespace xtd::drawing::drawing_2d::tests {
  class test_class_(pen_type_tests) {
    ...
    auto test_method_(texture_fill) {
    ...
    auto test_method_(path_gradient) {
    ...
    auto test_method_(conical_gradient) {
