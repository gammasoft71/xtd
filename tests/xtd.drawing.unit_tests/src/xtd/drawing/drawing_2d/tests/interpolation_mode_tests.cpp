...
namespace xtd::drawing::drawing_2d::tests {
  class test_class_(interpolation_mode_tests) {
    ...
    auto test_method_(nearest_neighbor) {
    ...
    auto test_method_(high_quality_bilinear) {
    ...
    auto test_method_(high_quality_bicubic) {
