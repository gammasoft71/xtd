...
namespace xtd::drawing::tests {
  class test_class_(color_translator_tests) {
    auto test_method_(from_argb_to_hex) {
    ...
    auto test_method_(from_argb_to_hsl) {
    ...
    auto test_method_(from_argb_to_hsla) {
    ...
    auto test_method_(from_argb_to_html) {
    ...
    auto test_method_(from_argb_to_rgb) {
    ...
    auto test_method_(from_argb_to_rgba) {
    ...
    auto test_method_(from_argb_to_win32) {
    ...
    auto test_method_(from_known_color_to_hex) {
    ...
    auto test_method_(from_known_color_to_hsl) {
    ...
    auto test_method_(from_known_color_to_hsla) {
    ...
    auto test_method_(from_known_color_to_html) {
    ...
    auto test_method_(from_known_color_to_rgb) {
    ...
    auto test_method_(from_known_color_to_rgba) {
    ...
    auto test_method_(from_known_color_to_win32) {
      #if !defined(__XTD_BUILD_WITH_CONTINUOUS_INTEGRATION_SYSTEM__)
