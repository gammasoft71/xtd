...
namespace xtd::tests {
  class test_class_(color_suffixes_tests) {
    void test_method_(_color_operator_on_char_ptr) {
    ...
    void test_method_(_color_operator_on_char32_ptr) {
      auto v = U"dodger blue"_color;
      assert::is_instance_of<color>(v);
      assert::are_equal("color [dodger_blue]", v.to_string());
    }
    
    void test_method_(_color_operator_on_wchar_ptr) {
