...
namespace xtd::drawing::tests {
  ...
  private:
    ...
    void draw_rectangle_with_color(object& sender, paint_event_args& e) {
      ...
      e.graphics().draw_rounded_rectangle(pen(color::transparent, 1), rectangle(50, 50, 150, 100), 10);
      e.graphics().draw_rounded_rectangle(pen(color::black, 1), rectangle(250, 50, 150, 100), 10);
      e.graphics().draw_rounded_rectangle(pen(color::white, 1), rectangle(450, 50, 150, 100), 10);
      e.graphics().draw_rounded_rectangle(pen(application::style_sheet().system_colors().control_text(), 1), rectangle(650, 50, 150, 100), 10);
      
      e.graphics().draw_rounded_rectangle(pen(color::red, 4), rectangle(50, 200, 150, 100), 20);
      e.graphics().draw_rounded_rectangle(pen(color::green, 4), rectangle(250, 200, 150, 100), 20);
      e.graphics().draw_rounded_rectangle(pen(color::blue, 4), rectangle(450, 200, 150, 100), 20);
      e.graphics().draw_rounded_rectangle(pen(color::yellow, 4), rectangle(650, 200, 150, 100), 20);
      
      e.graphics().draw_rounded_rectangle(pen(color::from_argb(128, color::red), 10), rectangle(50, 350, 150, 100), 30);
      e.graphics().draw_rounded_rectangle(pen(color::from_argb(128, color::green), 10), rectangle(250, 350, 150, 100), 30);
      e.graphics().draw_rounded_rectangle(pen(color::from_argb(128, color::blue), 10), rectangle(450, 350, 150, 100), 30);
      e.graphics().draw_rounded_rectangle(pen(color::from_argb(128, color::yellow), 10), rectangle(650, 350, 150, 100), 30);
    }
    ...
    void fill_rectangle_with_color(object& sender, paint_event_args& e) {
      ...
      e.graphics().fill_rounded_rectangle(solid_brush(color::transparent), rectangle(50, 50, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::black), rectangle(250, 50, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::white), rectangle(450, 50, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(application::style_sheet().system_colors().control_text()), rectangle(650, 50, 150, 100), 20);
      
      e.graphics().fill_rounded_rectangle(solid_brush(color::red), rectangle(50, 200, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::green), rectangle(250, 200, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::blue), rectangle(450, 200, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::yellow), rectangle(650, 200, 150, 100), 20);
      
      e.graphics().fill_rounded_rectangle(solid_brush(color::from_argb(128, color::red)), rectangle(50, 350, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::from_argb(128, color::green)), rectangle(250, 350, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::from_argb(128, color::blue)), rectangle(450, 350, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(solid_brush(color::from_argb(128, color::yellow)), rectangle(650, 350, 150, 100), 20);
    }
    ...
    void fill_rectangle_with_conical_gradient(object& sender, paint_event_args& e) {
      ...
      e.graphics().fill_rounded_rectangle(conical_gradient_brush(point(150, 150), {color1, color2, color3, color4}, 0), rectangle(50, 50, 200, 200), 20);
      e.graphics().fill_rounded_rectangle(conical_gradient_brush(point(400, 150), {color1, color2, color3, color4}, 90), rectangle(300, 50, 200, 200), 20);
      e.graphics().fill_rounded_rectangle(conical_gradient_brush(point(600, 100), {color1, color2, color3, color4}, 0), rectangle(550, 50, 200, 200), 20);
      
      e.graphics().fill_rounded_rectangle(conical_gradient_brush(point(150, 400), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, 0), rectangle(50, 300, 200, 200), 20);
      e.graphics().fill_rounded_rectangle(conical_gradient_brush(point(400, 400), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, 90), rectangle(300, 300, 200, 200), 20);
      e.graphics().fill_rounded_rectangle(conical_gradient_brush(point(600, 350), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, 0), rectangle(550, 300, 200, 200), 20);
    }
    ...
    void fill_rectangle_with_linear_gradient(object& sender, paint_event_args& e) {
      ...
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(50, 50, 150, 100), {color1, color2, color3, color4}, 0), rectangle(50, 50, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(250, 50, 150, 100), {color1, color2, color3, color4}, 45), rectangle(250, 50, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(450, 50, 150, 100), {color1, color2, color3, color4}, 90), rectangle(450, 50, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(650, 50, 150, 100), {color1, color2, color3, color4}, 135), rectangle(650, 50, 150, 100), 20);
      
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(50, 200, 150, 100), {color1, color2, color3, color4}, 180), rectangle(50, 200, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(250, 200, 150, 100), {color1, color2, color3, color4}, 225), rectangle(250, 200, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(450, 200, 150, 100), {color1, color2, color3, color4}, 270), rectangle(450, 200, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(650, 200, 150, 100), {color1, color2, color3, color4}, 315), rectangle(650, 200, 150, 100), 20);
      
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(50, 400, 150, 100), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, xtd::drawing::drawing_2d::linear_gradient_mode::horizontal), rectangle(50, 400, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(250, 400, 150, 100), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, xtd::drawing::drawing_2d::linear_gradient_mode::vertical), rectangle(250, 400, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(450, 400, 150, 100), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, xtd::drawing::drawing_2d::linear_gradient_mode::forward_diagonal), rectangle(450, 400, 150, 100), 20);
      e.graphics().fill_rounded_rectangle(linear_gradient_brush(rectangle(650, 400, 150, 100), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, xtd::drawing::drawing_2d::linear_gradient_mode::backward_diagonal), rectangle(650, 400, 150, 100), 20);
    }
    ...
    void fill_rectangle_with_radial_gradient(object& sender, paint_event_args& e) {
      ...
      e.graphics().fill_rounded_rectangle(radial_gradient_brush(point(150, 150), {color1, color2, color3, color4}, 100), rectangle(50, 50, 200, 200), 20);
      
      radial_gradient_brush brush1(point(400, 150), {color1, color2, color3, color4}, 100);
      brush1.focal_point(point(350, 100));
      e.graphics().fill_rounded_rectangle(brush1, rectangle(300, 50, 200, 200), 20);
      
      e.graphics().fill_rounded_rectangle(radial_gradient_brush(point(150, 400), {color::from_argb(128, color1), color::from_argb(128, color2), color::from_argb(128, color3), color::from_argb(128, color4)}, 100), rectangle(50, 300, 200, 200), 20);
      ...
      e.graphics().fill_rounded_rectangle(brush2, rectangle(300, 300, 200, 200), 20);
    }
    ...
    void fill_rectangle_with_texture(object& sender, paint_event_args& e) {
      ...
      e.graphics().fill_rounded_rectangle(texture_brush(create_circle_texture_image(forground_color, background_color)), rectangle(50, 50, 400, 200), 30);
      e.graphics().fill_rounded_rectangle(texture_brush(system_images::from_name("gammasoft", drawing::size(96, 96))), rectangle(50, 300, 400, 250), 30);
    }
...
startup_(tests::lines_form::main);
