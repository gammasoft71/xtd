...
assembly_title_("xtd.drawing.rounded_rectangles.tests");
assembly_description_("xtd.drawing.rounded_rectangles.tests contains graphiccs rounded rectangle manual tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.drawing.rounded_rectangles.tests");
assembly_copyright_("Copyright © Gammasoft 2025");
assembly_trademark_("");
assembly_culture_("en_US.UTF-8");

// The following GUID is for the ID of the typelib if this project is exposed to COM

assembly_guid_("469f6f2f-0b16-4192-b245-146fd48ed64f");
