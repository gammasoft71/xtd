...
assembly_title_("xtd.drawing.lines.tests");
assembly_description_("xtd.drawing.lines.tests contains graphics line manual tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.drawing.lines.tests");
...
assembly_guid_("1c8ce4be-4183-4a71-a666-89b39b8d4288");
