...
namespace unit_tests {
  ...
  public:
    ...
    void test_method_(format_with_currency_argument_and_two_digitis_precision) {
      assert::are_not_equal("$42.24000", strings::format("{0:C10}", to_value<Value>(42.24)), "The precision of currency format  is ignored");
      assert::are_equal("$42.24", strings::format("{0:C10}", to_value<Value>(42.24)), "The precision of currency format is ignored");
    }
    
    void test_method_(format_with_currency_argument_and_three_digitis_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:C100}", to_value<Value>(42.24));});
    }
    
    void test_method_(format_with_currency_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:C-5}", to_value<Value>(42.24));});
    }
    ...
    void test_method_(format_with_exponencial_argument_and_one_digiti_precision) {
      if (std::is_same<Value, float>::value)
        assert::are_equal("4.22400017E+01", strings::format("{0:E8}", to_value<Value>(42.24)));
      else
        assert::are_equal("4.22400000E+01", strings::format("{0:E8}", to_value<Value>(42.24)));
    }
    ...
    void test_method_(format_with_exponencial_argument_and_three_digitis_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:E100}", to_value<Value>(42.24));});
    }
    
    void test_method_(format_with_exponencial_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:E-8}", to_value<Value>(42.24));});
    }
    ...
    void test_method_(format_with_fixed_point_argument_and_two_digitis_precision) {
      if (std::is_same<Value, float>::value)
        assert::are_equal("42.2400016785", strings::format("{0:F10}", to_value<Value>(42.24)));
      else
        assert::are_equal("42.2400000000", strings::format("{0:F10}", to_value<Value>(42.24)));
    }
    
    void test_method_(format_with_fixed_point_argument_and_three_digitis_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0F100}", to_value<Value>(42.24));});
    }
    
    void test_method_(format_with_fixed_point_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0F-4}", to_value<Value>(42.24));});
    }
    ...
    void test_method_(format_with_generals_argument_and_two_digitis_precision) {
      assert::are_equal("42", strings::format("{0:G10}", to_value<Value>(42.0)));
    }
    
    void test_method_(format_with_decimals_with_general_argument_and_two_digitis_precision) {
      if (std::is_same<Value, float>::value)
        assert::are_equal("42.24000168", strings::format("{0:G10}", to_value<Value>(42.24)));
      else
        assert::are_equal("42.24", strings::format("{0:G10}", to_value<Value>(42.24)));
    }
    ...
    void test_method_(format_with_decimals_with_general_argument_and_three_digitis_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:G100}", to_value<Value>(42.24));});
    }
    
    void test_method_(format_with_general_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:G-4}", to_value<Value>(42.0));});
    }
    
    void test_method_(format_with_decimals_with_general_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:G-4}", to_value<Value>(42.24));});
    }
    
    void test_method_(format_with_decimals_with_general_argument_and_invalid_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:Ga}", to_value<Value>(42.0));});
    }
    ...
    void test_method_(format_with_number_argument_and_two_digitis_precision) {
      if (std::is_same<Value, float>::value)
        assert::are_equal("1,234,567.8750000000", strings::format("{0:N10}", to_value<Value>(1234567.89)));
      else
        assert::are_equal("1,234,567.8899999999", strings::format("{0:N10}", to_value<Value>(1234567.89)));
    }
    
    void test_method_(format_with_number_argument_and_three_digitis_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:N100}", to_value<Value>(1234567.89));});
    }
    
    void test_method_(format_with_number_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:N-4", to_value<Value>(1234567.89));});
    }
    ...
    void test_method_(format_with_percent_argument_and_two_digitis_precision) {
      assert::are_equal("6.5000000000 %", strings::format("{0:P10}", to_value<Value>(0.065)));
    }
    
    void test_method_(format_with_percent_argument_and_three_digitis_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:P100}", to_value<Value>(0.42));});
    }
    
    void test_method_(format_with_percent_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:P-2}", to_value<Value>(0.42));});
    }
    ...
    void test_method_(format_with_alignment_before_format) {
      assert::are_equal(" 42.00", strings::format("{0,6:F}", to_value<Value>(42.0)));
    }
    
    void test_method_(format_with_alignmentafter_format) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:F,6}", to_value<Value>(42.0));});
    }
