...
namespace unit_tests {
  ...
  public:
    ...
    void test_method_(format_with_binary_argument_and_two_digits_precision) {
      assert::are_equal("0000101010", strings::format("{0:B10}", to_value<Value>(42)));
    }
    
    void test_method_(format_with_binary_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:B100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_binary_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:B-3}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_with_currency_argument_and_two_digits_precision) {
      assert::are_not_equal("$42.00000", strings::format("{0:C10}", to_value<Value>(42)), "The precision of currency format  is ignored");
      assert::are_equal("$42.00", strings::format("{0:C10}", to_value<Value>(42)), "The precision of currency format is ignored");
    }
    
    void test_method_(format_with_currency_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:C100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_currency_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:C-5}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_with_decimal_argument_and_two_digits_precision) {
      assert::are_equal("0000000042", strings::format("{0:D10}", to_value<Value>(42)));
    }
    
    void test_method_(format_with_decimal_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:D100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_decimal_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:D-5}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_negative_with_decimal_argument_and_two_digits_precision) {
      if (std::is_signed<Value>::value)
        assert::are_equal("-0000000123", strings::format("{0:D10}", to_value<Value>(-123)));
    }
    
    void test_method_(format_negative_with_decimal_argument_and_three_digits_precision) {
      if (std::is_signed<Value>::value)
        assert::throws<std::invalid_argument>([]{strings::format("{0:D100}", to_value<Value>(-123));});
    }
    
    void test_method_(format_negative_with_decimal_argument_and_negative_precision) {
      if (std::is_signed<Value>::value)
        assert::throws<std::invalid_argument>([]{strings::format("{0:D-6}", to_value<Value>(-123));});
    }
    ...
    void test_method_(format_with_exponencial_argument_and_one_digit_precision) {
      assert::are_equal("4.20000000E+01", strings::format("{0:E8}", to_value<Value>(42)));
    }
    ...
    void test_method_(format_with_exponencial_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:E100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_exponencial_argument_and_nagetive_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:E-10}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_with_fixed_point_argument_and_two_digits_precision) {
      assert::are_equal("42.0000000000", strings::format("{0:F10}", to_value<Value>(42)));
    }
    
    void test_method_(format_with_fixed_point_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:F100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_fixed_point_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:F-4}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_with_general_argument_and_two_digits_precision) {
      assert::are_equal("42", strings::format("{0:G10}", to_value<Value>(42)));
    }
    
    void test_method_(format_with_general_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:G100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_general_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:G-2}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_with_number_argument_and_two_digits_precision) {
      if (std::is_same<Value, char>::value || std::is_same<Value, unsigned char>::value || std::is_same<Value, int8_t>::value || std::is_same<Value, uint8_t>::value)
        assert::are_equal("123.0000000000", strings::format("{0:N10}", to_value<Value>(123)));
      else if (std::is_same<Value, short>::value || std::is_same<Value, unsigned short>::value)
        assert::are_equal("1,234.0000000000", strings::format("{0:N10}", to_value<Value>(1234)));
      else
        assert::are_equal("1,234,567.0000000000", strings::format("{0:N10}", to_value<Value>(1234567)));
    }
    
    void test_method_(format_with_number_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:N100}", to_value<Value>(123));});
    }
    
    void test_method_(format_with_number_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:N-4}", to_value<Value>(123));});
    }
    ...
    void test_method_(format_with_octal_argument_and_two_digits_precision) {
      assert::are_equal("0000000052", strings::format("{0:O10}", to_value<Value>(42)));
    }
    
    void test_method_(format_with_octal_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:O100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_octal_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:O-5}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_with_percent_argument_and_two_digits_precision) {
      assert::are_equal("600.0000000000 %", strings::format("{0:P10}", to_value<Value>(6)));
    }
    
    void test_method_(format_with_percent_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:P100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_percent_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:P-4}", to_value<Value>(42));});
    }
    ...
    void test_method_(format_with_hexadecimal_argument_and_two_digits_precision) {
      assert::are_equal("000000002A", strings::format("{0:X10}", to_value<Value>(42)));
    }
    
    void test_method_(format_with_hexadecimal_argument_and_three_digits_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:X100}", to_value<Value>(42));});
    }
    
    void test_method_(format_with_hexadecimal_argument_and_negative_precision) {
      assert::throws<std::invalid_argument>([]{strings::format("{0:X-4}", to_value<Value>(42));});
    }
