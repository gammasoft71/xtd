...
namespace unit_tests {
  ...
  public:
    ...
    void test_method_(parse_styles_none_with_binary_specifier) {
      assert::throws<std::invalid_argument>([]{xtd::parse<Value>("0b101010", number_styles::none);});
    }
    ...
    void test_method_(parse_styles_none_with_hexa_specifier) {
      assert::throws<std::invalid_argument>([]{xtd::parse<Value>("0x2A", number_styles::none);});
    }
