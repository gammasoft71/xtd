...
assembly_title_("xtd.tunit.manual_tests");
assembly_description_("xtd.tunit.manual_tests contains xtd.tunit manual tests.");
assembly_configuration_("Test");
assembly_company_("Gammasoft");
assembly_product_("xtd.tunit.manual_tests");
...
assembly_guid_("4444323e-0f9c-4071-8706-ab9f95e23e42");
