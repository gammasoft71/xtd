...
# Drag-and-drop mouse behavior overview (xtd.forms)
...
[comment]: <> (https://learn.microsoft.com/en-us/dotnet/desktop/winforms/input-mouse/drag-and-drop?view=netdesktop-6.0)
