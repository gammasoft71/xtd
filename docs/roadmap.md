...
|-----------|---------------------------------|-----------|-------------------------------------------------|
| xtd.core  | io::binary_reader               | Gammasoft | ![status](pictures/releases/status/started.png) | 
| xtd.core  | io::binary_writer               | Gammasoft | ![status](pictures/releases/status/started.png) | 
