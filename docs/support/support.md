...
* First read [Code of conduct](https://github.com/gammasoft71/xtd/blob/master/CODE_OF_CONDUCT.md) and the [design guidelines](/documentation/design_guidelines/design_guidelines.md) to make sure your contribution follows the rules.
