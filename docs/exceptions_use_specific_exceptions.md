...
# How to use specific exceptions in a catch block (xtd.core)
...
[comment]: <> (https://learn.microsoft.com/en-us/dotnet/standard/exceptions/how-to-use-specific-exceptions-in-a-catch-block)
