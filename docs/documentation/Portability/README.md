...
| Library                                                                                           | Windows | macOS | Linux | FreeBSD | Haiku OS | iOS | Android |
| ------------------------------------------------------------------------------------------------- | ------- | ----- | ----- | ------- | -------- | --- | ------- |
| [xtd.core](https://gammasoft71.github.io/xtd/reference_guides/latest/group__xtd__core.html)       | ✔️       | ✔️     | ✔️     | ✔️       | ✔️        | ✔️   | ✔️       |
...
| [xtd.tunit](https://gammasoft71.github.io/xtd/reference_guides/latest/group__xtd__tunit.html)     | ✔️       | ✔️     | ✔️     | ✔️       | ✔️        | ✔️   | ✔️       |
