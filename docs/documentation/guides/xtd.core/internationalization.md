...
The locale impact the format string as currency and date time see [Format number, dates other types](/docs/documentation/guides/xtd.core/format_number_dates_other_types/overview) for more information.
