...
To define an event, you use the [xtd::event](/docs/documentation/guides/xtd.core/types_overview/events) class in your [event](/docs/documentation/guides/xtd.core/types_overview/events) class signature, and you specify the delegate type for the event. 
...
For more information, see [Events](/docs/documentation/guides/xtd.core/types_overview/events).
