...
| 2        | C                 | 15.21%  |
| 3        | Java              | 12.84%  |
| 4        | [C++](/docs/documentation/Portability/c%2B%2B)     |  9.92%  |
| 5        | C#                |  4.42%  |
| 6        | Visual Basic      |  3.95%  |
| 7        | JavaScript        |  2.74%  |
...
C is the most widely used programming language. Every fourth application is programmed in C/[C++](/docs/documentation/Portability/c%2B%2B). They are standard for creating operating systems and various desktop applications. C/[C++](/docs/documentation/Portability/c%2B%2B) are the most widely used system programming languages.
