...
# Print a multi-page text file (xtd.forms)
...
[comment]: <> (https://learn.microsoft.com/en-us/dotnet/desktop/winforms/printing/how-to-print-text-document?view=netdesktop-6.0)
