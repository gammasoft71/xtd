...
# Create a simple-bound control (xtd.forms)
...
[comment]: <> (https://learn.microsoft.com/en-us/dotnet/desktop/winforms/data/how-to-create-control-binding?view=netdesktop-6.0)
