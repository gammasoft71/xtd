...
* ![fixed](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/fixed.png) [BUG] xtd::forms - combo_box selection not displayed in combo_box - [#193](https://github.com/gammasoft71/xtd/issues/193)
* ![fixed](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/fixed.png) [BUG] xtd.forms - combo_box in vertical_layout_panel fires drop_down and drop_down_closed events twice - [#192](https://github.com/gammasoft71/xtd/issues/192)
...
* ![fixed](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/fixed.png) [BUG] Path not updated with xtd install on Windows - [#188](https://github.com/gammasoft71/xtd/issues/188)
...
* ![fixed](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/fixed.png) [BUG] A contextual menu with menu items without menu crashs at creation - [#33](https://github.com/gammasoft71/xtd/issues/33)
...
* ![added](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/added.png) [ENHANCEMENT] xtd.core - string - Represents text as a sequence of UTF-8 code units.
...
* ![added](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/added.png) [ENHANCEMENT] xtd.core - any_pair - Implements a std::pair with the key and the value strongly typed to be xtd::any.
...
* ![added](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/added.png) [ENHANCEMENT] xtd.core - vector_list - Represents a collection of xtd::any.
...
* ![added](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/added.png) [ENHANCEMENT] xtd.core - switch_object - Provides an abstract base class to create new debugging and tracing switches.
...
* ![added](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/added.png) [ENHANCEMENT] xtd.drawing - texts - Provides a collection of string objects for use by a Windows Forms application.
