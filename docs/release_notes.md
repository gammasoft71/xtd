...
* ![added](https://github.com/gammasoft71/xtd/blob/master/docs/pictures/releases/status/added.png) xtd.core - directory - Provides static methods for the creation, copying, deletion, moving, and opening of directories, and aids in the creation of xtd::io::directory_dtream objects. - [#52](https://github.com/gammasoft71/xtd/issues/52)
