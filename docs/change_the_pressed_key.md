...
# How to modify keyboard key events (xtd.forms)
...
[comment]: <> (https://learn.microsoft.com/en-us/dotnet/desktop/winforms/input-keyboard/how-to-change-key-press?view=netdesktop-6.0)
