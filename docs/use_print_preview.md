...
# Print using print preview (xtd.forms)
...
[comment]: <> (https://learn.microsoft.com/en-us/dotnet/desktop/winforms/printing/how-to-print-in-windows-forms-using-print-preview?view=netdesktop-6.0)
