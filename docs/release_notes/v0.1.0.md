...
* [added] continuous integration build - Continuous integration build for Windows, macOs and linux (appveyor, CircleCI and travisCI).
...
* [added] background_color - Sets the background color of the console.
...
* [added] property - Represent a css property class.
...
* ~~[todo] h_scroll_bar_renderer - Provides horizontal scroll bar renderer methods.~~
...
* ~~[todo] sixteen_segment_display_renderer - Provides sixteen segment display renderer methods.~~
* ~~[todo] splitter_renderer - Provides splitter renderer methods.~~
* [added] switch_button_renderer - Provides switch button renderer methods.
* ~~[todo] text_box_renderer - Provides text box renderer methods.~~
* ~~[todo] tool_tip_renderer - Provides tool tip renderer methods.~~
* ~~[todo] tool_strip_progress_bar_renderer - Provides strip progress bar renderer methods.~~
...
* [added] ostream_event_listener - Represents ostream event listener.
...
* [added] collection_valid - Contains specific collection validations.
...
* ~~[todo] windows light - Windows light theme css files.~~
