...
color color::from_known_color(known_color color) {
  switch (color) {
    case known_color::active_border: return color::from_handle(native::system_colors::active_border());
    case known_color::active_caption: return color::from_handle(native::system_colors::active_caption());
    case known_color::active_caption_text: return color::from_handle(native::system_colors::active_caption_text());
    case known_color::app_workspace: return color::from_handle(native::system_colors::app_workspace());
    case known_color::control: return color::from_handle(native::system_colors::control());
    case known_color::control_dark: return color::from_handle(native::system_colors::control_dark());
    case known_color::control_dark_dark: return color::from_handle(native::system_colors::control_dark_dark());
    case known_color::control_light: return color::from_handle(native::system_colors::control_light());
    case known_color::control_light_light: return color::from_handle(native::system_colors::control_light_light());
    case known_color::control_text: return color::from_handle(native::system_colors::control_text());
    case known_color::desktop: return color::from_handle(native::system_colors::desktop());
    case known_color::gray_text: return color::from_handle(native::system_colors::gray_text());
    case known_color::highlight: return color::from_handle(native::system_colors::highlight());
    case known_color::highlight_text: return color::from_handle(native::system_colors::highlight_text());
    case known_color::hot_track: return color::from_handle(native::system_colors::hot_track());
    case known_color::inactive_border: return color::from_handle(native::system_colors::inactive_border());
    case known_color::inactive_caption: return color::from_handle(native::system_colors::inactive_caption());
    case known_color::inactive_caption_text: return color::from_handle(native::system_colors::inactive_caption_text());
    case known_color::info: return color::from_handle(native::system_colors::info());
    case known_color::info_text: return color::from_handle(native::system_colors::info_text());
    case known_color::menu: return color::from_handle(native::system_colors::menu());
    case known_color::menu_text: return color::from_handle(native::system_colors::menu_text());
    case known_color::scroll_bar: return color::from_handle(native::system_colors::scroll_bar());
    case known_color::window: return color::from_handle(native::system_colors::window());
    case known_color::window_frame: return color::from_handle(native::system_colors::window_frame());
    case known_color::window_text: return color::from_handle(native::system_colors::window_text());
    case known_color::transparent: return color::from_argb(0x00FFFFFF);
    case known_color::alice_blue: return color::from_argb(0xFFF0F8FF);
    case known_color::antique_white: return color::from_argb(0xFFFAEBD7);
    case known_color::aqua: return color::from_argb(0xFF00FFFF);
    case known_color::aquamarine: return color::from_argb(0xFF7FFFD4);
    case known_color::azure: return color::from_argb(0xFFF0FFFF);
    case known_color::beige: return color::from_argb(0xFFF5F5DC);
    case known_color::bisque: return color::from_argb(0xFFFFE4C4);
    case known_color::black: return color::from_argb(0xFF000000);
    case known_color::blanched_almond: return color::from_argb(0xFFFFEBCD);
    case known_color::blue: return color::from_argb(0xFF0000FF);
    case known_color::blue_violet: return color::from_argb(0xFF8A2BE2);
    case known_color::brown: return color::from_argb(0xFFA52A2A);
    case known_color::burly_wood: return color::from_argb(0xFFDEB887);
    case known_color::cadet_blue: return color::from_argb(0xFF5F9EA0);
    case known_color::chartreuse: return color::from_argb(0xFF7FFF00);
    case known_color::chocolate: return color::from_argb(0xFFD2691E);
    case known_color::coral: return color::from_argb(0xFFFF7F50);
    case known_color::cornflower_blue: return color::from_argb(0xFF6495ED);
    case known_color::cornsilk: return color::from_argb(0xFFFFF8DC);
    case known_color::crimson: return color::from_argb(0xFFDC143C);
    case known_color::cyan: return color::from_argb(0xFF00FFFF);
    case known_color::dark_blue: return color::from_argb(0xFF00008B);
    case known_color::dark_cyan: return color::from_argb(0xFF008B8B);
    case known_color::dark_goldenrod: return color::from_argb(0xFFB8860B);
    case known_color::dark_gray: return color::from_argb(0xFFA9A9A9);
    case known_color::dark_green: return color::from_argb(0xFF006400);
    case known_color::dark_khaki: return color::from_argb(0xFFBDB76B);
    case known_color::dark_magenta: return color::from_argb(0xFF8B008B);
    case known_color::dark_olive_green: return color::from_argb(0xFF556B2F);
    case known_color::dark_orange: return color::from_argb(0xFFFF8C00);
    case known_color::dark_orchid: return color::from_argb(0xFF9932CC);
    case known_color::dark_red: return color::from_argb(0xFF8B0000);
    case known_color::dark_salmon: return color::from_argb(0xFFE9967A);
    case known_color::dark_sea_green: return color::from_argb(0xFF8FBC8B);
    case known_color::dark_slate_blue: return color::from_argb(0xFF483D8B);
    case known_color::dark_slate_gray: return color::from_argb(0xFF2F4F4F);
    case known_color::dark_turquoise: return color::from_argb(0xFF00CED1);
    case known_color::dark_violet: return color::from_argb(0xFF9400D3);
    case known_color::deep_pink: return color::from_argb(0xFFFF1493);
    case known_color::deep_sky_blue: return color::from_argb(0xFF00BFFF);
    case known_color::dim_gray: return color::from_argb(0xFF696969);
    case known_color::dodger_blue: return color::from_argb(0xFF1E90FF);
    case known_color::firebrick: return color::from_argb(0xFFB22222);
    case known_color::floral_white: return color::from_argb(0xFFFFFAF0);
    case known_color::forest_green: return color::from_argb(0xFF228B22);
    case known_color::fuchsia: return color::from_argb(0xFFFF00FF);
    case known_color::gainsboro: return color::from_argb(0xFFDCDCDC);
    case known_color::ghost_white: return color::from_argb(0xFFF8F8FF);
    case known_color::gold: return color::from_argb(0xFFFFD700);
    case known_color::goldenrod: return color::from_argb(0xFFDAA520);
    case known_color::gray: return color::from_argb(0xFF808080);
    case known_color::green: return color::from_argb(0xFF008000);
    case known_color::green_yellow: return color::from_argb(0xFFADFF2F);
    case known_color::honeydew: return color::from_argb(0xFFF0FFF0);
    case known_color::hot_pink: return color::from_argb(0xFFFF69B4);
    case known_color::indian_red: return color::from_argb(0xFFCD5C5C);
    case known_color::indigo: return color::from_argb(0xFF4B0082);
    case known_color::ivory: return color::from_argb(0xFFFFFFF0);
    case known_color::khaki: return color::from_argb(0xFFF0E68C);
    case known_color::lavender: return color::from_argb(0xFFE6E6FA);
    case known_color::lavender_blush: return color::from_argb(0xFFFFF0F5);
    case known_color::lawn_green: return color::from_argb(0xFF7CFC00);
    case known_color::lemon_chiffon: return color::from_argb(0xFFFFFACD);
    case known_color::light_blue: return color::from_argb(0xFFADD8E6);
    case known_color::light_coral: return color::from_argb(0xFFF08080);
    case known_color::light_cyan: return color::from_argb(0xFFE0FFFF);
    case known_color::light_goldenrod_yellow: return color::from_argb(0xFFFAFAD2);
    case known_color::light_gray: return color::from_argb(0xFFD3D3D3);
    case known_color::light_green: return color::from_argb(0xFF90EE90);
    case known_color::light_pink: return color::from_argb(0xFFFFB6C1);
    case known_color::light_salmon: return color::from_argb(0xFFFFA07A);
    case known_color::light_sea_green: return color::from_argb(0xFF20B2AA);
    case known_color::light_sky_blue: return color::from_argb(0xFF87CEFA);
    case known_color::light_slate_gray: return color::from_argb(0xFF778899);
    case known_color::light_steel_blue: return color::from_argb(0xFFB0C4DE);
    case known_color::light_yellow: return color::from_argb(0xFFFFFFE0);
    case known_color::lime: return color::from_argb(0xFF00FF00);
    case known_color::lime_green: return color::from_argb(0xFF32CD32);
    case known_color::linen: return color::from_argb(0xFFFAF0E6);
    case known_color::magenta: return color::from_argb(0xFFFF00FF);
    case known_color::maroon: return color::from_argb(0xFF800000);
    case known_color::medium_aquamarine: return color::from_argb(0xFF66CDAA);
    case known_color::medium_blue: return color::from_argb(0xFF0000CD);
    case known_color::medium_orchid: return color::from_argb(0xFFBA55D3);
    case known_color::medium_purple: return color::from_argb(0xFF9370DB);
    case known_color::medium_sea_green: return color::from_argb(0xFF3CB371);
    case known_color::medium_slate_blue: return color::from_argb(0xFF7B68EE);
    case known_color::medium_spring_green: return color::from_argb(0xFF00FA9A);
    case known_color::medium_turquoise: return color::from_argb(0xFF48D1CC);
    case known_color::medium_violet_red: return color::from_argb(0xFFC71585);
    case known_color::midnight_blue: return color::from_argb(0xFF191970);
    case known_color::mint_cream: return color::from_argb(0xFFF5FFFA);
    case known_color::misty_rose: return color::from_argb(0xFFFFE4E1);
    case known_color::moccasin: return color::from_argb(0xFFFFE4B5);
    case known_color::navajo_white: return color::from_argb(0xFFFFDEAD);
    case known_color::navy: return color::from_argb(0xFF000080);
    case known_color::old_lace: return color::from_argb(0xFFFDF5E6);
    case known_color::olive: return color::from_argb(0xFF808000);
    case known_color::olive_drab: return color::from_argb(0xFF6B8E23);
    case known_color::orange: return color::from_argb(0xFFFFA500);
    case known_color::orange_red: return color::from_argb(0xFFFF4500);
    case known_color::orchid: return color::from_argb(0xFFDA70D6);
    case known_color::pale_goldenrod: return color::from_argb(0xFFEEE8AA);
    case known_color::pale_green: return color::from_argb(0xFF98FB98);
    case known_color::pale_turquoise: return color::from_argb(0xFFAFEEEE);
    case known_color::pale_violet_red: return color::from_argb(0xFFDB7093);
    case known_color::papaya_whip: return color::from_argb(0xFFFFEFD5);
    case known_color::peach_puff: return color::from_argb(0xFFFFDAB9);
    case known_color::peru: return color::from_argb(0xFFCD853F);
    case known_color::pink: return color::from_argb(0xFFFFC0CB);
    case known_color::plum: return color::from_argb(0xFFDDA0DD);
    case known_color::powder_blue: return color::from_argb(0xFFB0E0E6);
    case known_color::purple: return color::from_argb(0xFF800080);
    case known_color::rebecca_purple: return color::from_argb(0xFF663399);
    case known_color::red: return color::from_argb(0xFFFF0000);
    case known_color::rosy_brown: return color::from_argb(0xFFBC8F8F);
    case known_color::royal_blue: return color::from_argb(0xFF4169E1);
    case known_color::saddle_brown: return color::from_argb(0xFF8B4513);
    case known_color::salmon: return color::from_argb(0xFFFA8072);
    case known_color::sandy_brown: return color::from_argb(0xFFF4A460);
    case known_color::sea_green: return color::from_argb(0xFF2E8B57);
    case known_color::sea_shell: return color::from_argb(0xFFFFF5EE);
    case known_color::sienna: return color::from_argb(0xFFA0522D);
    case known_color::silver: return color::from_argb(0xFFC0C0C0);
    case known_color::sky_blue: return color::from_argb(0xFF87CEEB);
    case known_color::slate_blue: return color::from_argb(0xFF6A5ACD);
    case known_color::slate_gray: return color::from_argb(0xFF708090);
    case known_color::snow: return color::from_argb(0xFFFFFAFA);
    case known_color::spring_green: return color::from_argb(0xFF00FF7F);
    case known_color::steel_blue: return color::from_argb(0xFF4682B4);
    case known_color::tan: return color::from_argb(0xFFD2B48C);
    case known_color::teal: return color::from_argb(0xFF008080);
    case known_color::thistle: return color::from_argb(0xFFD8BFD8);
    case known_color::tomato: return color::from_argb(0xFFFF6347);
    case known_color::turquoise: return color::from_argb(0xFF40E0D0);
    case known_color::violet: return color::from_argb(0xFFEE82EE);
    case known_color::wheat: return color::from_argb(0xFFF5DEB3);
    case known_color::white: return color::from_argb(0xFFFFFFFF);
    case known_color::white_smoke: return color::from_argb(0xFFF5F5F5);
    case known_color::yellow: return color::from_argb(0xFFFFFF00);
    case known_color::yellow_green: return color::from_argb(0xFF9ACD32);
    case known_color::button_face: return color::from_handle(native::system_colors::button_face());
    case known_color::button_highlight: return color::from_handle(native::system_colors::button_highlight());
    case known_color::button_shadow: return color::from_handle(native::system_colors::button_shadow());
    case known_color::gradient_active_caption: return color::from_handle(native::system_colors::gradient_active_caption());
    case known_color::gradient_inactive_caption: return color::from_handle(native::system_colors::gradient_inactive_caption());
    case known_color::menu_bar: return color::from_handle(native::system_colors::menu_bar());
    case known_color::menu_highlight: return color::from_handle(native::system_colors::menu_highlight());
