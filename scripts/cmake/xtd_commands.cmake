...
macro(target_type TYPE)
  ...
  elseif ("${TYPE}" STREQUAL "SHARED_LIBRARY")
    ...
    if ("${APPLICATION_NAME}" STREQUAL "xtd.core" OR "${APPLICATION_NAME}" STREQUAL "xtd.3rdparty.call_stack")
  ...
  set_target_properties(${APPLICATION_NAME} PROPERTIES FOLDER "${PROJECT_PATH}")
...
macro(install_component)
  ...
  install(TARGETS ${APPLICATION_NAME} EXPORT ${INSTALL_NAME})
...
if (XTD_ENABLE_COMMAND_REFERENCE_GUIDE_GENERATOR AND NOT DOXYGEN_FOUND)
  ...
  elseif (NOT DOXYGEN_FOUND AND XTD_DOWNLOAD_DOXYGEN)
    ...
    message(FATAL_ERROR "Doxygen not found try with set \"XTD_DOWNLOAD_DOXYGEN\" option to ON")
  endif ()
