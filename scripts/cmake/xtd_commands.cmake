...
macro(target_type TYPE)
  ...
  elseif ("${TYPE}" STREQUAL "SHARED_LIBRARY")
    string(TOUPPER TARGET_NAME_UPPER ${APPLICATION_NAME})
...
macro(install_component)
  ...
  if ("${APPLICATION_TYPE}" STREQUAL "CONSOLE_APPLICATION" OR "${APPLICATION_TYPE}" STREQUAL "GUI_APPLICATION")
    set(DESTINATION bin)
  else ()
    set(DESTINATION lib)
  endif ()
...
## @brief Write resources file source. Typically properties/resources.cpp
## @remarks Internal use only.
macro(write_resources_file_source)
  set(RESOURCES_FILE_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/properties/resources.cpp)

  if (APPLE AND "${APPLICATION_TYPE}" STREQUAL "GUI_APPLICATION")
    set(PREFIX_PATH "..")
  endif ()

  file(WRITE ${RESOURCES_FILE_SOURCE}
    "#pragma region xtd generated code\n"
    "// This code was generated by CMake script.\n"
    "//\n"
    "// Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.\n"
  ...
  foreach(RESOURCE_LINE ${PROJECT_RESOURCES})
    ...
    if ("${EXTENSION}" STREQUAL ".bmp" OR "${EXTENSION}" STREQUAL ".gif" OR "${EXTENSION}" STREQUAL ".jpeg" OR "${EXTENSION}" STREQUAL ".jpg" OR "${EXTENSION}" STREQUAL ".png" OR "${EXTENSION}" STREQUAL ".tif" OR "${EXTENSION}" STREQUAL ".tiff")
      file(APPEND ${RESOURCES_FILE_SOURCE}
        "const xtd::drawing::bitmap& ${APPLICATION_DEFAULT_NAMESPACE}::properties::resources::${NAME}() {\n"
    ...
    elseif ("${EXTENSION}" STREQUAL ".ico")
      file(APPEND ${RESOURCES_FILE_SOURCE}
        "const xtd::drawing::icon& ${APPLICATION_DEFAULT_NAMESPACE}::properties::resources::${NAME}() {\n"
    ...
    elseif ("${EXTENSION}" STREQUAL ".txt")
      file(APPEND ${RESOURCES_FILE_SOURCE}
        "const std::string& ${APPLICATION_DEFAULT_NAMESPACE}::properties::resources::${NAME}() {\n"
    ...
    elseif ("${EXTENSION}" STREQUAL ".wav")
      file(APPEND ${RESOURCES_FILE_SOURCE}
        "const xtd::object& ${APPLICATION_DEFAULT_NAMESPACE}::properties::resources::${NAME}() {\n"
  ...
  auto_source_group(${RESOURCES_FILE_SOURCE}) 
  set(PROJECT_SOURCES "${PROJECT_SOURCES};${RESOURCES_FILE_SOURCE}")
endmacro()
...
if (NOT "${xtd_DIR}" STREQUAL "xtd_DIR-NOTFOUND")
  ...
  if (NOT "${xtd.forms_DIR}" STREQUAL "xtd.forms_DIR-NOTFOUND")
    get_filename_component(XTD_FORMS_PATH_BASE ${xtd_DIR} DIRECTORY)
  ...
  if (NOT "${xtd.console_DIR}" STREQUAL "xtd.console_DIR-NOTFOUND")
    get_filename_component(XTD_CONSOLE_PATH_BASE ${xtd_DIR} DIRECTORY)
