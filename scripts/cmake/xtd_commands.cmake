...
macro(target_type TYPE)
  ...
  if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/locale")
    ...
    if (APPLE AND ("${TYPE}" STREQUAL "GUI_APPLICATION" OR "${TYPE}" STREQUAL "C_GUI_APPLICATION"))
      ...
      file(COPY ${CMAKE_CURRENT_SOURCE_DIR}/resources/locale DESTINATION ${CMAKE_CURRENT_BINARY_DIR})
      file(COPY ${CMAKE_CURRENT_SOURCE_DIR}/resources/locale DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/Debug)
      file(COPY ${CMAKE_CURRENT_SOURCE_DIR}/resources/locale DESTINATION DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/Release)
    endif ()
  endif ()
