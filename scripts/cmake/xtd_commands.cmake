...
macro(get_operating_system_name OPERATING_SYSTEM_NAME)
  ...
  elseif (MSYS)
    set(${OPERATING_SYSTEM_NAME} "MSYS2")
  elseif (UNIX)
...
macro(target_type TYPE)
  ...
  elseif ("${TYPE}" STREQUAL "GUI_APPLICATION" OR "${TYPE}" STREQUAL "C_GUI_APPLICATION")
    ...
    if ("${TYPE}" STREQUAL "C_GUI_APPLICATION")
      set(PROJECT_TYPE_REFERENCE xtd_c.forms)
    else()
  ...
  elseif ("${TYPE}" STREQUAL "TEST_APPLICATION" OR "${TYPE}" STREQUAL "C_TEST_APPLICATION")
    ...
    if ("${TYPE}" STREQUAL "C_TEST_APPLICATION")
      set(PROJECT_TYPE_REFERENCE xtd_c.tunit)
    else()
  ...
  elseif ("${TYPE}" STREQUAL "SHARED_LIBRARY" OR "${TYPE}" STREQUAL "C_SHARED_LIBRARY")
    ...
    if (NOT ("${TARGET_NAME}" STREQUAL "xtd.core" OR "${TARGET_NAME}" STREQUAL "xtd.3rdparty.call_stack" OR "${TARGET_NAME}" STREQUAL "xtd.core.native" OR "${TARGET_NAME}" STREQUAL "xtd.core.native.unix" OR "${TARGET_NAME}" STREQUAL "xtd.core.native.win32"))
...
##  add_sources(my_project.cpp)
##
##  assembly_copyright("© 2023 by Gammasoft.")
##
##  target_type(GUI_APPLICATION)
## @endcode
...
# standard C++
choice_options(XTD_BUILD_CPP_STANDARD "Choose c++ stadard to build xtd projects" 23 20 17 14 11 98 compiler_default)
...
if (NOT "${xtd_DIR}" STREQUAL "xtd_DIR-NOTFOUND" AND NOT "${xtd_DIR}" STREQUAL "")
  ...
  add_definitions(-D__XTD_RESOURCES_PATH__="${XTD_PATH_BASE}/share/xtd/resources")
  ...
  add_definitions(-D__XTD_DRAWING_INCLUDE_PATH__="${XTD_PATH_BASE}/include")
  add_definitions(-D__XTD_DRAWING_LIB_PATH__="${XTD_PATH_BASE}/lib")
  add_definitions(-D__XTD_DRAWING_RESOURCES_PATH__="${XTD_PATH_BASE}/share/xtd/resources")
  ...
  add_definitions(-D__XTD_TUNIT_INCLUDE_PATH__="${XTD_PATH_BASE}/include")
  add_definitions(-D__XTD_TUNIT_LIB_PATH__="${XTD_PATH_BASE}/lib")
elseif (NOT "${xtd.console_DIR}" STREQUAL "xtd.console_DIR-NOTFOUND" AND NOT "${xtd.console_DIR}" STREQUAL "")
  ...
  add_definitions(-D__XTD_INCLUDE_PATH__="${XTD_CONSOLE_PATH_BASE}/include")
  add_definitions(-D__XTD_LIB_PATH__="${XTD_CONSOLE_PATH_BASE}/lib")
  add_definitions(-D__XTD_RESOURCES_PATH__="${XTD_CONSOLE_PATH_BASE}/share/xtd/resources")
  ...
  add_definitions(-D__XTD_DRAWING_INCLUDE_PATH__="")
  add_definitions(-D__XTD_DRAWING_LIB_PATH__="")
  add_definitions(-D__XTD_DRAWING_RESOURCES_PATH__="")
  add_definitions(-D__XTD_FORMS_INCLUDE_PATH__="")
  add_definitions(-D__XTD_FORMS_LIB_PATH__="")
  add_definitions(-D__XTD_FORMS_RESOURCES_PATH__="")
  add_definitions(-D__XTD_TUNIT_INCLUDE_PATH__="")
  add_definitions(-D__XTD_TUNIT_LIB_PATH__="")
elseif (NOT "${xtd.drawing_DIR}" STREQUAL "xtd.drawing_DIR-NOTFOUND" AND NOT "${xtd.drawing_DIR}" STREQUAL "")
  get_filename_component(XTD_DRAWING_PATH_BASE "${xtd.drawing_DIR}" DIRECTORY)
  add_definitions(-D__XTD_INCLUDE_PATH__="${XTD_DRAWING_PATH_BASE}/include")
  add_definitions(-D__XTD_LIB_PATH__="${XTD_DRAWING_PATH_BASE}/lib")
  add_definitions(-D__XTD_RESOURCES_PATH__="${XTD_DRAWING_PATH_BASE}/share/xtd/resources")
  add_definitions(-D__XTD_CONSOLE_INCLUDE_PATH__="${XTD_DRAWING_PATH_BASE}/include")
  add_definitions(-D__XTD_CONSOLE_LIB_PATH__="${XTD_DRAWING_PATH_BASE}/lib")
  add_definitions(-D__XTD_DRAWING_INCLUDE_PATH__="${XTD_DRAWING_PATH_BASE}/include")
  add_definitions(-D__XTD_DRAWING_LIB_PATH__="${XTD_DRAWING_PATH_BASE}/lib")
  add_definitions(-D__XTD_DRAWING_RESOURCES_PATH__="${XTD_DRAWING_PATH_BASE}/share/xtd/resources")
  add_definitions(-D__XTD_FORMS_INCLUDE_PATH__="")
  add_definitions(-D__XTD_FORMS_LIB_PATH__="")
  add_definitions(-D__XTD_FORMS_RESOURCES_PATH__="")
  add_definitions(-D__XTD_TUNIT_INCLUDE_PATH__="")
...
elseif (NOT "${xtd.forms_DIR}" STREQUAL "xtd.forms_DIR-NOTFOUND" AND NOT "${xtd.forms_DIR}" STREQUAL "")
  ...
  add_definitions(-D__XTD_INCLUDE_PATH__="${XTD_FORMS_PATH_BASE}/include")
  add_definitions(-D__XTD_LIB_PATH__="${XTD_FORMS_PATH_BASE}/lib")
  add_definitions(-D__XTD_RESOURCES_PATH__="${XTD_FORMS_PATH_BASE}/share/xtd/resources")
  add_definitions(-D__XTD_CONSOLE_INCLUDE_PATH__="${XTD_FORMS_PATH_BASE}/include")
  add_definitions(-D__XTD_CONSOLE_LIB_PATH__="${XTD_FORMS_PATH_BASE}/lib")
  add_definitions(-D__XTD_DRAWING_INCLUDE_PATH__="${XTD_FORMS_PATH_BASE}/include")
  add_definitions(-D__XTD_DRAWING_LIB_PATH__="${XTD_FORMS_PATH_BASE}/lib")
  add_definitions(-D__XTD_DRAWING_RESOURCES_PATH__="${XTD_FORMS_PATH_BASE}/share/xtd/resources")
...
elseif (NOT "${xtd.tunit_DIR}" STREQUAL "xtd.tunit_DIR-NOTFOUND" AND NOT "${xtd.tunit_DIR}" STREQUAL "")
  get_filename_component(XTD_TUNIT_PATH_BASE "${xtd.tunit_DIR}" DIRECTORY)
  add_definitions(-D__XTD_INCLUDE_PATH__="${XTD_TUNIT_PATH_BASE}/include")
  add_definitions(-D__XTD_LIB_PATH__="${XTD_TUNIT_PATH_BASE}/lib")
  add_definitions(-D__XTD_RESOURCES_PATH__="${XTD_TUNIT_PATH_BASE}/share/xtd/resources")
  add_definitions(-D__XTD_CONSOLE_INCLUDE_PATH__="${XTD_TUNIT_PATH_BASE}/include")
  add_definitions(-D__XTD_CONSOLE_LIB_PATH__="${XTD_TUNIT_PATH_BASE}/lib")
  add_definitions(-D__XTD_DRAWING_INCLUDE_PATH__="")
  add_definitions(-D__XTD_DRAWING_LIB_PATH__="")
  add_definitions(-D__XTD_DRAWING_RESOURCES_PATH__="")
  add_definitions(-D__XTD_FORMS_INCLUDE_PATH__="")
  add_definitions(-D__XTD_FORMS_LIB_PATH__="")
  add_definitions(-D__XTD_FORMS_RESOURCES_PATH__="")
  add_definitions(-D__XTD_TUNIT_INCLUDE_PATH__="${XTD_TUNIT_PATH_BASE}/include")
  add_definitions(-D__XTD_TUNIT_LIB_PATH__="${XTD_TUNIT_PATH_BASE}/lib")
elseif (NOT "${CMAKE_INSTALL_PREFIX}" STREQUAL "")
  add_definitions(-D__XTD_INCLUDE_PATH__="${CMAKE_INSTALL_PREFIX}/include")
  add_definitions(-D__XTD_LIB_PATH__="${CMAKE_INSTALL_PREFIX}/lib")
  add_definitions(-D__XTD_RESOURCES_PATH__="${CMAKE_INSTALL_PREFIX}/share/xtd/resources")
  add_definitions(-D__XTD_CONSOLE_INCLUDE_PATH__="${CMAKE_INSTALL_PREFIX}/include")
  add_definitions(-D__XTD_CONSOLE_LIB_PATH__="${CMAKE_INSTALL_PREFIX}/lib")
  add_definitions(-D__XTD_DRAWING_INCLUDE_PATH__="${CMAKE_INSTALL_PREFIX}/include")
  add_definitions(-D__XTD_DRAWING_LIB_PATH__="${CMAKE_INSTALL_PREFIX}/lib")
  add_definitions(-D__XTD_DRAWING_RESOURCES_PATH__="${CMAKE_INSTALL_PREFIX}/share/xtd/resources")
  add_definitions(-D__XTD_FORMS_INCLUDE_PATH__="${CMAKE_INSTALL_PREFIX}/include")
  add_definitions(-D__XTD_FORMS_LIB_PATH__="${CMAKE_INSTALL_PREFIX}/lib")
  add_definitions(-D__XTD_FORMS_RESOURCES_PATH__="${CMAKE_INSTALL_PREFIX}/share/xtd/resources")
  add_definitions(-D__XTD_TUNIT_INCLUDE_PATH__="${CMAKE_INSTALL_PREFIX}/include")
  add_definitions(-D__XTD_TUNIT_LIB_PATH__="${CMAKE_INSTALL_PREFIX}/lib")
else ()
  add_definitions(-D__XTD_INCLUDE_PATH__="")
  add_definitions(-D__XTD_LIB_PATH__="")
  add_definitions(-D__XTD_RESOURCES_PATH__="")
  add_definitions(-D__XTD_CONSOLE_INCLUDE_PATH__="")
  add_definitions(-D__XTD_CONSOLE_LIB_PATH__="")
  add_definitions(-D__XTD_DRAWING_INCLUDE_PATH__="")
  add_definitions(-D__XTD_DRAWING_LIB_PATH__="")
  add_definitions(-D__XTD_DRAWING_RESOURCES_PATH__="")
  add_definitions(-D__XTD_FORMS_INCLUDE_PATH__="")
