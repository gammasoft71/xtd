...
namespace xtd {
  ...
  namespace forms {
    ...
    public:
      ...
      virtual size_t marquee_animation_speed() {return this->data_->marquee_animation_speed_;}
      ...
      virtual int32_t step() {return this->data_->step_;}
      ...
      virtual progress_bar_style style() const {return this->data_->style_;}
