...
forms::create_params button_base::create_params() const {
  ...
  switch (this->text_align_) {
    ...
    case content_alignment::middle_left: create_params.style(create_params.style() | BS_LEFT); break;
    case content_alignment::middle_center: create_params.style(create_params.style() | BS_CENTER); break;
    case content_alignment::middle_right: create_params.style(create_params.style() | BS_RIGHT); break;
