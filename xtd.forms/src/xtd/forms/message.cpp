...
std::string xtd::forms::message::to_string() const {
  ...
  return xtd::strings::format("msg={}, hwnd=0x{:X}, wparam=0x{:X}, lparam=0x{:X}", native::control_api::message_to_string(this->msg_), this->hwnd_, this->wparam_, this->lparam_, this->result_);
}
