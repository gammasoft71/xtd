...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      template<typename TestClass>
      class_cleanup_attribute(const std::string& name, TestClass& test_class, void (*method)(), const xtd::tunit::line_info& caller) {test_class.add_class_cleanup({name, method, caller});}
    };
  }
}
