...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      template<typename TestClass>
      test_method_attribute(const std::string& name, TestClass& test_class, void (TestClass::*method)(), xtd::tunit::test_state test_state, const xtd::tunit::line_info& line_info) noexcept {test_class.add_test_method({name, {test_class, method}, test_state == xtd::tunit::test_state::ignored, line_info});}
    };
  }
}
