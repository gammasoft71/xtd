...
namespace xtd {
  ...
  namespace tunit {
    ...
    public:
      ...
      test(const std::string& name, xtd::delegate<void()> method, bool ignore, const xtd::tunit::line_info& caller) noexcept : name_(name), method_(method), ignore_(ignore), info_(caller) {}
