...
namespace keycodes {
  ...
  private:
    ...
    xtd::forms::menu_item file_exit_menu_item_ {xtd::drawing::texts::exit(), overload<>(&xtd::forms::application::exit), xtd::forms::menu_images::file_exit(), xtd::forms::shortcut::ctrl_q};
