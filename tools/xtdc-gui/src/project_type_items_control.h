...
namespace xtdc_gui {
  ...
  public:
    ...
    project_type_items_control() {
      ...
      auto_scroll(true);
      back_color(xtd::forms::theme_color::current_theme_color().window());
  ...
  private:
    void on_selected_index_changed(const xtd::event_args& e) {
      ...
      if (selected_index_ != -1) {
        project_type_item_controls_[project_type_item_controls_.size() - 1 - selected_index_]->back_color(xtd::forms::theme_color::current_theme_color().accent());
        project_type_item_controls_[project_type_item_controls_.size() - 1 - selected_index_]->fore_color(xtd::forms::theme_color::current_theme_color().accent_text());
