  ...
  public:
    ...
    project_type_items_control() {
      std::vector<project_type_item> project_type_items {
        {"Solution File", "A project for creating an empty solution file.", project_language::all&~project_language::xtd, project_sdk::none, project_platform::all, project_type::solution_file},
        {"xtd Solution File", "A project for creating an empty xtd solution file.", project_language::xtd, project_sdk::none, project_platform::all, project_type::solution_file},
        {"catch2 Unit Test project (c++)", "A project for creating a catch2 unit tests application.", project_language::cpp, project_sdk::catch2, project_platform::all, project_type::unit_tests_project},
        {"gtest Unit Test project (c++)", "A project for creating a gtest unit tests application.", project_language::cpp, project_sdk::gtest, project_platform::all, project_type::unit_tests_project},
        {"xtd Unit Test project (c++)", "A project for creating a xtd unit tests application.", project_language::xtd, project_sdk::none, project_platform::all, project_type::unit_tests_project},
        {"Static library (objective-c)", "A project for creating a objective-c static class library.", project_language::objectivec, project_sdk::none, project_platform::macos, project_type::static_library},
        {"Static library (c#)", "A project for creating a c# static class library.", project_language::csharp, project_sdk::none, project_platform::windows, project_type::static_library},
        {"Static library (c)", "A project for creating a c static library.", project_language::c, project_sdk::none, project_platform::all, project_type::static_library},
        {"Static library (c++)", "A project for creating a c++ static class library.", project_language::cpp, project_sdk::none, project_platform::all, project_type::static_library},
        {"xtd Static library (c++)", "A project for creating a xtd static class library.", project_language::xtd, project_sdk::none, project_platform::all, project_type::static_library},
        {"Shared library (objective-c)", "A project for creating a objective-c shared class library.", project_language::objectivec, project_sdk::none, project_platform::macos, project_type::shared_library},
        {"Shared library (c#)", "A project for creating a c# shared class library.", project_language::csharp, project_sdk::none, project_platform::windows, project_type::shared_library},
        {"Shared library (c)", "A project for creating a c shared library.", project_language::c, project_sdk::none, project_platform::all, project_type::shared_library},
        {"Shared library (c++)", "A project for creating a c++ shared class library.", project_language::cpp, project_sdk::none, project_platform::all, project_type::shared_library},
        {"xtd Shared library (c++)", "A project for creating a xtd shared class library.", project_language::xtd, project_sdk::none, project_platform::all, project_type::shared_library},
        {"Console Application (objective-c)", "A project for creating an objective-c command-line application.", project_language::objectivec, project_sdk::none, project_platform::macos, project_type::console},
        {"Console Application (c#)", "A project for creating a c# command-line application.", project_language::csharp, project_sdk::none, project_platform::windows, project_type::console},
        {"Console Application (c)", "A project for creating a c command-line application.", project_language::c, project_sdk::none, project_platform::all, project_type::console},
        {"Console Application (c++)", "A project for creating a c++ command-line application.", project_language::cpp, project_sdk::none, project_platform::all, project_type::console},
        {"xtd Console Application (c++)", "A project for creating a xtd command-line application.", project_language::xtd, project_sdk::none, project_platform::all, project_type::console},
        ...
        {"Qt GUI Application (c++)", "A project for creating a Qt application with a graphic user interface.", project_language::cpp, project_sdk::qt5, project_platform::all, project_type::gui},
        ...
        {"xtd GUI Application (c++)", "A project for creating a xtd application with a graphic user interface.", project_language::xtd, project_sdk::none, project_platform::all, project_type::gui},
      };
