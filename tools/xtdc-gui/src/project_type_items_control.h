  ...
  public:
    ...
    project_type_items_control() {
      std::vector<project_type_item> project_type_items {
        ...
        {xtd::drawing::bitmap(xtd_staticlib_icon), "Static library (objective-c)", "A project for creating a objective-c static class library.", project_language::objectivec, project_sdk::none, project_platform::macos, project_type::static_library},
        {xtd::drawing::bitmap(xtd_staticlib_icon), "Static library (c#)", "A project for creating a c# static class library.", project_language::csharp, project_sdk::none, project_platform::windows, project_type::static_library},
        {xtd::drawing::bitmap(xtd_staticlib_icon), "Static library (c)", "A project for creating a c static library.", project_language::c, project_sdk::none, project_platform::all, project_type::static_library},
        {xtd::drawing::bitmap(xtd_staticlib_icon), "Static library (c++)", "A project for creating a c++ static class library.", project_language::cpp, project_sdk::none, project_platform::all, project_type::static_library},
        ...
        {xtd::drawing::bitmap(xtd_sharedlib_icon), "Shared library (objective-c)", "A project for creating a objective-c shared class library.", project_language::objectivec, project_sdk::none, project_platform::macos, project_type::shared_library},
        {xtd::drawing::bitmap(xtd_sharedlib_icon), "Shared library (c#)", "A project for creating a c# shared class library.", project_language::csharp, project_sdk::none, project_platform::windows, project_type::shared_library},
        {xtd::drawing::bitmap(xtd_sharedlib_icon), "Shared library (c)", "A project for creating a c shared library.", project_language::c, project_sdk::none, project_platform::all, project_type::shared_library},
        {xtd::drawing::bitmap(xtd_sharedlib_icon), "Shared library (c++)", "A project for creating a c++ shared class library.", project_language::cpp, project_sdk::none, project_platform::all, project_type::shared_library},
        ...
        {xtd::drawing::bitmap(xtd_console_icon), "Console Application (objective-c)", "A project for creating an objective-c command-line application.", project_language::objectivec, project_sdk::none, project_platform::macos, project_type::console},
        {xtd::drawing::bitmap(xtd_console_icon), "Console Application (c#)", "A project for creating a c# command-line application.", project_language::csharp, project_sdk::none, project_platform::windows, project_type::console},
        {xtd::drawing::bitmap(xtd_console_icon), "Console Application (c)", "A project for creating a c command-line application.", project_language::c, project_sdk::none, project_platform::all, project_type::console},
        {xtd::drawing::bitmap(xtd_console_icon), "Console Application (c++)", "A project for creating a c++ command-line application.", project_language::cpp, project_sdk::none, project_platform::all, project_type::console},
        ...
        {xtd::drawing::bitmap(xtd_gui_icon), "Cocoa UI Application (objective-c)", "A project for creating a cocoa application with a graphic user\ninterface.", project_language::objectivec, project_sdk::cocoa, project_platform::macos, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "Gtkmm GUI Application (c++)", "A project for creating a gtkmm application with a graphic user\ninterface.", project_language::cpp, project_sdk::gtkmm, project_platform::linux, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "Gtk+3 GUI Application (c)", "A project for creating a gtk+3 application with a graphic user\ninterface.", project_language::c, project_sdk::gtk3, project_platform::linux, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "Gtk+2 GUI Application (c)", "A project for creating a gtk+2 application with a graphic user\ninterface.", project_language::c, project_sdk::gtk2, project_platform::linux, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "WPF GUI Application (c#)", "A project for creating a WPF application with a graphic user\ninterface.", project_language::csharp, project_sdk::wpf, project_platform::windows, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "Winforms GUI Application (c#)", "A project for creating a Winforms application with a graphic user\ninterface.", project_language::csharp, project_sdk::winforms, project_platform::windows, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "Win32 GUI Application (c)", "A project for creating a Win32 application with a graphic user\ninterface.", project_language::c, project_sdk::win32, project_platform::windows, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "fltk GUI Application (c++)", "A project for creating a fltk application with a graphic user\ninterface.", project_language::cpp, project_sdk::fltk, project_platform::all, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "Qt GUI Application (c++)", "A project for creating a Qt application with a graphic user interface.", project_language::cpp, project_sdk::qt5, project_platform::all, project_type::gui},
        {xtd::drawing::bitmap(xtd_gui_icon), "wxWidgets GUI Application (c++)", "A project for creating a wxWidgets application with a graphic user\ninterface.", project_language::cpp, project_sdk::wxwidgets, project_platform::all, project_type::gui},
