...
main_form::main_form() {
  ...
  startup_open_recent_projects_list_box_.key_down += [&](control& sender, key_event_args& e) {
    if (e.key_code() == keys::del && startup_open_recent_projects_list_box_.selected_index() != 0xFFFFFFFFFFFFFFFF)
  ...
  startup_open_recent_projects_list_box_.double_click += [&] {
    if (startup_open_recent_projects_list_box_.selected_index() != 0xFFFFFFFFFFFFFFFF) {
  ...
  open_xtd_example_console_list_box_.selected_value_changed += [&] {
    if (open_xtd_example_console_list_box_.selected_index() != 0xFFFFFFFFFFFFFFFF) {
  ...
  open_xtd_example_forms_list_box_.selected_value_changed += [&] {
    if (open_xtd_example_forms_list_box_.selected_index() != 0xFFFFFFFFFFFFFFFF) {
  ...
  open_xtd_example_tunit_list_box_.selected_value_changed += [&] {
    if (open_xtd_example_tunit_list_box_.selected_index() != 0xFFFFFFFFFFFFFFFF) {
  ...
  create_create_recent_projects_list_box_.key_down += [&](control& sender, key_event_args& e) {
    if (e.key_code() == keys::del && create_create_recent_projects_list_box_.selected_index() != 0xFFFFFFFFFFFFFFFF)
