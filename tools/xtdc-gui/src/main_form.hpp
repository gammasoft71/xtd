...
namespace xtdc_gui {
  ...
  private:
    ...
    void run_project();
    void run_project(const xtd::string& project_path);
    void settings();
    void show_about_dialog();
    void update_open_xtd_examples(const xtd_example_item& item, const xtd::string& context);
    void update_open_xtd_examples_description(const xtd::string& description);
    void update_open_xtd_examples_picture(const xtd::drawing::image& picture);
    void update_open_xtd_examples_output(const xtd::string& output);
    ...
    xtd::forms::label open_xtd_examples_information_link_label_;
    ...
    xtd::forms::menu_item file_open_project_menu_item_ {"Open a project or solution", {*this, overload<>(&main_form::open_project)}, xtd::drawing::bitmap(xtd::drawing::bitmap::from_xpm_data(xtd_open_examples_icon), xtd::forms::menu_images::size()), xtd::forms::shortcut::ctrl_o};
    xtd::forms::menu_item file_run_project_menu_item_ {"Run a project", {*this, overload<>(&main_form::run_project)}, xtd::drawing::bitmap(xtd::drawing::bitmap::from_xpm_data(xtd_run_icon), xtd::forms::menu_images::size()), xtd::forms::shortcut::ctrl_r};
    xtd::forms::menu_item file_create_new_project_menu_item_ {"Create new project", {*this, overload<>(&main_form::new_project)}, xtd::drawing::bitmap(xtd::drawing::bitmap::from_xpm_data(xtd_new_icon), xtd::forms::menu_images::size()), xtd::forms::shortcut::ctrl_n};
    ...
    xtd::forms::menu_item file_exit_menu_item_ {xtd::drawing::texts::exit(), overload<>(&xtd::forms::application::exit), xtd::forms::menu_images::file_exit(), xtd::environment::os_version().is_windows() ? xtd::forms::shortcut::alt_f4 : xtd::forms::shortcut::ctrl_q};
