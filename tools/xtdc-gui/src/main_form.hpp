...
namespace xtdc_gui {
  ...
  private:
    ...
    xtd::forms::menu_item file_exit_menu_item_ {xtd::drawing::texts::exit(), overload_<>(&xtd::forms::application::exit), xtd::forms::menu_images::file_exit(), xtd::environment::os_version().is_windows() ? xtd::forms::shortcut::alt_f4 : xtd::forms::shortcut::ctrl_q};
