...
namespace xtdc_gui {
  ...
  private:
    ...
    std::vector<xtd_example_item> xtd_forms_examples_ {
      ...
      {"Common dialogs - color_dialog", "epresents a common dialog box that displays available colors along with controls that enable the user to define custom colors.", {"xtd_forms/common_dialogs/color_dialog"}},
