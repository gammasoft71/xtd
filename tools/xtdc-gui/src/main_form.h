...
namespace xtdc_gui {
  ...
  private:
    ...
    std::vector<xtd_example_item> xtd_forms_examples_ {
      ...
      {"Common dialogs - input dialog", "prompts the user to input text.", {"xtd_forms/common_dialogs/input_dialog"}},
      ...
      {"Dialogs - message box", "displays a message window, also known as a dialog box, which presents a message to the user. It is a modal window, blocking other actions in the application until the user closes it. A MessageBox can contain text, buttons, and symbols that inform and instruct the user.", {"xtd_forms/dialogs/message_box"}},
      {"Dialogs - message box (show sheet)", "displays a message window, also known as a dialog box, which presents a message to the user. It is a modal window, blocking other actions in the application until the user closes it. A MessageBox can contain text, buttons, and symbols that inform and instruct the user.", {"xtd_forms/dialogs/message_box_show_sheet"}},
