...
namespace xtdc_gui {
  ...
  private:
    ...
    std::vector<xtd_example_item> xtd_forms_examples_ {
      ...
      {"Common dialogs - about_dialog", "represents a common dialog box that displays about box.", {"xtd_forms/common_dialogs/about_dialog"}},
      {"Common dialogs - color_dialog", "represents a common dialog box that displays available colors along with controls that enable the user to define custom colors.", {"xtd_forms/common_dialogs/color_dialog"}},
      {"Common dialogs - folder_browser_dialog", "prompts the user to select a folder.", {"xtd_forms/common_dialogs/folder_browser_dialog"}},
      {"Common dialogs - font_dialog", "prompts the user to choose a font from among those installed on the local computer.", {"xtd_forms/common_dialogs/font_dialog"}},
      {"Common dialogs - message_box", "displays a message window, also known as a dialog box, which presents a message to the user. It is a modal window, blocking other actions in the application until the user closes it. A MessageBox can contain text, buttons, and symbols that inform and instruct the user.", {"xtd_forms/common_dialogs/message_box"}},
      {"Common dialogs - open_file_dialog", "displays a standard dialog box that prompts the user to open a file.", {"xtd_forms/common_dialogs/open_file_dialog"}},
      {"Common dialogs - save_file_dialog", "prompts the user to select a location for saving a file.", {"xtd_forms/common_dialogs/save_file_dialog"}},
      {"Components - background_worker", "executes an operation on a separate thread.", {"xtd_forms/components/background_worker"}},
      {"Components - button_images", "shows how to create a bitmap button with xtd::froms::button_images factory class.", {"xtd_forms/components/button_images"}},
      {"Components - cursor", "represents the image used to paint the mouse pointer.", {"xtd_forms/components/cursor"}},
      {"Components - image_list", "provides methods to manage a collection of image objects.", {"xtd_forms/components/image_list"}},
      ...
      {"Components - system_images", "demonstrates the use of xtd::drawing::system_images class.", {"xtd_forms/components/system_images"}},
      ...
      {"Containers - group_box", "represents a Windows control that displays a frame around a group of controls with an optional caption.", {"xtd_forms/containers/group_box"}},
      {"Containers - panel", "used to group collections of controls.", {"xtd_forms/containers/panel"}},
      {"Containers - tab_control", "manages a related set of tab pages.", {"xtd_forms/containers/tab_control"}},
      ...
      {"Custom dialogs - user_dialog", "demonstrates the use of xtd::forms::form as dialog.", {"xtd_forms/custom_dialogs/user_dialog"}},
