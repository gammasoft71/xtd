...
namespace xtdc_command {
  ...
  public:
    ...
    void create(const xtd::ustring& name, bool create_solution) const {
      ...
      create_catch2_unit_test_application_cmakelists_txt(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
      create_catch2_unit_test_application_source(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
      create_catch2_unit_test_application_main(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
    }
