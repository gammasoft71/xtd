...
namespace xtdc_command {
  ...
  public:
    ...
    void create(const xtd::ustring& name, bool create_solution) const {
      ...
      create_gtk2_gui_cmakelists_txt(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
      create_gtk2_gui_source(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
    }
