...
namespace xtdc_command {
  ...
  public:
    ...
    void create(const xtd::ustring& name, bool create_solution) const {
      ...
      create_c_shared_library_cmakelists_txt(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
      create_c_shared_library_export(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
      create_c_shared_library_include(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
      create_c_shared_library_source(name, create_solution ? xtd::io::path::combine(current_path(), name) : current_path());
    }
