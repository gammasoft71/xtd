...
* [xtd - kanban board](https://github.com/users/gammasoft71/projects/3) and [Roadmap](https://github.com/gammasoft71/xtd/blob/master/docs/roadmap.md) provide a view of the xtd roadmap.
* [Roadmap](https://github.com/gammasoft71/xtd/blob/master/docs/roadmap.md) provide a Kanban view for all tasks (enhancements, pull requests, bugs, questions,...).
